...
class EdsDummy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EdsDummy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.endpoint.v3'), createEmptyInstance: create)
