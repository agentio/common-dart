...
import '../../../config/endpoint/v3/load_report.pb.dart' as $174;

/// A load report Envoy sends to the management server.
class LoadStatsRequest extends $pb.GeneratedMessage {
  factory LoadStatsRequest({
    $47.Node? node,
    $core.Iterable<$174.ClusterStats>? clusterStats,
  }) {
    final $result = create();
    if (node != null) {
      $result.node = node;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LoadStatsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.load_stats.v3'), createEmptyInstance: create)
    ..aOM<$47.Node>(1, _omitFieldNames ? '' : 'node', subBuilder: $47.Node.create)
    ..pc<$174.ClusterStats>(2, _omitFieldNames ? '' : 'clusterStats', $pb.PbFieldType.PM, subBuilder: $174.ClusterStats.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$174.ClusterStats> get clusterStats => $_getList(1);
}
...
class LoadStatsResponse extends $pb.GeneratedMessage {
  factory LoadStatsResponse({
    ...
    $28.Duration? loadReportingInterval,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LoadStatsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.load_stats.v3'), createEmptyInstance: create)
    ..pPS(1, _omitFieldNames ? '' : 'clusters')
    ..aOM<$28.Duration>(2, _omitFieldNames ? '' : 'loadReportingInterval', subBuilder: $28.Duration.create)
  ...
  @$pb.TagNumber(2)
  $28.Duration get loadReportingInterval => $_getN(1);
  @$pb.TagNumber(2)
  set loadReportingInterval($28.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasLoadReportingInterval() => $_has(1);
  @$pb.TagNumber(2)
  void clearLoadReportingInterval() => clearField(2);
  @$pb.TagNumber(2)
  $28.Duration ensureLoadReportingInterval() => $_ensure(1);
