...
import '../../../api/v2/endpoint/load_report.pb.dart' as $173;
...
class LoadStatsRequest extends $pb.GeneratedMessage {
  factory LoadStatsRequest({
    $36.Node? node,
    $core.Iterable<$173.ClusterStats>? clusterStats,
  }) {
    final $result = create();
    if (node != null) {
      $result.node = node;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LoadStatsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.load_stats.v2'), createEmptyInstance: create)
    ...
    ..pc<$173.ClusterStats>(2, _omitFieldNames ? '' : 'clusterStats', $pb.PbFieldType.PM, subBuilder: $173.ClusterStats.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$173.ClusterStats> get clusterStats => $_getList(1);
}
