...
class SrdsDummy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SrdsDummy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.route.v3'), createEmptyInstance: create)
