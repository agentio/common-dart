...
import '../../../../io/prometheus/client/metrics.pb.dart' as $163;
...
class StreamMetricsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamMetricsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.metrics.v3'), createEmptyInstance: create)
...
class StreamMetricsMessage_Identifier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamMetricsMessage.Identifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.metrics.v3'), createEmptyInstance: create)
...
class StreamMetricsMessage extends $pb.GeneratedMessage {
  factory StreamMetricsMessage({
    ...
    $core.Iterable<$163.MetricFamily>? envoyMetrics,
  }) {
    final $result = create();
    if (identifier != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamMetricsMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.metrics.v3'), createEmptyInstance: create)
    ..aOM<StreamMetricsMessage_Identifier>(1, _omitFieldNames ? '' : 'identifier', subBuilder: StreamMetricsMessage_Identifier.create)
    ..pc<$163.MetricFamily>(2, _omitFieldNames ? '' : 'envoyMetrics', $pb.PbFieldType.PM, subBuilder: $163.MetricFamily.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$163.MetricFamily> get envoyMetrics => $_getList(1);
}
