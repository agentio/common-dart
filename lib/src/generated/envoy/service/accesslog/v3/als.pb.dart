...
import '../../../data/accesslog/v3/accesslog.pb.dart' as $67;
...
class StreamAccessLogsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamAccessLogsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.accesslog.v3'), createEmptyInstance: create)
...
class StreamAccessLogsMessage_Identifier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamAccessLogsMessage.Identifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.accesslog.v3'), createEmptyInstance: create)
...
class StreamAccessLogsMessage_HTTPAccessLogEntries extends $pb.GeneratedMessage {
  factory StreamAccessLogsMessage_HTTPAccessLogEntries({
    $core.Iterable<$67.HTTPAccessLogEntry>? logEntry,
  }) {
    final $result = create();
    if (logEntry != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamAccessLogsMessage.HTTPAccessLogEntries', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.accesslog.v3'), createEmptyInstance: create)
    ..pc<$67.HTTPAccessLogEntry>(1, _omitFieldNames ? '' : 'logEntry', $pb.PbFieldType.PM, subBuilder: $67.HTTPAccessLogEntry.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$67.HTTPAccessLogEntry> get logEntry => $_getList(0);
}
...
class StreamAccessLogsMessage_TCPAccessLogEntries extends $pb.GeneratedMessage {
  factory StreamAccessLogsMessage_TCPAccessLogEntries({
    $core.Iterable<$67.TCPAccessLogEntry>? logEntry,
  }) {
    final $result = create();
    if (logEntry != null) {
      $result.logEntry.addAll(logEntry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamAccessLogsMessage.TCPAccessLogEntries', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.accesslog.v3'), createEmptyInstance: create)
    ..pc<$67.TCPAccessLogEntry>(1, _omitFieldNames ? '' : 'logEntry', $pb.PbFieldType.PM, subBuilder: $67.TCPAccessLogEntry.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$67.TCPAccessLogEntry> get logEntry => $_getList(0);
}
...
class StreamAccessLogsMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamAccessLogsMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.accesslog.v3'), createEmptyInstance: create)
    ..oo(0, [2, 3])
