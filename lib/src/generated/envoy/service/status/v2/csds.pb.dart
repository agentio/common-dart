...
import '../../../admin/v2alpha/config_dump.pb.dart' as $176;
import '../../../api/v2/core/base.pb.dart' as $36;
import '../../../type/matcher/node.pb.dart' as $175;
...
class ClientStatusRequest extends $pb.GeneratedMessage {
  factory ClientStatusRequest({
    $core.Iterable<$175.NodeMatcher>? nodeMatchers,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientStatusRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.status.v2'), createEmptyInstance: create)
    ..pc<$175.NodeMatcher>(1, _omitFieldNames ? '' : 'nodeMatchers', $pb.PbFieldType.PM, subBuilder: $175.NodeMatcher.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$175.NodeMatcher> get nodeMatchers => $_getList(0);
}
...
class PerXdsConfig extends $pb.GeneratedMessage {
  factory PerXdsConfig({
    ConfigStatus? status,
    $176.ListenersConfigDump? listenerConfig,
    $176.ClustersConfigDump? clusterConfig,
    $176.RoutesConfigDump? routeConfig,
    $176.ScopedRoutesConfigDump? scopedRouteConfig,
  }) {
    final $result = create();
    if (status != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PerXdsConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.status.v2'), createEmptyInstance: create)
    ...
    ..aOM<$176.ListenersConfigDump>(2, _omitFieldNames ? '' : 'listenerConfig', subBuilder: $176.ListenersConfigDump.create)
    ..aOM<$176.ClustersConfigDump>(3, _omitFieldNames ? '' : 'clusterConfig', subBuilder: $176.ClustersConfigDump.create)
    ..aOM<$176.RoutesConfigDump>(4, _omitFieldNames ? '' : 'routeConfig', subBuilder: $176.RoutesConfigDump.create)
    ..aOM<$176.ScopedRoutesConfigDump>(5, _omitFieldNames ? '' : 'scopedRouteConfig', subBuilder: $176.ScopedRoutesConfigDump.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $176.ListenersConfigDump get listenerConfig => $_getN(1);
  @$pb.TagNumber(2)
  set listenerConfig($176.ListenersConfigDump v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasListenerConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearListenerConfig() => clearField(2);
  @$pb.TagNumber(2)
  $176.ListenersConfigDump ensureListenerConfig() => $_ensure(1);

  @$pb.TagNumber(3)
  $176.ClustersConfigDump get clusterConfig => $_getN(2);
  @$pb.TagNumber(3)
  set clusterConfig($176.ClustersConfigDump v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasClusterConfig() => $_has(2);
  @$pb.TagNumber(3)
  void clearClusterConfig() => clearField(3);
  @$pb.TagNumber(3)
  $176.ClustersConfigDump ensureClusterConfig() => $_ensure(2);

  @$pb.TagNumber(4)
  $176.RoutesConfigDump get routeConfig => $_getN(3);
  @$pb.TagNumber(4)
  set routeConfig($176.RoutesConfigDump v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasRouteConfig() => $_has(3);
  @$pb.TagNumber(4)
  void clearRouteConfig() => clearField(4);
  @$pb.TagNumber(4)
  $176.RoutesConfigDump ensureRouteConfig() => $_ensure(3);

  @$pb.TagNumber(5)
  $176.ScopedRoutesConfigDump get scopedRouteConfig => $_getN(4);
  @$pb.TagNumber(5)
  set scopedRouteConfig($176.ScopedRoutesConfigDump v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasScopedRouteConfig() => $_has(4);
  @$pb.TagNumber(5)
  void clearScopedRouteConfig() => clearField(5);
  @$pb.TagNumber(5)
  $176.ScopedRoutesConfigDump ensureScopedRouteConfig() => $_ensure(4);
}
