...
import '../../../admin/v3/config_dump_shared.pb.dart' as $150;
import '../../../admin/v3/config_dump_shared.pbenum.dart' as $150;
import '../../../config/core/v3/base.pb.dart' as $47;
import '../../../type/matcher/v3/node.pb.dart' as $177;
...
class ClientStatusRequest extends $pb.GeneratedMessage {
  factory ClientStatusRequest({
    $core.Iterable<$177.NodeMatcher>? nodeMatchers,
    $47.Node? node,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientStatusRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.status.v3'), createEmptyInstance: create)
    ..pc<$177.NodeMatcher>(1, _omitFieldNames ? '' : 'nodeMatchers', $pb.PbFieldType.PM, subBuilder: $177.NodeMatcher.create)
    ..aOM<$47.Node>(2, _omitFieldNames ? '' : 'node', subBuilder: $47.Node.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$177.NodeMatcher> get nodeMatchers => $_getList(0);

  /// The node making the csds request.
  @$pb.TagNumber(2)
  $47.Node get node => $_getN(1);
  @$pb.TagNumber(2)
  set node($47.Node v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasNode() => $_has(1);
  @$pb.TagNumber(2)
  void clearNode() => clearField(2);
  @$pb.TagNumber(2)
  $47.Node ensureNode() => $_ensure(1);
...
class PerXdsConfig extends $pb.GeneratedMessage {
  factory PerXdsConfig({
    ConfigStatus? status,
    $150.ListenersConfigDump? listenerConfig,
    $150.ClustersConfigDump? clusterConfig,
    $150.RoutesConfigDump? routeConfig,
    $150.ScopedRoutesConfigDump? scopedRouteConfig,
    $150.EndpointsConfigDump? endpointConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PerXdsConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.status.v3'), createEmptyInstance: create)
    ...
    ..aOM<$150.ListenersConfigDump>(2, _omitFieldNames ? '' : 'listenerConfig', subBuilder: $150.ListenersConfigDump.create)
    ..aOM<$150.ClustersConfigDump>(3, _omitFieldNames ? '' : 'clusterConfig', subBuilder: $150.ClustersConfigDump.create)
    ..aOM<$150.RoutesConfigDump>(4, _omitFieldNames ? '' : 'routeConfig', subBuilder: $150.RoutesConfigDump.create)
    ..aOM<$150.ScopedRoutesConfigDump>(5, _omitFieldNames ? '' : 'scopedRouteConfig', subBuilder: $150.ScopedRoutesConfigDump.create)
    ..aOM<$150.EndpointsConfigDump>(6, _omitFieldNames ? '' : 'endpointConfig', subBuilder: $150.EndpointsConfigDump.create)
  ...
  @$pb.TagNumber(2)
  $150.ListenersConfigDump get listenerConfig => $_getN(1);
  @$pb.TagNumber(2)
  set listenerConfig($150.ListenersConfigDump v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasListenerConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearListenerConfig() => clearField(2);
  @$pb.TagNumber(2)
  $150.ListenersConfigDump ensureListenerConfig() => $_ensure(1);

  @$pb.TagNumber(3)
  $150.ClustersConfigDump get clusterConfig => $_getN(2);
  @$pb.TagNumber(3)
  set clusterConfig($150.ClustersConfigDump v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasClusterConfig() => $_has(2);
  @$pb.TagNumber(3)
  void clearClusterConfig() => clearField(3);
  @$pb.TagNumber(3)
  $150.ClustersConfigDump ensureClusterConfig() => $_ensure(2);

  @$pb.TagNumber(4)
  $150.RoutesConfigDump get routeConfig => $_getN(3);
  @$pb.TagNumber(4)
  set routeConfig($150.RoutesConfigDump v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasRouteConfig() => $_has(3);
  @$pb.TagNumber(4)
  void clearRouteConfig() => clearField(4);
  @$pb.TagNumber(4)
  $150.RoutesConfigDump ensureRouteConfig() => $_ensure(3);

  @$pb.TagNumber(5)
  $150.ScopedRoutesConfigDump get scopedRouteConfig => $_getN(4);
  @$pb.TagNumber(5)
  set scopedRouteConfig($150.ScopedRoutesConfigDump v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasScopedRouteConfig() => $_has(4);
  @$pb.TagNumber(5)
  void clearScopedRouteConfig() => clearField(5);
  @$pb.TagNumber(5)
  $150.ScopedRoutesConfigDump ensureScopedRouteConfig() => $_ensure(4);

  @$pb.TagNumber(6)
  $150.EndpointsConfigDump get endpointConfig => $_getN(5);
  @$pb.TagNumber(6)
  set endpointConfig($150.EndpointsConfigDump v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasEndpointConfig() => $_has(5);
  @$pb.TagNumber(6)
  void clearEndpointConfig() => clearField(6);
  @$pb.TagNumber(6)
  $150.EndpointsConfigDump ensureEndpointConfig() => $_ensure(5);
...
class ClientConfig_GenericXdsConfig extends $pb.GeneratedMessage {
  factory ClientConfig_GenericXdsConfig({
    ...
    $34.Any? xdsConfig,
    $65.Timestamp? lastUpdated,
    ConfigStatus? configStatus,
    $150.ClientResourceStatus? clientStatus,
    $150.UpdateFailureState? errorState,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientConfig.GenericXdsConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.status.v3'), createEmptyInstance: create)
    ...
    ..aOM<$34.Any>(4, _omitFieldNames ? '' : 'xdsConfig', subBuilder: $34.Any.create)
    ..aOM<$65.Timestamp>(5, _omitFieldNames ? '' : 'lastUpdated', subBuilder: $65.Timestamp.create)
    ...
    ..e<$150.ClientResourceStatus>(7, _omitFieldNames ? '' : 'clientStatus', $pb.PbFieldType.OE, defaultOrMaker: $150.ClientResourceStatus.UNKNOWN, valueOf: $150.ClientResourceStatus.valueOf, enumValues: $150.ClientResourceStatus.values)
    ..aOM<$150.UpdateFailureState>(8, _omitFieldNames ? '' : 'errorState', subBuilder: $150.UpdateFailureState.create)
  ...
  @$pb.TagNumber(4)
  $34.Any get xdsConfig => $_getN(3);
  @$pb.TagNumber(4)
  set xdsConfig($34.Any v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasXdsConfig() => $_has(3);
  @$pb.TagNumber(4)
  void clearXdsConfig() => clearField(4);
  @$pb.TagNumber(4)
  $34.Any ensureXdsConfig() => $_ensure(3);

  /// Timestamp when the xDS resource was last updated
  @$pb.TagNumber(5)
  $65.Timestamp get lastUpdated => $_getN(4);
  @$pb.TagNumber(5)
  set lastUpdated($65.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasLastUpdated() => $_has(4);
  @$pb.TagNumber(5)
  void clearLastUpdated() => clearField(5);
  @$pb.TagNumber(5)
  $65.Timestamp ensureLastUpdated() => $_ensure(4);
  ...
  @$pb.TagNumber(7)
  $150.ClientResourceStatus get clientStatus => $_getN(6);
  @$pb.TagNumber(7)
  set clientStatus($150.ClientResourceStatus v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasClientStatus() => $_has(6);
  @$pb.TagNumber(7)
  void clearClientStatus() => clearField(7);
  ...
  /// [#not-implemented-hide:]
  @$pb.TagNumber(8)
  $150.UpdateFailureState get errorState => $_getN(7);
  @$pb.TagNumber(8)
  set errorState($150.UpdateFailureState v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasErrorState() => $_has(7);
  @$pb.TagNumber(8)
  void clearErrorState() => clearField(8);
  @$pb.TagNumber(8)
  $150.UpdateFailureState ensureErrorState() => $_ensure(7);
...
class ClientConfig extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    if (clientScope != null) {
      $result.clientScope = clientScope;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.status.v3'), createEmptyInstance: create)
    ...
    ..aOS(4, _omitFieldNames ? '' : 'clientScope')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $core.String get clientScope => $_getSZ(3);
  @$pb.TagNumber(4)
  set clientScope($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasClientScope() => $_has(3);
  @$pb.TagNumber(4)
  void clearClientScope() => clearField(4);
}
