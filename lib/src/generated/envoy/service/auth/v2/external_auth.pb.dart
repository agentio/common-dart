...
import 'attribute_context.pb.dart' as $158;

class CheckRequest extends $pb.GeneratedMessage {
  factory CheckRequest({
    $158.AttributeContext? attributes,
  }) {
    final $result = create();
    if (attributes != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.auth.v2'), createEmptyInstance: create)
    ..aOM<$158.AttributeContext>(1, _omitFieldNames ? '' : 'attributes', subBuilder: $158.AttributeContext.create)
  ...
  @$pb.TagNumber(1)
  $158.AttributeContext get attributes => $_getN(0);
  @$pb.TagNumber(1)
  set attributes($158.AttributeContext v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAttributes() => $_has(0);
  @$pb.TagNumber(1)
  void clearAttributes() => clearField(1);
  @$pb.TagNumber(1)
  $158.AttributeContext ensureAttributes() => $_ensure(0);
}

/// HTTP attributes for a denied response.
class DeniedHttpResponse extends $pb.GeneratedMessage {
  factory DeniedHttpResponse({
    $120.HttpStatus? status,
    $core.Iterable<$36.HeaderValueOption>? headers,
    $core.String? body,
  }) {
    final $result = create();
    if (status != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeniedHttpResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.auth.v2'), createEmptyInstance: create)
    ..aOM<$120.HttpStatus>(1, _omitFieldNames ? '' : 'status', subBuilder: $120.HttpStatus.create)
    ..pc<$36.HeaderValueOption>(2, _omitFieldNames ? '' : 'headers', $pb.PbFieldType.PM, subBuilder: $36.HeaderValueOption.create)
  ...
  @$pb.TagNumber(1)
  $120.HttpStatus get status => $_getN(0);
  @$pb.TagNumber(1)
  set status($120.HttpStatus v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasStatus() => $_has(0);
  @$pb.TagNumber(1)
  void clearStatus() => clearField(1);
  @$pb.TagNumber(1)
  $120.HttpStatus ensureStatus() => $_ensure(0);

  /// This field allows the authorization service to send HTTP response headers
  /// to the downstream client. Note that the `append` field in `HeaderValueOption` defaults to
  /// false when used in this message.
  @$pb.TagNumber(2)
  $core.List<$36.HeaderValueOption> get headers => $_getList(1);
...
class OkHttpResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $core.List<$36.HeaderValueOption> get headers => $_getList(0);
}
