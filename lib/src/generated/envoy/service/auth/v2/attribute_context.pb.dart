...
class AttributeContext_Peer extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.Peer', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.auth.v2'), createEmptyInstance: create)
    ..aOM<$31.Address>(1, _omitFieldNames ? '' : 'address', subBuilder: $31.Address.create)
    ..aOS(2, _omitFieldNames ? '' : 'service')
    ..m<$core.String, $core.String>(3, _omitFieldNames ? '' : 'labels', entryClassName: 'AttributeContext.Peer.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('envoy.service.auth.v2'))
...
class AttributeContext_Request extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.Request', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.auth.v2'), createEmptyInstance: create)
    ..aOM<$65.Timestamp>(1, _omitFieldNames ? '' : 'time', subBuilder: $65.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  $65.Timestamp get time => $_getN(0);
  @$pb.TagNumber(1)
  set time($65.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTime() => $_has(0);
  @$pb.TagNumber(1)
  void clearTime() => clearField(1);
  @$pb.TagNumber(1)
  $65.Timestamp ensureTime() => $_ensure(0);
...
class AttributeContext_HttpRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.HttpRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.auth.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'method')
    ..m<$core.String, $core.String>(3, _omitFieldNames ? '' : 'headers', entryClassName: 'AttributeContext.HttpRequest.HeadersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('envoy.service.auth.v2'))
...
class AttributeContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.auth.v2'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(10, _omitFieldNames ? '' : 'contextExtensions', entryClassName: 'AttributeContext.ContextExtensionsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('envoy.service.auth.v2'))
    ..aOM<$36.Metadata>(11, _omitFieldNames ? '' : 'metadataContext', subBuilder: $36.Metadata.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(11)
  $36.Metadata get metadataContext => $_getN(4);
  @$pb.TagNumber(11)
  set metadataContext($36.Metadata v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasMetadataContext() => $_has(4);
  @$pb.TagNumber(11)
  void clearMetadataContext() => clearField(11);
  @$pb.TagNumber(11)
  $36.Metadata ensureMetadataContext() => $_ensure(4);
}
