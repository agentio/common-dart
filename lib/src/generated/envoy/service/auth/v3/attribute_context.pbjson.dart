...
const AttributeContext_HttpRequest$json = {
  ...
  '2': [
    ...
    {'1': 'headers', '3': 3, '4': 3, '5': 11, '6': '.envoy.service.auth.v3.AttributeContext.HttpRequest.HeadersEntry', '8': {}, '10': 'headers'},
    {'1': 'header_map', '3': 13, '4': 1, '5': 11, '6': '.envoy.config.core.v3.HeaderMap', '8': {}, '10': 'headerMap'},
...
final $typed_data.Uint8List attributeContextDescriptor = $convert.base64Decode(
    ...
    'djIuQXR0cmlidXRlQ29udGV4dC5SZXF1ZXN0GsUECgtIdHRwUmVxdWVzdBIOCgJpZBgBIAEoCV'
    'ICaWQSFgoGbWV0aG9kGAIgASgJUgZtZXRob2QScAoHaGVhZGVycxgDIAMoCzJALmVudm95LnNl'
    'cnZpY2UuYXV0aC52My5BdHRyaWJ1dGVDb250ZXh0Lkh0dHBSZXF1ZXN0LkhlYWRlcnNFbnRyeU'
    'IU8pj+jwUOEgxoZWFkZXJzX3R5cGVSB2hlYWRlcnMSVAoKaGVhZGVyX21hcBgNIAEoCzIfLmVu'
    'dm95LmNvbmZpZy5jb3JlLnYzLkhlYWRlck1hcEIU8pj+jwUOEgxoZWFkZXJzX3R5cGVSCWhlYW'
    'Rlck1hcBISCgRwYXRoGAQgASgJUgRwYXRoEhIKBGhvc3QYBSABKAlSBGhvc3QSFgoGc2NoZW1l'
    'GAYgASgJUgZzY2hlbWUSFAoFcXVlcnkYByABKAlSBXF1ZXJ5EhoKCGZyYWdtZW50GAggASgJUg'
    'hmcmFnbWVudBISCgRzaXplGAkgASgDUgRzaXplEhoKCHByb3RvY29sGAogASgJUghwcm90b2Nv'
    'bBISCgRib2R5GAsgASgJUgRib2R5EhkKCHJhd19ib2R5GAwgASgMUgdyYXdCb2R5GjoKDEhlYW'
    'RlcnNFbnRyeRIQCgNrZXkYASABKAlSA2tleRIUCgV2YWx1ZRgCIAEoCVIFdmFsdWU6AjgBOjma'
    'xYgeNAoyZW52b3kuc2VydmljZS5hdXRoLnYyLkF0dHJpYnV0ZUNvbnRleHQuSHR0cFJlcXVlc3'
    'QaHgoKVExTU2Vzc2lvbhIQCgNzbmkYASABKAlSA3NuaRpEChZDb250ZXh0RXh0ZW5zaW9uc0Vu'
    'dHJ5EhAKA2tleRgBIAEoCVIDa2V5EhQKBXZhbHVlGAIgASgJUgV2YWx1ZToCOAE6LZrFiB4oCi'
    'ZlbnZveS5zZXJ2aWNlLmF1dGgudjIuQXR0cmlidXRlQ29udGV4dA==');
