...
import 'attribute_context.pb.dart' as $159;

class CheckRequest extends $pb.GeneratedMessage {
  factory CheckRequest({
    $159.AttributeContext? attributes,
  }) {
    final $result = create();
    if (attributes != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.auth.v3'), createEmptyInstance: create)
    ..aOM<$159.AttributeContext>(1, _omitFieldNames ? '' : 'attributes', subBuilder: $159.AttributeContext.create)
  ...
  @$pb.TagNumber(1)
  $159.AttributeContext get attributes => $_getN(0);
  @$pb.TagNumber(1)
  set attributes($159.AttributeContext v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAttributes() => $_has(0);
  @$pb.TagNumber(1)
  void clearAttributes() => clearField(1);
  @$pb.TagNumber(1)
  $159.AttributeContext ensureAttributes() => $_ensure(0);
}
...
class DeniedHttpResponse extends $pb.GeneratedMessage {
  factory DeniedHttpResponse({
    ...
    $core.Iterable<$47.HeaderValueOption>? headers,
    $core.String? body,
  }) {
    final $result = create();
    if (status != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeniedHttpResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.auth.v3'), createEmptyInstance: create)
    ...
    ..pc<$47.HeaderValueOption>(2, _omitFieldNames ? '' : 'headers', $pb.PbFieldType.PM, subBuilder: $47.HeaderValueOption.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$47.HeaderValueOption> get headers => $_getList(1);
...
class OkHttpResponse extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    $core.Iterable<$47.QueryParameter>? queryParametersToSet,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OkHttpResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.auth.v3'), createEmptyInstance: create)
    ..pc<$47.HeaderValueOption>(2, _omitFieldNames ? '' : 'headers', $pb.PbFieldType.PM, subBuilder: $47.HeaderValueOption.create)
    ..aOM<$30.Struct>(3, _omitFieldNames ? '' : 'dynamicMetadata', subBuilder: $30.Struct.create)
    ...
    ..pc<$47.QueryParameter>(7, _omitFieldNames ? '' : 'queryParametersToSet', $pb.PbFieldType.PM, subBuilder: $47.QueryParameter.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$47.HeaderValueOption> get headers => $_getList(0);
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(3)
  $30.Struct get dynamicMetadata => $_getN(1);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(3)
  set dynamicMetadata($30.Struct v) { setField(3, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(3)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(3)
  $30.Struct ensureDynamicMetadata() => $_ensure(1);
  ...
  @$pb.TagNumber(7)
  $core.List<$47.QueryParameter> get queryParametersToSet => $_getList(4);
...
class CheckResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.auth.v3'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOM<$157.Status>(1, _omitFieldNames ? '' : 'status', subBuilder: $157.Status.create)
    ...
    ..aOM<$30.Struct>(4, _omitFieldNames ? '' : 'dynamicMetadata', subBuilder: $30.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $157.Status get status => $_getN(0);
  @$pb.TagNumber(1)
  set status($157.Status v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasStatus() => $_has(0);
  @$pb.TagNumber(1)
  void clearStatus() => clearField(1);
  @$pb.TagNumber(1)
  $157.Status ensureStatus() => $_ensure(0);
  ...
  @$pb.TagNumber(4)
  $30.Struct get dynamicMetadata => $_getN(3);
  @$pb.TagNumber(4)
  set dynamicMetadata($30.Struct v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDynamicMetadata() => $_has(3);
  @$pb.TagNumber(4)
  void clearDynamicMetadata() => clearField(4);
  @$pb.TagNumber(4)
  $30.Struct ensureDynamicMetadata() => $_ensure(3);
}
