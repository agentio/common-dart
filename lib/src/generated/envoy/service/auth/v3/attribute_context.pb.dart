...
class AttributeContext_HttpRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.HttpRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.auth.v3'), createEmptyInstance: create)
    ...
    ..aOM<$47.HeaderMap>(13, _omitFieldNames ? '' : 'headerMap', subBuilder: $47.HeaderMap.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(13)
  $47.HeaderMap get headerMap => $_getN(12);
  @$pb.TagNumber(13)
  set headerMap($47.HeaderMap v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasHeaderMap() => $_has(12);
  @$pb.TagNumber(13)
  void clearHeaderMap() => clearField(13);
  @$pb.TagNumber(13)
  $47.HeaderMap ensureHeaderMap() => $_ensure(12);
}
...
class AttributeContext extends $pb.GeneratedMessage {
  factory AttributeContext({
    ...
    $47.Metadata? routeMetadataContext,
  }) {
    final $result = create();
    if (source != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.auth.v3'), createEmptyInstance: create)
    ...
    ..aOM<$47.Metadata>(11, _omitFieldNames ? '' : 'metadataContext', subBuilder: $47.Metadata.create)
    ..aOM<AttributeContext_TLSSession>(12, _omitFieldNames ? '' : 'tlsSession', subBuilder: AttributeContext_TLSSession.create)
    ..aOM<$47.Metadata>(13, _omitFieldNames ? '' : 'routeMetadataContext', subBuilder: $47.Metadata.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(11)
  $47.Metadata get metadataContext => $_getN(4);
  @$pb.TagNumber(11)
  set metadataContext($47.Metadata v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasMetadataContext() => $_has(4);
  @$pb.TagNumber(11)
  void clearMetadataContext() => clearField(11);
  @$pb.TagNumber(11)
  $47.Metadata ensureMetadataContext() => $_ensure(4);
  ...
  @$pb.TagNumber(13)
  $47.Metadata get routeMetadataContext => $_getN(6);
  @$pb.TagNumber(13)
  set routeMetadataContext($47.Metadata v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasRouteMetadataContext() => $_has(6);
  @$pb.TagNumber(13)
  void clearRouteMetadataContext() => clearField(13);
  @$pb.TagNumber(13)
  $47.Metadata ensureRouteMetadataContext() => $_ensure(6);
}
