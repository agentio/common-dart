...
import '../v2/external_auth.pb.dart' as $4;

export 'external_auth.pb.dart';

@$pb.GrpcServiceName('envoy.service.auth.v2alpha.Authorization')
...
abstract class AuthorizationServiceBase extends $grpc.Service {
  $core.String get $name => 'envoy.service.auth.v2alpha.Authorization';
