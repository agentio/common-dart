...
import '../../../config/core/v3/health_check.pb.dart' as $103;
import '../../../config/core/v3/health_check.pbenum.dart' as $103;
import '../../../config/endpoint/v3/endpoint_components.pb.dart' as $104;
...
class EndpointHealth extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EndpointHealth', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.health.v3'), createEmptyInstance: create)
    ..aOM<$104.Endpoint>(1, _omitFieldNames ? '' : 'endpoint', subBuilder: $104.Endpoint.create)
  ...
  @$pb.TagNumber(1)
  $104.Endpoint get endpoint => $_getN(0);
  @$pb.TagNumber(1)
  set endpoint($104.Endpoint v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasEndpoint() => $_has(0);
  @$pb.TagNumber(1)
  void clearEndpoint() => clearField(1);
  @$pb.TagNumber(1)
  $104.Endpoint ensureEndpoint() => $_ensure(0);
...
class LocalityEndpoints extends $pb.GeneratedMessage {
  factory LocalityEndpoints({
    $47.Locality? locality,
    $core.Iterable<$104.Endpoint>? endpoints,
  }) {
    final $result = create();
    if (locality != null) {
      $result.locality = locality;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LocalityEndpoints', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.health.v3'), createEmptyInstance: create)
    ..aOM<$47.Locality>(1, _omitFieldNames ? '' : 'locality', subBuilder: $47.Locality.create)
    ..pc<$104.Endpoint>(2, _omitFieldNames ? '' : 'endpoints', $pb.PbFieldType.PM, subBuilder: $104.Endpoint.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$104.Endpoint> get endpoints => $_getList(1);
}
...
class ClusterHealthCheck extends $pb.GeneratedMessage {
  factory ClusterHealthCheck({
    ...
    $core.Iterable<$115.Cluster_TransportSocketMatch>? transportSocketMatches,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClusterHealthCheck', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.health.v3'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'clusterName')
    ..pc<$103.HealthCheck>(2, _omitFieldNames ? '' : 'healthChecks', $pb.PbFieldType.PM, subBuilder: $103.HealthCheck.create)
    ..pc<LocalityEndpoints>(3, _omitFieldNames ? '' : 'localityEndpoints', $pb.PbFieldType.PM, subBuilder: LocalityEndpoints.create)
    ..pc<$115.Cluster_TransportSocketMatch>(4, _omitFieldNames ? '' : 'transportSocketMatches', $pb.PbFieldType.PM, subBuilder: $115.Cluster_TransportSocketMatch.create)
    ..aOM<$42.BindConfig>(5, _omitFieldNames ? '' : 'upstreamBindConfig', subBuilder: $42.BindConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$103.HealthCheck> get healthChecks => $_getList(1);
  ...
  @$pb.TagNumber(4)
  $core.List<$115.Cluster_TransportSocketMatch> get transportSocketMatches => $_getList(3);

  /// Optional configuration used to bind newly established upstream connections.
  /// If the address and port are empty, no bind will be performed.
  @$pb.TagNumber(5)
  $42.BindConfig get upstreamBindConfig => $_getN(4);
  @$pb.TagNumber(5)
  set upstreamBindConfig($42.BindConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasUpstreamBindConfig() => $_has(4);
  @$pb.TagNumber(5)
  void clearUpstreamBindConfig() => clearField(5);
  @$pb.TagNumber(5)
  $42.BindConfig ensureUpstreamBindConfig() => $_ensure(4);
}
