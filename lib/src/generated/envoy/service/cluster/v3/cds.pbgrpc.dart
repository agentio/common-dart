...
@$pb.GrpcServiceName('envoy.service.cluster.v3.ClusterDiscoveryService')
class ClusterDiscoveryServiceClient extends $grpc.Client {
  static final _$streamClusters = $grpc.ClientMethod<$3.DiscoveryRequest, $3.DiscoveryResponse>(
  ...
  static final _$deltaClusters = $grpc.ClientMethod<$3.DeltaDiscoveryRequest, $3.DeltaDiscoveryResponse>(
  ...
  static final _$fetchClusters = $grpc.ClientMethod<$3.DiscoveryRequest, $3.DiscoveryResponse>(
  ...
  $grpc.ResponseStream<$3.DiscoveryResponse> streamClusters($async.Stream<$3.DiscoveryRequest> request, {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$streamClusters, request, options: options);
  }

  $grpc.ResponseStream<$3.DeltaDiscoveryResponse> deltaClusters($async.Stream<$3.DeltaDiscoveryRequest> request, {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$deltaClusters, request, options: options);
  }

  $grpc.ResponseFuture<$3.DiscoveryResponse> fetchClusters($3.DiscoveryRequest request, {$grpc.CallOptions? options}) {
...
abstract class ClusterDiscoveryServiceBase extends $grpc.Service {
  $core.String get $name => 'envoy.service.cluster.v3.ClusterDiscoveryService';
  ...
  $async.Future<$3.DiscoveryResponse> fetchClusters_Pre($grpc.ServiceCall call, $async.Future<$3.DiscoveryRequest> request) async {
    return fetchClusters(call, await request);
  }

  $async.Stream<$3.DiscoveryResponse> streamClusters($grpc.ServiceCall call, $async.Stream<$3.DiscoveryRequest> request);
  $async.Stream<$3.DeltaDiscoveryResponse> deltaClusters($grpc.ServiceCall call, $async.Stream<$3.DeltaDiscoveryRequest> request);
  $async.Future<$3.DiscoveryResponse> fetchClusters($grpc.ServiceCall call, $3.DiscoveryRequest request);
}
