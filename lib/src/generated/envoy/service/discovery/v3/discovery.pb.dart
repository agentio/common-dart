...
class DiscoveryRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DiscoveryRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.discovery.v3'), createEmptyInstance: create)
    ...
    ..aOM<$157.Status>(6, _omitFieldNames ? '' : 'errorDetail', subBuilder: $157.Status.create)
  ...
  @$pb.TagNumber(6)
  $157.Status get errorDetail => $_getN(5);
  @$pb.TagNumber(6)
  set errorDetail($157.Status v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasErrorDetail() => $_has(5);
  @$pb.TagNumber(6)
  void clearErrorDetail() => clearField(6);
  @$pb.TagNumber(6)
  $157.Status ensureErrorDetail() => $_ensure(5);
...
class DiscoveryResponse extends $pb.GeneratedMessage {
  factory DiscoveryResponse({
    $core.String? versionInfo,
    $core.Iterable<$34.Any>? resources,
    $core.bool? canary,
    $core.String? typeUrl,
    $core.String? nonce,
    $47.ControlPlane? controlPlane,
  }) {
    final $result = create();
    if (versionInfo != null) {
      $result.versionInfo = versionInfo;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DiscoveryResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.discovery.v3'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'versionInfo')
    ..pc<$34.Any>(2, _omitFieldNames ? '' : 'resources', $pb.PbFieldType.PM, subBuilder: $34.Any.create)
    ..aOB(3, _omitFieldNames ? '' : 'canary')
    ..aOS(4, _omitFieldNames ? '' : 'typeUrl')
    ..aOS(5, _omitFieldNames ? '' : 'nonce')
    ..aOM<$47.ControlPlane>(6, _omitFieldNames ? '' : 'controlPlane', subBuilder: $47.ControlPlane.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$34.Any> get resources => $_getList(1);
  ...
  @$pb.TagNumber(6)
  $47.ControlPlane get controlPlane => $_getN(5);
  @$pb.TagNumber(6)
  set controlPlane($47.ControlPlane v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasControlPlane() => $_has(5);
  @$pb.TagNumber(6)
  void clearControlPlane() => clearField(6);
  @$pb.TagNumber(6)
  $47.ControlPlane ensureControlPlane() => $_ensure(5);
}
...
class DeltaDiscoveryRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeltaDiscoveryRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.discovery.v3'), createEmptyInstance: create)
    ...
    ..aOM<$157.Status>(7, _omitFieldNames ? '' : 'errorDetail', subBuilder: $157.Status.create)
  ...
  @$pb.TagNumber(7)
  $157.Status get errorDetail => $_getN(6);
  @$pb.TagNumber(7)
  set errorDetail($157.Status v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasErrorDetail() => $_has(6);
  @$pb.TagNumber(7)
  void clearErrorDetail() => clearField(7);
  @$pb.TagNumber(7)
  $157.Status ensureErrorDetail() => $_ensure(6);
...
class DeltaDiscoveryResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeltaDiscoveryResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.discovery.v3'), createEmptyInstance: create)
    ...
    ..aOM<$47.ControlPlane>(7, _omitFieldNames ? '' : 'controlPlane', subBuilder: $47.ControlPlane.create)
  ...
  $47.ControlPlane get controlPlane => $_getN(5);
  @$pb.TagNumber(7)
  set controlPlane($47.ControlPlane v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasControlPlane() => $_has(5);
  @$pb.TagNumber(7)
...
class Resource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Resource', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.discovery.v3'), createEmptyInstance: create)
    ...
    ..aOM<$34.Any>(2, _omitFieldNames ? '' : 'resource', subBuilder: $34.Any.create)
    ..aOS(3, _omitFieldNames ? '' : 'name')
    ..pPS(4, _omitFieldNames ? '' : 'aliases')
    ..aOM<$28.Duration>(6, _omitFieldNames ? '' : 'ttl', subBuilder: $28.Duration.create)
  ...
  @$pb.TagNumber(2)
  $34.Any get resource => $_getN(1);
  @$pb.TagNumber(2)
  set resource($34.Any v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasResource() => $_has(1);
  @$pb.TagNumber(2)
  void clearResource() => clearField(2);
  @$pb.TagNumber(2)
  $34.Any ensureResource() => $_ensure(1);
  ...
  @$pb.TagNumber(6)
  $28.Duration get ttl => $_getN(4);
  @$pb.TagNumber(6)
  set ttl($28.Duration v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasTtl() => $_has(4);
  @$pb.TagNumber(6)
  void clearTtl() => clearField(6);
  @$pb.TagNumber(6)
  $28.Duration ensureTtl() => $_ensure(4);
