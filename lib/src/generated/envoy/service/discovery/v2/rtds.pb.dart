...
class RtdsDummy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RtdsDummy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.discovery.v2'), createEmptyInstance: create)
...
class Runtime extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Runtime', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.discovery.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$30.Struct>(2, _omitFieldNames ? '' : 'layer', subBuilder: $30.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $30.Struct get layer => $_getN(1);
  @$pb.TagNumber(2)
  set layer($30.Struct v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasLayer() => $_has(1);
  @$pb.TagNumber(2)
  void clearLayer() => clearField(2);
  @$pb.TagNumber(2)
  $30.Struct ensureLayer() => $_ensure(1);
}
