...
import '../../../data/tap/v3/wrapper.pb.dart' as $172;
...
class StreamTapsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamTapsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.tap.v3'), createEmptyInstance: create)
    ...
    ..aOM<$172.TraceWrapper>(3, _omitFieldNames ? '' : 'trace', subBuilder: $172.TraceWrapper.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The trace data.
  @$pb.TagNumber(3)
  $172.TraceWrapper get trace => $_getN(2);
  @$pb.TagNumber(3)
  set trace($172.TraceWrapper v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasTrace() => $_has(2);
  @$pb.TagNumber(3)
  void clearTrace() => clearField(3);
  @$pb.TagNumber(3)
  $172.TraceWrapper ensureTrace() => $_ensure(2);
}
