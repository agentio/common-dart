...
class RateLimitRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimitRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.ratelimit.v2'), createEmptyInstance: create)
    ...
    ..pc<$132.RateLimitDescriptor>(2, _omitFieldNames ? '' : 'descriptors', $pb.PbFieldType.PM, subBuilder: $132.RateLimitDescriptor.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$132.RateLimitDescriptor> get descriptors => $_getList(1);
...
class RateLimitResponse extends $pb.GeneratedMessage {
  factory RateLimitResponse({
    ...
    $core.Iterable<$36.HeaderValue>? requestHeadersToAdd,
  }) {
    final $result = create();
    if (overallCode != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimitResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.ratelimit.v2'), createEmptyInstance: create)
    ...
    ..pc<$36.HeaderValue>(3, _omitFieldNames ? '' : 'headers', $pb.PbFieldType.PM, subBuilder: $36.HeaderValue.create)
    ..pc<$36.HeaderValue>(4, _omitFieldNames ? '' : 'requestHeadersToAdd', $pb.PbFieldType.PM, subBuilder: $36.HeaderValue.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.List<$36.HeaderValue> get headers => $_getList(2);

  /// A list of headers to add to the request when forwarded
  @$pb.TagNumber(4)
  $core.List<$36.HeaderValue> get requestHeadersToAdd => $_getList(3);
}
