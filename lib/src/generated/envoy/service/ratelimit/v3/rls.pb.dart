...
import '../../../extensions/common/ratelimit/v3/ratelimit.pb.dart' as $156;
...
class RateLimitRequest extends $pb.GeneratedMessage {
  factory RateLimitRequest({
    $core.String? domain,
    $core.Iterable<$156.RateLimitDescriptor>? descriptors,
    $core.int? hitsAddend,
  }) {
    final $result = create();
    if (domain != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimitRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.ratelimit.v3'), createEmptyInstance: create)
    ...
    ..pc<$156.RateLimitDescriptor>(2, _omitFieldNames ? '' : 'descriptors', $pb.PbFieldType.PM, subBuilder: $156.RateLimitDescriptor.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$156.RateLimitDescriptor> get descriptors => $_getList(1);
...
class RateLimitResponse_Quota extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimitResponse.Quota', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.ratelimit.v3'), createEmptyInstance: create)
    ...
    ..aOM<$65.Timestamp>(2, _omitFieldNames ? '' : 'validUntil', subBuilder: $65.Timestamp.create)
  ...
  @$pb.TagNumber(2)
  $65.Timestamp get validUntil => $_getN(1);
  @$pb.TagNumber(2)
  set validUntil($65.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValidUntil() => $_has(1);
  @$pb.TagNumber(2)
  void clearValidUntil() => clearField(2);
  @$pb.TagNumber(2)
  $65.Timestamp ensureValidUntil() => $_ensure(1);
...
class RateLimitResponse_DescriptorStatus extends $pb.GeneratedMessage {
  factory RateLimitResponse_DescriptorStatus({
    ...
    $28.Duration? durationUntilReset,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimitResponse.DescriptorStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.ratelimit.v3'), createEmptyInstance: create)
    ...
    ..aOM<$28.Duration>(4, _omitFieldNames ? '' : 'durationUntilReset', subBuilder: $28.Duration.create)
  ...
  @$pb.TagNumber(4)
  $28.Duration get durationUntilReset => $_getN(3);
  @$pb.TagNumber(4)
  set durationUntilReset($28.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDurationUntilReset() => $_has(3);
  @$pb.TagNumber(4)
  void clearDurationUntilReset() => clearField(4);
  @$pb.TagNumber(4)
  $28.Duration ensureDurationUntilReset() => $_ensure(3);
...
class RateLimitResponse extends $pb.GeneratedMessage {
  factory RateLimitResponse({
    ...
    $core.Iterable<$47.HeaderValue>? responseHeadersToAdd,
    $core.Iterable<$47.HeaderValue>? requestHeadersToAdd,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimitResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.ratelimit.v3'), createEmptyInstance: create)
    ...
    ..pc<$47.HeaderValue>(3, _omitFieldNames ? '' : 'responseHeadersToAdd', $pb.PbFieldType.PM, subBuilder: $47.HeaderValue.create)
    ..pc<$47.HeaderValue>(4, _omitFieldNames ? '' : 'requestHeadersToAdd', $pb.PbFieldType.PM, subBuilder: $47.HeaderValue.create)
    ..a<$core.List<$core.int>>(5, _omitFieldNames ? '' : 'rawBody', $pb.PbFieldType.OY)
    ..aOM<$30.Struct>(6, _omitFieldNames ? '' : 'dynamicMetadata', subBuilder: $30.Struct.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$47.HeaderValue> get responseHeadersToAdd => $_getList(2);

  /// A list of headers to add to the request when forwarded
  @$pb.TagNumber(4)
  $core.List<$47.HeaderValue> get requestHeadersToAdd => $_getList(3);
  ...
  @$pb.TagNumber(6)
  $30.Struct get dynamicMetadata => $_getN(5);
  @$pb.TagNumber(6)
  set dynamicMetadata($30.Struct v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasDynamicMetadata() => $_has(5);
  @$pb.TagNumber(6)
  void clearDynamicMetadata() => clearField(6);
  @$pb.TagNumber(6)
  $30.Struct ensureDynamicMetadata() => $_ensure(5);
