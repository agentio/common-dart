...
class StreamEventsRequest_Identifier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamEventsRequest.Identifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.event_reporting.v3'), createEmptyInstance: create)
...
class StreamEventsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamEventsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.event_reporting.v3'), createEmptyInstance: create)
    ..aOM<StreamEventsRequest_Identifier>(1, _omitFieldNames ? '' : 'identifier', subBuilder: StreamEventsRequest_Identifier.create)
    ..pc<$34.Any>(2, _omitFieldNames ? '' : 'events', $pb.PbFieldType.PM, subBuilder: $34.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$34.Any> get events => $_getList(1);
}
...
class StreamEventsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamEventsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.event_reporting.v3'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
