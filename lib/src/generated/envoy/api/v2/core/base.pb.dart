...
import '../../../type/semantic_version.pb.dart' as $29;
import 'address.pb.dart' as $31;
import 'backoff.pb.dart' as $32;
import 'http_uri.pb.dart' as $33;
...
class BuildVersion extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BuildVersion', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.core'), createEmptyInstance: create)
    ..aOM<$29.SemanticVersion>(1, _omitFieldNames ? '' : 'version', subBuilder: $29.SemanticVersion.create)
  ...
  @$pb.TagNumber(1)
  $29.SemanticVersion get version => $_getN(0);
  @$pb.TagNumber(1)
  set version($29.SemanticVersion v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasVersion() => $_has(0);
  @$pb.TagNumber(1)
  void clearVersion() => clearField(1);
  @$pb.TagNumber(1)
  $29.SemanticVersion ensureVersion() => $_ensure(0);
...
class Node extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    $core.Iterable<$31.Address>? listeningAddresses,
  }) {
    final $result = create();
    if (id != null) {
      $result.id = id;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Node', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.core'), createEmptyInstance: create)
    ...
    ..pc<$31.Address>(11, _omitFieldNames ? '' : 'listeningAddresses', $pb.PbFieldType.PM, subBuilder: $31.Address.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(11)
  $core.List<$31.Address> get listeningAddresses => $_getList(10);
}
...
class Metadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Metadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.core'), createEmptyInstance: create)
    ..m<$core.String, $30.Struct>(1, _omitFieldNames ? '' : 'filterMetadata', entryClassName: 'Metadata.FilterMetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $30.Struct.create, valueDefaultOrMaker: $30.Struct.getDefault, packageName: const $pb.PackageName('envoy.api.v2.core'))
    ..hasRequiredFields = false
  ;
...
class RetryPolicy extends $pb.GeneratedMessage {
  factory RetryPolicy({
    $32.BackoffStrategy? retryBackOff,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RetryPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.core'), createEmptyInstance: create)
    ..aOM<$32.BackoffStrategy>(1, _omitFieldNames ? '' : 'retryBackOff', subBuilder: $32.BackoffStrategy.create)
  ...
  @$pb.TagNumber(1)
  $32.BackoffStrategy get retryBackOff => $_getN(0);
  @$pb.TagNumber(1)
  set retryBackOff($32.BackoffStrategy v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasRetryBackOff() => $_has(0);
  @$pb.TagNumber(1)
  void clearRetryBackOff() => clearField(1);
  @$pb.TagNumber(1)
  $32.BackoffStrategy ensureRetryBackOff() => $_ensure(0);
...
class RemoteDataSource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RemoteDataSource', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.core'), createEmptyInstance: create)
    ..aOM<$33.HttpUri>(1, _omitFieldNames ? '' : 'httpUri', subBuilder: $33.HttpUri.create)
  ...
  @$pb.TagNumber(1)
  $33.HttpUri get httpUri => $_getN(0);
  @$pb.TagNumber(1)
  set httpUri($33.HttpUri v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasHttpUri() => $_has(0);
  @$pb.TagNumber(1)
  void clearHttpUri() => clearField(1);
  @$pb.TagNumber(1)
  $33.HttpUri ensureHttpUri() => $_ensure(0);
...
class RuntimeFractionalPercent extends $pb.GeneratedMessage {
  factory RuntimeFractionalPercent({
    $35.FractionalPercent? defaultValue,
    $core.String? runtimeKey,
  }) {
    final $result = create();
    if (defaultValue != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RuntimeFractionalPercent', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.core'), createEmptyInstance: create)
    ..aOM<$35.FractionalPercent>(1, _omitFieldNames ? '' : 'defaultValue', subBuilder: $35.FractionalPercent.create)
    ..aOS(2, _omitFieldNames ? '' : 'runtimeKey')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $35.FractionalPercent get defaultValue => $_getN(0);
  @$pb.TagNumber(1)
  set defaultValue($35.FractionalPercent v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDefaultValue() => $_has(0);
  @$pb.TagNumber(1)
  void clearDefaultValue() => clearField(1);
  @$pb.TagNumber(1)
  $35.FractionalPercent ensureDefaultValue() => $_ensure(0);
