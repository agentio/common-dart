...
import '../../../../google/protobuf/empty.pb.dart' as $37;
...
class GrpcService_EnvoyGrpc extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrpcService.EnvoyGrpc', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.core'), createEmptyInstance: create)
...
class GrpcService_GoogleGrpc_SslCredentials extends $pb.GeneratedMessage {
  factory GrpcService_GoogleGrpc_SslCredentials({
    $36.DataSource? rootCerts,
    $36.DataSource? privateKey,
    $36.DataSource? certChain,
  }) {
    final $result = create();
    if (rootCerts != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrpcService.GoogleGrpc.SslCredentials', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.core'), createEmptyInstance: create)
    ..aOM<$36.DataSource>(1, _omitFieldNames ? '' : 'rootCerts', subBuilder: $36.DataSource.create)
    ..aOM<$36.DataSource>(2, _omitFieldNames ? '' : 'privateKey', subBuilder: $36.DataSource.create)
    ..aOM<$36.DataSource>(3, _omitFieldNames ? '' : 'certChain', subBuilder: $36.DataSource.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $36.DataSource get rootCerts => $_getN(0);
  @$pb.TagNumber(1)
  set rootCerts($36.DataSource v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasRootCerts() => $_has(0);
  @$pb.TagNumber(1)
  void clearRootCerts() => clearField(1);
  @$pb.TagNumber(1)
  $36.DataSource ensureRootCerts() => $_ensure(0);

  /// PEM encoded client private key.
  @$pb.TagNumber(2)
  $36.DataSource get privateKey => $_getN(1);
  @$pb.TagNumber(2)
  set privateKey($36.DataSource v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPrivateKey() => $_has(1);
  @$pb.TagNumber(2)
  void clearPrivateKey() => clearField(2);
  @$pb.TagNumber(2)
  $36.DataSource ensurePrivateKey() => $_ensure(1);

  /// PEM encoded client certificate chain.
  @$pb.TagNumber(3)
  $36.DataSource get certChain => $_getN(2);
  @$pb.TagNumber(3)
  set certChain($36.DataSource v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCertChain() => $_has(2);
  @$pb.TagNumber(3)
  void clearCertChain() => clearField(3);
  @$pb.TagNumber(3)
  $36.DataSource ensureCertChain() => $_ensure(2);
}
...
class GrpcService_GoogleGrpc_GoogleLocalCredentials extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrpcService.GoogleGrpc.GoogleLocalCredentials', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.core'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class GrpcService_GoogleGrpc_ChannelCredentials extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrpcService.GoogleGrpc.ChannelCredentials', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.core'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ...
    ..aOM<$37.Empty>(2, _omitFieldNames ? '' : 'googleDefault', subBuilder: $37.Empty.create)
  ...
  @$pb.TagNumber(2)
  $37.Empty get googleDefault => $_getN(1);
  @$pb.TagNumber(2)
  set googleDefault($37.Empty v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasGoogleDefault() => $_has(1);
  @$pb.TagNumber(2)
  void clearGoogleDefault() => clearField(2);
  @$pb.TagNumber(2)
  $37.Empty ensureGoogleDefault() => $_ensure(1);
...
class GrpcService_GoogleGrpc_CallCredentials_ServiceAccountJWTAccessCredentials extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrpcService.GoogleGrpc.CallCredentials.ServiceAccountJWTAccessCredentials', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.core'), createEmptyInstance: create)
...
class GrpcService_GoogleGrpc_CallCredentials_GoogleIAMCredentials extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrpcService.GoogleGrpc.CallCredentials.GoogleIAMCredentials', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.core'), createEmptyInstance: create)
...
class GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin_ConfigType> _GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin_ConfigTypeByTag = {
    2 : GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin_ConfigType.config,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrpcService.GoogleGrpc.CallCredentials.MetadataCredentialsFromPlugin', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.core'), createEmptyInstance: create)
    ..oo(0, [2, 3])
...
class GrpcService_GoogleGrpc_CallCredentials_StsService extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrpcService.GoogleGrpc.CallCredentials.StsService', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.core'), createEmptyInstance: create)
...
class GrpcService_GoogleGrpc_CallCredentials extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrpcService.GoogleGrpc.CallCredentials', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.core'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5, 6, 7])
    ..aOS(1, _omitFieldNames ? '' : 'accessToken')
    ..aOM<$37.Empty>(2, _omitFieldNames ? '' : 'googleComputeEngine', subBuilder: $37.Empty.create)
  ...
  /// https://grpc.io/grpc/cpp/namespacegrpc.html#a6beb3ac70ff94bd2ebbd89b8f21d1f61
  @$pb.TagNumber(2)
  $37.Empty get googleComputeEngine => $_getN(1);
  @$pb.TagNumber(2)
  set googleComputeEngine($37.Empty v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasGoogleComputeEngine() => $_has(1);
  @$pb.TagNumber(2)
  void clearGoogleComputeEngine() => clearField(2);
  @$pb.TagNumber(2)
  $37.Empty ensureGoogleComputeEngine() => $_ensure(1);
...
class GrpcService_GoogleGrpc extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrpcService.GoogleGrpc', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.core'), createEmptyInstance: create)
    ...
    ..aOM<$30.Struct>(6, _omitFieldNames ? '' : 'config', subBuilder: $30.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  /// gRPC library.
  @$pb.TagNumber(6)
  $30.Struct get config => $_getN(5);
  @$pb.TagNumber(6)
  set config($30.Struct v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasConfig() => $_has(5);
  @$pb.TagNumber(6)
  void clearConfig() => clearField(6);
  @$pb.TagNumber(6)
  $30.Struct ensureConfig() => $_ensure(5);
}
...
class GrpcService extends $pb.GeneratedMessage {
  factory GrpcService({
    ...
    $28.Duration? timeout,
    $core.Iterable<$36.HeaderValue>? initialMetadata,
  }) {
    final $result = create();
    if (envoyGrpc != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrpcService', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.core'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ...
    ..aOM<$28.Duration>(3, _omitFieldNames ? '' : 'timeout', subBuilder: $28.Duration.create)
    ..pc<$36.HeaderValue>(5, _omitFieldNames ? '' : 'initialMetadata', $pb.PbFieldType.PM, subBuilder: $36.HeaderValue.create)
    ..hasRequiredFields = false
  ;
  ...
  /// request.
  @$pb.TagNumber(3)
  $28.Duration get timeout => $_getN(2);
  @$pb.TagNumber(3)
  set timeout($28.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasTimeout() => $_has(2);
  @$pb.TagNumber(3)
  void clearTimeout() => clearField(3);
  @$pb.TagNumber(3)
  $28.Duration ensureTimeout() => $_ensure(2);

  /// Additional metadata to include in streams initiated to the GrpcService.
  /// This can be used for scenarios in which additional ad hoc authorization
  /// headers (e.g. ``x-foo-bar: baz-key``) are to be injected.
  @$pb.TagNumber(5)
  $core.List<$36.HeaderValue> get initialMetadata => $_getList(3);
}
