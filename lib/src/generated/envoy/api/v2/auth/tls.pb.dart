...
import 'common.pb.dart' as $76;
import 'secret.pb.dart' as $77;
...
class DownstreamTlsContext extends $pb.GeneratedMessage {
  factory DownstreamTlsContext({
    ...
    $76.TlsSessionTicketKeys? sessionTicketKeys,
    $77.SdsSecretConfig? sessionTicketKeysSdsSecretConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DownstreamTlsContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.auth'), createEmptyInstance: create)
    ...
    ..aOM<$76.TlsSessionTicketKeys>(4, _omitFieldNames ? '' : 'sessionTicketKeys', subBuilder: $76.TlsSessionTicketKeys.create)
    ..aOM<$77.SdsSecretConfig>(5, _omitFieldNames ? '' : 'sessionTicketKeysSdsSecretConfig', subBuilder: $77.SdsSecretConfig.create)
  ...
  @$pb.TagNumber(4)
  $76.TlsSessionTicketKeys get sessionTicketKeys => $_getN(3);
  @$pb.TagNumber(4)
  set sessionTicketKeys($76.TlsSessionTicketKeys v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasSessionTicketKeys() => $_has(3);
  @$pb.TagNumber(4)
  void clearSessionTicketKeys() => clearField(4);
  @$pb.TagNumber(4)
  $76.TlsSessionTicketKeys ensureSessionTicketKeys() => $_ensure(3);

  /// Config for fetching TLS session ticket keys via SDS API.
  @$pb.TagNumber(5)
  $77.SdsSecretConfig get sessionTicketKeysSdsSecretConfig => $_getN(4);
  @$pb.TagNumber(5)
  set sessionTicketKeysSdsSecretConfig($77.SdsSecretConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasSessionTicketKeysSdsSecretConfig() => $_has(4);
  @$pb.TagNumber(5)
  void clearSessionTicketKeysSdsSecretConfig() => clearField(5);
  @$pb.TagNumber(5)
  $77.SdsSecretConfig ensureSessionTicketKeysSdsSecretConfig() => $_ensure(4);
...
class CommonTlsContext_CombinedCertificateValidationContext extends $pb.GeneratedMessage {
  factory CommonTlsContext_CombinedCertificateValidationContext({
    $76.CertificateValidationContext? defaultValidationContext,
    $77.SdsSecretConfig? validationContextSdsSecretConfig,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommonTlsContext.CombinedCertificateValidationContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.auth'), createEmptyInstance: create)
    ..aOM<$76.CertificateValidationContext>(1, _omitFieldNames ? '' : 'defaultValidationContext', subBuilder: $76.CertificateValidationContext.create)
    ..aOM<$77.SdsSecretConfig>(2, _omitFieldNames ? '' : 'validationContextSdsSecretConfig', subBuilder: $77.SdsSecretConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $76.CertificateValidationContext get defaultValidationContext => $_getN(0);
  @$pb.TagNumber(1)
  set defaultValidationContext($76.CertificateValidationContext v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDefaultValidationContext() => $_has(0);
  @$pb.TagNumber(1)
  void clearDefaultValidationContext() => clearField(1);
  @$pb.TagNumber(1)
  $76.CertificateValidationContext ensureDefaultValidationContext() => $_ensure(0);

  /// Config for fetching validation context via SDS API.
  @$pb.TagNumber(2)
  $77.SdsSecretConfig get validationContextSdsSecretConfig => $_getN(1);
  @$pb.TagNumber(2)
  set validationContextSdsSecretConfig($77.SdsSecretConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValidationContextSdsSecretConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearValidationContextSdsSecretConfig() => clearField(2);
  @$pb.TagNumber(2)
  $77.SdsSecretConfig ensureValidationContextSdsSecretConfig() => $_ensure(1);
}
...
class CommonTlsContext extends $pb.GeneratedMessage {
  factory CommonTlsContext({
    $76.TlsParameters? tlsParams,
    $core.Iterable<$76.TlsCertificate>? tlsCertificates,
    $76.CertificateValidationContext? validationContext,
    $core.Iterable<$core.String>? alpnProtocols,
    $core.Iterable<$77.SdsSecretConfig>? tlsCertificateSdsSecretConfigs,
    $77.SdsSecretConfig? validationContextSdsSecretConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommonTlsContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.auth'), createEmptyInstance: create)
    ..oo(0, [3, 7, 8])
    ..aOM<$76.TlsParameters>(1, _omitFieldNames ? '' : 'tlsParams', subBuilder: $76.TlsParameters.create)
    ..pc<$76.TlsCertificate>(2, _omitFieldNames ? '' : 'tlsCertificates', $pb.PbFieldType.PM, subBuilder: $76.TlsCertificate.create)
    ..aOM<$76.CertificateValidationContext>(3, _omitFieldNames ? '' : 'validationContext', subBuilder: $76.CertificateValidationContext.create)
    ..pPS(4, _omitFieldNames ? '' : 'alpnProtocols')
    ..pc<$77.SdsSecretConfig>(6, _omitFieldNames ? '' : 'tlsCertificateSdsSecretConfigs', $pb.PbFieldType.PM, subBuilder: $77.SdsSecretConfig.create)
    ..aOM<$77.SdsSecretConfig>(7, _omitFieldNames ? '' : 'validationContextSdsSecretConfig', subBuilder: $77.SdsSecretConfig.create)
  ...
  @$pb.TagNumber(1)
  $76.TlsParameters get tlsParams => $_getN(0);
  @$pb.TagNumber(1)
  set tlsParams($76.TlsParameters v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTlsParams() => $_has(0);
  @$pb.TagNumber(1)
  void clearTlsParams() => clearField(1);
  @$pb.TagNumber(1)
  $76.TlsParameters ensureTlsParams() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $core.List<$76.TlsCertificate> get tlsCertificates => $_getList(1);

  /// How to validate peer certificates.
  @$pb.TagNumber(3)
  $76.CertificateValidationContext get validationContext => $_getN(2);
  @$pb.TagNumber(3)
  set validationContext($76.CertificateValidationContext v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasValidationContext() => $_has(2);
  @$pb.TagNumber(3)
  void clearValidationContext() => clearField(3);
  @$pb.TagNumber(3)
  $76.CertificateValidationContext ensureValidationContext() => $_ensure(2);
  ...
  @$pb.TagNumber(6)
  $core.List<$77.SdsSecretConfig> get tlsCertificateSdsSecretConfigs => $_getList(4);

  /// Config for fetching validation context via SDS API.
  @$pb.TagNumber(7)
  $77.SdsSecretConfig get validationContextSdsSecretConfig => $_getN(5);
  @$pb.TagNumber(7)
  set validationContextSdsSecretConfig($77.SdsSecretConfig v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasValidationContextSdsSecretConfig() => $_has(5);
  @$pb.TagNumber(7)
  void clearValidationContextSdsSecretConfig() => clearField(7);
  @$pb.TagNumber(7)
  $77.SdsSecretConfig ensureValidationContextSdsSecretConfig() => $_ensure(5);
