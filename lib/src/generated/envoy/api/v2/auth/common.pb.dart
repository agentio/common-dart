...
class TlsCertificate extends $pb.GeneratedMessage {
  factory TlsCertificate({
    $36.DataSource? certificateChain,
    $36.DataSource? privateKey,
    $36.DataSource? password,
    $36.DataSource? ocspStaple,
    $core.Iterable<$36.DataSource>? signedCertificateTimestamp,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TlsCertificate', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.auth'), createEmptyInstance: create)
    ..aOM<$36.DataSource>(1, _omitFieldNames ? '' : 'certificateChain', subBuilder: $36.DataSource.create)
    ..aOM<$36.DataSource>(2, _omitFieldNames ? '' : 'privateKey', subBuilder: $36.DataSource.create)
    ..aOM<$36.DataSource>(3, _omitFieldNames ? '' : 'password', subBuilder: $36.DataSource.create)
    ..aOM<$36.DataSource>(4, _omitFieldNames ? '' : 'ocspStaple', subBuilder: $36.DataSource.create)
    ..pc<$36.DataSource>(5, _omitFieldNames ? '' : 'signedCertificateTimestamp', $pb.PbFieldType.PM, subBuilder: $36.DataSource.create)
  ...
  @$pb.TagNumber(1)
  $36.DataSource get certificateChain => $_getN(0);
  @$pb.TagNumber(1)
  set certificateChain($36.DataSource v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCertificateChain() => $_has(0);
  @$pb.TagNumber(1)
  void clearCertificateChain() => clearField(1);
  @$pb.TagNumber(1)
  $36.DataSource ensureCertificateChain() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $36.DataSource get password => $_getN(2);
  @$pb.TagNumber(3)
  set password($36.DataSource v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasPassword() => $_has(2);
  @$pb.TagNumber(3)
  void clearPassword() => clearField(3);
  @$pb.TagNumber(3)
  $36.DataSource ensurePassword() => $_ensure(2);

  /// [#not-implemented-hide:]
  @$pb.TagNumber(4)
  $36.DataSource get ocspStaple => $_getN(3);
  @$pb.TagNumber(4)
  set ocspStaple($36.DataSource v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasOcspStaple() => $_has(3);
  @$pb.TagNumber(4)
  void clearOcspStaple() => clearField(4);
  @$pb.TagNumber(4)
  $36.DataSource ensureOcspStaple() => $_ensure(3);

  /// [#not-implemented-hide:]
  @$pb.TagNumber(5)
  $core.List<$36.DataSource> get signedCertificateTimestamp => $_getList(4);
...
class TlsSessionTicketKeys extends $pb.GeneratedMessage {
  factory TlsSessionTicketKeys({
    $core.Iterable<$36.DataSource>? keys,
  }) {
    final $result = create();
    if (keys != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TlsSessionTicketKeys', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.auth'), createEmptyInstance: create)
    ..pc<$36.DataSource>(1, _omitFieldNames ? '' : 'keys', $pb.PbFieldType.PM, subBuilder: $36.DataSource.create)
    ..hasRequiredFields = false
  ;
...
class CertificateValidationContext extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    $26.BoolValue? requireOcspStaple,
    $26.BoolValue? requireSignedCertificateTimestamp,
    $36.DataSource? crl,
    $core.bool? allowExpiredCertificate,
    $core.Iterable<$74.StringMatcher>? matchSubjectAltNames,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CertificateValidationContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.auth'), createEmptyInstance: create)
    ..aOM<$36.DataSource>(1, _omitFieldNames ? '' : 'trustedCa', subBuilder: $36.DataSource.create)
    ...
    ..aOM<$26.BoolValue>(5, _omitFieldNames ? '' : 'requireOcspStaple', subBuilder: $26.BoolValue.create)
    ..aOM<$26.BoolValue>(6, _omitFieldNames ? '' : 'requireSignedCertificateTimestamp', subBuilder: $26.BoolValue.create)
    ..aOM<$36.DataSource>(7, _omitFieldNames ? '' : 'crl', subBuilder: $36.DataSource.create)
    ..aOB(8, _omitFieldNames ? '' : 'allowExpiredCertificate')
    ..pc<$74.StringMatcher>(9, _omitFieldNames ? '' : 'matchSubjectAltNames', $pb.PbFieldType.PM, subBuilder: $74.StringMatcher.create)
  ...
  ///  system CA locations.
  @$pb.TagNumber(1)
  $36.DataSource get trustedCa => $_getN(0);
  @$pb.TagNumber(1)
  set trustedCa($36.DataSource v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTrustedCa() => $_has(0);
  @$pb.TagNumber(1)
  void clearTrustedCa() => clearField(1);
  @$pb.TagNumber(1)
  $36.DataSource ensureTrustedCa() => $_ensure(0);
  ...
  @$pb.TagNumber(5)
  $26.BoolValue get requireOcspStaple => $_getN(4);
  @$pb.TagNumber(5)
  set requireOcspStaple($26.BoolValue v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasRequireOcspStaple() => $_has(4);
  @$pb.TagNumber(5)
  void clearRequireOcspStaple() => clearField(5);
  @$pb.TagNumber(5)
  $26.BoolValue ensureRequireOcspStaple() => $_ensure(4);

  /// [#not-implemented-hide:] Must present signed certificate time-stamp.
  @$pb.TagNumber(6)
  $26.BoolValue get requireSignedCertificateTimestamp => $_getN(5);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(6)
  $26.BoolValue ensureRequireSignedCertificateTimestamp() => $_ensure(5);
  ...
  @$pb.TagNumber(7)
  $36.DataSource get crl => $_getN(6);
  @$pb.TagNumber(7)
  set crl($36.DataSource v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasCrl() => $_has(6);
  @$pb.TagNumber(7)
  void clearCrl() => clearField(7);
  @$pb.TagNumber(7)
  $36.DataSource ensureCrl() => $_ensure(6);
  ...
  ///    <envoy_api_field_auth.CertificateValidationContext.trusted_ca>`.
  @$pb.TagNumber(9)
  $core.List<$74.StringMatcher> get matchSubjectAltNames => $_getList(8);
