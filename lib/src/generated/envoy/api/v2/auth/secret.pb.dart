...
class GenericSecret extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenericSecret', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.auth'), createEmptyInstance: create)
    ..aOM<$36.DataSource>(1, _omitFieldNames ? '' : 'secret', subBuilder: $36.DataSource.create)
  ...
  @$pb.TagNumber(1)
  $36.DataSource get secret => $_getN(0);
  @$pb.TagNumber(1)
  set secret($36.DataSource v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSecret() => $_has(0);
  @$pb.TagNumber(1)
  void clearSecret() => clearField(1);
  @$pb.TagNumber(1)
  $36.DataSource ensureSecret() => $_ensure(0);
}

class SdsSecretConfig extends $pb.GeneratedMessage {
  factory SdsSecretConfig({
    $core.String? name,
    $75.ConfigSource? sdsConfig,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SdsSecretConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.auth'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$75.ConfigSource>(2, _omitFieldNames ? '' : 'sdsConfig', subBuilder: $75.ConfigSource.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $75.ConfigSource get sdsConfig => $_getN(1);
  @$pb.TagNumber(2)
  set sdsConfig($75.ConfigSource v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSdsConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearSdsConfig() => clearField(2);
  @$pb.TagNumber(2)
  $75.ConfigSource ensureSdsConfig() => $_ensure(1);
}
...
class Secret extends $pb.GeneratedMessage {
  factory Secret({
    $core.String? name,
    $76.TlsCertificate? tlsCertificate,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Secret', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.auth'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5])
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$76.TlsCertificate>(2, _omitFieldNames ? '' : 'tlsCertificate', subBuilder: $76.TlsCertificate.create)
    ..aOM<$76.TlsSessionTicketKeys>(3, _omitFieldNames ? '' : 'sessionTicketKeys', subBuilder: $76.TlsSessionTicketKeys.create)
    ..aOM<$76.CertificateValidationContext>(4, _omitFieldNames ? '' : 'validationContext', subBuilder: $76.CertificateValidationContext.create)
  ...
  @$pb.TagNumber(2)
  $76.TlsCertificate get tlsCertificate => $_getN(1);
  @$pb.TagNumber(2)
  set tlsCertificate($76.TlsCertificate v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTlsCertificate() => $_has(1);
  @$pb.TagNumber(2)
  void clearTlsCertificate() => clearField(2);
  @$pb.TagNumber(2)
  $76.TlsCertificate ensureTlsCertificate() => $_ensure(1);

  @$pb.TagNumber(3)
  $76.TlsSessionTicketKeys get sessionTicketKeys => $_getN(2);
  @$pb.TagNumber(3)
  set sessionTicketKeys($76.TlsSessionTicketKeys v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSessionTicketKeys() => $_has(2);
  @$pb.TagNumber(3)
  void clearSessionTicketKeys() => clearField(3);
  @$pb.TagNumber(3)
  $76.TlsSessionTicketKeys ensureSessionTicketKeys() => $_ensure(2);

  @$pb.TagNumber(4)
  $76.CertificateValidationContext get validationContext => $_getN(3);
  @$pb.TagNumber(4)
  set validationContext($76.CertificateValidationContext v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasValidationContext() => $_has(3);
  @$pb.TagNumber(4)
  void clearValidationContext() => clearField(4);
  @$pb.TagNumber(4)
  $76.CertificateValidationContext ensureValidationContext() => $_ensure(3);
