...
import 'route/route_components.pb.dart' as $91;

/// [#next-free-field: 11]
class RouteConfiguration extends $pb.GeneratedMessage {
  factory RouteConfiguration({
    $core.String? name,
    $core.Iterable<$91.VirtualHost>? virtualHosts,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RouteConfiguration', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2'), createEmptyInstance: create)
    ...
    ..pc<$91.VirtualHost>(2, _omitFieldNames ? '' : 'virtualHosts', $pb.PbFieldType.PM, subBuilder: $91.VirtualHost.create)
    ..pPS(3, _omitFieldNames ? '' : 'internalOnlyHeaders')
    ..pc<$36.HeaderValueOption>(4, _omitFieldNames ? '' : 'responseHeadersToAdd', $pb.PbFieldType.PM, subBuilder: $36.HeaderValueOption.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$91.VirtualHost> get virtualHosts => $_getList(1);
  ...
  @$pb.TagNumber(4)
  $core.List<$36.HeaderValueOption> get responseHeadersToAdd => $_getList(3);
