...
import '../core/health_check.pbenum.dart' as $81;
...
class LbEndpoint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LbEndpoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.endpoint'), createEmptyInstance: create)
    ...
    ..e<$81.HealthStatus>(2, _omitFieldNames ? '' : 'healthStatus', $pb.PbFieldType.OE, defaultOrMaker: $81.HealthStatus.UNKNOWN, valueOf: $81.HealthStatus.valueOf, enumValues: $81.HealthStatus.values)
    ..aOM<$36.Metadata>(3, _omitFieldNames ? '' : 'metadata', subBuilder: $36.Metadata.create)
  ...
  @$pb.TagNumber(2)
  $81.HealthStatus get healthStatus => $_getN(1);
  @$pb.TagNumber(2)
  set healthStatus($81.HealthStatus v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  $36.Metadata get metadata => $_getN(2);
  @$pb.TagNumber(3)
  set metadata($36.Metadata v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMetadata() => $_has(2);
  @$pb.TagNumber(3)
  void clearMetadata() => clearField(3);
  @$pb.TagNumber(3)
  $36.Metadata ensureMetadata() => $_ensure(2);
...
class LocalityLbEndpoints extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LocalityLbEndpoints', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.endpoint'), createEmptyInstance: create)
    ..aOM<$36.Locality>(1, _omitFieldNames ? '' : 'locality', subBuilder: $36.Locality.create)
  ...
  @$pb.TagNumber(1)
  $36.Locality get locality => $_getN(0);
  @$pb.TagNumber(1)
  set locality($36.Locality v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasLocality() => $_has(0);
  @$pb.TagNumber(1)
  void clearLocality() => clearField(1);
  @$pb.TagNumber(1)
  $36.Locality ensureLocality() => $_ensure(0);
