...
class FilterChainMatch extends $pb.GeneratedMessage {
  factory FilterChainMatch({
    $core.Iterable<$31.CidrRange>? prefixRanges,
    $core.String? addressSuffix,
    $26.UInt32Value? suffixLen,
    $core.Iterable<$31.CidrRange>? sourcePrefixRanges,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FilterChainMatch', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.listener'), createEmptyInstance: create)
    ..pc<$31.CidrRange>(3, _omitFieldNames ? '' : 'prefixRanges', $pb.PbFieldType.PM, subBuilder: $31.CidrRange.create)
    ..aOS(4, _omitFieldNames ? '' : 'addressSuffix')
    ..aOM<$26.UInt32Value>(5, _omitFieldNames ? '' : 'suffixLen', subBuilder: $26.UInt32Value.create)
    ..pc<$31.CidrRange>(6, _omitFieldNames ? '' : 'sourcePrefixRanges', $pb.PbFieldType.PM, subBuilder: $31.CidrRange.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$31.CidrRange> get prefixRanges => $_getList(0);
  ...
  /// ignored.
  @$pb.TagNumber(6)
  $core.List<$31.CidrRange> get sourcePrefixRanges => $_getList(3);
...
class FilterChain extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    $84.DownstreamTlsContext? tlsContext,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FilterChain', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.listener'), createEmptyInstance: create)
    ...
    ..aOM<$84.DownstreamTlsContext>(2, _omitFieldNames ? '' : 'tlsContext', subBuilder: $84.DownstreamTlsContext.create)
    ...
    ..aOM<$36.Metadata>(5, _omitFieldNames ? '' : 'metadata', subBuilder: $36.Metadata.create)
    ..aOM<$36.TransportSocket>(6, _omitFieldNames ? '' : 'transportSocket', subBuilder: $36.TransportSocket.create)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  $84.DownstreamTlsContext get tlsContext => $_getN(1);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  set tlsContext($84.DownstreamTlsContext v) { setField(2, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  $84.DownstreamTlsContext ensureTlsContext() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  $26.BoolValue get useProxyProto => $_getN(3);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(4)
  $26.BoolValue ensureUseProxyProto() => $_ensure(3);

  /// [#not-implemented-hide:] filter chain metadata.
  @$pb.TagNumber(5)
  $36.Metadata get metadata => $_getN(4);
  @$pb.TagNumber(5)
  set metadata($36.Metadata v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasMetadata() => $_has(4);
  @$pb.TagNumber(5)
  void clearMetadata() => clearField(5);
  @$pb.TagNumber(5)
  $36.Metadata ensureMetadata() => $_ensure(4);
  ...
  @$pb.TagNumber(6)
  $36.TransportSocket get transportSocket => $_getN(5);
  @$pb.TagNumber(6)
  set transportSocket($36.TransportSocket v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasTransportSocket() => $_has(5);
  @$pb.TagNumber(6)
  void clearTransportSocket() => clearField(6);
  @$pb.TagNumber(6)
  $36.TransportSocket ensureTransportSocket() => $_ensure(5);
...
class ListenerFilterChainMatchPredicate extends $pb.GeneratedMessage {
  factory ListenerFilterChainMatchPredicate({
    ...
    $core.bool? anyMatch,
    $79.Int32Range? destinationPortRange,
  }) {
    final $result = create();
    if (orMatch != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListenerFilterChainMatchPredicate', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.listener'), createEmptyInstance: create)
    ...
    ..aOM<$79.Int32Range>(5, _omitFieldNames ? '' : 'destinationPortRange', subBuilder: $79.Int32Range.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $79.Int32Range get destinationPortRange => $_getN(4);
  @$pb.TagNumber(5)
  set destinationPortRange($79.Int32Range v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDestinationPortRange() => $_has(4);
  @$pb.TagNumber(5)
  void clearDestinationPortRange() => clearField(5);
  @$pb.TagNumber(5)
  $79.Int32Range ensureDestinationPortRange() => $_ensure(4);
}
