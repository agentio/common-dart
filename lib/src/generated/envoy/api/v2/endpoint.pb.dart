...
import 'endpoint/endpoint_components.pb.dart' as $82;
...
class ClusterLoadAssignment_Policy_DropOverload extends $pb.GeneratedMessage {
  factory ClusterLoadAssignment_Policy_DropOverload({
    ...
    $35.FractionalPercent? dropPercentage,
  }) {
    final $result = create();
    if (category != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClusterLoadAssignment.Policy.DropOverload', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2'), createEmptyInstance: create)
    ...
    ..aOM<$35.FractionalPercent>(2, _omitFieldNames ? '' : 'dropPercentage', subBuilder: $35.FractionalPercent.create)
  ...
  @$pb.TagNumber(2)
  $35.FractionalPercent get dropPercentage => $_getN(1);
  @$pb.TagNumber(2)
  set dropPercentage($35.FractionalPercent v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDropPercentage() => $_has(1);
  @$pb.TagNumber(2)
  void clearDropPercentage() => clearField(2);
  @$pb.TagNumber(2)
  $35.FractionalPercent ensureDropPercentage() => $_ensure(1);
}
...
class ClusterLoadAssignment_Policy extends $pb.GeneratedMessage {
  factory ClusterLoadAssignment_Policy({
    ...
    $26.UInt32Value? overprovisioningFactor,
    $28.Duration? endpointStaleAfter,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClusterLoadAssignment.Policy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2'), createEmptyInstance: create)
    ...
    ..aOM<$26.UInt32Value>(3, _omitFieldNames ? '' : 'overprovisioningFactor', subBuilder: $26.UInt32Value.create)
    ..aOM<$28.Duration>(4, _omitFieldNames ? '' : 'endpointStaleAfter', subBuilder: $28.Duration.create)
  ...
  @$pb.TagNumber(3)
  $26.UInt32Value get overprovisioningFactor => $_getN(1);
  @$pb.TagNumber(3)
  set overprovisioningFactor($26.UInt32Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasOverprovisioningFactor() => $_has(1);
  @$pb.TagNumber(3)
  void clearOverprovisioningFactor() => clearField(3);
  @$pb.TagNumber(3)
  $26.UInt32Value ensureOverprovisioningFactor() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  $28.Duration get endpointStaleAfter => $_getN(2);
  @$pb.TagNumber(4)
  set endpointStaleAfter($28.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasEndpointStaleAfter() => $_has(2);
  @$pb.TagNumber(4)
  void clearEndpointStaleAfter() => clearField(4);
  @$pb.TagNumber(4)
  $28.Duration ensureEndpointStaleAfter() => $_ensure(2);
...
class ClusterLoadAssignment extends $pb.GeneratedMessage {
  factory ClusterLoadAssignment({
    ...
    $core.Iterable<$82.LocalityLbEndpoints>? endpoints,
    ClusterLoadAssignment_Policy? policy,
    $core.Map<$core.String, $82.Endpoint>? namedEndpoints,
  }) {
    final $result = create();
    if (clusterName != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClusterLoadAssignment', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2'), createEmptyInstance: create)
    ...
    ..pc<$82.LocalityLbEndpoints>(2, _omitFieldNames ? '' : 'endpoints', $pb.PbFieldType.PM, subBuilder: $82.LocalityLbEndpoints.create)
    ..aOM<ClusterLoadAssignment_Policy>(4, _omitFieldNames ? '' : 'policy', subBuilder: ClusterLoadAssignment_Policy.create)
    ..m<$core.String, $82.Endpoint>(5, _omitFieldNames ? '' : 'namedEndpoints', entryClassName: 'ClusterLoadAssignment.NamedEndpointsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $82.Endpoint.create, valueDefaultOrMaker: $82.Endpoint.getDefault, packageName: const $pb.PackageName('envoy.api.v2'))
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$82.LocalityLbEndpoints> get endpoints => $_getList(1);
  ...
  /// [#not-implemented-hide:]
  @$pb.TagNumber(5)
  $core.Map<$core.String, $82.Endpoint> get namedEndpoints => $_getMap(3);
}
