...
import '../../config/cluster/v3/circuit_breaker.pb.dart' as $105;
import '../../config/core/v3/address.pb.dart' as $42;
import '../../config/core/v3/base.pb.dart' as $47;
import '../../config/core/v3/health_check.pbenum.dart' as $103;
import '../../type/v3/percent.pb.dart' as $44;
import 'metrics.pb.dart' as $148;
...
class ClusterStatus extends $pb.GeneratedMessage {
  factory ClusterStatus({
    ...
    $44.Percent? successRateEjectionThreshold,
    $core.Iterable<HostStatus>? hostStatuses,
    $44.Percent? localOriginSuccessRateEjectionThreshold,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClusterStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.admin.v3'), createEmptyInstance: create)
    ...
    ..aOM<$44.Percent>(3, _omitFieldNames ? '' : 'successRateEjectionThreshold', subBuilder: $44.Percent.create)
    ..pc<HostStatus>(4, _omitFieldNames ? '' : 'hostStatuses', $pb.PbFieldType.PM, subBuilder: HostStatus.create)
    ..aOM<$44.Percent>(5, _omitFieldNames ? '' : 'localOriginSuccessRateEjectionThreshold', subBuilder: $44.Percent.create)
    ..aOM<$105.CircuitBreakers>(6, _omitFieldNames ? '' : 'circuitBreakers', subBuilder: $105.CircuitBreakers.create)
  ...
  @$pb.TagNumber(3)
  $44.Percent get successRateEjectionThreshold => $_getN(2);
  @$pb.TagNumber(3)
  set successRateEjectionThreshold($44.Percent v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSuccessRateEjectionThreshold() => $_has(2);
  @$pb.TagNumber(3)
  void clearSuccessRateEjectionThreshold() => clearField(3);
  @$pb.TagNumber(3)
  $44.Percent ensureSuccessRateEjectionThreshold() => $_ensure(2);
  ...
  ///  3. Outlier detection is not enabled for this cluster.
  @$pb.TagNumber(5)
  $44.Percent get localOriginSuccessRateEjectionThreshold => $_getN(4);
  @$pb.TagNumber(5)
  set localOriginSuccessRateEjectionThreshold($44.Percent v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(5)
  $44.Percent ensureLocalOriginSuccessRateEjectionThreshold() => $_ensure(4);

  /// :ref:`Circuit breaking <arch_overview_circuit_break>` settings of the cluster.
  @$pb.TagNumber(6)
  $105.CircuitBreakers get circuitBreakers => $_getN(5);
  @$pb.TagNumber(6)
  set circuitBreakers($105.CircuitBreakers v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasCircuitBreakers() => $_has(5);
  @$pb.TagNumber(6)
  void clearCircuitBreakers() => clearField(6);
  @$pb.TagNumber(6)
  $105.CircuitBreakers ensureCircuitBreakers() => $_ensure(5);
...
class HostStatus extends $pb.GeneratedMessage {
  factory HostStatus({
    $42.Address? address,
    $core.Iterable<$148.SimpleMetric>? stats,
    HostHealthStatus? healthStatus,
    $44.Percent? successRate,
    $core.int? weight,
    $core.String? hostname,
    $core.int? priority,
    $44.Percent? localOriginSuccessRate,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HostStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.admin.v3'), createEmptyInstance: create)
    ...
    ..pc<$148.SimpleMetric>(2, _omitFieldNames ? '' : 'stats', $pb.PbFieldType.PM, subBuilder: $148.SimpleMetric.create)
    ..aOM<HostHealthStatus>(3, _omitFieldNames ? '' : 'healthStatus', subBuilder: HostHealthStatus.create)
    ..aOM<$44.Percent>(4, _omitFieldNames ? '' : 'successRate', subBuilder: $44.Percent.create)
    ...
    ..aOM<$44.Percent>(8, _omitFieldNames ? '' : 'localOriginSuccessRate', subBuilder: $44.Percent.create)
    ..aOM<$47.Locality>(9, _omitFieldNames ? '' : 'locality', subBuilder: $47.Locality.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$148.SimpleMetric> get stats => $_getList(1);
  ...
  ///  ejection.
  @$pb.TagNumber(4)
  $44.Percent get successRate => $_getN(3);
  @$pb.TagNumber(4)
  set successRate($44.Percent v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasSuccessRate() => $_has(3);
  @$pb.TagNumber(4)
  void clearSuccessRate() => clearField(4);
  @$pb.TagNumber(4)
  $44.Percent ensureSuccessRate() => $_ensure(3);
  ...
  ///  ejection.
  @$pb.TagNumber(8)
  $44.Percent get localOriginSuccessRate => $_getN(7);
  @$pb.TagNumber(8)
  set localOriginSuccessRate($44.Percent v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasLocalOriginSuccessRate() => $_has(7);
  @$pb.TagNumber(8)
  void clearLocalOriginSuccessRate() => clearField(8);
  @$pb.TagNumber(8)
  $44.Percent ensureLocalOriginSuccessRate() => $_ensure(7);

  /// locality of the host.
  @$pb.TagNumber(9)
  $47.Locality get locality => $_getN(8);
  @$pb.TagNumber(9)
  set locality($47.Locality v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasLocality() => $_has(8);
  @$pb.TagNumber(9)
  void clearLocality() => clearField(9);
  @$pb.TagNumber(9)
  $47.Locality ensureLocality() => $_ensure(8);
}
...
class HostHealthStatus extends $pb.GeneratedMessage {
  factory HostHealthStatus({
    ...
    $103.HealthStatus? edsHealthStatus,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HostHealthStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.admin.v3'), createEmptyInstance: create)
    ...
    ..e<$103.HealthStatus>(3, _omitFieldNames ? '' : 'edsHealthStatus', $pb.PbFieldType.OE, defaultOrMaker: $103.HealthStatus.UNKNOWN, valueOf: $103.HealthStatus.valueOf, enumValues: $103.HealthStatus.values)
  ...
  @$pb.TagNumber(3)
  $103.HealthStatus get edsHealthStatus => $_getN(2);
  @$pb.TagNumber(3)
  set edsHealthStatus($103.HealthStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
