...
class ListenerStatus extends $pb.GeneratedMessage {
  factory ListenerStatus({
    ...
    $core.Iterable<$42.Address>? additionalLocalAddresses,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListenerStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.admin.v3'), createEmptyInstance: create)
    ...
    ..aOM<$42.Address>(2, _omitFieldNames ? '' : 'localAddress', subBuilder: $42.Address.create)
    ..pc<$42.Address>(3, _omitFieldNames ? '' : 'additionalLocalAddresses', $pb.PbFieldType.PM, subBuilder: $42.Address.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $42.Address get localAddress => $_getN(1);
  @$pb.TagNumber(2)
  set localAddress($42.Address v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasLocalAddress() => $_has(1);
  @$pb.TagNumber(2)
  void clearLocalAddress() => clearField(2);
  @$pb.TagNumber(2)
  $42.Address ensureLocalAddress() => $_ensure(1);
  ...
  /// configuration.
  @$pb.TagNumber(3)
  $core.List<$42.Address> get additionalLocalAddresses => $_getList(2);
}
