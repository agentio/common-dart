...
import '../../config/bootstrap/v3/bootstrap.pb.dart' as $149;
import 'config_dump_shared.pb.dart' as $150;
import 'config_dump_shared.pbenum.dart' as $150;
...
class BootstrapConfigDump extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BootstrapConfigDump', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.admin.v3'), createEmptyInstance: create)
    ..aOM<$149.Bootstrap>(1, _omitFieldNames ? '' : 'bootstrap', subBuilder: $149.Bootstrap.create)
  ...
  @$pb.TagNumber(1)
  $149.Bootstrap get bootstrap => $_getN(0);
  @$pb.TagNumber(1)
  set bootstrap($149.Bootstrap v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBootstrap() => $_has(0);
  @$pb.TagNumber(1)
  void clearBootstrap() => clearField(1);
  @$pb.TagNumber(1)
  $149.Bootstrap ensureBootstrap() => $_ensure(0);
...
class SecretsConfigDump_DynamicSecret extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SecretsConfigDump.DynamicSecret', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.admin.v3'), createEmptyInstance: create)
    ...
    ..aOM<$150.UpdateFailureState>(5, _omitFieldNames ? '' : 'errorState', subBuilder: $150.UpdateFailureState.create)
    ..e<$150.ClientResourceStatus>(6, _omitFieldNames ? '' : 'clientStatus', $pb.PbFieldType.OE, defaultOrMaker: $150.ClientResourceStatus.UNKNOWN, valueOf: $150.ClientResourceStatus.valueOf, enumValues: $150.ClientResourceStatus.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $150.UpdateFailureState get errorState => $_getN(4);
  @$pb.TagNumber(5)
  set errorState($150.UpdateFailureState v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasErrorState() => $_has(4);
  @$pb.TagNumber(5)
  void clearErrorState() => clearField(5);
  @$pb.TagNumber(5)
  $150.UpdateFailureState ensureErrorState() => $_ensure(4);

  /// The client status of this resource.
  /// [#not-implemented-hide:]
  @$pb.TagNumber(6)
  $150.ClientResourceStatus get clientStatus => $_getN(5);
  @$pb.TagNumber(6)
  set clientStatus($150.ClientResourceStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
