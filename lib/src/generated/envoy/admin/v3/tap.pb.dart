...
import '../../config/tap/v3/common.pb.dart' as $147;

/// The /tap admin request body that is used to configure an active tap session.
class TapRequest extends $pb.GeneratedMessage {
  factory TapRequest({
    $core.String? configId,
    $147.TapConfig? tapConfig,
  }) {
    final $result = create();
    if (configId != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TapRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.admin.v3'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'configId')
    ..aOM<$147.TapConfig>(2, _omitFieldNames ? '' : 'tapConfig', subBuilder: $147.TapConfig.create)
  ...
  @$pb.TagNumber(2)
  $147.TapConfig get tapConfig => $_getN(1);
  @$pb.TagNumber(2)
  set tapConfig($147.TapConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTapConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearTapConfig() => clearField(2);
  @$pb.TagNumber(2)
  $147.TapConfig ensureTapConfig() => $_ensure(1);
}
