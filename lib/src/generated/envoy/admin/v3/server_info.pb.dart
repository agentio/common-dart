...
class ServerInfo extends $pb.GeneratedMessage {
  factory ServerInfo({
    ...
    $28.Duration? uptimeCurrentEpoch,
    $28.Duration? uptimeAllEpochs,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServerInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.admin.v3'), createEmptyInstance: create)
    ...
    ..aOM<$28.Duration>(3, _omitFieldNames ? '' : 'uptimeCurrentEpoch', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(4, _omitFieldNames ? '' : 'uptimeAllEpochs', subBuilder: $28.Duration.create)
    ...
    ..aOM<$47.Node>(7, _omitFieldNames ? '' : 'node', subBuilder: $47.Node.create)
  ...
  @$pb.TagNumber(3)
  $28.Duration get uptimeCurrentEpoch => $_getN(2);
  @$pb.TagNumber(3)
  set uptimeCurrentEpoch($28.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasUptimeCurrentEpoch() => $_has(2);
  @$pb.TagNumber(3)
  void clearUptimeCurrentEpoch() => clearField(3);
  @$pb.TagNumber(3)
  $28.Duration ensureUptimeCurrentEpoch() => $_ensure(2);

  /// Uptime since the start of the first epoch.
  @$pb.TagNumber(4)
  $28.Duration get uptimeAllEpochs => $_getN(3);
  @$pb.TagNumber(4)
  set uptimeAllEpochs($28.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasUptimeAllEpochs() => $_has(3);
  @$pb.TagNumber(4)
  void clearUptimeAllEpochs() => clearField(4);
  @$pb.TagNumber(4)
  $28.Duration ensureUptimeAllEpochs() => $_ensure(3);
  ...
  @$pb.TagNumber(7)
  $47.Node get node => $_getN(6);
  @$pb.TagNumber(7)
  set node($47.Node v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasNode() => $_has(6);
  @$pb.TagNumber(7)
  void clearNode() => clearField(7);
  @$pb.TagNumber(7)
  $47.Node ensureNode() => $_ensure(6);
}
...
class CommandLineOptions extends $pb.GeneratedMessage {
  factory CommandLineOptions({
    ...
    $28.Duration? fileFlushInterval,
    $28.Duration? drainTime,
    $28.Duration? parentShutdownTime,
    ...
    $core.bool? skipHotRestartOnNoParent,
    $core.bool? skipHotRestartParentStats,
  }) {
    final $result = create();
    if (baseId != null) {
    ...
    if (skipHotRestartOnNoParent != null) {
      $result.skipHotRestartOnNoParent = skipHotRestartOnNoParent;
    }
    if (skipHotRestartParentStats != null) {
      $result.skipHotRestartParentStats = skipHotRestartParentStats;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommandLineOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.admin.v3'), createEmptyInstance: create)
    ...
    ..aOM<$28.Duration>(16, _omitFieldNames ? '' : 'fileFlushInterval', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(17, _omitFieldNames ? '' : 'drainTime', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(18, _omitFieldNames ? '' : 'parentShutdownTime', subBuilder: $28.Duration.create)
    ...
    ..aOB(39, _omitFieldNames ? '' : 'skipHotRestartOnNoParent')
    ..aOB(40, _omitFieldNames ? '' : 'skipHotRestartParentStats')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(16)
  $28.Duration get fileFlushInterval => $_getN(14);
  @$pb.TagNumber(16)
  set fileFlushInterval($28.Duration v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasFileFlushInterval() => $_has(14);
  @$pb.TagNumber(16)
  void clearFileFlushInterval() => clearField(16);
  @$pb.TagNumber(16)
  $28.Duration ensureFileFlushInterval() => $_ensure(14);

  /// See :option:`--drain-time-s` for details.
  @$pb.TagNumber(17)
  $28.Duration get drainTime => $_getN(15);
  @$pb.TagNumber(17)
  set drainTime($28.Duration v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasDrainTime() => $_has(15);
  @$pb.TagNumber(17)
  void clearDrainTime() => clearField(17);
  @$pb.TagNumber(17)
  $28.Duration ensureDrainTime() => $_ensure(15);

  /// See :option:`--parent-shutdown-time-s` for details.
  @$pb.TagNumber(18)
  $28.Duration get parentShutdownTime => $_getN(16);
  @$pb.TagNumber(18)
  set parentShutdownTime($28.Duration v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasParentShutdownTime() => $_has(16);
  @$pb.TagNumber(18)
  void clearParentShutdownTime() => clearField(18);
  @$pb.TagNumber(18)
  $28.Duration ensureParentShutdownTime() => $_ensure(16);
  ...
  @$pb.TagNumber(39)
  $core.bool get skipHotRestartOnNoParent => $_getBF(34);
  @$pb.TagNumber(39)
  set skipHotRestartOnNoParent($core.bool v) { $_setBool(34, v); }
  @$pb.TagNumber(39)
  $core.bool hasSkipHotRestartOnNoParent() => $_has(34);
  @$pb.TagNumber(39)
  void clearSkipHotRestartOnNoParent() => clearField(39);

  /// See :option:`--skip-hot-restart-parent-stats` for details.
  @$pb.TagNumber(40)
  $core.bool get skipHotRestartParentStats => $_getBF(35);
  @$pb.TagNumber(40)
  set skipHotRestartParentStats($core.bool v) { $_setBool(35, v); }
  @$pb.TagNumber(40)
  $core.bool hasSkipHotRestartParentStats() => $_has(35);
  @$pb.TagNumber(40)
  void clearSkipHotRestartParentStats() => clearField(40);
}
