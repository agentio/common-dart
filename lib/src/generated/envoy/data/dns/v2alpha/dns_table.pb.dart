...
class DnsTable extends $pb.GeneratedMessage {
  factory DnsTable({
    ...
    $core.Iterable<$74.StringMatcher>? knownSuffixes,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DnsTable', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.dns.v2alpha'), createEmptyInstance: create)
    ...
    ..pc<$74.StringMatcher>(3, _omitFieldNames ? '' : 'knownSuffixes', $pb.PbFieldType.PM, subBuilder: $74.StringMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.List<$74.StringMatcher> get knownSuffixes => $_getList(2);
}
