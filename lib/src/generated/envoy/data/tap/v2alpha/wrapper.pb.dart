...
import 'http.pb.dart' as $166;
import 'transport.pb.dart' as $167;
...
class TraceWrapper extends $pb.GeneratedMessage {
  factory TraceWrapper({
    $166.HttpBufferedTrace? httpBufferedTrace,
    $166.HttpStreamedTraceSegment? httpStreamedTraceSegment,
    $167.SocketBufferedTrace? socketBufferedTrace,
    $167.SocketStreamedTraceSegment? socketStreamedTraceSegment,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TraceWrapper', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.tap.v2alpha'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4])
    ..aOM<$166.HttpBufferedTrace>(1, _omitFieldNames ? '' : 'httpBufferedTrace', subBuilder: $166.HttpBufferedTrace.create)
    ..aOM<$166.HttpStreamedTraceSegment>(2, _omitFieldNames ? '' : 'httpStreamedTraceSegment', subBuilder: $166.HttpStreamedTraceSegment.create)
    ..aOM<$167.SocketBufferedTrace>(3, _omitFieldNames ? '' : 'socketBufferedTrace', subBuilder: $167.SocketBufferedTrace.create)
    ..aOM<$167.SocketStreamedTraceSegment>(4, _omitFieldNames ? '' : 'socketStreamedTraceSegment', subBuilder: $167.SocketStreamedTraceSegment.create)
  ...
  @$pb.TagNumber(1)
  $166.HttpBufferedTrace get httpBufferedTrace => $_getN(0);
  @$pb.TagNumber(1)
  set httpBufferedTrace($166.HttpBufferedTrace v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasHttpBufferedTrace() => $_has(0);
  @$pb.TagNumber(1)
  void clearHttpBufferedTrace() => clearField(1);
  @$pb.TagNumber(1)
  $166.HttpBufferedTrace ensureHttpBufferedTrace() => $_ensure(0);

  /// An HTTP streamed tap trace segment.
  @$pb.TagNumber(2)
  $166.HttpStreamedTraceSegment get httpStreamedTraceSegment => $_getN(1);
  @$pb.TagNumber(2)
  set httpStreamedTraceSegment($166.HttpStreamedTraceSegment v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasHttpStreamedTraceSegment() => $_has(1);
  @$pb.TagNumber(2)
  void clearHttpStreamedTraceSegment() => clearField(2);
  @$pb.TagNumber(2)
  $166.HttpStreamedTraceSegment ensureHttpStreamedTraceSegment() => $_ensure(1);

  /// A socket buffered tap trace.
  @$pb.TagNumber(3)
  $167.SocketBufferedTrace get socketBufferedTrace => $_getN(2);
  @$pb.TagNumber(3)
  set socketBufferedTrace($167.SocketBufferedTrace v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSocketBufferedTrace() => $_has(2);
  @$pb.TagNumber(3)
  void clearSocketBufferedTrace() => clearField(3);
  @$pb.TagNumber(3)
  $167.SocketBufferedTrace ensureSocketBufferedTrace() => $_ensure(2);

  /// A socket streamed tap trace segment.
  @$pb.TagNumber(4)
  $167.SocketStreamedTraceSegment get socketStreamedTraceSegment => $_getN(3);
  @$pb.TagNumber(4)
  set socketStreamedTraceSegment($167.SocketStreamedTraceSegment v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasSocketStreamedTraceSegment() => $_has(3);
  @$pb.TagNumber(4)
  void clearSocketStreamedTraceSegment() => clearField(4);
  @$pb.TagNumber(4)
  $167.SocketStreamedTraceSegment ensureSocketStreamedTraceSegment() => $_ensure(3);
}
