...
class HttpBufferedTrace_Message extends $pb.GeneratedMessage {
  factory HttpBufferedTrace_Message({
    $core.Iterable<$36.HeaderValue>? headers,
    $165.Body? body,
    $core.Iterable<$36.HeaderValue>? trailers,
  }) {
    final $result = create();
    if (headers != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpBufferedTrace.Message', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.tap.v2alpha'), createEmptyInstance: create)
    ..pc<$36.HeaderValue>(1, _omitFieldNames ? '' : 'headers', $pb.PbFieldType.PM, subBuilder: $36.HeaderValue.create)
    ..aOM<$165.Body>(2, _omitFieldNames ? '' : 'body', subBuilder: $165.Body.create)
    ..pc<$36.HeaderValue>(3, _omitFieldNames ? '' : 'trailers', $pb.PbFieldType.PM, subBuilder: $36.HeaderValue.create)
  ...
  /// Message headers.
  @$pb.TagNumber(1)
  $core.List<$36.HeaderValue> get headers => $_getList(0);

  /// Message body.
  @$pb.TagNumber(2)
  $165.Body get body => $_getN(1);
  @$pb.TagNumber(2)
  set body($165.Body v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBody() => $_has(1);
  @$pb.TagNumber(2)
  void clearBody() => clearField(2);
  @$pb.TagNumber(2)
  $165.Body ensureBody() => $_ensure(1);

  /// Message trailers.
  @$pb.TagNumber(3)
  $core.List<$36.HeaderValue> get trailers => $_getList(2);
}
...
class HttpStreamedTraceSegment extends $pb.GeneratedMessage {
  factory HttpStreamedTraceSegment({
    ...
    $36.HeaderMap? requestHeaders,
    $165.Body? requestBodyChunk,
    $36.HeaderMap? requestTrailers,
    $36.HeaderMap? responseHeaders,
    $165.Body? responseBodyChunk,
    $36.HeaderMap? responseTrailers,
  }) {
    final $result = create();
    if (traceId != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpStreamedTraceSegment', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.tap.v2alpha'), createEmptyInstance: create)
    ...
    ..aOM<$36.HeaderMap>(2, _omitFieldNames ? '' : 'requestHeaders', subBuilder: $36.HeaderMap.create)
    ..aOM<$165.Body>(3, _omitFieldNames ? '' : 'requestBodyChunk', subBuilder: $165.Body.create)
    ..aOM<$36.HeaderMap>(4, _omitFieldNames ? '' : 'requestTrailers', subBuilder: $36.HeaderMap.create)
    ..aOM<$36.HeaderMap>(5, _omitFieldNames ? '' : 'responseHeaders', subBuilder: $36.HeaderMap.create)
    ..aOM<$165.Body>(6, _omitFieldNames ? '' : 'responseBodyChunk', subBuilder: $165.Body.create)
    ..aOM<$36.HeaderMap>(7, _omitFieldNames ? '' : 'responseTrailers', subBuilder: $36.HeaderMap.create)
    ..hasRequiredFields = false
  ;
  ...
  /// Request headers.
  @$pb.TagNumber(2)
  $36.HeaderMap get requestHeaders => $_getN(1);
  @$pb.TagNumber(2)
  set requestHeaders($36.HeaderMap v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasRequestHeaders() => $_has(1);
  @$pb.TagNumber(2)
  void clearRequestHeaders() => clearField(2);
  @$pb.TagNumber(2)
  $36.HeaderMap ensureRequestHeaders() => $_ensure(1);

  /// Request body chunk.
  @$pb.TagNumber(3)
  $165.Body get requestBodyChunk => $_getN(2);
  @$pb.TagNumber(3)
  set requestBodyChunk($165.Body v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasRequestBodyChunk() => $_has(2);
  @$pb.TagNumber(3)
  void clearRequestBodyChunk() => clearField(3);
  @$pb.TagNumber(3)
  $165.Body ensureRequestBodyChunk() => $_ensure(2);

  /// Request trailers.
  @$pb.TagNumber(4)
  $36.HeaderMap get requestTrailers => $_getN(3);
  @$pb.TagNumber(4)
  set requestTrailers($36.HeaderMap v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasRequestTrailers() => $_has(3);
  @$pb.TagNumber(4)
  void clearRequestTrailers() => clearField(4);
  @$pb.TagNumber(4)
  $36.HeaderMap ensureRequestTrailers() => $_ensure(3);

  /// Response headers.
  @$pb.TagNumber(5)
  $36.HeaderMap get responseHeaders => $_getN(4);
  @$pb.TagNumber(5)
  set responseHeaders($36.HeaderMap v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasResponseHeaders() => $_has(4);
  @$pb.TagNumber(5)
  void clearResponseHeaders() => clearField(5);
  @$pb.TagNumber(5)
  $36.HeaderMap ensureResponseHeaders() => $_ensure(4);

  /// Response body chunk.
  @$pb.TagNumber(6)
  $165.Body get responseBodyChunk => $_getN(5);
  @$pb.TagNumber(6)
  set responseBodyChunk($165.Body v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasResponseBodyChunk() => $_has(5);
  @$pb.TagNumber(6)
  void clearResponseBodyChunk() => clearField(6);
  @$pb.TagNumber(6)
  $165.Body ensureResponseBodyChunk() => $_ensure(5);

  /// Response trailers.
  @$pb.TagNumber(7)
  $36.HeaderMap get responseTrailers => $_getN(6);
  @$pb.TagNumber(7)
  set responseTrailers($36.HeaderMap v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasResponseTrailers() => $_has(6);
  @$pb.TagNumber(7)
  void clearResponseTrailers() => clearField(7);
  @$pb.TagNumber(7)
  $36.HeaderMap ensureResponseTrailers() => $_ensure(6);
}
