...
import 'common.pb.dart' as $165;

/// Connection properties.
class Connection extends $pb.GeneratedMessage {
  factory Connection({
    $31.Address? localAddress,
    $31.Address? remoteAddress,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Connection', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.tap.v2alpha'), createEmptyInstance: create)
    ..aOM<$31.Address>(2, _omitFieldNames ? '' : 'localAddress', subBuilder: $31.Address.create)
    ..aOM<$31.Address>(3, _omitFieldNames ? '' : 'remoteAddress', subBuilder: $31.Address.create)
  ...
  /// Local address.
  @$pb.TagNumber(2)
  $31.Address get localAddress => $_getN(0);
  @$pb.TagNumber(2)
  set localAddress($31.Address v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasLocalAddress() => $_has(0);
  @$pb.TagNumber(2)
  void clearLocalAddress() => clearField(2);
  @$pb.TagNumber(2)
  $31.Address ensureLocalAddress() => $_ensure(0);

  /// Remote address.
  @$pb.TagNumber(3)
  $31.Address get remoteAddress => $_getN(1);
  @$pb.TagNumber(3)
  set remoteAddress($31.Address v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasRemoteAddress() => $_has(1);
  @$pb.TagNumber(3)
  void clearRemoteAddress() => clearField(3);
  @$pb.TagNumber(3)
  $31.Address ensureRemoteAddress() => $_ensure(1);
}
...
class SocketEvent_Read extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SocketEvent.Read', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.tap.v2alpha'), createEmptyInstance: create)
    ..aOM<$165.Body>(1, _omitFieldNames ? '' : 'data', subBuilder: $165.Body.create)
    ..hasRequiredFields = false
  ;
  ...
  /// Binary data read.
  @$pb.TagNumber(1)
  $165.Body get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($165.Body v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $165.Body ensureData() => $_ensure(0);
}
...
class SocketEvent_Write extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SocketEvent.Write', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.tap.v2alpha'), createEmptyInstance: create)
    ..aOM<$165.Body>(1, _omitFieldNames ? '' : 'data', subBuilder: $165.Body.create)
...
class SocketEvent_Closed extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SocketEvent.Closed', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.tap.v2alpha'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class SocketEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SocketEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.tap.v2alpha'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4])
    ..aOM<$65.Timestamp>(1, _omitFieldNames ? '' : 'timestamp', subBuilder: $65.Timestamp.create)
  ...
  /// Timestamp for event.
  @$pb.TagNumber(1)
  $65.Timestamp get timestamp => $_getN(0);
  @$pb.TagNumber(1)
  set timestamp($65.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTimestamp() => $_has(0);
  @$pb.TagNumber(1)
  void clearTimestamp() => clearField(1);
  @$pb.TagNumber(1)
  $65.Timestamp ensureTimestamp() => $_ensure(0);
...
class SocketBufferedTrace extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SocketBufferedTrace', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.tap.v2alpha'), createEmptyInstance: create)
...
class SocketStreamedTraceSegment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SocketStreamedTraceSegment', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.tap.v2alpha'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..a<$fixnum.Int64>(1, _omitFieldNames ? '' : 'traceId', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<Connection>(2, _omitFieldNames ? '' : 'connection', subBuilder: Connection.create)
