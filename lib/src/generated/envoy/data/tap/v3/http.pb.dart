...
import 'common.pb.dart' as $169;

/// HTTP message wrapper.
class HttpBufferedTrace_Message extends $pb.GeneratedMessage {
  factory HttpBufferedTrace_Message({
    $core.Iterable<$47.HeaderValue>? headers,
    $169.Body? body,
    $core.Iterable<$47.HeaderValue>? trailers,
    $65.Timestamp? headersReceivedTime,
  }) {
    final $result = create();
    if (headers != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpBufferedTrace.Message', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.tap.v3'), createEmptyInstance: create)
    ..pc<$47.HeaderValue>(1, _omitFieldNames ? '' : 'headers', $pb.PbFieldType.PM, subBuilder: $47.HeaderValue.create)
    ..aOM<$169.Body>(2, _omitFieldNames ? '' : 'body', subBuilder: $169.Body.create)
    ..pc<$47.HeaderValue>(3, _omitFieldNames ? '' : 'trailers', $pb.PbFieldType.PM, subBuilder: $47.HeaderValue.create)
    ..aOM<$65.Timestamp>(4, _omitFieldNames ? '' : 'headersReceivedTime', subBuilder: $65.Timestamp.create)
  ...
  /// Message headers.
  @$pb.TagNumber(1)
  $core.List<$47.HeaderValue> get headers => $_getList(0);

  /// Message body.
  @$pb.TagNumber(2)
  $169.Body get body => $_getN(1);
  @$pb.TagNumber(2)
  set body($169.Body v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBody() => $_has(1);
  @$pb.TagNumber(2)
  void clearBody() => clearField(2);
  @$pb.TagNumber(2)
  $169.Body ensureBody() => $_ensure(1);

  /// Message trailers.
  @$pb.TagNumber(3)
  $core.List<$47.HeaderValue> get trailers => $_getList(2);

  /// The timestamp after receiving the message headers.
  @$pb.TagNumber(4)
  $65.Timestamp get headersReceivedTime => $_getN(3);
  @$pb.TagNumber(4)
  set headersReceivedTime($65.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasHeadersReceivedTime() => $_has(3);
  @$pb.TagNumber(4)
  void clearHeadersReceivedTime() => clearField(4);
  @$pb.TagNumber(4)
  $65.Timestamp ensureHeadersReceivedTime() => $_ensure(3);
}
...
class HttpBufferedTrace extends $pb.GeneratedMessage {
  factory HttpBufferedTrace({
    ...
    $169.Connection? downstreamConnection,
  }) {
    final $result = create();
    if (request != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpBufferedTrace', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.tap.v3'), createEmptyInstance: create)
    ...
    ..aOM<$169.Connection>(3, _omitFieldNames ? '' : 'downstreamConnection', subBuilder: $169.Connection.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $169.Connection get downstreamConnection => $_getN(2);
  @$pb.TagNumber(3)
  set downstreamConnection($169.Connection v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasDownstreamConnection() => $_has(2);
  @$pb.TagNumber(3)
  void clearDownstreamConnection() => clearField(3);
  @$pb.TagNumber(3)
  $169.Connection ensureDownstreamConnection() => $_ensure(2);
}
...
class HttpStreamedTraceSegment extends $pb.GeneratedMessage {
  factory HttpStreamedTraceSegment({
    ...
    $47.HeaderMap? requestHeaders,
    $169.Body? requestBodyChunk,
    $47.HeaderMap? requestTrailers,
    $47.HeaderMap? responseHeaders,
    $169.Body? responseBodyChunk,
    $47.HeaderMap? responseTrailers,
  }) {
    final $result = create();
    if (traceId != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpStreamedTraceSegment', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.tap.v3'), createEmptyInstance: create)
    ...
    ..aOM<$47.HeaderMap>(2, _omitFieldNames ? '' : 'requestHeaders', subBuilder: $47.HeaderMap.create)
    ..aOM<$169.Body>(3, _omitFieldNames ? '' : 'requestBodyChunk', subBuilder: $169.Body.create)
    ..aOM<$47.HeaderMap>(4, _omitFieldNames ? '' : 'requestTrailers', subBuilder: $47.HeaderMap.create)
    ..aOM<$47.HeaderMap>(5, _omitFieldNames ? '' : 'responseHeaders', subBuilder: $47.HeaderMap.create)
    ..aOM<$169.Body>(6, _omitFieldNames ? '' : 'responseBodyChunk', subBuilder: $169.Body.create)
    ..aOM<$47.HeaderMap>(7, _omitFieldNames ? '' : 'responseTrailers', subBuilder: $47.HeaderMap.create)
    ..hasRequiredFields = false
  ;
  ...
  /// Request headers.
  @$pb.TagNumber(2)
  $47.HeaderMap get requestHeaders => $_getN(1);
  @$pb.TagNumber(2)
  set requestHeaders($47.HeaderMap v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasRequestHeaders() => $_has(1);
  @$pb.TagNumber(2)
  void clearRequestHeaders() => clearField(2);
  @$pb.TagNumber(2)
  $47.HeaderMap ensureRequestHeaders() => $_ensure(1);

  /// Request body chunk.
  @$pb.TagNumber(3)
  $169.Body get requestBodyChunk => $_getN(2);
  @$pb.TagNumber(3)
  set requestBodyChunk($169.Body v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasRequestBodyChunk() => $_has(2);
  @$pb.TagNumber(3)
  void clearRequestBodyChunk() => clearField(3);
  @$pb.TagNumber(3)
  $169.Body ensureRequestBodyChunk() => $_ensure(2);

  /// Request trailers.
  @$pb.TagNumber(4)
  $47.HeaderMap get requestTrailers => $_getN(3);
  @$pb.TagNumber(4)
  set requestTrailers($47.HeaderMap v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasRequestTrailers() => $_has(3);
  @$pb.TagNumber(4)
  void clearRequestTrailers() => clearField(4);
  @$pb.TagNumber(4)
  $47.HeaderMap ensureRequestTrailers() => $_ensure(3);

  /// Response headers.
  @$pb.TagNumber(5)
  $47.HeaderMap get responseHeaders => $_getN(4);
  @$pb.TagNumber(5)
  set responseHeaders($47.HeaderMap v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasResponseHeaders() => $_has(4);
  @$pb.TagNumber(5)
  void clearResponseHeaders() => clearField(5);
  @$pb.TagNumber(5)
  $47.HeaderMap ensureResponseHeaders() => $_ensure(4);

  /// Response body chunk.
  @$pb.TagNumber(6)
  $169.Body get responseBodyChunk => $_getN(5);
  @$pb.TagNumber(6)
  set responseBodyChunk($169.Body v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasResponseBodyChunk() => $_has(5);
  @$pb.TagNumber(6)
  void clearResponseBodyChunk() => clearField(6);
  @$pb.TagNumber(6)
  $169.Body ensureResponseBodyChunk() => $_ensure(5);

  /// Response trailers.
  @$pb.TagNumber(7)
  $47.HeaderMap get responseTrailers => $_getN(6);
  @$pb.TagNumber(7)
  set responseTrailers($47.HeaderMap v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasResponseTrailers() => $_has(6);
  @$pb.TagNumber(7)
  void clearResponseTrailers() => clearField(7);
  @$pb.TagNumber(7)
  $47.HeaderMap ensureResponseTrailers() => $_ensure(6);
}
