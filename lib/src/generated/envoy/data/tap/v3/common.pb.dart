...
class Connection extends $pb.GeneratedMessage {
  factory Connection({
    $42.Address? localAddress,
    $42.Address? remoteAddress,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Connection', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.tap.v3'), createEmptyInstance: create)
    ..aOM<$42.Address>(1, _omitFieldNames ? '' : 'localAddress', subBuilder: $42.Address.create)
    ..aOM<$42.Address>(2, _omitFieldNames ? '' : 'remoteAddress', subBuilder: $42.Address.create)
    ..hasRequiredFields = false
  ;
  ...
  /// Local address.
  @$pb.TagNumber(1)
  $42.Address get localAddress => $_getN(0);
  @$pb.TagNumber(1)
  set localAddress($42.Address v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasLocalAddress() => $_has(0);
  @$pb.TagNumber(1)
  void clearLocalAddress() => clearField(1);
  @$pb.TagNumber(1)
  $42.Address ensureLocalAddress() => $_ensure(0);

  /// Remote address.
  @$pb.TagNumber(2)
  $42.Address get remoteAddress => $_getN(1);
  @$pb.TagNumber(2)
  set remoteAddress($42.Address v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasRemoteAddress() => $_has(1);
  @$pb.TagNumber(2)
  void clearRemoteAddress() => clearField(2);
  @$pb.TagNumber(2)
  $42.Address ensureRemoteAddress() => $_ensure(1);
}
