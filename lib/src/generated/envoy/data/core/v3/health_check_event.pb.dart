...
class HealthCheckEvent extends $pb.GeneratedMessage {
  factory HealthCheckEvent({
    ...
    HealthCheckSuccessful? successfulHealthCheckEvent,
  }) {
    final $result = create();
    ...
    if (successfulHealthCheckEvent != null) {
      $result.successfulHealthCheckEvent = successfulHealthCheckEvent;
    }
    return $result;
  }
  ...
  static const $core.Map<$core.int, HealthCheckEvent_Event> _HealthCheckEvent_EventByTag = {
    ...
    12 : HealthCheckEvent_Event.successfulHealthCheckEvent,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HealthCheckEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.core.v3'), createEmptyInstance: create)
    ...
    ..aOM<$42.Address>(2, _omitFieldNames ? '' : 'host', subBuilder: $42.Address.create)
    ...
    ..aOM<$65.Timestamp>(6, _omitFieldNames ? '' : 'timestamp', subBuilder: $65.Timestamp.create)
    ...
    ..aOM<$47.Metadata>(10, _omitFieldNames ? '' : 'metadata', subBuilder: $47.Metadata.create)
    ..aOM<$47.Locality>(11, _omitFieldNames ? '' : 'locality', subBuilder: $47.Locality.create)
    ..aOM<HealthCheckSuccessful>(12, _omitFieldNames ? '' : 'successfulHealthCheckEvent', subBuilder: HealthCheckSuccessful.create)
  ...
  @$pb.TagNumber(2)
  $42.Address get host => $_getN(1);
  @$pb.TagNumber(2)
  set host($42.Address v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasHost() => $_has(1);
  @$pb.TagNumber(2)
  void clearHost() => clearField(2);
  @$pb.TagNumber(2)
  $42.Address ensureHost() => $_ensure(1);
  ...
  /// Timestamp for event.
  @$pb.TagNumber(6)
  $65.Timestamp get timestamp => $_getN(5);
  @$pb.TagNumber(6)
  set timestamp($65.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasTimestamp() => $_has(5);
  @$pb.TagNumber(6)
  void clearTimestamp() => clearField(6);
  @$pb.TagNumber(6)
  $65.Timestamp ensureTimestamp() => $_ensure(5);
  ...
  /// Host metadata
  @$pb.TagNumber(10)
  $47.Metadata get metadata => $_getN(9);
  @$pb.TagNumber(10)
  set metadata($47.Metadata v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasMetadata() => $_has(9);
  @$pb.TagNumber(10)
  void clearMetadata() => clearField(10);
  @$pb.TagNumber(10)
  $47.Metadata ensureMetadata() => $_ensure(9);

  /// Host locality
  @$pb.TagNumber(11)
  $47.Locality get locality => $_getN(10);
  @$pb.TagNumber(11)
  set locality($47.Locality v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasLocality() => $_has(10);
  @$pb.TagNumber(11)
  void clearLocality() => clearField(11);
  @$pb.TagNumber(11)
  $47.Locality ensureLocality() => $_ensure(10);
  ...
  @$pb.TagNumber(12)
  HealthCheckSuccessful get successfulHealthCheckEvent => $_getN(11);
  @$pb.TagNumber(12)
  set successfulHealthCheckEvent(HealthCheckSuccessful v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasSuccessfulHealthCheckEvent() => $_has(11);
  @$pb.TagNumber(12)
  void clearSuccessfulHealthCheckEvent() => clearField(12);
  @$pb.TagNumber(12)
  HealthCheckSuccessful ensureSuccessfulHealthCheckEvent() => $_ensure(11);
}
...
class HealthCheckSuccessful extends $pb.GeneratedMessage {
  factory HealthCheckSuccessful() => create();
  HealthCheckSuccessful._() : super();
  factory HealthCheckSuccessful.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory HealthCheckSuccessful.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HealthCheckSuccessful', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.core.v3'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  HealthCheckSuccessful clone() => HealthCheckSuccessful()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HealthCheckSuccessful copyWith(void Function(HealthCheckSuccessful) updates) => super.copyWith((message) => updates(message as HealthCheckSuccessful)) as HealthCheckSuccessful;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static HealthCheckSuccessful create() => HealthCheckSuccessful._();
  HealthCheckSuccessful createEmptyInstance() => create();
  static $pb.PbList<HealthCheckSuccessful> createRepeated() => $pb.PbList<HealthCheckSuccessful>();
  @$core.pragma('dart2js:noInline')
  static HealthCheckSuccessful getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<HealthCheckSuccessful>(create);
  static HealthCheckSuccessful? _defaultInstance;
}
