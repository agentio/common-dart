...
const HealthCheckEvent$json = {
  ...
  '2': [
    ...
    {'1': 'successful_health_check_event', '3': 12, '4': 1, '5': 11, '6': '.envoy.data.core.v3.HealthCheckSuccessful', '9': 0, '10': 'successfulHealthCheckEvent'},
...
final $typed_data.Uint8List healthCheckEventDescriptor = $convert.base64Decode(
    ...
    'hlYWx0aHlFdmVudBJuCh1zdWNjZXNzZnVsX2hlYWx0aF9jaGVja19ldmVudBgMIAEoCzIpLmVu'
    'dm95LmRhdGEuY29yZS52My5IZWFsdGhDaGVja1N1Y2Nlc3NmdWxIAFIac3VjY2Vzc2Z1bEhlYW'
    'x0aENoZWNrRXZlbnQSZQoaaGVhbHRoX2NoZWNrX2ZhaWx1cmVfZXZlbnQYByABKAsyJi5lbnZv'
    'eS5kYXRhLmNvcmUudjMuSGVhbHRoQ2hlY2tGYWlsdXJlSABSF2hlYWx0aENoZWNrRmFpbHVyZU'
    'V2ZW50El0KFWRlZ3JhZGVkX2hlYWx0aHlfaG9zdBgIIAEoCzInLmVudm95LmRhdGEuY29yZS52'
    'My5EZWdyYWRlZEhlYWx0aHlIb3N0SABSE2RlZ3JhZGVkSGVhbHRoeUhvc3QSYQoXbm9fbG9uZ2'
    'VyX2RlZ3JhZGVkX2hvc3QYCSABKAsyKC5lbnZveS5kYXRhLmNvcmUudjMuTm9Mb25nZXJEZWdy'
    'YWRlZEhvc3RIAFIUbm9Mb25nZXJEZWdyYWRlZEhvc3QSOAoJdGltZXN0YW1wGAYgASgLMhouZ2'
    '9vZ2xlLnByb3RvYnVmLlRpbWVzdGFtcFIJdGltZXN0YW1wEjoKCG1ldGFkYXRhGAogASgLMh4u'
    'ZW52b3kuY29uZmlnLmNvcmUudjMuTWV0YWRhdGFSCG1ldGFkYXRhEjoKCGxvY2FsaXR5GAsgAS'
    'gLMh4uZW52b3kuY29uZmlnLmNvcmUudjMuTG9jYWxpdHlSCGxvY2FsaXR5Oi+axYgeKgooZW52'
    'b3kuZGF0YS5jb3JlLnYyYWxwaGEuSGVhbHRoQ2hlY2tFdmVudEIMCgVldmVudBID+EIB');
...
@$core.Deprecated('Use healthCheckSuccessfulDescriptor instead')
const HealthCheckSuccessful$json = {
  '1': 'HealthCheckSuccessful',
};

/// Descriptor for `HealthCheckSuccessful`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List healthCheckSuccessfulDescriptor = $convert.base64Decode(
    'ChVIZWFsdGhDaGVja1N1Y2Nlc3NmdWw=');
