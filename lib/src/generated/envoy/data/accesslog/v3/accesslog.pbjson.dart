...
const ResponseFlags$json = {
  ...
  '2': [
    ...
    {'1': 'downstream_remote_reset', '3': 28, '4': 1, '5': 8, '10': 'downstreamRemoteReset'},
  ],
...
final $typed_data.Uint8List responseFlagsDescriptor = $convert.base64Decode(
    ...
    '9uRmFpbHVyZRI2Chdkb3duc3RyZWFtX3JlbW90ZV9yZXNldBgcIAEoCFIVZG93bnN0cmVhbVJl'
    'bW90ZVJlc2V0GtUBCgxVbmF1dGhvcml6ZWQSUgoGcmVhc29uGAEgASgOMjouZW52b3kuZGF0YS'
    '5hY2Nlc3Nsb2cudjMuUmVzcG9uc2VGbGFncy5VbmF1dGhvcml6ZWQuUmVhc29uUgZyZWFzb24i'
    'NgoGUmVhc29uEhYKElJFQVNPTl9VTlNQRUNJRklFRBAAEhQKEEVYVEVSTkFMX1NFUlZJQ0UQAT'
    'o5msWIHjQKMmVudm95LmRhdGEuYWNjZXNzbG9nLnYyLlJlc3BvbnNlRmxhZ3MuVW5hdXRob3Jp'
    'emVkOiyaxYgeJwolZW52b3kuZGF0YS5hY2Nlc3Nsb2cudjIuUmVzcG9uc2VGbGFncw==');
...
final $typed_data.Uint8List tLSPropertiesDescriptor = $convert.base64Decode(
    ...
    'Npb25JZBInCg9qYTNfZmluZ2VycHJpbnQYByABKAlSDmphM0ZpbmdlcnByaW50GpkDChVDZXJ0'
    ...
    'Y3RBbHROYW1lUg5zdWJqZWN0QWx0TmFtZRIYCgdzdWJqZWN0GAIgASgJUgdzdWJqZWN0EhYKBm'
    'lzc3VlchgDIAEoCVIGaXNzdWVyGpIBCg5TdWJqZWN0QWx0TmFtZRISCgN1cmkYASABKAlIAFID'
    'dXJpEhIKA2RucxgCIAEoCUgAUgNkbnM6UZrFiB5MCkplbnZveS5kYXRhLmFjY2Vzc2xvZy52Mi'
    '5UTFNQcm9wZXJ0aWVzLkNlcnRpZmljYXRlUHJvcGVydGllcy5TdWJqZWN0QWx0TmFtZUIFCgNz'
    'YW46QprFiB49CjtlbnZveS5kYXRhLmFjY2Vzc2xvZy52Mi5UTFNQcm9wZXJ0aWVzLkNlcnRpZm'
    'ljYXRlUHJvcGVydGllcyJXCgpUTFNWZXJzaW9uEhcKE1ZFUlNJT05fVU5TUEVDSUZJRUQQABIJ'
    'CgVUTFN2MRABEgsKB1RMU3YxXzEQAhILCgdUTFN2MV8yEAMSCwoHVExTdjFfMxAEOiyaxYgeJw'
    'olZW52b3kuZGF0YS5hY2Nlc3Nsb2cudjIuVExTUHJvcGVydGllcw==');
