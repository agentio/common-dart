...
import '../../../config/core/v3/base.pbenum.dart' as $47;
...
class AccessLogCommon extends $pb.GeneratedMessage {
  factory AccessLogCommon({
    ...
    $42.Address? downstreamRemoteAddress,
    $42.Address? downstreamLocalAddress,
    ...
    $42.Address? upstreamRemoteAddress,
    $42.Address? upstreamLocalAddress,
    $core.String? upstreamCluster,
    ResponseFlags? responseFlags,
    $47.Metadata? metadata,
    $core.String? upstreamTransportFailureReason,
    $core.String? routeName,
    $42.Address? downstreamDirectRemoteAddress,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessLogCommon', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.accesslog.v3'), createEmptyInstance: create)
    ...
    ..aOM<$42.Address>(2, _omitFieldNames ? '' : 'downstreamRemoteAddress', subBuilder: $42.Address.create)
    ..aOM<$42.Address>(3, _omitFieldNames ? '' : 'downstreamLocalAddress', subBuilder: $42.Address.create)
    ...
    ..aOM<$42.Address>(13, _omitFieldNames ? '' : 'upstreamRemoteAddress', subBuilder: $42.Address.create)
    ..aOM<$42.Address>(14, _omitFieldNames ? '' : 'upstreamLocalAddress', subBuilder: $42.Address.create)
    ..aOS(15, _omitFieldNames ? '' : 'upstreamCluster')
    ..aOM<ResponseFlags>(16, _omitFieldNames ? '' : 'responseFlags', subBuilder: ResponseFlags.create)
    ..aOM<$47.Metadata>(17, _omitFieldNames ? '' : 'metadata', subBuilder: $47.Metadata.create)
    ..aOS(18, _omitFieldNames ? '' : 'upstreamTransportFailureReason')
    ..aOS(19, _omitFieldNames ? '' : 'routeName')
    ..aOM<$42.Address>(20, _omitFieldNames ? '' : 'downstreamDirectRemoteAddress', subBuilder: $42.Address.create)
    ..m<$core.String, $34.Any>(21, _omitFieldNames ? '' : 'filterStateObjects', entryClassName: 'AccessLogCommon.FilterStateObjectsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $34.Any.create, valueDefaultOrMaker: $34.Any.getDefault, packageName: const $pb.PackageName('envoy.data.accesslog.v3'))
    ...
    ..aOM<$28.Duration>(23, _omitFieldNames ? '' : 'duration', subBuilder: $28.Duration.create)
  ...
  @$pb.TagNumber(2)
  $42.Address get downstreamRemoteAddress => $_getN(1);
  @$pb.TagNumber(2)
  set downstreamRemoteAddress($42.Address v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDownstreamRemoteAddress() => $_has(1);
  @$pb.TagNumber(2)
  void clearDownstreamRemoteAddress() => clearField(2);
  @$pb.TagNumber(2)
  $42.Address ensureDownstreamRemoteAddress() => $_ensure(1);

  /// This field is the local/destination address on which the request from the user was received.
  @$pb.TagNumber(3)
  $42.Address get downstreamLocalAddress => $_getN(2);
  @$pb.TagNumber(3)
  set downstreamLocalAddress($42.Address v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasDownstreamLocalAddress() => $_has(2);
  @$pb.TagNumber(3)
  void clearDownstreamLocalAddress() => clearField(3);
  @$pb.TagNumber(3)
  $42.Address ensureDownstreamLocalAddress() => $_ensure(2);
  ...
  /// retries.
  @$pb.TagNumber(13)
  $42.Address get upstreamRemoteAddress => $_getN(12);
  @$pb.TagNumber(13)
  set upstreamRemoteAddress($42.Address v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasUpstreamRemoteAddress() => $_has(12);
  @$pb.TagNumber(13)
  void clearUpstreamRemoteAddress() => clearField(13);
  @$pb.TagNumber(13)
  $42.Address ensureUpstreamRemoteAddress() => $_ensure(12);

  /// The upstream local/origin address that handles this exchange. This does not include retries.
  @$pb.TagNumber(14)
  $42.Address get upstreamLocalAddress => $_getN(13);
  @$pb.TagNumber(14)
  set upstreamLocalAddress($42.Address v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasUpstreamLocalAddress() => $_has(13);
  @$pb.TagNumber(14)
  void clearUpstreamLocalAddress() => clearField(14);
  @$pb.TagNumber(14)
  $42.Address ensureUpstreamLocalAddress() => $_ensure(13);
  ...
  @$pb.TagNumber(17)
  $47.Metadata get metadata => $_getN(16);
  @$pb.TagNumber(17)
  set metadata($47.Metadata v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasMetadata() => $_has(16);
  @$pb.TagNumber(17)
  void clearMetadata() => clearField(17);
  @$pb.TagNumber(17)
  $47.Metadata ensureMetadata() => $_ensure(16);
  ...
  @$pb.TagNumber(20)
  $42.Address get downstreamDirectRemoteAddress => $_getN(19);
  @$pb.TagNumber(20)
  set downstreamDirectRemoteAddress($42.Address v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasDownstreamDirectRemoteAddress() => $_has(19);
  @$pb.TagNumber(20)
  void clearDownstreamDirectRemoteAddress() => clearField(20);
  @$pb.TagNumber(20)
  $42.Address ensureDownstreamDirectRemoteAddress() => $_ensure(19);
  ...
  @$pb.TagNumber(23)
  $28.Duration get duration => $_getN(22);
  @$pb.TagNumber(23)
  set duration($28.Duration v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasDuration() => $_has(22);
  @$pb.TagNumber(23)
  void clearDuration() => clearField(23);
  @$pb.TagNumber(23)
  $28.Duration ensureDuration() => $_ensure(22);
...
class ResponseFlags extends $pb.GeneratedMessage {
  factory ResponseFlags({
    ...
    $core.bool? downstreamRemoteReset,
  }) {
    final $result = create();
    ...
    if (downstreamRemoteReset != null) {
      $result.downstreamRemoteReset = downstreamRemoteReset;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResponseFlags', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.accesslog.v3'), createEmptyInstance: create)
    ...
    ..aOB(28, _omitFieldNames ? '' : 'downstreamRemoteReset')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(28)
  $core.bool get downstreamRemoteReset => $_getBF(27);
  @$pb.TagNumber(28)
  set downstreamRemoteReset($core.bool v) { $_setBool(27, v); }
  @$pb.TagNumber(28)
  $core.bool hasDownstreamRemoteReset() => $_has(27);
  @$pb.TagNumber(28)
  void clearDownstreamRemoteReset() => clearField(28);
}
...
class HTTPRequestProperties extends $pb.GeneratedMessage {
  factory HTTPRequestProperties({
    $47.RequestMethod? requestMethod,
    $core.String? scheme,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HTTPRequestProperties', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.accesslog.v3'), createEmptyInstance: create)
    ..e<$47.RequestMethod>(1, _omitFieldNames ? '' : 'requestMethod', $pb.PbFieldType.OE, defaultOrMaker: $47.RequestMethod.METHOD_UNSPECIFIED, valueOf: $47.RequestMethod.valueOf, enumValues: $47.RequestMethod.values)
  ...
  @$pb.TagNumber(1)
  $47.RequestMethod get requestMethod => $_getN(0);
  @$pb.TagNumber(1)
  set requestMethod($47.RequestMethod v) { setField(1, v); }
  @$pb.TagNumber(1)
