...
class OutlierDetectionEvent extends $pb.GeneratedMessage {
  factory OutlierDetectionEvent({
    ...
    $26.UInt64Value? secsSinceLastAction,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OutlierDetectionEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.cluster.v2alpha'), createEmptyInstance: create)
    ..oo(0, [9, 10, 11])
    ...
    ..aOM<$65.Timestamp>(2, _omitFieldNames ? '' : 'timestamp', subBuilder: $65.Timestamp.create)
    ..aOM<$26.UInt64Value>(3, _omitFieldNames ? '' : 'secsSinceLastAction', subBuilder: $26.UInt64Value.create)
  ...
  /// Timestamp for event.
  @$pb.TagNumber(2)
  $65.Timestamp get timestamp => $_getN(1);
  @$pb.TagNumber(2)
  set timestamp($65.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTimestamp() => $_has(1);
  @$pb.TagNumber(2)
  void clearTimestamp() => clearField(2);
  @$pb.TagNumber(2)
  $65.Timestamp ensureTimestamp() => $_ensure(1);

  /// The time in seconds since the last action (either an ejection or unejection) took place.
  @$pb.TagNumber(3)
  $26.UInt64Value get secsSinceLastAction => $_getN(2);
  @$pb.TagNumber(3)
  set secsSinceLastAction($26.UInt64Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSecsSinceLastAction() => $_has(2);
  @$pb.TagNumber(3)
  void clearSecsSinceLastAction() => clearField(3);
  @$pb.TagNumber(3)
  $26.UInt64Value ensureSecsSinceLastAction() => $_ensure(2);
...
class OutlierEjectSuccessRate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OutlierEjectSuccessRate', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.cluster.v2alpha'), createEmptyInstance: create)
...
class OutlierEjectConsecutive extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OutlierEjectConsecutive', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.cluster.v2alpha'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class OutlierEjectFailurePercentage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OutlierEjectFailurePercentage', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.cluster.v2alpha'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'hostSuccessRate', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;
