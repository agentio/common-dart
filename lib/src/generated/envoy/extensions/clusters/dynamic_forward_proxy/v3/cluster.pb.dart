...
class ClusterConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClusterConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.clusters.dynamic_forward_proxy.v3'), createEmptyInstance: create)
    ..oo(0, [1, 4])
    ..aOM<$191.DnsCacheConfig>(1, _omitFieldNames ? '' : 'dnsCacheConfig', subBuilder: $191.DnsCacheConfig.create)
  ...
  @$pb.TagNumber(1)
  $191.DnsCacheConfig get dnsCacheConfig => $_getN(0);
  @$pb.TagNumber(1)
  set dnsCacheConfig($191.DnsCacheConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDnsCacheConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearDnsCacheConfig() => clearField(1);
  @$pb.TagNumber(1)
  $191.DnsCacheConfig ensureDnsCacheConfig() => $_ensure(0);
...
class SubClustersConfig extends $pb.GeneratedMessage {
  factory SubClustersConfig({
    $115.Cluster_LbPolicy? lbPolicy,
    $26.UInt32Value? maxSubClusters,
    $28.Duration? subClusterTtl,
    $core.Iterable<$42.SocketAddress>? preresolveClusters,
  }) {
    final $result = create();
    if (lbPolicy != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SubClustersConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.clusters.dynamic_forward_proxy.v3'), createEmptyInstance: create)
    ..e<$115.Cluster_LbPolicy>(1, _omitFieldNames ? '' : 'lbPolicy', $pb.PbFieldType.OE, defaultOrMaker: $115.Cluster_LbPolicy.ROUND_ROBIN, valueOf: $115.Cluster_LbPolicy.valueOf, enumValues: $115.Cluster_LbPolicy.values)
    ..aOM<$26.UInt32Value>(2, _omitFieldNames ? '' : 'maxSubClusters', subBuilder: $26.UInt32Value.create)
    ..aOM<$28.Duration>(3, _omitFieldNames ? '' : 'subClusterTtl', subBuilder: $28.Duration.create)
    ..pc<$42.SocketAddress>(4, _omitFieldNames ? '' : 'preresolveClusters', $pb.PbFieldType.PM, subBuilder: $42.SocketAddress.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $115.Cluster_LbPolicy get lbPolicy => $_getN(0);
  @$pb.TagNumber(1)
  set lbPolicy($115.Cluster_LbPolicy v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $26.UInt32Value get maxSubClusters => $_getN(1);
  @$pb.TagNumber(2)
  set maxSubClusters($26.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMaxSubClusters() => $_has(1);
  @$pb.TagNumber(2)
  void clearMaxSubClusters() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt32Value ensureMaxSubClusters() => $_ensure(1);

  /// The TTL for sub clusters that are unused. Sub clusters that have not been used in the configured time
  /// interval will be purged. If not specified defaults to 5m.
  @$pb.TagNumber(3)
  $28.Duration get subClusterTtl => $_getN(2);
  @$pb.TagNumber(3)
  set subClusterTtl($28.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSubClusterTtl() => $_has(2);
  @$pb.TagNumber(3)
  void clearSubClusterTtl() => clearField(3);
  @$pb.TagNumber(3)
  $28.Duration ensureSubClusterTtl() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $core.List<$42.SocketAddress> get preresolveClusters => $_getList(3);
}
