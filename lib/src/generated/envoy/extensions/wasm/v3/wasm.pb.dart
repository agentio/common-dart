...
class VmConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VmConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.wasm.v3'), createEmptyInstance: create)
    ...
    ..aOM<$47.AsyncDataSource>(3, _omitFieldNames ? '' : 'code', subBuilder: $47.AsyncDataSource.create)
    ..aOM<$34.Any>(4, _omitFieldNames ? '' : 'configuration', subBuilder: $34.Any.create)
  ...
  @$pb.TagNumber(3)
  $47.AsyncDataSource get code => $_getN(2);
  @$pb.TagNumber(3)
  set code($47.AsyncDataSource v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCode() => $_has(2);
  @$pb.TagNumber(3)
  void clearCode() => clearField(3);
  @$pb.TagNumber(3)
  $47.AsyncDataSource ensureCode() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $34.Any get configuration => $_getN(3);
  @$pb.TagNumber(4)
  set configuration($34.Any v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasConfiguration() => $_has(3);
  @$pb.TagNumber(4)
  void clearConfiguration() => clearField(4);
  @$pb.TagNumber(4)
  $34.Any ensureConfiguration() => $_ensure(3);
