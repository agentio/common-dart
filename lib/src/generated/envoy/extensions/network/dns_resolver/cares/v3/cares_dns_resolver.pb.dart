...
class CaresDnsResolverConfig extends $pb.GeneratedMessage {
  factory CaresDnsResolverConfig({
    $core.Iterable<$42.Address>? resolvers,
    $109.DnsResolverOptions? dnsResolverOptions,
    $core.bool? useResolversAsFallback,
    $core.bool? filterUnroutableFamilies,
    $26.UInt32Value? udpMaxQueries,
  }) {
    final $result = create();
    if (resolvers != null) {
    ...
    if (udpMaxQueries != null) {
      $result.udpMaxQueries = udpMaxQueries;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CaresDnsResolverConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.network.dns_resolver.cares.v3'), createEmptyInstance: create)
    ..pc<$42.Address>(1, _omitFieldNames ? '' : 'resolvers', $pb.PbFieldType.PM, subBuilder: $42.Address.create)
    ..aOM<$109.DnsResolverOptions>(2, _omitFieldNames ? '' : 'dnsResolverOptions', subBuilder: $109.DnsResolverOptions.create)
    ..aOB(3, _omitFieldNames ? '' : 'useResolversAsFallback')
    ..aOB(4, _omitFieldNames ? '' : 'filterUnroutableFamilies')
    ..aOM<$26.UInt32Value>(5, _omitFieldNames ? '' : 'udpMaxQueries', subBuilder: $26.UInt32Value.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$42.Address> get resolvers => $_getList(0);

  /// Configuration of DNS resolver option flags which control the behavior of the DNS resolver.
  @$pb.TagNumber(2)
  $109.DnsResolverOptions get dnsResolverOptions => $_getN(1);
  @$pb.TagNumber(2)
  set dnsResolverOptions($109.DnsResolverOptions v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDnsResolverOptions() => $_has(1);
  @$pb.TagNumber(2)
  void clearDnsResolverOptions() => clearField(2);
  @$pb.TagNumber(2)
  $109.DnsResolverOptions ensureDnsResolverOptions() => $_ensure(1);
  ...
  @$pb.TagNumber(5)
  $26.UInt32Value get udpMaxQueries => $_getN(4);
  @$pb.TagNumber(5)
  set udpMaxQueries($26.UInt32Value v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasUdpMaxQueries() => $_has(4);
  @$pb.TagNumber(5)
  void clearUdpMaxQueries() => clearField(5);
  @$pb.TagNumber(5)
  $26.UInt32Value ensureUdpMaxQueries() => $_ensure(4);
}
