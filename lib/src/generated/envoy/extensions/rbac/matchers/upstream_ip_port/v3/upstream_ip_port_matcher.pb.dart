...
class UpstreamIpPortMatcher extends $pb.GeneratedMessage {
  factory UpstreamIpPortMatcher({
    $42.CidrRange? upstreamIp,
    $54.Int64Range? upstreamPortRange,
  }) {
    final $result = create();
    if (upstreamIp != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpstreamIpPortMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.rbac.matchers.upstream_ip_port.v3'), createEmptyInstance: create)
    ..aOM<$42.CidrRange>(1, _omitFieldNames ? '' : 'upstreamIp', subBuilder: $42.CidrRange.create)
    ..aOM<$54.Int64Range>(2, _omitFieldNames ? '' : 'upstreamPortRange', subBuilder: $54.Int64Range.create)
  ...
  @$pb.TagNumber(1)
  $42.CidrRange get upstreamIp => $_getN(0);
  @$pb.TagNumber(1)
  set upstreamIp($42.CidrRange v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUpstreamIp() => $_has(0);
  @$pb.TagNumber(1)
  void clearUpstreamIp() => clearField(1);
  @$pb.TagNumber(1)
  $42.CidrRange ensureUpstreamIp() => $_ensure(0);

  /// A port range that will be used to match the upstream port.
  @$pb.TagNumber(2)
  $54.Int64Range get upstreamPortRange => $_getN(1);
  @$pb.TagNumber(2)
  set upstreamPortRange($54.Int64Range v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpstreamPortRange() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpstreamPortRange() => clearField(2);
  @$pb.TagNumber(2)
  $54.Int64Range ensureUpstreamPortRange() => $_ensure(1);
}
