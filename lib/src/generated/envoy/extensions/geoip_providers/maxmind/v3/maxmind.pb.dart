...
import '../../common/v3/common.pb.dart' as $202;
...
class MaxMindConfig extends $pb.GeneratedMessage {
  factory MaxMindConfig({
    ...
    $202.CommonGeoipProviderConfig? commonProviderConfig,
  }) {
    final $result = create();
    if (cityDbPath != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MaxMindConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.geoip_providers.maxmind.v3'), createEmptyInstance: create)
    ...
    ..aOM<$202.CommonGeoipProviderConfig>(4, _omitFieldNames ? '' : 'commonProviderConfig', subBuilder: $202.CommonGeoipProviderConfig.create)
  ...
  @$pb.TagNumber(4)
  $202.CommonGeoipProviderConfig get commonProviderConfig => $_getN(3);
  @$pb.TagNumber(4)
  set commonProviderConfig($202.CommonGeoipProviderConfig v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCommonProviderConfig() => $_has(3);
  @$pb.TagNumber(4)
  void clearCommonProviderConfig() => clearField(4);
  @$pb.TagNumber(4)
  $202.CommonGeoipProviderConfig ensureCommonProviderConfig() => $_ensure(3);
}
