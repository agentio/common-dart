...
class UuidRequestIdConfig extends $pb.GeneratedMessage {
  factory UuidRequestIdConfig({
    $26.BoolValue? packTraceReason,
    $26.BoolValue? useRequestIdForTraceSampling,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UuidRequestIdConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.request_id.uuid.v3'), createEmptyInstance: create)
    ..aOM<$26.BoolValue>(1, _omitFieldNames ? '' : 'packTraceReason', subBuilder: $26.BoolValue.create)
    ..aOM<$26.BoolValue>(2, _omitFieldNames ? '' : 'useRequestIdForTraceSampling', subBuilder: $26.BoolValue.create)
  ...
  /// be possible.
  @$pb.TagNumber(1)
  $26.BoolValue get packTraceReason => $_getN(0);
  @$pb.TagNumber(1)
  set packTraceReason($26.BoolValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPackTraceReason() => $_has(0);
  @$pb.TagNumber(1)
  void clearPackTraceReason() => clearField(1);
  @$pb.TagNumber(1)
  $26.BoolValue ensurePackTraceReason() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $26.BoolValue get useRequestIdForTraceSampling => $_getN(1);
  @$pb.TagNumber(2)
  set useRequestIdForTraceSampling($26.BoolValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUseRequestIdForTraceSampling() => $_has(1);
  @$pb.TagNumber(2)
  void clearUseRequestIdForTraceSampling() => clearField(2);
  @$pb.TagNumber(2)
  $26.BoolValue ensureUseRequestIdForTraceSampling() => $_ensure(1);
}
