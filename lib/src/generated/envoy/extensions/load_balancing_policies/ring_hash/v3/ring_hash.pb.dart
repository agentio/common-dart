...
class RingHash extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    $178.ConsistentHashingLbConfig? consistentHashingLbConfig,
    $178.LocalityLbConfig_LocalityWeightedLbConfig? localityWeightedLbConfig,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RingHash', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.load_balancing_policies.ring_hash.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.UInt64Value>(2, _omitFieldNames ? '' : 'minimumRingSize', subBuilder: $26.UInt64Value.create)
    ..aOM<$26.UInt64Value>(3, _omitFieldNames ? '' : 'maximumRingSize', subBuilder: $26.UInt64Value.create)
    ..aOB(4, _omitFieldNames ? '' : 'useHostnameForHashing')
    ..aOM<$26.UInt32Value>(5, _omitFieldNames ? '' : 'hashBalanceFactor', subBuilder: $26.UInt32Value.create)
    ..aOM<$178.ConsistentHashingLbConfig>(6, _omitFieldNames ? '' : 'consistentHashingLbConfig', subBuilder: $178.ConsistentHashingLbConfig.create)
    ..aOM<$178.LocalityLbConfig_LocalityWeightedLbConfig>(7, _omitFieldNames ? '' : 'localityWeightedLbConfig', subBuilder: $178.LocalityLbConfig_LocalityWeightedLbConfig.create)
  ...
  @$pb.TagNumber(2)
  $26.UInt64Value get minimumRingSize => $_getN(1);
  @$pb.TagNumber(2)
  set minimumRingSize($26.UInt64Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMinimumRingSize() => $_has(1);
  @$pb.TagNumber(2)
  void clearMinimumRingSize() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt64Value ensureMinimumRingSize() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  set maximumRingSize($26.UInt64Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  $26.UInt32Value get hashBalanceFactor => $_getN(4);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  set hashBalanceFactor($26.UInt32Value v) { setField(5, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  $26.UInt32Value ensureHashBalanceFactor() => $_ensure(4);

  /// Common configuration for hashing-based load balancing policies.
  @$pb.TagNumber(6)
  $178.ConsistentHashingLbConfig get consistentHashingLbConfig => $_getN(5);
  @$pb.TagNumber(6)
  set consistentHashingLbConfig($178.ConsistentHashingLbConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasConsistentHashingLbConfig() => $_has(5);
  @$pb.TagNumber(6)
  void clearConsistentHashingLbConfig() => clearField(6);
  @$pb.TagNumber(6)
  $178.ConsistentHashingLbConfig ensureConsistentHashingLbConfig() => $_ensure(5);

  /// Enable locality weighted load balancing for ring hash lb explicitly.
  @$pb.TagNumber(7)
  $178.LocalityLbConfig_LocalityWeightedLbConfig get localityWeightedLbConfig => $_getN(6);
  @$pb.TagNumber(7)
  set localityWeightedLbConfig($178.LocalityLbConfig_LocalityWeightedLbConfig v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasLocalityWeightedLbConfig() => $_has(6);
  @$pb.TagNumber(7)
  void clearLocalityWeightedLbConfig() => clearField(7);
  @$pb.TagNumber(7)
  $178.LocalityLbConfig_LocalityWeightedLbConfig ensureLocalityWeightedLbConfig() => $_ensure(6);
}
