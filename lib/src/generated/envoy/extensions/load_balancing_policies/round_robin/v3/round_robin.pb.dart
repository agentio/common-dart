...
class RoundRobin extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RoundRobin', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.load_balancing_policies.round_robin.v3'), createEmptyInstance: create)
    ..aOM<$178.SlowStartConfig>(1, _omitFieldNames ? '' : 'slowStartConfig', subBuilder: $178.SlowStartConfig.create)
    ..aOM<$178.LocalityLbConfig>(2, _omitFieldNames ? '' : 'localityLbConfig', subBuilder: $178.LocalityLbConfig.create)
  ...
  @$pb.TagNumber(1)
  $178.SlowStartConfig get slowStartConfig => $_getN(0);
  @$pb.TagNumber(1)
  set slowStartConfig($178.SlowStartConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSlowStartConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearSlowStartConfig() => clearField(1);
  @$pb.TagNumber(1)
  $178.SlowStartConfig ensureSlowStartConfig() => $_ensure(0);

  /// Configuration for local zone aware load balancing or locality weighted load balancing.
  @$pb.TagNumber(2)
  $178.LocalityLbConfig get localityLbConfig => $_getN(1);
  @$pb.TagNumber(2)
  set localityLbConfig($178.LocalityLbConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasLocalityLbConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearLocalityLbConfig() => clearField(2);
  @$pb.TagNumber(2)
  $178.LocalityLbConfig ensureLocalityLbConfig() => $_ensure(1);
}
