...
class ClientSideWeightedRoundRobin extends $pb.GeneratedMessage {
  factory ClientSideWeightedRoundRobin({
    $26.BoolValue? enableOobLoadReport,
    $28.Duration? oobReportingPeriod,
    $28.Duration? blackoutPeriod,
    $28.Duration? weightExpirationPeriod,
    $28.Duration? weightUpdatePeriod,
    $26.FloatValue? errorUtilizationPenalty,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientSideWeightedRoundRobin', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.load_balancing_policies.client_side_weighted_round_robin.v3'), createEmptyInstance: create)
    ..aOM<$26.BoolValue>(1, _omitFieldNames ? '' : 'enableOobLoadReport', subBuilder: $26.BoolValue.create)
    ..aOM<$28.Duration>(2, _omitFieldNames ? '' : 'oobReportingPeriod', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(3, _omitFieldNames ? '' : 'blackoutPeriod', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(4, _omitFieldNames ? '' : 'weightExpirationPeriod', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(5, _omitFieldNames ? '' : 'weightUpdatePeriod', subBuilder: $28.Duration.create)
    ..aOM<$26.FloatValue>(6, _omitFieldNames ? '' : 'errorUtilizationPenalty', subBuilder: $26.FloatValue.create)
  ...
  @$pb.TagNumber(1)
  $26.BoolValue get enableOobLoadReport => $_getN(0);
  @$pb.TagNumber(1)
  set enableOobLoadReport($26.BoolValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasEnableOobLoadReport() => $_has(0);
  @$pb.TagNumber(1)
  void clearEnableOobLoadReport() => clearField(1);
  @$pb.TagNumber(1)
  $26.BoolValue ensureEnableOobLoadReport() => $_ensure(0);

  /// Load reporting interval to request from the server. Note that the
  /// server may not provide reports as frequently as the client requests.
  /// Used only when enable_oob_load_report is true. Default is 10 seconds.
  @$pb.TagNumber(2)
  $28.Duration get oobReportingPeriod => $_getN(1);
  @$pb.TagNumber(2)
  set oobReportingPeriod($28.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasOobReportingPeriod() => $_has(1);
  @$pb.TagNumber(2)
  void clearOobReportingPeriod() => clearField(2);
  @$pb.TagNumber(2)
  $28.Duration ensureOobReportingPeriod() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $28.Duration get blackoutPeriod => $_getN(2);
  @$pb.TagNumber(3)
  set blackoutPeriod($28.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasBlackoutPeriod() => $_has(2);
  @$pb.TagNumber(3)
  void clearBlackoutPeriod() => clearField(3);
  @$pb.TagNumber(3)
  $28.Duration ensureBlackoutPeriod() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $28.Duration get weightExpirationPeriod => $_getN(3);
  @$pb.TagNumber(4)
  set weightExpirationPeriod($28.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasWeightExpirationPeriod() => $_has(3);
  @$pb.TagNumber(4)
  void clearWeightExpirationPeriod() => clearField(4);
  @$pb.TagNumber(4)
  $28.Duration ensureWeightExpirationPeriod() => $_ensure(3);

  /// How often endpoint weights are recalculated. Values less than 100ms are
  /// capped at 100ms. Default is 1 second.
  @$pb.TagNumber(5)
  $28.Duration get weightUpdatePeriod => $_getN(4);
  @$pb.TagNumber(5)
  set weightUpdatePeriod($28.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasWeightUpdatePeriod() => $_has(4);
  @$pb.TagNumber(5)
  void clearWeightUpdatePeriod() => clearField(5);
  @$pb.TagNumber(5)
  $28.Duration ensureWeightUpdatePeriod() => $_ensure(4);

  /// The multiplier used to adjust endpoint weights with the error rate
  /// calculated as eps/qps. Configuration is rejected if this value is negative.
  /// Default is 1.0.
  @$pb.TagNumber(6)
  $26.FloatValue get errorUtilizationPenalty => $_getN(5);
  @$pb.TagNumber(6)
  set errorUtilizationPenalty($26.FloatValue v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasErrorUtilizationPenalty() => $_has(5);
  @$pb.TagNumber(6)
  void clearErrorUtilizationPenalty() => clearField(6);
  @$pb.TagNumber(6)
  $26.FloatValue ensureErrorUtilizationPenalty() => $_ensure(5);
}
