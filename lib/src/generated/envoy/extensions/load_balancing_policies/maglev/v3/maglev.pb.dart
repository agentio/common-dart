...
class Maglev extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Maglev', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.load_balancing_policies.maglev.v3'), createEmptyInstance: create)
    ...
    ..aOM<$178.ConsistentHashingLbConfig>(2, _omitFieldNames ? '' : 'consistentHashingLbConfig', subBuilder: $178.ConsistentHashingLbConfig.create)
    ..aOM<$178.LocalityLbConfig_LocalityWeightedLbConfig>(3, _omitFieldNames ? '' : 'localityWeightedLbConfig', subBuilder: $178.LocalityLbConfig_LocalityWeightedLbConfig.create)
  ...
  @$pb.TagNumber(2)
  $178.ConsistentHashingLbConfig get consistentHashingLbConfig => $_getN(1);
  @$pb.TagNumber(2)
  set consistentHashingLbConfig($178.ConsistentHashingLbConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasConsistentHashingLbConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearConsistentHashingLbConfig() => clearField(2);
  @$pb.TagNumber(2)
  $178.ConsistentHashingLbConfig ensureConsistentHashingLbConfig() => $_ensure(1);

  /// Enable locality weighted load balancing for maglev lb explicitly.
  @$pb.TagNumber(3)
  $178.LocalityLbConfig_LocalityWeightedLbConfig get localityWeightedLbConfig => $_getN(2);
  @$pb.TagNumber(3)
  set localityWeightedLbConfig($178.LocalityLbConfig_LocalityWeightedLbConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasLocalityWeightedLbConfig() => $_has(2);
  @$pb.TagNumber(3)
  void clearLocalityWeightedLbConfig() => clearField(3);
  @$pb.TagNumber(3)
  $178.LocalityLbConfig_LocalityWeightedLbConfig ensureLocalityWeightedLbConfig() => $_ensure(2);
}
