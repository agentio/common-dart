...
class WrrLocality extends $pb.GeneratedMessage {
  factory WrrLocality({
    $115.LoadBalancingPolicy? endpointPickingPolicy,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WrrLocality', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.load_balancing_policies.wrr_locality.v3'), createEmptyInstance: create)
    ..aOM<$115.LoadBalancingPolicy>(1, _omitFieldNames ? '' : 'endpointPickingPolicy', subBuilder: $115.LoadBalancingPolicy.create)
  ...
  @$pb.TagNumber(1)
  $115.LoadBalancingPolicy get endpointPickingPolicy => $_getN(0);
  @$pb.TagNumber(1)
  set endpointPickingPolicy($115.LoadBalancingPolicy v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasEndpointPickingPolicy() => $_has(0);
  @$pb.TagNumber(1)
  void clearEndpointPickingPolicy() => clearField(1);
  @$pb.TagNumber(1)
  $115.LoadBalancingPolicy ensureEndpointPickingPolicy() => $_ensure(0);
}
