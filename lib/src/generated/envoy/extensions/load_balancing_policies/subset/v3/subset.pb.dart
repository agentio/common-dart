...
class Subset extends $pb.GeneratedMessage {
  factory Subset({
    ...
    $115.LoadBalancingPolicy? subsetLbPolicy,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Subset', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.load_balancing_policies.subset.v3'), createEmptyInstance: create)
    ...
    ..aOM<$115.LoadBalancingPolicy>(9, _omitFieldNames ? '' : 'subsetLbPolicy', subBuilder: $115.LoadBalancingPolicy.create)
  ...
  @$pb.TagNumber(9)
  $115.LoadBalancingPolicy get subsetLbPolicy => $_getN(8);
  @$pb.TagNumber(9)
  set subsetLbPolicy($115.LoadBalancingPolicy v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasSubsetLbPolicy() => $_has(8);
  @$pb.TagNumber(9)
  void clearSubsetLbPolicy() => clearField(9);
  @$pb.TagNumber(9)
  $115.LoadBalancingPolicy ensureSubsetLbPolicy() => $_ensure(8);
