...
class Random extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Random', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.load_balancing_policies.random.v3'), createEmptyInstance: create)
    ..aOM<$178.LocalityLbConfig>(1, _omitFieldNames ? '' : 'localityLbConfig', subBuilder: $178.LocalityLbConfig.create)
  ...
  @$pb.TagNumber(1)
  $178.LocalityLbConfig get localityLbConfig => $_getN(0);
  @$pb.TagNumber(1)
  set localityLbConfig($178.LocalityLbConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasLocalityLbConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearLocalityLbConfig() => clearField(1);
  @$pb.TagNumber(1)
  $178.LocalityLbConfig ensureLocalityLbConfig() => $_ensure(0);
}
