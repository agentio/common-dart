...
class ProxyProtocolUpstreamTransport extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProxyProtocolUpstreamTransport', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.proxy_protocol.v3'), createEmptyInstance: create)
    ..aOM<$63.ProxyProtocolConfig>(1, _omitFieldNames ? '' : 'config', subBuilder: $63.ProxyProtocolConfig.create)
  ...
  @$pb.TagNumber(1)
  $63.ProxyProtocolConfig get config => $_getN(0);
  @$pb.TagNumber(1)
  set config($63.ProxyProtocolConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearConfig() => clearField(1);
  @$pb.TagNumber(1)
  $63.ProxyProtocolConfig ensureConfig() => $_ensure(0);
