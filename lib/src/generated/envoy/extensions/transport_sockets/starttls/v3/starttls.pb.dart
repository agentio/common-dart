...
import '../../raw_buffer/v3/raw_buffer.pb.dart' as $207;
import '../../tls/v3/tls.pb.dart' as $206;
...
class StartTlsConfig extends $pb.GeneratedMessage {
  factory StartTlsConfig({
    $207.RawBuffer? cleartextSocketConfig,
    $206.DownstreamTlsContext? tlsSocketConfig,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StartTlsConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.starttls.v3'), createEmptyInstance: create)
    ..aOM<$207.RawBuffer>(1, _omitFieldNames ? '' : 'cleartextSocketConfig', subBuilder: $207.RawBuffer.create)
    ..aOM<$206.DownstreamTlsContext>(2, _omitFieldNames ? '' : 'tlsSocketConfig', subBuilder: $206.DownstreamTlsContext.create)
  ...
  @$pb.TagNumber(1)
  $207.RawBuffer get cleartextSocketConfig => $_getN(0);
  @$pb.TagNumber(1)
  set cleartextSocketConfig($207.RawBuffer v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCleartextSocketConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearCleartextSocketConfig() => clearField(1);
  @$pb.TagNumber(1)
  $207.RawBuffer ensureCleartextSocketConfig() => $_ensure(0);

  /// Configuration for a downstream TLS socket.
  @$pb.TagNumber(2)
  $206.DownstreamTlsContext get tlsSocketConfig => $_getN(1);
  @$pb.TagNumber(2)
  set tlsSocketConfig($206.DownstreamTlsContext v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTlsSocketConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearTlsSocketConfig() => clearField(2);
  @$pb.TagNumber(2)
  $206.DownstreamTlsContext ensureTlsSocketConfig() => $_ensure(1);
}
...
class UpstreamStartTlsConfig extends $pb.GeneratedMessage {
  factory UpstreamStartTlsConfig({
    $207.RawBuffer? cleartextSocketConfig,
    $206.UpstreamTlsContext? tlsSocketConfig,
  }) {
    final $result = create();
    if (cleartextSocketConfig != null) {
      $result.cleartextSocketConfig = cleartextSocketConfig;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpstreamStartTlsConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.starttls.v3'), createEmptyInstance: create)
    ..aOM<$207.RawBuffer>(1, _omitFieldNames ? '' : 'cleartextSocketConfig', subBuilder: $207.RawBuffer.create)
    ..aOM<$206.UpstreamTlsContext>(2, _omitFieldNames ? '' : 'tlsSocketConfig', subBuilder: $206.UpstreamTlsContext.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $206.UpstreamTlsContext get tlsSocketConfig => $_getN(1);
  @$pb.TagNumber(2)
  set tlsSocketConfig($206.UpstreamTlsContext v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTlsSocketConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearTlsSocketConfig() => clearField(2);
  @$pb.TagNumber(2)
  $206.UpstreamTlsContext ensureTlsSocketConfig() => $_ensure(1);
}
