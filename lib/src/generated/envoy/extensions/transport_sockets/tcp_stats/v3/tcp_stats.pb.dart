...
class Config extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Config', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.tcp_stats.v3'), createEmptyInstance: create)
    ...
    ..aOM<$28.Duration>(2, _omitFieldNames ? '' : 'updatePeriod', subBuilder: $28.Duration.create)
  ...
  @$pb.TagNumber(2)
  $28.Duration get updatePeriod => $_getN(1);
  @$pb.TagNumber(2)
  set updatePeriod($28.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdatePeriod() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdatePeriod() => clearField(2);
  @$pb.TagNumber(2)
  $28.Duration ensureUpdatePeriod() => $_ensure(1);
}
