...
import 'common.pb.dart' as $110;
import 'secret.pb.dart' as $116;
...
class UpstreamTlsContext extends $pb.GeneratedMessage {
  factory UpstreamTlsContext({
    ...
    $26.UInt32Value? maxSessionKeys,
    $26.BoolValue? enforceRsaKeyUsage,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpstreamTlsContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.tls.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.UInt32Value>(4, _omitFieldNames ? '' : 'maxSessionKeys', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.BoolValue>(5, _omitFieldNames ? '' : 'enforceRsaKeyUsage', subBuilder: $26.BoolValue.create)
  ...
  @$pb.TagNumber(4)
  $26.UInt32Value get maxSessionKeys => $_getN(3);
  @$pb.TagNumber(4)
  set maxSessionKeys($26.UInt32Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasMaxSessionKeys() => $_has(3);
  @$pb.TagNumber(4)
  void clearMaxSessionKeys() => clearField(4);
  @$pb.TagNumber(4)
  $26.UInt32Value ensureMaxSessionKeys() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $26.BoolValue get enforceRsaKeyUsage => $_getN(4);
  @$pb.TagNumber(5)
  set enforceRsaKeyUsage($26.BoolValue v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasEnforceRsaKeyUsage() => $_has(4);
  @$pb.TagNumber(5)
  void clearEnforceRsaKeyUsage() => clearField(5);
  @$pb.TagNumber(5)
  $26.BoolValue ensureEnforceRsaKeyUsage() => $_ensure(4);
}
...
class DownstreamTlsContext extends $pb.GeneratedMessage {
  factory DownstreamTlsContext({
    CommonTlsContext? commonTlsContext,
    $26.BoolValue? requireClientCertificate,
    $26.BoolValue? requireSni,
    $110.TlsSessionTicketKeys? sessionTicketKeys,
    $116.SdsSecretConfig? sessionTicketKeysSdsSecretConfig,
    $28.Duration? sessionTimeout,
    $core.bool? disableStatelessSessionResumption,
    DownstreamTlsContext_OcspStaplePolicy? ocspStaplePolicy,
    $26.BoolValue? fullScanCertsOnSniMismatch,
    $core.bool? disableStatefulSessionResumption,
    $core.bool? preferClientCiphers,
  }) {
    final $result = create();
    if (commonTlsContext != null) {
      $result.commonTlsContext = commonTlsContext;
    ...
    if (preferClientCiphers != null) {
      $result.preferClientCiphers = preferClientCiphers;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DownstreamTlsContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.tls.v3'), createEmptyInstance: create)
    ..oo(0, [4, 5, 7])
    ..aOM<CommonTlsContext>(1, _omitFieldNames ? '' : 'commonTlsContext', subBuilder: CommonTlsContext.create)
    ..aOM<$26.BoolValue>(2, _omitFieldNames ? '' : 'requireClientCertificate', subBuilder: $26.BoolValue.create)
    ..aOM<$26.BoolValue>(3, _omitFieldNames ? '' : 'requireSni', subBuilder: $26.BoolValue.create)
    ..aOM<$110.TlsSessionTicketKeys>(4, _omitFieldNames ? '' : 'sessionTicketKeys', subBuilder: $110.TlsSessionTicketKeys.create)
    ..aOM<$116.SdsSecretConfig>(5, _omitFieldNames ? '' : 'sessionTicketKeysSdsSecretConfig', subBuilder: $116.SdsSecretConfig.create)
    ..aOM<$28.Duration>(6, _omitFieldNames ? '' : 'sessionTimeout', subBuilder: $28.Duration.create)
    ...
    ..aOM<$26.BoolValue>(9, _omitFieldNames ? '' : 'fullScanCertsOnSniMismatch', subBuilder: $26.BoolValue.create)
    ..aOB(10, _omitFieldNames ? '' : 'disableStatefulSessionResumption')
    ..aOB(11, _omitFieldNames ? '' : 'preferClientCiphers')
    ..hasRequiredFields = false
  ;
  ...
  /// certificate.
  @$pb.TagNumber(2)
  $26.BoolValue get requireClientCertificate => $_getN(1);
  @$pb.TagNumber(2)
  set requireClientCertificate($26.BoolValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasRequireClientCertificate() => $_has(1);
  @$pb.TagNumber(2)
  void clearRequireClientCertificate() => clearField(2);
  @$pb.TagNumber(2)
  $26.BoolValue ensureRequireClientCertificate() => $_ensure(1);

  /// If specified, Envoy will reject connections without a valid and matching SNI.
  /// [#not-implemented-hide:]
  @$pb.TagNumber(3)
  $26.BoolValue get requireSni => $_getN(2);
  @$pb.TagNumber(3)
  set requireSni($26.BoolValue v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasRequireSni() => $_has(2);
  @$pb.TagNumber(3)
  void clearRequireSni() => clearField(3);
  @$pb.TagNumber(3)
  $26.BoolValue ensureRequireSni() => $_ensure(2);

  /// TLS session ticket key settings.
  @$pb.TagNumber(4)
  $110.TlsSessionTicketKeys get sessionTicketKeys => $_getN(3);
  @$pb.TagNumber(4)
  set sessionTicketKeys($110.TlsSessionTicketKeys v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasSessionTicketKeys() => $_has(3);
  @$pb.TagNumber(4)
  void clearSessionTicketKeys() => clearField(4);
  @$pb.TagNumber(4)
  $110.TlsSessionTicketKeys ensureSessionTicketKeys() => $_ensure(3);

  /// Config for fetching TLS session ticket keys via SDS API.
  @$pb.TagNumber(5)
  $116.SdsSecretConfig get sessionTicketKeysSdsSecretConfig => $_getN(4);
  @$pb.TagNumber(5)
  set sessionTicketKeysSdsSecretConfig($116.SdsSecretConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasSessionTicketKeysSdsSecretConfig() => $_has(4);
  @$pb.TagNumber(5)
  void clearSessionTicketKeysSdsSecretConfig() => clearField(5);
  @$pb.TagNumber(5)
  $116.SdsSecretConfig ensureSessionTicketKeysSdsSecretConfig() => $_ensure(4);

  /// If specified, ``session_timeout`` will change the maximum lifetime (in seconds) of the TLS session.
  /// Currently this value is used as a hint for the `TLS session ticket lifetime (for TLSv1.2) <https://tools.ietf.org/html/rfc5077#section-5.6>`_.
  /// Only seconds can be specified (fractional seconds are ignored).
  @$pb.TagNumber(6)
  $28.Duration get sessionTimeout => $_getN(5);
  @$pb.TagNumber(6)
  set sessionTimeout($28.Duration v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasSessionTimeout() => $_has(5);
  @$pb.TagNumber(6)
  void clearSessionTimeout() => clearField(6);
  @$pb.TagNumber(6)
  $28.Duration ensureSessionTimeout() => $_ensure(5);
  ...
  @$pb.TagNumber(9)
  $26.BoolValue get fullScanCertsOnSniMismatch => $_getN(8);
  @$pb.TagNumber(9)
  set fullScanCertsOnSniMismatch($26.BoolValue v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasFullScanCertsOnSniMismatch() => $_has(8);
  @$pb.TagNumber(9)
  void clearFullScanCertsOnSniMismatch() => clearField(9);
  @$pb.TagNumber(9)
  $26.BoolValue ensureFullScanCertsOnSniMismatch() => $_ensure(8);
  ...
  @$pb.TagNumber(11)
  $core.bool get preferClientCiphers => $_getBF(10);
  @$pb.TagNumber(11)
  set preferClientCiphers($core.bool v) { $_setBool(10, v); }
  @$pb.TagNumber(11)
  $core.bool hasPreferClientCiphers() => $_has(10);
  @$pb.TagNumber(11)
  void clearPreferClientCiphers() => clearField(11);
}
...
class TlsKeyLog extends $pb.GeneratedMessage {
  factory TlsKeyLog({
    $core.String? path,
    $core.Iterable<$42.CidrRange>? localAddressRange,
    $core.Iterable<$42.CidrRange>? remoteAddressRange,
  }) {
    final $result = create();
    if (path != null) {
      $result.path = path;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TlsKeyLog', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.tls.v3'), createEmptyInstance: create)
    ...
    ..pc<$42.CidrRange>(2, _omitFieldNames ? '' : 'localAddressRange', $pb.PbFieldType.PM, subBuilder: $42.CidrRange.create)
    ..pc<$42.CidrRange>(3, _omitFieldNames ? '' : 'remoteAddressRange', $pb.PbFieldType.PM, subBuilder: $42.CidrRange.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$42.CidrRange> get localAddressRange => $_getList(1);
  ...
  @$pb.TagNumber(3)
  $core.List<$42.CidrRange> get remoteAddressRange => $_getList(2);
}
...
class CommonTlsContext_CertificateProvider extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommonTlsContext.CertificateProvider', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.tls.v3'), createEmptyInstance: create)
    ...
    ..aOM<$40.TypedExtensionConfig>(2, _omitFieldNames ? '' : 'typedConfig', subBuilder: $40.TypedExtensionConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $40.TypedExtensionConfig get typedConfig => $_getN(1);
  @$pb.TagNumber(2)
  set typedConfig($40.TypedExtensionConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTypedConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearTypedConfig() => clearField(2);
  @$pb.TagNumber(2)
  $40.TypedExtensionConfig ensureTypedConfig() => $_ensure(1);
}
...
class CommonTlsContext_CombinedCertificateValidationContext extends $pb.GeneratedMessage {
  factory CommonTlsContext_CombinedCertificateValidationContext({
    $110.CertificateValidationContext? defaultValidationContext,
    $116.SdsSecretConfig? validationContextSdsSecretConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommonTlsContext.CombinedCertificateValidationContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.tls.v3'), createEmptyInstance: create)
    ..aOM<$110.CertificateValidationContext>(1, _omitFieldNames ? '' : 'defaultValidationContext', subBuilder: $110.CertificateValidationContext.create)
    ..aOM<$116.SdsSecretConfig>(2, _omitFieldNames ? '' : 'validationContextSdsSecretConfig', subBuilder: $116.SdsSecretConfig.create)
  ...
  @$pb.TagNumber(1)
  $110.CertificateValidationContext get defaultValidationContext => $_getN(0);
  @$pb.TagNumber(1)
  set defaultValidationContext($110.CertificateValidationContext v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDefaultValidationContext() => $_has(0);
  @$pb.TagNumber(1)
  void clearDefaultValidationContext() => clearField(1);
  @$pb.TagNumber(1)
  $110.CertificateValidationContext ensureDefaultValidationContext() => $_ensure(0);

  /// Config for fetching validation context via SDS API. Note SDS API allows certificates to be
  /// fetched/refreshed over the network asynchronously with respect to the TLS handshake.
  @$pb.TagNumber(2)
  $116.SdsSecretConfig get validationContextSdsSecretConfig => $_getN(1);
  @$pb.TagNumber(2)
  set validationContextSdsSecretConfig($116.SdsSecretConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValidationContextSdsSecretConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearValidationContextSdsSecretConfig() => clearField(2);
  @$pb.TagNumber(2)
  $116.SdsSecretConfig ensureValidationContextSdsSecretConfig() => $_ensure(1);
...
class CommonTlsContext extends $pb.GeneratedMessage {
  factory CommonTlsContext({
    $110.TlsParameters? tlsParams,
    $core.Iterable<$110.TlsCertificate>? tlsCertificates,
    $110.CertificateValidationContext? validationContext,
    $core.Iterable<$core.String>? alpnProtocols,
    $core.Iterable<$116.SdsSecretConfig>? tlsCertificateSdsSecretConfigs,
    $116.SdsSecretConfig? validationContextSdsSecretConfig,
  ...
  @$core.Deprecated('This field is deprecated.')
    CommonTlsContext_CertificateProviderInstance? validationContextCertificateProviderInstance,
    $40.TypedExtensionConfig? customHandshaker,
    $110.CertificateProviderPluginInstance? tlsCertificateProviderInstance,
    TlsKeyLog? keyLog,
    $40.TypedExtensionConfig? customTlsCertificateSelector,
  }) {
    final $result = create();
    if (tlsParams != null) {
    ...
    if (customTlsCertificateSelector != null) {
      $result.customTlsCertificateSelector = customTlsCertificateSelector;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommonTlsContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.tls.v3'), createEmptyInstance: create)
    ..oo(0, [3, 7, 8, 10, 12])
    ..aOM<$110.TlsParameters>(1, _omitFieldNames ? '' : 'tlsParams', subBuilder: $110.TlsParameters.create)
    ..pc<$110.TlsCertificate>(2, _omitFieldNames ? '' : 'tlsCertificates', $pb.PbFieldType.PM, subBuilder: $110.TlsCertificate.create)
    ..aOM<$110.CertificateValidationContext>(3, _omitFieldNames ? '' : 'validationContext', subBuilder: $110.CertificateValidationContext.create)
    ..pPS(4, _omitFieldNames ? '' : 'alpnProtocols')
    ..pc<$116.SdsSecretConfig>(6, _omitFieldNames ? '' : 'tlsCertificateSdsSecretConfigs', $pb.PbFieldType.PM, subBuilder: $116.SdsSecretConfig.create)
    ..aOM<$116.SdsSecretConfig>(7, _omitFieldNames ? '' : 'validationContextSdsSecretConfig', subBuilder: $116.SdsSecretConfig.create)
    ...
    ..aOM<$40.TypedExtensionConfig>(13, _omitFieldNames ? '' : 'customHandshaker', subBuilder: $40.TypedExtensionConfig.create)
    ..aOM<$110.CertificateProviderPluginInstance>(14, _omitFieldNames ? '' : 'tlsCertificateProviderInstance', subBuilder: $110.CertificateProviderPluginInstance.create)
    ..aOM<TlsKeyLog>(15, _omitFieldNames ? '' : 'keyLog', subBuilder: TlsKeyLog.create)
    ..aOM<$40.TypedExtensionConfig>(16, _omitFieldNames ? '' : 'customTlsCertificateSelector', subBuilder: $40.TypedExtensionConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $110.TlsParameters get tlsParams => $_getN(0);
  @$pb.TagNumber(1)
  set tlsParams($110.TlsParameters v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTlsParams() => $_has(0);
  @$pb.TagNumber(1)
  void clearTlsParams() => clearField(1);
  @$pb.TagNumber(1)
  $110.TlsParameters ensureTlsParams() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $core.List<$110.TlsCertificate> get tlsCertificates => $_getList(1);

  /// How to validate peer certificates.
  @$pb.TagNumber(3)
  $110.CertificateValidationContext get validationContext => $_getN(2);
  @$pb.TagNumber(3)
  set validationContext($110.CertificateValidationContext v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasValidationContext() => $_has(2);
  @$pb.TagNumber(3)
  void clearValidationContext() => clearField(3);
  @$pb.TagNumber(3)
  $110.CertificateValidationContext ensureValidationContext() => $_ensure(2);
  ...
  ///  is ignored.
  @$pb.TagNumber(6)
  $core.List<$116.SdsSecretConfig> get tlsCertificateSdsSecretConfigs => $_getList(4);

  /// Config for fetching validation context via SDS API. Note SDS API allows certificates to be
  /// fetched/refreshed over the network asynchronously with respect to the TLS handshake.
  @$pb.TagNumber(7)
  $116.SdsSecretConfig get validationContextSdsSecretConfig => $_getN(5);
  @$pb.TagNumber(7)
  set validationContextSdsSecretConfig($116.SdsSecretConfig v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasValidationContextSdsSecretConfig() => $_has(5);
  @$pb.TagNumber(7)
  void clearValidationContextSdsSecretConfig() => clearField(7);
  @$pb.TagNumber(7)
  $116.SdsSecretConfig ensureValidationContextSdsSecretConfig() => $_ensure(5);
  ...
  /// behavior.
  @$pb.TagNumber(13)
  $40.TypedExtensionConfig get customHandshaker => $_getN(11);
  @$pb.TagNumber(13)
  set customHandshaker($40.TypedExtensionConfig v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasCustomHandshaker() => $_has(11);
  @$pb.TagNumber(13)
  void clearCustomHandshaker() => clearField(13);
  @$pb.TagNumber(13)
  $40.TypedExtensionConfig ensureCustomHandshaker() => $_ensure(11);
  ...
  ///  [#not-implemented-hide:]
  @$pb.TagNumber(14)
  $110.CertificateProviderPluginInstance get tlsCertificateProviderInstance => $_getN(12);
  @$pb.TagNumber(14)
  set tlsCertificateProviderInstance($110.CertificateProviderPluginInstance v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasTlsCertificateProviderInstance() => $_has(12);
  @$pb.TagNumber(14)
  void clearTlsCertificateProviderInstance() => clearField(14);
  @$pb.TagNumber(14)
  $110.CertificateProviderPluginInstance ensureTlsCertificateProviderInstance() => $_ensure(12);
  ...
  @$pb.TagNumber(16)
  $40.TypedExtensionConfig get customTlsCertificateSelector => $_getN(14);
  @$pb.TagNumber(16)
  set customTlsCertificateSelector($40.TypedExtensionConfig v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasCustomTlsCertificateSelector() => $_has(14);
  @$pb.TagNumber(16)
  void clearCustomTlsCertificateSelector() => clearField(16);
  @$pb.TagNumber(16)
  $40.TypedExtensionConfig ensureCustomTlsCertificateSelector() => $_ensure(14);
}
