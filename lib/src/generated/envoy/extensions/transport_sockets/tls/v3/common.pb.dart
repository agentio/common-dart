...
class TlsCertificate extends $pb.GeneratedMessage {
  factory TlsCertificate({
    $47.DataSource? certificateChain,
    $47.DataSource? privateKey,
    $47.DataSource? password,
    $47.DataSource? ocspStaple,
    $core.Iterable<$47.DataSource>? signedCertificateTimestamp,
    PrivateKeyProvider? privateKeyProvider,
    $47.WatchedDirectory? watchedDirectory,
    $47.DataSource? pkcs12,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TlsCertificate', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.tls.v3'), createEmptyInstance: create)
    ..aOM<$47.DataSource>(1, _omitFieldNames ? '' : 'certificateChain', subBuilder: $47.DataSource.create)
    ..aOM<$47.DataSource>(2, _omitFieldNames ? '' : 'privateKey', subBuilder: $47.DataSource.create)
    ..aOM<$47.DataSource>(3, _omitFieldNames ? '' : 'password', subBuilder: $47.DataSource.create)
    ..aOM<$47.DataSource>(4, _omitFieldNames ? '' : 'ocspStaple', subBuilder: $47.DataSource.create)
    ..pc<$47.DataSource>(5, _omitFieldNames ? '' : 'signedCertificateTimestamp', $pb.PbFieldType.PM, subBuilder: $47.DataSource.create)
    ..aOM<PrivateKeyProvider>(6, _omitFieldNames ? '' : 'privateKeyProvider', subBuilder: PrivateKeyProvider.create)
    ..aOM<$47.WatchedDirectory>(7, _omitFieldNames ? '' : 'watchedDirectory', subBuilder: $47.WatchedDirectory.create)
    ..aOM<$47.DataSource>(8, _omitFieldNames ? '' : 'pkcs12', subBuilder: $47.DataSource.create)
    ..hasRequiredFields = false
  ;
  ...
  ///  SDS.
  @$pb.TagNumber(1)
  $47.DataSource get certificateChain => $_getN(0);
  @$pb.TagNumber(1)
  set certificateChain($47.DataSource v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCertificateChain() => $_has(0);
  @$pb.TagNumber(1)
  void clearCertificateChain() => clearField(1);
  @$pb.TagNumber(1)
  $47.DataSource ensureCertificateChain() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $47.DataSource get privateKey => $_getN(1);
  @$pb.TagNumber(2)
  set privateKey($47.DataSource v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPrivateKey() => $_has(1);
  @$pb.TagNumber(2)
  void clearPrivateKey() => clearField(2);
  @$pb.TagNumber(2)
  $47.DataSource ensurePrivateKey() => $_ensure(1);

  /// The password to decrypt the TLS private key. If this field is not set, it is assumed that the
  /// TLS private key is not password encrypted.
  @$pb.TagNumber(3)
  $47.DataSource get password => $_getN(2);
  @$pb.TagNumber(3)
  set password($47.DataSource v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasPassword() => $_has(2);
  @$pb.TagNumber(3)
  void clearPassword() => clearField(3);
  @$pb.TagNumber(3)
  $47.DataSource ensurePassword() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $47.DataSource get ocspStaple => $_getN(3);
  @$pb.TagNumber(4)
  set ocspStaple($47.DataSource v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasOcspStaple() => $_has(3);
  @$pb.TagNumber(4)
  void clearOcspStaple() => clearField(4);
  @$pb.TagNumber(4)
  $47.DataSource ensureOcspStaple() => $_ensure(3);

  /// [#not-implemented-hide:]
  @$pb.TagNumber(5)
  $core.List<$47.DataSource> get signedCertificateTimestamp => $_getList(4);
  ...
  @$pb.TagNumber(7)
  $47.WatchedDirectory get watchedDirectory => $_getN(6);
  @$pb.TagNumber(7)
  set watchedDirectory($47.WatchedDirectory v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasWatchedDirectory() => $_has(6);
  @$pb.TagNumber(7)
  void clearWatchedDirectory() => clearField(7);
  @$pb.TagNumber(7)
  $47.WatchedDirectory ensureWatchedDirectory() => $_ensure(6);
  ...
  @$pb.TagNumber(8)
  $47.DataSource get pkcs12 => $_getN(7);
  @$pb.TagNumber(8)
  set pkcs12($47.DataSource v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasPkcs12() => $_has(7);
  @$pb.TagNumber(8)
  void clearPkcs12() => clearField(8);
  @$pb.TagNumber(8)
  $47.DataSource ensurePkcs12() => $_ensure(7);
}

class TlsSessionTicketKeys extends $pb.GeneratedMessage {
  factory TlsSessionTicketKeys({
    $core.Iterable<$47.DataSource>? keys,
  }) {
    final $result = create();
    if (keys != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TlsSessionTicketKeys', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.tls.v3'), createEmptyInstance: create)
    ..pc<$47.DataSource>(1, _omitFieldNames ? '' : 'keys', $pb.PbFieldType.PM, subBuilder: $47.DataSource.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$47.DataSource> get keys => $_getList(0);
}
...
class SubjectAltNameMatcher extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SubjectAltNameMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.tls.v3'), createEmptyInstance: create)
    ...
    ..aOM<$58.StringMatcher>(2, _omitFieldNames ? '' : 'matcher', subBuilder: $58.StringMatcher.create)
  ...
  @$pb.TagNumber(2)
  $58.StringMatcher get matcher => $_getN(1);
  @$pb.TagNumber(2)
  set matcher($58.StringMatcher v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMatcher() => $_has(1);
  @$pb.TagNumber(2)
  void clearMatcher() => clearField(2);
  @$pb.TagNumber(2)
  $58.StringMatcher ensureMatcher() => $_ensure(1);
...
class CertificateValidationContext_SystemRootCerts extends $pb.GeneratedMessage {
  factory CertificateValidationContext_SystemRootCerts() => create();
  CertificateValidationContext_SystemRootCerts._() : super();
  factory CertificateValidationContext_SystemRootCerts.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CertificateValidationContext_SystemRootCerts.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CertificateValidationContext.SystemRootCerts', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.tls.v3'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CertificateValidationContext_SystemRootCerts clone() => CertificateValidationContext_SystemRootCerts()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CertificateValidationContext_SystemRootCerts copyWith(void Function(CertificateValidationContext_SystemRootCerts) updates) => super.copyWith((message) => updates(message as CertificateValidationContext_SystemRootCerts)) as CertificateValidationContext_SystemRootCerts;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static CertificateValidationContext_SystemRootCerts create() => CertificateValidationContext_SystemRootCerts._();
  CertificateValidationContext_SystemRootCerts createEmptyInstance() => create();
  static $pb.PbList<CertificateValidationContext_SystemRootCerts> createRepeated() => $pb.PbList<CertificateValidationContext_SystemRootCerts>();
  @$core.pragma('dart2js:noInline')
  static CertificateValidationContext_SystemRootCerts getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CertificateValidationContext_SystemRootCerts>(create);
  static CertificateValidationContext_SystemRootCerts? _defaultInstance;
}

/// [#next-free-field: 18]
class CertificateValidationContext extends $pb.GeneratedMessage {
  factory CertificateValidationContext({
    $47.DataSource? trustedCa,
    $core.Iterable<$core.String>? verifyCertificateHash,
    $core.Iterable<$core.String>? verifyCertificateSpki,
    $26.BoolValue? requireSignedCertificateTimestamp,
    $47.DataSource? crl,
    $core.bool? allowExpiredCertificate,
  @$core.Deprecated('This field is deprecated.')
    $core.Iterable<$58.StringMatcher>? matchSubjectAltNames,
    CertificateValidationContext_TrustChainVerification? trustChainVerification,
    $47.WatchedDirectory? watchedDirectory,
    $40.TypedExtensionConfig? customValidatorConfig,
    ...
    $26.UInt32Value? maxVerifyDepth,
    CertificateValidationContext_SystemRootCerts? systemRootCerts,
  }) {
    final $result = create();
    if (trustedCa != null) {
    ...
    if (systemRootCerts != null) {
      $result.systemRootCerts = systemRootCerts;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CertificateValidationContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.tls.v3'), createEmptyInstance: create)
    ..aOM<$47.DataSource>(1, _omitFieldNames ? '' : 'trustedCa', subBuilder: $47.DataSource.create)
    ..pPS(2, _omitFieldNames ? '' : 'verifyCertificateHash')
    ..pPS(3, _omitFieldNames ? '' : 'verifyCertificateSpki')
    ..aOM<$26.BoolValue>(6, _omitFieldNames ? '' : 'requireSignedCertificateTimestamp', subBuilder: $26.BoolValue.create)
    ..aOM<$47.DataSource>(7, _omitFieldNames ? '' : 'crl', subBuilder: $47.DataSource.create)
    ..aOB(8, _omitFieldNames ? '' : 'allowExpiredCertificate')
    ..pc<$58.StringMatcher>(9, _omitFieldNames ? '' : 'matchSubjectAltNames', $pb.PbFieldType.PM, subBuilder: $58.StringMatcher.create)
    ...
    ..aOM<$47.WatchedDirectory>(11, _omitFieldNames ? '' : 'watchedDirectory', subBuilder: $47.WatchedDirectory.create)
    ..aOM<$40.TypedExtensionConfig>(12, _omitFieldNames ? '' : 'customValidatorConfig', subBuilder: $40.TypedExtensionConfig.create)
    ...
    ..aOM<$26.UInt32Value>(16, _omitFieldNames ? '' : 'maxVerifyDepth', subBuilder: $26.UInt32Value.create)
    ..aOM<CertificateValidationContext_SystemRootCerts>(17, _omitFieldNames ? '' : 'systemRootCerts', subBuilder: CertificateValidationContext_SystemRootCerts.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $47.DataSource get trustedCa => $_getN(0);
  @$pb.TagNumber(1)
  set trustedCa($47.DataSource v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTrustedCa() => $_has(0);
  @$pb.TagNumber(1)
  void clearTrustedCa() => clearField(1);
  @$pb.TagNumber(1)
  $47.DataSource ensureTrustedCa() => $_ensure(0);
  ...
  @$pb.TagNumber(6)
  $26.BoolValue get requireSignedCertificateTimestamp => $_getN(3);
  @$pb.TagNumber(6)
  set requireSignedCertificateTimestamp($26.BoolValue v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasRequireSignedCertificateTimestamp() => $_has(3);
  @$pb.TagNumber(6)
  void clearRequireSignedCertificateTimestamp() => clearField(6);
  @$pb.TagNumber(6)
  $26.BoolValue ensureRequireSignedCertificateTimestamp() => $_ensure(3);
  ...
  ///  delivered via SDS.
  @$pb.TagNumber(7)
  $47.DataSource get crl => $_getN(4);
  @$pb.TagNumber(7)
  set crl($47.DataSource v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasCrl() => $_has(4);
  @$pb.TagNumber(7)
  void clearCrl() => clearField(7);
  @$pb.TagNumber(7)
  $47.DataSource ensureCrl() => $_ensure(4);
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
  $core.List<$58.StringMatcher> get matchSubjectAltNames => $_getList(6);
  ...
  @$pb.TagNumber(11)
  $47.WatchedDirectory get watchedDirectory => $_getN(8);
  @$pb.TagNumber(11)
  set watchedDirectory($47.WatchedDirectory v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasWatchedDirectory() => $_has(8);
  @$pb.TagNumber(11)
  void clearWatchedDirectory() => clearField(11);
  @$pb.TagNumber(11)
  $47.WatchedDirectory ensureWatchedDirectory() => $_ensure(8);
  ...
  @$pb.TagNumber(12)
  $40.TypedExtensionConfig get customValidatorConfig => $_getN(9);
  @$pb.TagNumber(12)
  set customValidatorConfig($40.TypedExtensionConfig v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasCustomValidatorConfig() => $_has(9);
  @$pb.TagNumber(12)
  void clearCustomValidatorConfig() => clearField(12);
  @$pb.TagNumber(12)
  $40.TypedExtensionConfig ensureCustomValidatorConfig() => $_ensure(9);
  ...
  @$pb.TagNumber(16)
  $26.UInt32Value get maxVerifyDepth => $_getN(13);
  @$pb.TagNumber(16)
  set maxVerifyDepth($26.UInt32Value v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasMaxVerifyDepth() => $_has(13);
  @$pb.TagNumber(16)
  void clearMaxVerifyDepth() => clearField(16);
  @$pb.TagNumber(16)
  $26.UInt32Value ensureMaxVerifyDepth() => $_ensure(13);
  ...
  /// [#not-implemented-hide:]
  @$pb.TagNumber(17)
  CertificateValidationContext_SystemRootCerts get systemRootCerts => $_getN(14);
  @$pb.TagNumber(17)
  set systemRootCerts(CertificateValidationContext_SystemRootCerts v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasSystemRootCerts() => $_has(14);
  @$pb.TagNumber(17)
  void clearSystemRootCerts() => clearField(17);
  @$pb.TagNumber(17)
  CertificateValidationContext_SystemRootCerts ensureSystemRootCerts() => $_ensure(14);
}
