...
class GenericSecret extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenericSecret', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.tls.v3'), createEmptyInstance: create)
    ..aOM<$47.DataSource>(1, _omitFieldNames ? '' : 'secret', subBuilder: $47.DataSource.create)
  ...
  @$pb.TagNumber(1)
  $47.DataSource get secret => $_getN(0);
  @$pb.TagNumber(1)
  set secret($47.DataSource v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSecret() => $_has(0);
  @$pb.TagNumber(1)
  void clearSecret() => clearField(1);
  @$pb.TagNumber(1)
  $47.DataSource ensureSecret() => $_ensure(0);
}

class SdsSecretConfig extends $pb.GeneratedMessage {
  factory SdsSecretConfig({
    $core.String? name,
    $50.ConfigSource? sdsConfig,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SdsSecretConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.tls.v3'), createEmptyInstance: create)
    ...
    ..aOM<$50.ConfigSource>(2, _omitFieldNames ? '' : 'sdsConfig', subBuilder: $50.ConfigSource.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $50.ConfigSource get sdsConfig => $_getN(1);
  @$pb.TagNumber(2)
  set sdsConfig($50.ConfigSource v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSdsConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearSdsConfig() => clearField(2);
  @$pb.TagNumber(2)
  $50.ConfigSource ensureSdsConfig() => $_ensure(1);
}
...
class Secret extends $pb.GeneratedMessage {
  factory Secret({
    $core.String? name,
    $110.TlsCertificate? tlsCertificate,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Secret', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.tls.v3'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5])
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$110.TlsCertificate>(2, _omitFieldNames ? '' : 'tlsCertificate', subBuilder: $110.TlsCertificate.create)
    ..aOM<$110.TlsSessionTicketKeys>(3, _omitFieldNames ? '' : 'sessionTicketKeys', subBuilder: $110.TlsSessionTicketKeys.create)
    ..aOM<$110.CertificateValidationContext>(4, _omitFieldNames ? '' : 'validationContext', subBuilder: $110.CertificateValidationContext.create)
  ...
  @$pb.TagNumber(2)
  $110.TlsCertificate get tlsCertificate => $_getN(1);
  @$pb.TagNumber(2)
  set tlsCertificate($110.TlsCertificate v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTlsCertificate() => $_has(1);
  @$pb.TagNumber(2)
  void clearTlsCertificate() => clearField(2);
  @$pb.TagNumber(2)
  $110.TlsCertificate ensureTlsCertificate() => $_ensure(1);

  @$pb.TagNumber(3)
  $110.TlsSessionTicketKeys get sessionTicketKeys => $_getN(2);
  @$pb.TagNumber(3)
  set sessionTicketKeys($110.TlsSessionTicketKeys v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSessionTicketKeys() => $_has(2);
  @$pb.TagNumber(3)
  void clearSessionTicketKeys() => clearField(3);
  @$pb.TagNumber(3)
  $110.TlsSessionTicketKeys ensureSessionTicketKeys() => $_ensure(2);

  @$pb.TagNumber(4)
  $110.CertificateValidationContext get validationContext => $_getN(3);
  @$pb.TagNumber(4)
  set validationContext($110.CertificateValidationContext v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasValidationContext() => $_has(3);
  @$pb.TagNumber(4)
  void clearValidationContext() => clearField(4);
  @$pb.TagNumber(4)
  $110.CertificateValidationContext ensureValidationContext() => $_ensure(3);
