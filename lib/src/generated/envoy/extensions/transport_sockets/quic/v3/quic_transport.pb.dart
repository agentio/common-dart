...
class QuicDownstreamTransport extends $pb.GeneratedMessage {
  factory QuicDownstreamTransport({
    $206.DownstreamTlsContext? downstreamTlsContext,
    $26.BoolValue? enableEarlyData,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QuicDownstreamTransport', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.quic.v3'), createEmptyInstance: create)
    ..aOM<$206.DownstreamTlsContext>(1, _omitFieldNames ? '' : 'downstreamTlsContext', subBuilder: $206.DownstreamTlsContext.create)
    ..aOM<$26.BoolValue>(2, _omitFieldNames ? '' : 'enableEarlyData', subBuilder: $26.BoolValue.create)
  ...
  @$pb.TagNumber(1)
  $206.DownstreamTlsContext get downstreamTlsContext => $_getN(0);
  @$pb.TagNumber(1)
  set downstreamTlsContext($206.DownstreamTlsContext v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDownstreamTlsContext() => $_has(0);
  @$pb.TagNumber(1)
  void clearDownstreamTlsContext() => clearField(1);
  @$pb.TagNumber(1)
  $206.DownstreamTlsContext ensureDownstreamTlsContext() => $_ensure(0);
  ...
  /// Default to true.
  @$pb.TagNumber(2)
  $26.BoolValue get enableEarlyData => $_getN(1);
  @$pb.TagNumber(2)
  set enableEarlyData($26.BoolValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasEnableEarlyData() => $_has(1);
  @$pb.TagNumber(2)
  void clearEnableEarlyData() => clearField(2);
  @$pb.TagNumber(2)
  $26.BoolValue ensureEnableEarlyData() => $_ensure(1);
}
...
class QuicUpstreamTransport extends $pb.GeneratedMessage {
  factory QuicUpstreamTransport({
    $206.UpstreamTlsContext? upstreamTlsContext,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QuicUpstreamTransport', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.transport_sockets.quic.v3'), createEmptyInstance: create)
    ..aOM<$206.UpstreamTlsContext>(1, _omitFieldNames ? '' : 'upstreamTlsContext', subBuilder: $206.UpstreamTlsContext.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $206.UpstreamTlsContext get upstreamTlsContext => $_getN(0);
  @$pb.TagNumber(1)
  set upstreamTlsContext($206.UpstreamTlsContext v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUpstreamTlsContext() => $_has(0);
  @$pb.TagNumber(1)
  void clearUpstreamTlsContext() => clearField(1);
  @$pb.TagNumber(1)
  $206.UpstreamTlsContext ensureUpstreamTlsContext() => $_ensure(0);
}
