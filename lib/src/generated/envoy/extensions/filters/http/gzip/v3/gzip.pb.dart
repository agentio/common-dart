...
import '../../compressor/v3/compressor.pb.dart' as $185;
...
class Gzip extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Gzip', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.gzip.v3'), createEmptyInstance: create)
    ...
    ..aOM<$185.Compressor>(10, _omitFieldNames ? '' : 'compressor', subBuilder: $185.Compressor.create)
    ..aOM<$26.UInt32Value>(11, _omitFieldNames ? '' : 'chunkSize', subBuilder: $26.UInt32Value.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(9)
  $26.UInt32Value get windowBits => $_getN(3);
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(9)
  $26.UInt32Value ensureWindowBits() => $_ensure(3);
  ...
  @$pb.TagNumber(10)
  $185.Compressor get compressor => $_getN(4);
  @$pb.TagNumber(10)
  set compressor($185.Compressor v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasCompressor() => $_has(4);
  @$pb.TagNumber(10)
  void clearCompressor() => clearField(10);
  @$pb.TagNumber(10)
  $185.Compressor ensureCompressor() => $_ensure(4);
  ...
  @$pb.TagNumber(11)
  $26.UInt32Value get chunkSize => $_getN(5);
  @$pb.TagNumber(11)
  set chunkSize($26.UInt32Value v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasChunkSize() => $_has(5);
  @$pb.TagNumber(11)
  void clearChunkSize() => clearField(11);
  @$pb.TagNumber(11)
  $26.UInt32Value ensureChunkSize() => $_ensure(5);
}
