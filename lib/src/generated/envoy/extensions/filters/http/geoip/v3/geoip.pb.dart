...
class Geoip extends $pb.GeneratedMessage {
  factory Geoip({
    ...
    $40.TypedExtensionConfig? provider,
  }) {
    final $result = create();
    if (xffConfig != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Geoip', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.geoip.v3'), createEmptyInstance: create)
    ...
    ..aOM<$40.TypedExtensionConfig>(3, _omitFieldNames ? '' : 'provider', subBuilder: $40.TypedExtensionConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $40.TypedExtensionConfig get provider => $_getN(1);
  @$pb.TagNumber(3)
  set provider($40.TypedExtensionConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasProvider() => $_has(1);
  @$pb.TagNumber(3)
  void clearProvider() => clearField(3);
  @$pb.TagNumber(3)
  $40.TypedExtensionConfig ensureProvider() => $_ensure(1);
}
