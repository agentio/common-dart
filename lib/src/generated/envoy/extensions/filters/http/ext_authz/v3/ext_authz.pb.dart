...
import '../../../../../config/core/v3/config_source.pbenum.dart' as $50;
...
class ExtAuthz extends $pb.GeneratedMessage {
  factory ExtAuthz({
    ...
    $47.RuntimeFeatureFlag? denyAtDisable,
    $50.ApiVersion? transportApiVersion,
    $core.String? statPrefix,
    $62.MetadataMatcher? filterEnabledMetadata,
    ...
    $26.BoolValue? chargeClusterResponseStats,
    $core.Iterable<$core.String>? routeMetadataContextNamespaces,
    $core.Iterable<$core.String>? routeTypedMetadataContextNamespaces,
    $core.bool? encodeRawHeaders,
    $core.bool? validateMutations,
    $58.ListStringMatcher? disallowedHeaders,
    $179.HeaderMutationRules? decoderHeaderMutationRules,
    $26.BoolValue? enableDynamicMetadataIngestion,
    ...
    if (encodeRawHeaders != null) {
      $result.encodeRawHeaders = encodeRawHeaders;
    }
    if (validateMutations != null) {
      $result.validateMutations = validateMutations;
    }
    if (disallowedHeaders != null) {
      $result.disallowedHeaders = disallowedHeaders;
    }
    if (decoderHeaderMutationRules != null) {
      $result.decoderHeaderMutationRules = decoderHeaderMutationRules;
    }
    if (enableDynamicMetadataIngestion != null) {
      $result.enableDynamicMetadataIngestion = enableDynamicMetadataIngestion;
    }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExtAuthz', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.ext_authz.v3'), createEmptyInstance: create)
    ...
    ..aOM<$160.HttpStatus>(7, _omitFieldNames ? '' : 'statusOnError', subBuilder: $160.HttpStatus.create)
    ...
    ..aOM<$47.RuntimeFeatureFlag>(11, _omitFieldNames ? '' : 'denyAtDisable', subBuilder: $47.RuntimeFeatureFlag.create)
    ..e<$50.ApiVersion>(12, _omitFieldNames ? '' : 'transportApiVersion', $pb.PbFieldType.OE, defaultOrMaker: $50.ApiVersion.AUTO, valueOf: $50.ApiVersion.valueOf, enumValues: $50.ApiVersion.values)
    ..aOS(13, _omitFieldNames ? '' : 'statPrefix')
    ..aOM<$62.MetadataMatcher>(14, _omitFieldNames ? '' : 'filterEnabledMetadata', subBuilder: $62.MetadataMatcher.create)
    ..aOS(15, _omitFieldNames ? '' : 'bootstrapMetadataLabelsKey')
    ..pPS(16, _omitFieldNames ? '' : 'typedMetadataContextNamespaces')
    ..aOM<$58.ListStringMatcher>(17, _omitFieldNames ? '' : 'allowedHeaders', subBuilder: $58.ListStringMatcher.create)
    ..aOB(18, _omitFieldNames ? '' : 'includeTlsSession')
    ..aOB(19, _omitFieldNames ? '' : 'failureModeAllowHeaderAdd')
    ..aOM<$26.BoolValue>(20, _omitFieldNames ? '' : 'chargeClusterResponseStats', subBuilder: $26.BoolValue.create)
    ..pPS(21, _omitFieldNames ? '' : 'routeMetadataContextNamespaces')
    ..pPS(22, _omitFieldNames ? '' : 'routeTypedMetadataContextNamespaces')
    ..aOB(23, _omitFieldNames ? '' : 'encodeRawHeaders')
    ..aOB(24, _omitFieldNames ? '' : 'validateMutations')
    ..aOM<$58.ListStringMatcher>(25, _omitFieldNames ? '' : 'disallowedHeaders', subBuilder: $58.ListStringMatcher.create)
    ..aOM<$179.HeaderMutationRules>(26, _omitFieldNames ? '' : 'decoderHeaderMutationRules', subBuilder: $179.HeaderMutationRules.create)
    ..aOM<$26.BoolValue>(27, _omitFieldNames ? '' : 'enableDynamicMetadataIngestion', subBuilder: $26.BoolValue.create)
    ..aOM<$30.Struct>(28, _omitFieldNames ? '' : 'filterMetadata', subBuilder: $30.Struct.create)
  ...
  @$pb.TagNumber(7)
  $160.HttpStatus get statusOnError => $_getN(5);
  @$pb.TagNumber(7)
  set statusOnError($160.HttpStatus v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasStatusOnError() => $_has(5);
  @$pb.TagNumber(7)
  void clearStatusOnError() => clearField(7);
  @$pb.TagNumber(7)
  $160.HttpStatus ensureStatusOnError() => $_ensure(5);
  ...
  @$pb.TagNumber(9)
  $47.RuntimeFractionalPercent get filterEnabled => $_getN(7);
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(9)
  $47.RuntimeFractionalPercent ensureFilterEnabled() => $_ensure(7);
  ...
  ///  be returned.
  @$pb.TagNumber(11)
  $47.RuntimeFeatureFlag get denyAtDisable => $_getN(9);
  @$pb.TagNumber(11)
  set denyAtDisable($47.RuntimeFeatureFlag v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasDenyAtDisable() => $_has(9);
  @$pb.TagNumber(11)
  void clearDenyAtDisable() => clearField(11);
  @$pb.TagNumber(11)
  $47.RuntimeFeatureFlag ensureDenyAtDisable() => $_ensure(9);

  /// API version for ext_authz transport protocol. This describes the ext_authz gRPC endpoint and
  /// version of messages used on the wire.
  @$pb.TagNumber(12)
  $50.ApiVersion get transportApiVersion => $_getN(10);
  @$pb.TagNumber(12)
  set transportApiVersion($50.ApiVersion v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  /// If this field is not specified, the filter will be enabled for all requests.
  @$pb.TagNumber(14)
  $62.MetadataMatcher get filterEnabledMetadata => $_getN(12);
  @$pb.TagNumber(14)
  set filterEnabledMetadata($62.MetadataMatcher v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasFilterEnabledMetadata() => $_has(12);
  @$pb.TagNumber(14)
  void clearFilterEnabledMetadata() => clearField(14);
  @$pb.TagNumber(14)
  $62.MetadataMatcher ensureFilterEnabledMetadata() => $_ensure(12);
  ...
  @$pb.TagNumber(17)
  $58.ListStringMatcher get allowedHeaders => $_getN(15);
  @$pb.TagNumber(17)
  set allowedHeaders($58.ListStringMatcher v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasAllowedHeaders() => $_has(15);
  @$pb.TagNumber(17)
  void clearAllowedHeaders() => clearField(17);
  @$pb.TagNumber(17)
  $58.ListStringMatcher ensureAllowedHeaders() => $_ensure(15);
  ...
  /// Defaults to true.
  @$pb.TagNumber(20)
  $26.BoolValue get chargeClusterResponseStats => $_getN(18);
  @$pb.TagNumber(20)
  set chargeClusterResponseStats($26.BoolValue v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasChargeClusterResponseStats() => $_has(18);
  @$pb.TagNumber(20)
  void clearChargeClusterResponseStats() => clearField(20);
  @$pb.TagNumber(20)
  $26.BoolValue ensureChargeClusterResponseStats() => $_ensure(18);
  ...
  @$pb.TagNumber(23)
  $core.bool get encodeRawHeaders => $_getBF(21);
  @$pb.TagNumber(23)
  set encodeRawHeaders($core.bool v) { $_setBool(21, v); }
  @$pb.TagNumber(23)
  $core.bool hasEncodeRawHeaders() => $_has(21);
  @$pb.TagNumber(23)
  void clearEncodeRawHeaders() => clearField(23);
  ...
  @$pb.TagNumber(24)
  $core.bool get validateMutations => $_getBF(22);
  @$pb.TagNumber(24)
  set validateMutations($core.bool v) { $_setBool(22, v); }
  @$pb.TagNumber(24)
  $core.bool hasValidateMutations() => $_has(22);
  @$pb.TagNumber(24)
  void clearValidateMutations() => clearField(24);
  ...
  @$pb.TagNumber(25)
  $58.ListStringMatcher get disallowedHeaders => $_getN(23);
  @$pb.TagNumber(25)
  set disallowedHeaders($58.ListStringMatcher v) { setField(25, v); }
  @$pb.TagNumber(25)
  $core.bool hasDisallowedHeaders() => $_has(23);
  @$pb.TagNumber(25)
  void clearDisallowedHeaders() => clearField(25);
  @$pb.TagNumber(25)
  $58.ListStringMatcher ensureDisallowedHeaders() => $_ensure(23);
  ...
  @$pb.TagNumber(26)
  $179.HeaderMutationRules get decoderHeaderMutationRules => $_getN(24);
  @$pb.TagNumber(26)
  set decoderHeaderMutationRules($179.HeaderMutationRules v) { setField(26, v); }
  @$pb.TagNumber(26)
  $core.bool hasDecoderHeaderMutationRules() => $_has(24);
  @$pb.TagNumber(26)
  void clearDecoderHeaderMutationRules() => clearField(26);
  @$pb.TagNumber(26)
  $179.HeaderMutationRules ensureDecoderHeaderMutationRules() => $_ensure(24);
  ...
  @$pb.TagNumber(27)
  $26.BoolValue get enableDynamicMetadataIngestion => $_getN(25);
  @$pb.TagNumber(27)
  set enableDynamicMetadataIngestion($26.BoolValue v) { setField(27, v); }
  @$pb.TagNumber(27)
  $core.bool hasEnableDynamicMetadataIngestion() => $_has(25);
  @$pb.TagNumber(27)
  void clearEnableDynamicMetadataIngestion() => clearField(27);
  @$pb.TagNumber(27)
  $26.BoolValue ensureEnableDynamicMetadataIngestion() => $_ensure(25);
  ...
  /// name.
  @$pb.TagNumber(28)
  $30.Struct get filterMetadata => $_getN(26);
  @$pb.TagNumber(28)
  set filterMetadata($30.Struct v) { setField(28, v); }
  @$pb.TagNumber(28)
  $core.bool hasFilterMetadata() => $_has(26);
  @$pb.TagNumber(28)
  void clearFilterMetadata() => clearField(28);
  @$pb.TagNumber(28)
  $30.Struct ensureFilterMetadata() => $_ensure(26);
}
...
class HttpService extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpService', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.ext_authz.v3'), createEmptyInstance: create)
    ..aOM<$46.HttpUri>(1, _omitFieldNames ? '' : 'serverUri', subBuilder: $46.HttpUri.create)
  ...
  @$pb.TagNumber(1)
  $46.HttpUri get serverUri => $_getN(0);
  @$pb.TagNumber(1)
  set serverUri($46.HttpUri v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasServerUri() => $_has(0);
  @$pb.TagNumber(1)
  void clearServerUri() => clearField(1);
  @$pb.TagNumber(1)
  $46.HttpUri ensureServerUri() => $_ensure(0);
...
class AuthorizationRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    $58.ListStringMatcher? allowedHeaders,
    $core.Iterable<$47.HeaderValue>? headersToAdd,
  }) {
    final $result = create();
    if (allowedHeaders != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuthorizationRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.ext_authz.v3'), createEmptyInstance: create)
    ...
    ..pc<$47.HeaderValue>(2, _omitFieldNames ? '' : 'headersToAdd', $pb.PbFieldType.PM, subBuilder: $47.HeaderValue.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$47.HeaderValue> get headersToAdd => $_getList(1);
}

/// [#next-free-field: 6]
class AuthorizationResponse extends $pb.GeneratedMessage {
  factory AuthorizationResponse({
    $58.ListStringMatcher? allowedUpstreamHeaders,
    $58.ListStringMatcher? allowedClientHeaders,
    $58.ListStringMatcher? allowedUpstreamHeadersToAppend,
    $58.ListStringMatcher? allowedClientHeadersOnSuccess,
    $58.ListStringMatcher? dynamicMetadataFromHeaders,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuthorizationResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.ext_authz.v3'), createEmptyInstance: create)
    ..aOM<$58.ListStringMatcher>(1, _omitFieldNames ? '' : 'allowedUpstreamHeaders', subBuilder: $58.ListStringMatcher.create)
    ..aOM<$58.ListStringMatcher>(2, _omitFieldNames ? '' : 'allowedClientHeaders', subBuilder: $58.ListStringMatcher.create)
    ..aOM<$58.ListStringMatcher>(3, _omitFieldNames ? '' : 'allowedUpstreamHeadersToAppend', subBuilder: $58.ListStringMatcher.create)
    ..aOM<$58.ListStringMatcher>(4, _omitFieldNames ? '' : 'allowedClientHeadersOnSuccess', subBuilder: $58.ListStringMatcher.create)
    ..aOM<$58.ListStringMatcher>(5, _omitFieldNames ? '' : 'dynamicMetadataFromHeaders', subBuilder: $58.ListStringMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $58.ListStringMatcher get allowedUpstreamHeaders => $_getN(0);
  @$pb.TagNumber(1)
  set allowedUpstreamHeaders($58.ListStringMatcher v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAllowedUpstreamHeaders() => $_has(0);
  @$pb.TagNumber(1)
  void clearAllowedUpstreamHeaders() => clearField(1);
  @$pb.TagNumber(1)
  $58.ListStringMatcher ensureAllowedUpstreamHeaders() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $58.ListStringMatcher get allowedClientHeaders => $_getN(1);
  @$pb.TagNumber(2)
  set allowedClientHeaders($58.ListStringMatcher v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAllowedClientHeaders() => $_has(1);
  @$pb.TagNumber(2)
  void clearAllowedClientHeaders() => clearField(2);
  @$pb.TagNumber(2)
  $58.ListStringMatcher ensureAllowedClientHeaders() => $_ensure(1);

  /// When this :ref:`list <envoy_v3_api_msg_type.matcher.v3.ListStringMatcher>` is set, authorization
  /// response headers that have a correspondent match will be added to the original client request.
  /// Note that coexistent headers will be appended.
  @$pb.TagNumber(3)
  $58.ListStringMatcher get allowedUpstreamHeadersToAppend => $_getN(2);
  @$pb.TagNumber(3)
  set allowedUpstreamHeadersToAppend($58.ListStringMatcher v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAllowedUpstreamHeadersToAppend() => $_has(2);
  @$pb.TagNumber(3)
  void clearAllowedUpstreamHeadersToAppend() => clearField(3);
  @$pb.TagNumber(3)
  $58.ListStringMatcher ensureAllowedUpstreamHeadersToAppend() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $58.ListStringMatcher get allowedClientHeadersOnSuccess => $_getN(3);
  @$pb.TagNumber(4)
  set allowedClientHeadersOnSuccess($58.ListStringMatcher v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAllowedClientHeadersOnSuccess() => $_has(3);
  @$pb.TagNumber(4)
  void clearAllowedClientHeadersOnSuccess() => clearField(4);
  @$pb.TagNumber(4)
  $58.ListStringMatcher ensureAllowedClientHeadersOnSuccess() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $58.ListStringMatcher get dynamicMetadataFromHeaders => $_getN(4);
  @$pb.TagNumber(5)
  set dynamicMetadataFromHeaders($58.ListStringMatcher v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDynamicMetadataFromHeaders() => $_has(4);
  @$pb.TagNumber(5)
  void clearDynamicMetadataFromHeaders() => clearField(5);
  @$pb.TagNumber(5)
  $58.ListStringMatcher ensureDynamicMetadataFromHeaders() => $_ensure(4);
}
