...
class HealthCheck extends $pb.GeneratedMessage {
  factory HealthCheck({
    ...
    $core.Map<$core.String, $44.Percent>? clusterMinHealthyPercentages,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HealthCheck', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.health_check.v3'), createEmptyInstance: create)
    ...
    ..m<$core.String, $44.Percent>(4, _omitFieldNames ? '' : 'clusterMinHealthyPercentages', entryClassName: 'HealthCheck.ClusterMinHealthyPercentagesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $44.Percent.create, valueDefaultOrMaker: $44.Percent.getDefault, packageName: const $pb.PackageName('envoy.extensions.filters.http.health_check.v3'))
    ..pc<$66.HeaderMatcher>(5, _omitFieldNames ? '' : 'headers', $pb.PbFieldType.PM, subBuilder: $66.HeaderMatcher.create)
  ...
  ///     as if it were 12%.
  @$pb.TagNumber(4)
  $core.Map<$core.String, $44.Percent> get clusterMinHealthyPercentages => $_getMap(2);
