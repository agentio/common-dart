...
class Mutations extends $pb.GeneratedMessage {
  factory Mutations({
    $core.Iterable<$179.HeaderMutation>? requestMutations,
    $core.Iterable<$179.HeaderMutation>? responseMutations,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Mutations', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.header_mutation.v3'), createEmptyInstance: create)
    ..pc<$179.HeaderMutation>(1, _omitFieldNames ? '' : 'requestMutations', $pb.PbFieldType.PM, subBuilder: $179.HeaderMutation.create)
    ..pc<$179.HeaderMutation>(2, _omitFieldNames ? '' : 'responseMutations', $pb.PbFieldType.PM, subBuilder: $179.HeaderMutation.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$179.HeaderMutation> get requestMutations => $_getList(0);

  /// The response mutations are applied before the response is sent to the downstream client.
  @$pb.TagNumber(2)
  $core.List<$179.HeaderMutation> get responseMutations => $_getList(1);
}
...
class HeaderMutation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HeaderMutation', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.header_mutation.v3'), createEmptyInstance: create)
    ..aOM<Mutations>(1, _omitFieldNames ? '' : 'mutations', subBuilder: Mutations.create)
    ..aOB(2, _omitFieldNames ? '' : 'mostSpecificHeaderMutationsWins')
    ..hasRequiredFields = false
  ;
  ...
  ///  is evaluated last.
  @$pb.TagNumber(2)
  $core.bool get mostSpecificHeaderMutationsWins => $_getBF(1);
  @$pb.TagNumber(2)
  set mostSpecificHeaderMutationsWins($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasMostSpecificHeaderMutationsWins() => $_has(1);
  @$pb.TagNumber(2)
  void clearMostSpecificHeaderMutationsWins() => clearField(2);
}
