...
class RBAC extends $pb.GeneratedMessage {
  factory RBAC({
    ...
    $core.String? rulesStatPrefix,
    $core.bool? trackPerRuleStats,
  }) {
    final $result = create();
    if (rules != null) {
      $result.rules = rules;
    ...
    if (rulesStatPrefix != null) {
      $result.rulesStatPrefix = rulesStatPrefix;
    }
    if (trackPerRuleStats != null) {
      $result.trackPerRuleStats = trackPerRuleStats;
    }
    return $result;
  }
  RBAC._() : super();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RBAC', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.rbac.v3'), createEmptyInstance: create)
    ...
    ..aOM<$61.Matcher>(4, _omitFieldNames ? '' : 'matcher', subBuilder: $61.Matcher.create)
    ..aOM<$61.Matcher>(5, _omitFieldNames ? '' : 'shadowMatcher', subBuilder: $61.Matcher.create)
    ..aOS(6, _omitFieldNames ? '' : 'rulesStatPrefix')
    ..aOB(7, _omitFieldNames ? '' : 'trackPerRuleStats')
  ...
  @$pb.TagNumber(4)
  $61.Matcher get matcher => $_getN(3);
  @$pb.TagNumber(4)
  set matcher($61.Matcher v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasMatcher() => $_has(3);
  @$pb.TagNumber(4)
  void clearMatcher() => clearField(4);
  @$pb.TagNumber(4)
  $61.Matcher ensureMatcher() => $_ensure(3);

  /// The match tree to use for emitting stats and logs which can be used for rule testing for
  /// incoming requests.
  /// If absent, no shadow matcher will be applied.
  @$pb.TagNumber(5)
  $61.Matcher get shadowMatcher => $_getN(4);
  @$pb.TagNumber(5)
  set shadowMatcher($61.Matcher v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasShadowMatcher() => $_has(4);
  @$pb.TagNumber(5)
  void clearShadowMatcher() => clearField(5);
  @$pb.TagNumber(5)
  $61.Matcher ensureShadowMatcher() => $_ensure(4);

  /// If specified, rules will emit stats with the given prefix.
  /// This is useful to distinguish the stat when there are more than 1 RBAC filter configured with
  /// rules.
  @$pb.TagNumber(6)
  $core.String get rulesStatPrefix => $_getSZ(5);
  @$pb.TagNumber(6)
  set rulesStatPrefix($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
  $core.bool hasRulesStatPrefix() => $_has(5);
  @$pb.TagNumber(6)
  void clearRulesStatPrefix() => clearField(6);

  /// If track_per_rule_stats is true, counters will be published for each rule and shadow rule.
  @$pb.TagNumber(7)
  $core.bool get trackPerRuleStats => $_getBF(6);
  @$pb.TagNumber(7)
  set trackPerRuleStats($core.bool v) { $_setBool(6, v); }
  @$pb.TagNumber(7)
  $core.bool hasTrackPerRuleStats() => $_has(6);
  @$pb.TagNumber(7)
  void clearTrackPerRuleStats() => clearField(7);
}
