...
class Decompressor_RequestDirectionConfig extends $pb.GeneratedMessage {
  factory Decompressor_RequestDirectionConfig({
    ...
    $26.BoolValue? advertiseAcceptEncoding,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Decompressor.RequestDirectionConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.decompressor.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.BoolValue>(2, _omitFieldNames ? '' : 'advertiseAcceptEncoding', subBuilder: $26.BoolValue.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $26.BoolValue get advertiseAcceptEncoding => $_getN(1);
  @$pb.TagNumber(2)
  set advertiseAcceptEncoding($26.BoolValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAdvertiseAcceptEncoding() => $_has(1);
  @$pb.TagNumber(2)
  void clearAdvertiseAcceptEncoding() => clearField(2);
  @$pb.TagNumber(2)
  $26.BoolValue ensureAdvertiseAcceptEncoding() => $_ensure(1);
}
...
class Decompressor extends $pb.GeneratedMessage {
  factory Decompressor({
    $40.TypedExtensionConfig? decompressorLibrary,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Decompressor', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.decompressor.v3'), createEmptyInstance: create)
    ..aOM<$40.TypedExtensionConfig>(1, _omitFieldNames ? '' : 'decompressorLibrary', subBuilder: $40.TypedExtensionConfig.create)
  ...
  @$pb.TagNumber(1)
  $40.TypedExtensionConfig get decompressorLibrary => $_getN(0);
  @$pb.TagNumber(1)
  set decompressorLibrary($40.TypedExtensionConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDecompressorLibrary() => $_has(0);
  @$pb.TagNumber(1)
  void clearDecompressorLibrary() => clearField(1);
  @$pb.TagNumber(1)
  $40.TypedExtensionConfig ensureDecompressorLibrary() => $_ensure(0);
