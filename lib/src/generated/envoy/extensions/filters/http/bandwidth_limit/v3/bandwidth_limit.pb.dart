...
class BandwidthLimit extends $pb.GeneratedMessage {
  factory BandwidthLimit({
    ...
    $26.UInt64Value? limitKbps,
    $28.Duration? fillInterval,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BandwidthLimit', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.bandwidth_limit.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.UInt64Value>(3, _omitFieldNames ? '' : 'limitKbps', subBuilder: $26.UInt64Value.create)
    ..aOM<$28.Duration>(4, _omitFieldNames ? '' : 'fillInterval', subBuilder: $28.Duration.create)
  ...
  @$pb.TagNumber(3)
  $26.UInt64Value get limitKbps => $_getN(2);
  @$pb.TagNumber(3)
  set limitKbps($26.UInt64Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasLimitKbps() => $_has(2);
  @$pb.TagNumber(3)
  void clearLimitKbps() => clearField(3);
  @$pb.TagNumber(3)
  $26.UInt64Value ensureLimitKbps() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $28.Duration get fillInterval => $_getN(3);
  @$pb.TagNumber(4)
  set fillInterval($28.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasFillInterval() => $_has(3);
  @$pb.TagNumber(4)
  void clearFillInterval() => clearField(4);
  @$pb.TagNumber(4)
  $28.Duration ensureFillInterval() => $_ensure(3);
