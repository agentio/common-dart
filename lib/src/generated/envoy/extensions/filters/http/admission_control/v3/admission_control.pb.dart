...
class AdmissionControl_SuccessCriteria_HttpCriteria extends $pb.GeneratedMessage {
  factory AdmissionControl_SuccessCriteria_HttpCriteria({
    $core.Iterable<$54.Int32Range>? httpSuccessStatus,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdmissionControl.SuccessCriteria.HttpCriteria', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.admission_control.v3'), createEmptyInstance: create)
    ..pc<$54.Int32Range>(1, _omitFieldNames ? '' : 'httpSuccessStatus', $pb.PbFieldType.PM, subBuilder: $54.Int32Range.create)
  ...
  /// range [100, 600).
  @$pb.TagNumber(1)
  $core.List<$54.Int32Range> get httpSuccessStatus => $_getList(0);
}
...
class AdmissionControl extends $pb.GeneratedMessage {
  factory AdmissionControl({
    ...
    $28.Duration? samplingWindow,
    $47.RuntimeDouble? aggression,
    $47.RuntimePercent? srThreshold,
    $47.RuntimeUInt32? rpsThreshold,
    $47.RuntimePercent? maxRejectionProbability,
  }) {
    final $result = create();
    if (enabled != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdmissionControl', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.admission_control.v3'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOM<$47.RuntimeFeatureFlag>(1, _omitFieldNames ? '' : 'enabled', subBuilder: $47.RuntimeFeatureFlag.create)
    ...
    ..aOM<$28.Duration>(3, _omitFieldNames ? '' : 'samplingWindow', subBuilder: $28.Duration.create)
    ..aOM<$47.RuntimeDouble>(4, _omitFieldNames ? '' : 'aggression', subBuilder: $47.RuntimeDouble.create)
    ..aOM<$47.RuntimePercent>(5, _omitFieldNames ? '' : 'srThreshold', subBuilder: $47.RuntimePercent.create)
    ..aOM<$47.RuntimeUInt32>(6, _omitFieldNames ? '' : 'rpsThreshold', subBuilder: $47.RuntimeUInt32.create)
    ..aOM<$47.RuntimePercent>(7, _omitFieldNames ? '' : 'maxRejectionProbability', subBuilder: $47.RuntimePercent.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $47.RuntimeFeatureFlag get enabled => $_getN(0);
  @$pb.TagNumber(1)
  set enabled($47.RuntimeFeatureFlag v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasEnabled() => $_has(0);
  @$pb.TagNumber(1)
  void clearEnabled() => clearField(1);
  @$pb.TagNumber(1)
  $47.RuntimeFeatureFlag ensureEnabled() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $28.Duration get samplingWindow => $_getN(2);
  @$pb.TagNumber(3)
  set samplingWindow($28.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSamplingWindow() => $_has(2);
  @$pb.TagNumber(3)
  void clearSamplingWindow() => clearField(3);
  @$pb.TagNumber(3)
  $28.Duration ensureSamplingWindow() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $47.RuntimeDouble get aggression => $_getN(3);
  @$pb.TagNumber(4)
  set aggression($47.RuntimeDouble v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAggression() => $_has(3);
  @$pb.TagNumber(4)
  void clearAggression() => clearField(4);
  @$pb.TagNumber(4)
  $47.RuntimeDouble ensureAggression() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $47.RuntimePercent get srThreshold => $_getN(4);
  @$pb.TagNumber(5)
  set srThreshold($47.RuntimePercent v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasSrThreshold() => $_has(4);
  @$pb.TagNumber(5)
  void clearSrThreshold() => clearField(5);
  @$pb.TagNumber(5)
  $47.RuntimePercent ensureSrThreshold() => $_ensure(4);
  ...
  /// Defaults to 0.
  @$pb.TagNumber(6)
  $47.RuntimeUInt32 get rpsThreshold => $_getN(5);
  @$pb.TagNumber(6)
  set rpsThreshold($47.RuntimeUInt32 v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasRpsThreshold() => $_has(5);
  @$pb.TagNumber(6)
  void clearRpsThreshold() => clearField(6);
  @$pb.TagNumber(6)
  $47.RuntimeUInt32 ensureRpsThreshold() => $_ensure(5);

  /// The probability of rejection will never exceed this value, even if the failure rate is rising.
  /// Defaults to 80%.
  @$pb.TagNumber(7)
  $47.RuntimePercent get maxRejectionProbability => $_getN(6);
  @$pb.TagNumber(7)
  set maxRejectionProbability($47.RuntimePercent v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasMaxRejectionProbability() => $_has(6);
  @$pb.TagNumber(7)
  void clearMaxRejectionProbability() => clearField(7);
  @$pb.TagNumber(7)
  $47.RuntimePercent ensureMaxRejectionProbability() => $_ensure(6);
}
