...
class OnDemandCds extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OnDemandCds', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.on_demand.v3'), createEmptyInstance: create)
    ..aOM<$50.ConfigSource>(1, _omitFieldNames ? '' : 'source', subBuilder: $50.ConfigSource.create)
  ...
  @$pb.TagNumber(1)
  $50.ConfigSource get source => $_getN(0);
  @$pb.TagNumber(1)
  set source($50.ConfigSource v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSource() => $_has(0);
  @$pb.TagNumber(1)
  void clearSource() => clearField(1);
  @$pb.TagNumber(1)
  $50.ConfigSource ensureSource() => $_ensure(0);
