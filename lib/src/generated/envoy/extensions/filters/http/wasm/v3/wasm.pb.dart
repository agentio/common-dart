...
class Wasm extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Wasm', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.wasm.v3'), createEmptyInstance: create)
