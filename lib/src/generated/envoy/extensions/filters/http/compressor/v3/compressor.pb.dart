...
class Compressor_CommonDirectionConfig extends $pb.GeneratedMessage {
  factory Compressor_CommonDirectionConfig({
    ...
    $26.UInt32Value? minContentLength,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Compressor.CommonDirectionConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.compressor.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.UInt32Value>(2, _omitFieldNames ? '' : 'minContentLength', subBuilder: $26.UInt32Value.create)
  ...
  @$pb.TagNumber(2)
  $26.UInt32Value get minContentLength => $_getN(1);
  @$pb.TagNumber(2)
  set minContentLength($26.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMinContentLength() => $_has(1);
  @$pb.TagNumber(2)
  void clearMinContentLength() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt32Value ensureMinContentLength() => $_ensure(1);
...
class Compressor extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    $40.TypedExtensionConfig? compressorLibrary,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Compressor', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.compressor.v3'), createEmptyInstance: create)
    ..aOM<$26.UInt32Value>(1, _omitFieldNames ? '' : 'contentLength', subBuilder: $26.UInt32Value.create)
    ...
    ..aOM<$47.RuntimeFeatureFlag>(5, _omitFieldNames ? '' : 'runtimeEnabled', subBuilder: $47.RuntimeFeatureFlag.create)
    ..aOM<$40.TypedExtensionConfig>(6, _omitFieldNames ? '' : 'compressorLibrary', subBuilder: $40.TypedExtensionConfig.create)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  $26.UInt32Value get contentLength => $_getN(0);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  set contentLength($26.UInt32Value v) { setField(1, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  $26.UInt32Value ensureContentLength() => $_ensure(0);
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  $47.RuntimeFeatureFlag get runtimeEnabled => $_getN(4);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  set runtimeEnabled($47.RuntimeFeatureFlag v) { setField(5, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  $47.RuntimeFeatureFlag ensureRuntimeEnabled() => $_ensure(4);
  ...
  @$pb.TagNumber(6)
  $40.TypedExtensionConfig get compressorLibrary => $_getN(5);
  @$pb.TagNumber(6)
  set compressorLibrary($40.TypedExtensionConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasCompressorLibrary() => $_has(5);
  @$pb.TagNumber(6)
  void clearCompressorLibrary() => clearField(6);
  @$pb.TagNumber(6)
  $40.TypedExtensionConfig ensureCompressorLibrary() => $_ensure(5);
...
class ResponseDirectionOverrides extends $pb.GeneratedMessage {
  factory ResponseDirectionOverrides({
    $26.BoolValue? removeAcceptEncodingHeader,
  }) {
    final $result = create();
    if (removeAcceptEncodingHeader != null) {
      $result.removeAcceptEncodingHeader = removeAcceptEncodingHeader;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResponseDirectionOverrides', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.compressor.v3'), createEmptyInstance: create)
    ..aOM<$26.BoolValue>(1, _omitFieldNames ? '' : 'removeAcceptEncodingHeader', subBuilder: $26.BoolValue.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $26.BoolValue get removeAcceptEncodingHeader => $_getN(0);
  @$pb.TagNumber(1)
  set removeAcceptEncodingHeader($26.BoolValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasRemoveAcceptEncodingHeader() => $_has(0);
  @$pb.TagNumber(1)
  void clearRemoveAcceptEncodingHeader() => clearField(1);
  @$pb.TagNumber(1)
  $26.BoolValue ensureRemoveAcceptEncodingHeader() => $_ensure(0);
}
