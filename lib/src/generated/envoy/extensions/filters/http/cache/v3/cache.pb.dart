...
class CacheConfig_KeyCreatorParams extends $pb.GeneratedMessage {
  factory CacheConfig_KeyCreatorParams({
    ...
    $core.Iterable<$66.QueryParameterMatcher>? queryParametersIncluded,
    $core.Iterable<$66.QueryParameterMatcher>? queryParametersExcluded,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CacheConfig.KeyCreatorParams', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.cache.v3'), createEmptyInstance: create)
    ...
    ..pc<$66.QueryParameterMatcher>(3, _omitFieldNames ? '' : 'queryParametersIncluded', $pb.PbFieldType.PM, subBuilder: $66.QueryParameterMatcher.create)
    ..pc<$66.QueryParameterMatcher>(4, _omitFieldNames ? '' : 'queryParametersExcluded', $pb.PbFieldType.PM, subBuilder: $66.QueryParameterMatcher.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$66.QueryParameterMatcher> get queryParametersIncluded => $_getList(2);
  ...
  @$pb.TagNumber(4)
  $core.List<$66.QueryParameterMatcher> get queryParametersExcluded => $_getList(3);
}
...
class CacheConfig extends $pb.GeneratedMessage {
  factory CacheConfig({
    $34.Any? typedConfig,
    $core.Iterable<$58.StringMatcher>? allowedVaryHeaders,
    CacheConfig_KeyCreatorParams? keyCreatorParams,
    $core.int? maxBodyBytes,
    $26.BoolValue? disabled,
    $core.bool? ignoreRequestCacheControlHeader,
  }) {
    final $result = create();
    if (typedConfig != null) {
    ...
    if (ignoreRequestCacheControlHeader != null) {
      $result.ignoreRequestCacheControlHeader = ignoreRequestCacheControlHeader;
    }
    return $result;
  }
  CacheConfig._() : super();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CacheConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.cache.v3'), createEmptyInstance: create)
    ...
    ..pc<$58.StringMatcher>(2, _omitFieldNames ? '' : 'allowedVaryHeaders', $pb.PbFieldType.PM, subBuilder: $58.StringMatcher.create)
    ...
    ..aOM<$26.BoolValue>(5, _omitFieldNames ? '' : 'disabled', subBuilder: $26.BoolValue.create)
    ..aOB(6, _omitFieldNames ? '' : 'ignoreRequestCacheControlHeader')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$58.StringMatcher> get allowedVaryHeaders => $_getList(1);
  ...
  @$pb.TagNumber(5)
  $26.BoolValue get disabled => $_getN(4);
  @$pb.TagNumber(5)
  set disabled($26.BoolValue v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDisabled() => $_has(4);
  @$pb.TagNumber(5)
  void clearDisabled() => clearField(5);
  @$pb.TagNumber(5)
  $26.BoolValue ensureDisabled() => $_ensure(4);
  ...
  @$pb.TagNumber(6)
  $core.bool get ignoreRequestCacheControlHeader => $_getBF(5);
  @$pb.TagNumber(6)
  set ignoreRequestCacheControlHeader($core.bool v) { $_setBool(5, v); }
  @$pb.TagNumber(6)
  $core.bool hasIgnoreRequestCacheControlHeader() => $_has(5);
  @$pb.TagNumber(6)
  void clearIgnoreRequestCacheControlHeader() => clearField(6);
}
