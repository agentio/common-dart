...
class Lua extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    $core.Map<$core.String, $47.DataSource>? sourceCodes,
    $47.DataSource? defaultSourceCode,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Lua', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.lua.v3'), createEmptyInstance: create)
    ...
    ..m<$core.String, $47.DataSource>(2, _omitFieldNames ? '' : 'sourceCodes', entryClassName: 'Lua.SourceCodesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $47.DataSource.create, valueDefaultOrMaker: $47.DataSource.getDefault, packageName: const $pb.PackageName('envoy.extensions.filters.http.lua.v3'))
    ..aOM<$47.DataSource>(3, _omitFieldNames ? '' : 'defaultSourceCode', subBuilder: $47.DataSource.create)
  ...
  @$pb.TagNumber(2)
  $core.Map<$core.String, $47.DataSource> get sourceCodes => $_getMap(1);
  ...
  @$pb.TagNumber(3)
  $47.DataSource get defaultSourceCode => $_getN(2);
  @$pb.TagNumber(3)
  set defaultSourceCode($47.DataSource v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasDefaultSourceCode() => $_has(2);
  @$pb.TagNumber(3)
  void clearDefaultSourceCode() => clearField(3);
  @$pb.TagNumber(3)
  $47.DataSource ensureDefaultSourceCode() => $_ensure(2);
...
class LuaPerRoute extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LuaPerRoute', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.lua.v3'), createEmptyInstance: create)
    ...
    ..aOM<$47.DataSource>(3, _omitFieldNames ? '' : 'sourceCode', subBuilder: $47.DataSource.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $47.DataSource get sourceCode => $_getN(2);
  @$pb.TagNumber(3)
  set sourceCode($47.DataSource v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSourceCode() => $_has(2);
  @$pb.TagNumber(3)
  void clearSourceCode() => clearField(3);
  @$pb.TagNumber(3)
  $47.DataSource ensureSourceCode() => $_ensure(2);
}
