...
class IPTagging_IPTag extends $pb.GeneratedMessage {
  factory IPTagging_IPTag({
    ...
    $core.Iterable<$42.CidrRange>? ipList,
  }) {
    final $result = create();
    if (ipTagName != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IPTagging.IPTag', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.ip_tagging.v3'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'ipTagName')
    ..pc<$42.CidrRange>(2, _omitFieldNames ? '' : 'ipList', $pb.PbFieldType.PM, subBuilder: $42.CidrRange.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$42.CidrRange> get ipList => $_getList(1);
}
...
class IPTagging extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IPTagging', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.ip_tagging.v3'), createEmptyInstance: create)
