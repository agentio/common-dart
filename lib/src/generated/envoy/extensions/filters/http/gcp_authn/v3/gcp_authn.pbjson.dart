  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.envoy.config.core.v3.HttpUri',
      '8': {'3': true},
      '10': 'httpUri',
    },
    ...
    {'1': 'cluster', '3': 5, '4': 1, '5': 9, '10': 'cluster'},
...
final $typed_data.Uint8List gcpAuthnFilterConfigDescriptor = $convert.base64Decode(
    'ChRHY3BBdXRobkZpbHRlckNvbmZpZxJFCghodHRwX3VyaRgBIAEoCzIdLmVudm95LmNvbmZpZy'
    '5jb3JlLnYzLkh0dHBVcmlCCxgBkseG2AQDMy4wUgdodHRwVXJpEkQKDHJldHJ5X3BvbGljeRgC'
    'IAEoCzIhLmVudm95LmNvbmZpZy5jb3JlLnYzLlJldHJ5UG9saWN5UgtyZXRyeVBvbGljeRJfCg'
    'xjYWNoZV9jb25maWcYAyABKAsyPC5lbnZveS5leHRlbnNpb25zLmZpbHRlcnMuaHR0cC5nY3Bf'
    'YXV0aG4udjMuVG9rZW5DYWNoZUNvbmZpZ1ILY2FjaGVDb25maWcSWgoMdG9rZW5faGVhZGVyGA'
    'QgASgLMjcuZW52b3kuZXh0ZW5zaW9ucy5maWx0ZXJzLmh0dHAuZ2NwX2F1dGhuLnYzLlRva2Vu'
    'SGVhZGVyUgt0b2tlbkhlYWRlchIYCgdjbHVzdGVyGAUgASgJUgdjbHVzdGVyEkUKB3RpbWVvdX'
    'QYBiABKAsyGS5nb29nbGUucHJvdG9idWYuRHVyYXRpb25CEPpCDaoBChoGCICAgIAQMgBSB3Rp'
    'bWVvdXQ=');
...
final $typed_data.Uint8List tokenHeaderDescriptor = $convert.base64Decode(
    'CgtUb2tlbkhlYWRlchIhCgRuYW1lGAEgASgJQg36QgpyCBABwAEByAEAUgRuYW1lEi4KDHZhbH'
    'VlX3ByZWZpeBgCIAEoCUIL+kIIcgbAAQLIAQBSC3ZhbHVlUHJlZml4');
