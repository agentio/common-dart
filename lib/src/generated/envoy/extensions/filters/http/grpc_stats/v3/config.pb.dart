...
import '../../../../../config/core/v3/grpc_method_list.pb.dart' as $183;
...
class FilterConfig extends $pb.GeneratedMessage {
  factory FilterConfig({
    ...
    $183.GrpcMethodList? individualMethodStatsAllowlist,
    $26.BoolValue? statsForAllMethods,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FilterConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.grpc_stats.v3'), createEmptyInstance: create)
    ...
    ..aOM<$183.GrpcMethodList>(2, _omitFieldNames ? '' : 'individualMethodStatsAllowlist', subBuilder: $183.GrpcMethodList.create)
    ..aOM<$26.BoolValue>(3, _omitFieldNames ? '' : 'statsForAllMethods', subBuilder: $26.BoolValue.create)
  ...
  @$pb.TagNumber(2)
  $183.GrpcMethodList get individualMethodStatsAllowlist => $_getN(1);
  @$pb.TagNumber(2)
  set individualMethodStatsAllowlist($183.GrpcMethodList v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasIndividualMethodStatsAllowlist() => $_has(1);
  @$pb.TagNumber(2)
  void clearIndividualMethodStatsAllowlist() => clearField(2);
  @$pb.TagNumber(2)
  $183.GrpcMethodList ensureIndividualMethodStatsAllowlist() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $26.BoolValue get statsForAllMethods => $_getN(2);
  @$pb.TagNumber(3)
  set statsForAllMethods($26.BoolValue v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasStatsForAllMethods() => $_has(2);
  @$pb.TagNumber(3)
  void clearStatsForAllMethods() => clearField(3);
  @$pb.TagNumber(3)
  $26.BoolValue ensureStatsForAllMethods() => $_ensure(2);
