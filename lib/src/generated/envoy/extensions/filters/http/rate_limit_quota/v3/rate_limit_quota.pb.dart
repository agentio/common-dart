...
import '../../../../../../google/rpc/status.pb.dart' as $157;
...
import '../../../../../type/v3/ratelimit_strategy.pb.dart' as $155;
...
class RateLimitQuotaFilterConfig extends $pb.GeneratedMessage {
  factory RateLimitQuotaFilterConfig({
    $48.GrpcService? rlqsServer,
    $core.String? domain,
    $61.Matcher? bucketMatchers,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimitQuotaFilterConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.rate_limit_quota.v3'), createEmptyInstance: create)
    ..aOM<$48.GrpcService>(1, _omitFieldNames ? '' : 'rlqsServer', subBuilder: $48.GrpcService.create)
    ..aOS(2, _omitFieldNames ? '' : 'domain')
    ..aOM<$61.Matcher>(3, _omitFieldNames ? '' : 'bucketMatchers', subBuilder: $61.Matcher.create)
    ...
    ..pc<$47.HeaderValueOption>(6, _omitFieldNames ? '' : 'requestHeadersToAddWhenNotEnforced', $pb.PbFieldType.PM, subBuilder: $47.HeaderValueOption.create)
  ...
  @$pb.TagNumber(1)
  $48.GrpcService get rlqsServer => $_getN(0);
  @$pb.TagNumber(1)
  set rlqsServer($48.GrpcService v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasRlqsServer() => $_has(0);
  @$pb.TagNumber(1)
  void clearRlqsServer() => clearField(1);
  @$pb.TagNumber(1)
  $48.GrpcService ensureRlqsServer() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $61.Matcher get bucketMatchers => $_getN(2);
  @$pb.TagNumber(3)
  set bucketMatchers($61.Matcher v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasBucketMatchers() => $_has(2);
  @$pb.TagNumber(3)
  void clearBucketMatchers() => clearField(3);
  @$pb.TagNumber(3)
  $61.Matcher ensureBucketMatchers() => $_ensure(2);
  ...
  @$pb.TagNumber(6)
  $core.List<$47.HeaderValueOption> get requestHeadersToAddWhenNotEnforced => $_getList(5);
}
...
class RateLimitQuotaOverride extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimitQuotaOverride', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.rate_limit_quota.v3'), createEmptyInstance: create)
    ...
    ..aOM<$61.Matcher>(2, _omitFieldNames ? '' : 'bucketMatchers', subBuilder: $61.Matcher.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $61.Matcher get bucketMatchers => $_getN(1);
  @$pb.TagNumber(2)
  set bucketMatchers($61.Matcher v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBucketMatchers() => $_has(1);
  @$pb.TagNumber(2)
  void clearBucketMatchers() => clearField(2);
  @$pb.TagNumber(2)
  $61.Matcher ensureBucketMatchers() => $_ensure(1);
}
...
class RateLimitQuotaBucketSettings_NoAssignmentBehavior extends $pb.GeneratedMessage {
  factory RateLimitQuotaBucketSettings_NoAssignmentBehavior({
    $155.RateLimitStrategy? fallbackRateLimit,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimitQuotaBucketSettings.NoAssignmentBehavior', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.rate_limit_quota.v3'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<$155.RateLimitStrategy>(1, _omitFieldNames ? '' : 'fallbackRateLimit', subBuilder: $155.RateLimitStrategy.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $155.RateLimitStrategy get fallbackRateLimit => $_getN(0);
  @$pb.TagNumber(1)
  set fallbackRateLimit($155.RateLimitStrategy v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasFallbackRateLimit() => $_has(0);
  @$pb.TagNumber(1)
  void clearFallbackRateLimit() => clearField(1);
  @$pb.TagNumber(1)
  $155.RateLimitStrategy ensureFallbackRateLimit() => $_ensure(0);
}
...
class RateLimitQuotaBucketSettings_ExpiredAssignmentBehavior extends $pb.GeneratedMessage {
  factory RateLimitQuotaBucketSettings_ExpiredAssignmentBehavior({
    $28.Duration? expiredAssignmentBehaviorTimeout,
    $155.RateLimitStrategy? fallbackRateLimit,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimitQuotaBucketSettings.ExpiredAssignmentBehavior', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.rate_limit_quota.v3'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOM<$28.Duration>(1, _omitFieldNames ? '' : 'expiredAssignmentBehaviorTimeout', subBuilder: $28.Duration.create)
    ..aOM<$155.RateLimitStrategy>(2, _omitFieldNames ? '' : 'fallbackRateLimit', subBuilder: $155.RateLimitStrategy.create)
  ...
  @$pb.TagNumber(1)
  $28.Duration get expiredAssignmentBehaviorTimeout => $_getN(0);
  @$pb.TagNumber(1)
  set expiredAssignmentBehaviorTimeout($28.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasExpiredAssignmentBehaviorTimeout() => $_has(0);
  @$pb.TagNumber(1)
  void clearExpiredAssignmentBehaviorTimeout() => clearField(1);
  @$pb.TagNumber(1)
  $28.Duration ensureExpiredAssignmentBehaviorTimeout() => $_ensure(0);
  ...
  /// runs out.
  @$pb.TagNumber(2)
  $155.RateLimitStrategy get fallbackRateLimit => $_getN(1);
  @$pb.TagNumber(2)
  set fallbackRateLimit($155.RateLimitStrategy v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFallbackRateLimit() => $_has(1);
  @$pb.TagNumber(2)
  void clearFallbackRateLimit() => clearField(2);
  @$pb.TagNumber(2)
  $155.RateLimitStrategy ensureFallbackRateLimit() => $_ensure(1);
...
class RateLimitQuotaBucketSettings_DenyResponseSettings extends $pb.GeneratedMessage {
  factory RateLimitQuotaBucketSettings_DenyResponseSettings({
    $160.HttpStatus? httpStatus,
    $26.BytesValue? httpBody,
    $157.Status? grpcStatus,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimitQuotaBucketSettings.DenyResponseSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.rate_limit_quota.v3'), createEmptyInstance: create)
    ..aOM<$160.HttpStatus>(1, _omitFieldNames ? '' : 'httpStatus', subBuilder: $160.HttpStatus.create)
    ..aOM<$26.BytesValue>(2, _omitFieldNames ? '' : 'httpBody', subBuilder: $26.BytesValue.create)
    ..aOM<$157.Status>(3, _omitFieldNames ? '' : 'grpcStatus', subBuilder: $157.Status.create)
    ..pc<$47.HeaderValueOption>(4, _omitFieldNames ? '' : 'responseHeadersToAdd', $pb.PbFieldType.PM, subBuilder: $47.HeaderValueOption.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $160.HttpStatus get httpStatus => $_getN(0);
  @$pb.TagNumber(1)
  set httpStatus($160.HttpStatus v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasHttpStatus() => $_has(0);
  @$pb.TagNumber(1)
  void clearHttpStatus() => clearField(1);
  @$pb.TagNumber(1)
  $160.HttpStatus ensureHttpStatus() => $_ensure(0);

  /// HTTP response body used to deny for HTTP requests (gRPC excluded).
  /// If not set, an empty body is returned.
  @$pb.TagNumber(2)
  $26.BytesValue get httpBody => $_getN(1);
  @$pb.TagNumber(2)
  set httpBody($26.BytesValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasHttpBody() => $_has(1);
  @$pb.TagNumber(2)
  void clearHttpBody() => clearField(2);
  @$pb.TagNumber(2)
  $26.BytesValue ensureHttpBody() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $157.Status get grpcStatus => $_getN(2);
  @$pb.TagNumber(3)
  set grpcStatus($157.Status v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasGrpcStatus() => $_has(2);
  @$pb.TagNumber(3)
  void clearGrpcStatus() => clearField(3);
  @$pb.TagNumber(3)
  $157.Status ensureGrpcStatus() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $core.List<$47.HeaderValueOption> get responseHeadersToAdd => $_getList(3);
}
...
class RateLimitQuotaBucketSettings_BucketIdBuilder_ValueBuilder extends $pb.GeneratedMessage {
  factory RateLimitQuotaBucketSettings_BucketIdBuilder_ValueBuilder({
    ...
    $40.TypedExtensionConfig? customValue,
  }) {
    final $result = create();
    if (stringValue != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimitQuotaBucketSettings.BucketIdBuilder.ValueBuilder', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.rate_limit_quota.v3'), createEmptyInstance: create)
    ...
    ..aOM<$40.TypedExtensionConfig>(2, _omitFieldNames ? '' : 'customValue', subBuilder: $40.TypedExtensionConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $40.TypedExtensionConfig get customValue => $_getN(1);
  @$pb.TagNumber(2)
  set customValue($40.TypedExtensionConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCustomValue() => $_has(1);
  @$pb.TagNumber(2)
  void clearCustomValue() => clearField(2);
  @$pb.TagNumber(2)
  $40.TypedExtensionConfig ensureCustomValue() => $_ensure(1);
}
...
class RateLimitQuotaBucketSettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimitQuotaBucketSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.rate_limit_quota.v3'), createEmptyInstance: create)
    ...
    ..aOM<$28.Duration>(2, _omitFieldNames ? '' : 'reportingInterval', subBuilder: $28.Duration.create)
  ...
  @$pb.TagNumber(2)
  $28.Duration get reportingInterval => $_getN(1);
  @$pb.TagNumber(2)
  set reportingInterval($28.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasReportingInterval() => $_has(1);
  @$pb.TagNumber(2)
  void clearReportingInterval() => clearField(2);
  @$pb.TagNumber(2)
  $28.Duration ensureReportingInterval() => $_ensure(1);
