...
import '../../../network/http_connection_manager/v3/http_connection_manager.pb.dart' as $194;
...
class Router_UpstreamAccessLogOptions extends $pb.GeneratedMessage {
  factory Router_UpstreamAccessLogOptions({
    ...
    $28.Duration? upstreamLogFlushInterval,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Router.UpstreamAccessLogOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.router.v3'), createEmptyInstance: create)
    ...
    ..aOM<$28.Duration>(2, _omitFieldNames ? '' : 'upstreamLogFlushInterval', subBuilder: $28.Duration.create)
  ...
  @$pb.TagNumber(2)
  $28.Duration get upstreamLogFlushInterval => $_getN(1);
  @$pb.TagNumber(2)
  set upstreamLogFlushInterval($28.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpstreamLogFlushInterval() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpstreamLogFlushInterval() => clearField(2);
  @$pb.TagNumber(2)
  $28.Duration ensureUpstreamLogFlushInterval() => $_ensure(1);
}

/// [#next-free-field: 10]
class Router extends $pb.GeneratedMessage {
  factory Router({
    $26.BoolValue? dynamicStats,
  @$core.Deprecated('This field is deprecated.')
    $core.bool? startChildSpan,
    $core.Iterable<$72.AccessLog>? upstreamLog,
    ...
    $core.Iterable<$194.HttpFilter>? upstreamHttpFilters,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Router', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.router.v3'), createEmptyInstance: create)
    ..aOM<$26.BoolValue>(1, _omitFieldNames ? '' : 'dynamicStats', subBuilder: $26.BoolValue.create)
    ..aOB(2, _omitFieldNames ? '' : 'startChildSpan')
    ..pc<$72.AccessLog>(3, _omitFieldNames ? '' : 'upstreamLog', $pb.PbFieldType.PM, subBuilder: $72.AccessLog.create)
    ...
    ..pc<$194.HttpFilter>(8, _omitFieldNames ? '' : 'upstreamHttpFilters', $pb.PbFieldType.PM, subBuilder: $194.HttpFilter.create)
  ...
  @$pb.TagNumber(1)
  $26.BoolValue get dynamicStats => $_getN(0);
  @$pb.TagNumber(1)
  set dynamicStats($26.BoolValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDynamicStats() => $_has(0);
  @$pb.TagNumber(1)
  void clearDynamicStats() => clearField(1);
  @$pb.TagNumber(1)
  $26.BoolValue ensureDynamicStats() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $core.List<$72.AccessLog> get upstreamLog => $_getList(2);
  ...
  @$pb.TagNumber(8)
  $core.List<$194.HttpFilter> get upstreamHttpFilters => $_getList(7);
