...
class StreamConfig extends $pb.GeneratedMessage {
  factory StreamConfig({
    ...
    $26.UInt64Value? memoryBufferBytesLimit,
    $26.UInt64Value? storageBufferBytesLimit,
    $26.UInt64Value? storageBufferQueueHighWatermarkBytes,
  }) {
    final $result = create();
    if (behavior != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.file_system_buffer.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.UInt64Value>(2, _omitFieldNames ? '' : 'memoryBufferBytesLimit', subBuilder: $26.UInt64Value.create)
    ..aOM<$26.UInt64Value>(3, _omitFieldNames ? '' : 'storageBufferBytesLimit', subBuilder: $26.UInt64Value.create)
    ..aOM<$26.UInt64Value>(4, _omitFieldNames ? '' : 'storageBufferQueueHighWatermarkBytes', subBuilder: $26.UInt64Value.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $26.UInt64Value get memoryBufferBytesLimit => $_getN(1);
  @$pb.TagNumber(2)
  set memoryBufferBytesLimit($26.UInt64Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMemoryBufferBytesLimit() => $_has(1);
  @$pb.TagNumber(2)
  void clearMemoryBufferBytesLimit() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt64Value ensureMemoryBufferBytesLimit() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $26.UInt64Value get storageBufferBytesLimit => $_getN(2);
  @$pb.TagNumber(3)
  set storageBufferBytesLimit($26.UInt64Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasStorageBufferBytesLimit() => $_has(2);
  @$pb.TagNumber(3)
  void clearStorageBufferBytesLimit() => clearField(3);
  @$pb.TagNumber(3)
  $26.UInt64Value ensureStorageBufferBytesLimit() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $26.UInt64Value get storageBufferQueueHighWatermarkBytes => $_getN(3);
  @$pb.TagNumber(4)
  set storageBufferQueueHighWatermarkBytes($26.UInt64Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasStorageBufferQueueHighWatermarkBytes() => $_has(3);
  @$pb.TagNumber(4)
  void clearStorageBufferQueueHighWatermarkBytes() => clearField(4);
  @$pb.TagNumber(4)
  $26.UInt64Value ensureStorageBufferQueueHighWatermarkBytes() => $_ensure(3);
}
...
class FileSystemBufferFilterConfig extends $pb.GeneratedMessage {
  factory FileSystemBufferFilterConfig({
    ...
    $26.StringValue? storageBufferPath,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FileSystemBufferFilterConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.file_system_buffer.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.StringValue>(2, _omitFieldNames ? '' : 'storageBufferPath', subBuilder: $26.StringValue.create)
  ...
  @$pb.TagNumber(2)
  $26.StringValue get storageBufferPath => $_getN(1);
  @$pb.TagNumber(2)
  set storageBufferPath($26.StringValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasStorageBufferPath() => $_has(1);
  @$pb.TagNumber(2)
  void clearStorageBufferPath() => clearField(2);
  @$pb.TagNumber(2)
  $26.StringValue ensureStorageBufferPath() => $_ensure(1);
