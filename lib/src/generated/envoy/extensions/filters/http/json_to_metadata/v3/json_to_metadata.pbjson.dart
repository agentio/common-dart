...
const JsonToMetadata_MatchRules$json = {
  ...
  '2': [
    ...
    {'1': 'allow_content_types_regex', '3': 4, '4': 1, '5': 11, '6': '.envoy.type.matcher.v3.RegexMatcher', '10': 'allowContentTypesRegex'},
  ],
};
...
final $typed_data.Uint8List jsonToMetadataDescriptor = $convert.base64Decode(
    ...
    '9uVG9NZXRhZGF0YS5LZXlWYWx1ZVBhaXJSB29uRXJyb3IaywIKCk1hdGNoUnVsZXMSZgoFcnVs'
    ...
    '93X2VtcHR5X2NvbnRlbnRfdHlwZRgDIAEoCFIVYWxsb3dFbXB0eUNvbnRlbnRUeXBlEl4KGWFs'
    'bG93X2NvbnRlbnRfdHlwZXNfcmVnZXgYBCABKAsyIy5lbnZveS50eXBlLm1hdGNoZXIudjMuUm'
    'VnZXhNYXRjaGVyUhZhbGxvd0NvbnRlbnRUeXBlc1JlZ2V4IjcKCVZhbHVlVHlwZRISCg5QUk9U'
    'T0JVRl9WQUxVRRAAEgoKBlNUUklORxABEgoKBk5VTUJFUhAC');
