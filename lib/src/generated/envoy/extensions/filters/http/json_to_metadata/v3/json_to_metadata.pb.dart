...
class JsonToMetadata_MatchRules extends $pb.GeneratedMessage {
  factory JsonToMetadata_MatchRules({
    ...
    $55.RegexMatcher? allowContentTypesRegex,
  }) {
    final $result = create();
    if (rules != null) {
    ...
    if (allowContentTypesRegex != null) {
      $result.allowContentTypesRegex = allowContentTypesRegex;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JsonToMetadata.MatchRules', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.json_to_metadata.v3'), createEmptyInstance: create)
    ...
    ..aOM<$55.RegexMatcher>(4, _omitFieldNames ? '' : 'allowContentTypesRegex', subBuilder: $55.RegexMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $55.RegexMatcher get allowContentTypesRegex => $_getN(3);
  @$pb.TagNumber(4)
  set allowContentTypesRegex($55.RegexMatcher v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAllowContentTypesRegex() => $_has(3);
  @$pb.TagNumber(4)
  void clearAllowContentTypesRegex() => clearField(4);
  @$pb.TagNumber(4)
  $55.RegexMatcher ensureAllowContentTypesRegex() => $_ensure(3);
}
