...
class GrpcJsonTranscoder extends $pb.GeneratedMessage {
  factory GrpcJsonTranscoder({
    ...
    $26.UInt32Value? maxRequestBodySize,
    $26.UInt32Value? maxResponseBodySize,
    $core.bool? captureUnknownQueryParameters,
  }) {
    final $result = create();
    ...
    if (captureUnknownQueryParameters != null) {
      $result.captureUnknownQueryParameters = captureUnknownQueryParameters;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrpcJsonTranscoder', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.grpc_json_transcoder.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.UInt32Value>(15, _omitFieldNames ? '' : 'maxRequestBodySize', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(16, _omitFieldNames ? '' : 'maxResponseBodySize', subBuilder: $26.UInt32Value.create)
    ..aOB(17, _omitFieldNames ? '' : 'captureUnknownQueryParameters')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(15)
  $26.UInt32Value get maxRequestBodySize => $_getN(14);
  @$pb.TagNumber(15)
  set maxRequestBodySize($26.UInt32Value v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasMaxRequestBodySize() => $_has(14);
  @$pb.TagNumber(15)
  void clearMaxRequestBodySize() => clearField(15);
  @$pb.TagNumber(15)
  $26.UInt32Value ensureMaxRequestBodySize() => $_ensure(14);
  ...
  ///  If unset, the current stream buffer size is used.
  @$pb.TagNumber(16)
  $26.UInt32Value get maxResponseBodySize => $_getN(15);
  @$pb.TagNumber(16)
  set maxResponseBodySize($26.UInt32Value v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasMaxResponseBodySize() => $_has(15);
  @$pb.TagNumber(16)
  void clearMaxResponseBodySize() => clearField(16);
  @$pb.TagNumber(16)
  $26.UInt32Value ensureMaxResponseBodySize() => $_ensure(15);
  ...
  @$pb.TagNumber(17)
  $core.bool get captureUnknownQueryParameters => $_getBF(16);
  @$pb.TagNumber(17)
  set captureUnknownQueryParameters($core.bool v) { $_setBool(16, v); }
  @$pb.TagNumber(17)
  $core.bool hasCaptureUnknownQueryParameters() => $_has(16);
  @$pb.TagNumber(17)
  void clearCaptureUnknownQueryParameters() => clearField(17);
}

class UnknownQueryParams_Values extends $pb.GeneratedMessage {
  factory UnknownQueryParams_Values({
  ...
  UnknownQueryParams_Values._() : super();
  factory UnknownQueryParams_Values.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UnknownQueryParams_Values.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UnknownQueryParams.Values', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.grpc_json_transcoder.v3'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UnknownQueryParams_Values clone() => UnknownQueryParams_Values()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UnknownQueryParams_Values copyWith(void Function(UnknownQueryParams_Values) updates) => super.copyWith((message) => updates(message as UnknownQueryParams_Values)) as UnknownQueryParams_Values;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UnknownQueryParams_Values create() => UnknownQueryParams_Values._();
  UnknownQueryParams_Values createEmptyInstance() => create();
  static $pb.PbList<UnknownQueryParams_Values> createRepeated() => $pb.PbList<UnknownQueryParams_Values>();
  @$core.pragma('dart2js:noInline')
  static UnknownQueryParams_Values getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UnknownQueryParams_Values>(create);
  static UnknownQueryParams_Values? _defaultInstance;
...
class UnknownQueryParams extends $pb.GeneratedMessage {
  factory UnknownQueryParams({
    $core.Map<$core.String, UnknownQueryParams_Values>? key,
  }) {
    final $result = create();
    if (key != null) {
  ...
  UnknownQueryParams._() : super();
  factory UnknownQueryParams.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UnknownQueryParams.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UnknownQueryParams', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.grpc_json_transcoder.v3'), createEmptyInstance: create)
    ..m<$core.String, UnknownQueryParams_Values>(1, _omitFieldNames ? '' : 'key', entryClassName: 'UnknownQueryParams.KeyEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: UnknownQueryParams_Values.create, valueDefaultOrMaker: UnknownQueryParams_Values.getDefault, packageName: const $pb.PackageName('envoy.extensions.filters.http.grpc_json_transcoder.v3'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UnknownQueryParams clone() => UnknownQueryParams()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UnknownQueryParams copyWith(void Function(UnknownQueryParams) updates) => super.copyWith((message) => updates(message as UnknownQueryParams)) as UnknownQueryParams;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UnknownQueryParams create() => UnknownQueryParams._();
  UnknownQueryParams createEmptyInstance() => create();
  static $pb.PbList<UnknownQueryParams> createRepeated() => $pb.PbList<UnknownQueryParams>();
  @$core.pragma('dart2js:noInline')
  static UnknownQueryParams getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UnknownQueryParams>(create);
  static UnknownQueryParams? _defaultInstance;

  /// A map from unrecognized query parameter keys, to the values associated with those keys.
  @$pb.TagNumber(1)
  $core.Map<$core.String, UnknownQueryParams_Values> get key => $_getMap(0);
}
