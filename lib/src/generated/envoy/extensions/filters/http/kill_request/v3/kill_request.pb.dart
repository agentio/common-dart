...
class KillRequest extends $pb.GeneratedMessage {
  factory KillRequest({
    $44.FractionalPercent? probability,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KillRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.kill_request.v3'), createEmptyInstance: create)
    ..aOM<$44.FractionalPercent>(1, _omitFieldNames ? '' : 'probability', subBuilder: $44.FractionalPercent.create)
  ...
  @$pb.TagNumber(1)
  $44.FractionalPercent get probability => $_getN(0);
  @$pb.TagNumber(1)
  set probability($44.FractionalPercent v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasProbability() => $_has(0);
  @$pb.TagNumber(1)
  void clearProbability() => clearField(1);
  @$pb.TagNumber(1)
  $44.FractionalPercent ensureProbability() => $_ensure(0);
