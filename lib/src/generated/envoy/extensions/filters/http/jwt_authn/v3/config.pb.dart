...
class JwtProvider extends $pb.GeneratedMessage {
  factory JwtProvider({
    ...
    $58.StringMatcher? subjects,
    $core.bool? requireExpiration,
    $28.Duration? maxLifetime,
  }) {
    final $result = create();
    if (issuer != null) {
    ...
    if (requireExpiration != null) {
      $result.requireExpiration = requireExpiration;
    }
    if (maxLifetime != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JwtProvider', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.jwt_authn.v3'), createEmptyInstance: create)
    ...
    ..aOM<$47.DataSource>(4, _omitFieldNames ? '' : 'localJwks', subBuilder: $47.DataSource.create)
    ...
    ..aOM<$58.StringMatcher>(19, _omitFieldNames ? '' : 'subjects', subBuilder: $58.StringMatcher.create)
    ..aOB(20, _omitFieldNames ? '' : 'requireExpiration')
    ..aOM<$28.Duration>(21, _omitFieldNames ? '' : 'maxLifetime', subBuilder: $28.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $47.DataSource get localJwks => $_getN(3);
  @$pb.TagNumber(4)
  set localJwks($47.DataSource v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLocalJwks() => $_has(3);
  @$pb.TagNumber(4)
  void clearLocalJwks() => clearField(4);
  @$pb.TagNumber(4)
  $47.DataSource ensureLocalJwks() => $_ensure(3);
  ...
  @$pb.TagNumber(19)
  $58.StringMatcher get subjects => $_getN(18);
  @$pb.TagNumber(19)
  set subjects($58.StringMatcher v) { setField(19, v); }
  @$pb.TagNumber(19)
  $core.bool hasSubjects() => $_has(18);
  @$pb.TagNumber(19)
  void clearSubjects() => clearField(19);
  @$pb.TagNumber(19)
  $58.StringMatcher ensureSubjects() => $_ensure(18);
  ...
  @$pb.TagNumber(20)
  $core.bool get requireExpiration => $_getBF(19);
  @$pb.TagNumber(20)
  set requireExpiration($core.bool v) { $_setBool(19, v); }
  @$pb.TagNumber(20)
  $core.bool hasRequireExpiration() => $_has(19);
  @$pb.TagNumber(20)
  void clearRequireExpiration() => clearField(20);
  ...
  ///        seconds: 86400
  @$pb.TagNumber(21)
  $28.Duration get maxLifetime => $_getN(20);
  @$pb.TagNumber(21)
  set maxLifetime($28.Duration v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasMaxLifetime() => $_has(20);
  @$pb.TagNumber(21)
  void clearMaxLifetime() => clearField(21);
  @$pb.TagNumber(21)
  $28.Duration ensureMaxLifetime() => $_ensure(20);
}
...
class RemoteJwks extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RemoteJwks', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.jwt_authn.v3'), createEmptyInstance: create)
    ...
    ..aOM<$28.Duration>(2, _omitFieldNames ? '' : 'cacheDuration', subBuilder: $28.Duration.create)
    ..aOM<JwksAsyncFetch>(3, _omitFieldNames ? '' : 'asyncFetch', subBuilder: JwksAsyncFetch.create)
    ..aOM<$47.RetryPolicy>(4, _omitFieldNames ? '' : 'retryPolicy', subBuilder: $47.RetryPolicy.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $28.Duration get cacheDuration => $_getN(1);
  @$pb.TagNumber(2)
  set cacheDuration($28.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCacheDuration() => $_has(1);
  @$pb.TagNumber(2)
  void clearCacheDuration() => clearField(2);
  @$pb.TagNumber(2)
  $28.Duration ensureCacheDuration() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  $47.RetryPolicy get retryPolicy => $_getN(3);
  @$pb.TagNumber(4)
  set retryPolicy($47.RetryPolicy v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasRetryPolicy() => $_has(3);
  @$pb.TagNumber(4)
  void clearRetryPolicy() => clearField(4);
  @$pb.TagNumber(4)
  $47.RetryPolicy ensureRetryPolicy() => $_ensure(3);
}
...
class JwksAsyncFetch extends $pb.GeneratedMessage {
  factory JwksAsyncFetch({
    ...
    $28.Duration? failedRefetchDuration,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JwksAsyncFetch', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.jwt_authn.v3'), createEmptyInstance: create)
    ...
    ..aOM<$28.Duration>(2, _omitFieldNames ? '' : 'failedRefetchDuration', subBuilder: $28.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $28.Duration get failedRefetchDuration => $_getN(1);
  @$pb.TagNumber(2)
  set failedRefetchDuration($28.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFailedRefetchDuration() => $_has(1);
  @$pb.TagNumber(2)
  void clearFailedRefetchDuration() => clearField(2);
  @$pb.TagNumber(2)
  $28.Duration ensureFailedRefetchDuration() => $_ensure(1);
}
...
class JwtRequirement extends $pb.GeneratedMessage {
  factory JwtRequirement({
    ...
    $37.Empty? allowMissingOrFailed,
    $37.Empty? allowMissing,
  }) {
    final $result = create();
    if (providerName != null) {
      $result.providerName = providerName;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JwtRequirement', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.jwt_authn.v3'), createEmptyInstance: create)
    ...
    ..aOM<$37.Empty>(5, _omitFieldNames ? '' : 'allowMissingOrFailed', subBuilder: $37.Empty.create)
    ..aOM<$37.Empty>(6, _omitFieldNames ? '' : 'allowMissing', subBuilder: $37.Empty.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $37.Empty get allowMissingOrFailed => $_getN(4);
  @$pb.TagNumber(5)
  set allowMissingOrFailed($37.Empty v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasAllowMissingOrFailed() => $_has(4);
  @$pb.TagNumber(5)
  void clearAllowMissingOrFailed() => clearField(5);
  @$pb.TagNumber(5)
  $37.Empty ensureAllowMissingOrFailed() => $_ensure(4);
  ...
  @$pb.TagNumber(6)
  $37.Empty get allowMissing => $_getN(5);
  @$pb.TagNumber(6)
  set allowMissing($37.Empty v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasAllowMissing() => $_has(5);
  @$pb.TagNumber(6)
  void clearAllowMissing() => clearField(6);
  @$pb.TagNumber(6)
  $37.Empty ensureAllowMissing() => $_ensure(5);
}
...
class RequirementRule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RequirementRule', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.jwt_authn.v3'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOM<$66.RouteMatch>(1, _omitFieldNames ? '' : 'match', subBuilder: $66.RouteMatch.create)
  ...
  ///       prefix: /
  @$pb.TagNumber(1)
  $66.RouteMatch get match => $_getN(0);
  @$pb.TagNumber(1)
  set match($66.RouteMatch v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasMatch() => $_has(0);
  @$pb.TagNumber(1)
  void clearMatch() => clearField(1);
  @$pb.TagNumber(1)
  $66.RouteMatch ensureMatch() => $_ensure(0);
...
class JwtAuthentication extends $pb.GeneratedMessage {
  factory JwtAuthentication({
    ...
    $core.bool? stripFailureResponse,
  }) {
    final $result = create();
    if (providers != null) {
    ...
    if (stripFailureResponse != null) {
      $result.stripFailureResponse = stripFailureResponse;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JwtAuthentication', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.jwt_authn.v3'), createEmptyInstance: create)
    ...
    ..aOB(6, _omitFieldNames ? '' : 'stripFailureResponse')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $core.bool get stripFailureResponse => $_getBF(5);
  @$pb.TagNumber(6)
  set stripFailureResponse($core.bool v) { $_setBool(5, v); }
  @$pb.TagNumber(6)
  $core.bool hasStripFailureResponse() => $_has(5);
  @$pb.TagNumber(6)
  void clearStripFailureResponse() => clearField(6);
}
