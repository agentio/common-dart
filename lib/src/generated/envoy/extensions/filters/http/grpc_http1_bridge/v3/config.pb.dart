...
class Config extends $pb.GeneratedMessage {
  factory Config({
    ...
    $core.bool? ignoreQueryParameters,
  }) {
    final $result = create();
    ...
    if (ignoreQueryParameters != null) {
      $result.ignoreQueryParameters = ignoreQueryParameters;
    }
    return $result;
  }
  Config._() : super();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Config', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.grpc_http1_bridge.v3'), createEmptyInstance: create)
    ...
    ..aOB(2, _omitFieldNames ? '' : 'ignoreQueryParameters')
  ...
  @$pb.TagNumber(2)
  $core.bool get ignoreQueryParameters => $_getBF(1);
  @$pb.TagNumber(2)
  set ignoreQueryParameters($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasIgnoreQueryParameters() => $_has(1);
  @$pb.TagNumber(2)
  void clearIgnoreQueryParameters() => clearField(2);
}
