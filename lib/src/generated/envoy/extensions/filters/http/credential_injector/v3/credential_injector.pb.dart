...
class CredentialInjector extends $pb.GeneratedMessage {
  factory CredentialInjector({
    $core.bool? overwrite,
    $core.bool? allowRequestWithoutCredential,
    $40.TypedExtensionConfig? credential,
  }) {
    final $result = create();
    if (overwrite != null) {
      $result.overwrite = overwrite;
    }
    if (allowRequestWithoutCredential != null) {
      $result.allowRequestWithoutCredential = allowRequestWithoutCredential;
    }
    if (credential != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CredentialInjector', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.credential_injector.v3'), createEmptyInstance: create)
    ...
    ..aOB(2, _omitFieldNames ? '' : 'allowRequestWithoutCredential')
    ..aOM<$40.TypedExtensionConfig>(3, _omitFieldNames ? '' : 'credential', subBuilder: $40.TypedExtensionConfig.create)
  ...
  @$pb.TagNumber(2)
  $core.bool get allowRequestWithoutCredential => $_getBF(1);
  @$pb.TagNumber(2)
  set allowRequestWithoutCredential($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasAllowRequestWithoutCredential() => $_has(1);
  @$pb.TagNumber(2)
  void clearAllowRequestWithoutCredential() => clearField(2);

  /// The credential to inject into the proxied requests
  /// [#extension-category: envoy.http.injected_credentials]
  @$pb.TagNumber(3)
  $40.TypedExtensionConfig get credential => $_getN(2);
  @$pb.TagNumber(3)
  set credential($40.TypedExtensionConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCredential() => $_has(2);
  @$pb.TagNumber(3)
  void clearCredential() => clearField(3);
  @$pb.TagNumber(3)
  $40.TypedExtensionConfig ensureCredential() => $_ensure(2);
}
