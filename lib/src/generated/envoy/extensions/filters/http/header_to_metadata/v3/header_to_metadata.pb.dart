...
class Config_KeyValuePair extends $pb.GeneratedMessage {
  factory Config_KeyValuePair({
    ...
    $55.RegexMatchAndSubstitute? regexValueRewrite,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Config.KeyValuePair', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.header_to_metadata.v3'), createEmptyInstance: create)
    ...
    ..aOM<$55.RegexMatchAndSubstitute>(6, _omitFieldNames ? '' : 'regexValueRewrite', subBuilder: $55.RegexMatchAndSubstitute.create)
  ...
  @$pb.TagNumber(6)
  $55.RegexMatchAndSubstitute get regexValueRewrite => $_getN(5);
  @$pb.TagNumber(6)
  set regexValueRewrite($55.RegexMatchAndSubstitute v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasRegexValueRewrite() => $_has(5);
  @$pb.TagNumber(6)
  void clearRegexValueRewrite() => clearField(6);
  @$pb.TagNumber(6)
  $55.RegexMatchAndSubstitute ensureRegexValueRewrite() => $_ensure(5);
}
...
class Config_Rule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Config.Rule', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.header_to_metadata.v3'), createEmptyInstance: create)
...
class Config extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Config', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.header_to_metadata.v3'), createEmptyInstance: create)
