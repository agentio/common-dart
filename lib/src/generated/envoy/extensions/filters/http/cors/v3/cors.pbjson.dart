...
const CorsPolicy$json = {
  ...
  '2': [
    ...
    {'1': 'forward_not_matching_preflights', '3': 10, '4': 1, '5': 11, '6': '.google.protobuf.BoolValue', '10': 'forwardNotMatchingPreflights'},
  ],
};
...
final $typed_data.Uint8List corsPolicyDescriptor = $convert.base64Decode(
    ...
    'VmFsdWVSGWFsbG93UHJpdmF0ZU5ldHdvcmtBY2Nlc3MSYQofZm9yd2FyZF9ub3RfbWF0Y2hpbm'
    'dfcHJlZmxpZ2h0cxgKIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5Cb29sVmFsdWVSHGZvcndhcmRO'
    'b3RNYXRjaGluZ1ByZWZsaWdodHM=');
