...
class StatefulSession extends $pb.GeneratedMessage {
  factory StatefulSession({
    $40.TypedExtensionConfig? sessionState,
    $core.bool? strict,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StatefulSession', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.stateful_session.v3'), createEmptyInstance: create)
    ..aOM<$40.TypedExtensionConfig>(1, _omitFieldNames ? '' : 'sessionState', subBuilder: $40.TypedExtensionConfig.create)
  ...
  @$pb.TagNumber(1)
  $40.TypedExtensionConfig get sessionState => $_getN(0);
  @$pb.TagNumber(1)
  set sessionState($40.TypedExtensionConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSessionState() => $_has(0);
  @$pb.TagNumber(1)
  void clearSessionState() => clearField(1);
  @$pb.TagNumber(1)
  $40.TypedExtensionConfig ensureSessionState() => $_ensure(0);
