...
import '../../../../../config/ratelimit/v3/rls.pb.dart' as $184;
...
class RateLimit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimit', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.ratelimit.v3'), createEmptyInstance: create)
    ...
    ..aOM<$28.Duration>(4, _omitFieldNames ? '' : 'timeout', subBuilder: $28.Duration.create)
    ..aOB(5, _omitFieldNames ? '' : 'failureModeDeny')
    ..aOB(6, _omitFieldNames ? '' : 'rateLimitedAsResourceExhausted')
    ..aOM<$184.RateLimitServiceConfig>(7, _omitFieldNames ? '' : 'rateLimitService', subBuilder: $184.RateLimitServiceConfig.create)
    ...
    ..aOM<$160.HttpStatus>(10, _omitFieldNames ? '' : 'rateLimitedStatus', subBuilder: $160.HttpStatus.create)
    ..pc<$47.HeaderValueOption>(11, _omitFieldNames ? '' : 'responseHeadersToAdd', $pb.PbFieldType.PM, subBuilder: $47.HeaderValueOption.create)
    ..aOM<$160.HttpStatus>(12, _omitFieldNames ? '' : 'statusOnError', subBuilder: $160.HttpStatus.create)
  ...
  @$pb.TagNumber(4)
  $28.Duration get timeout => $_getN(3);
  @$pb.TagNumber(4)
  set timeout($28.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTimeout() => $_has(3);
  @$pb.TagNumber(4)
  void clearTimeout() => clearField(4);
  @$pb.TagNumber(4)
  $28.Duration ensureTimeout() => $_ensure(3);
  ...
  /// success.
  @$pb.TagNumber(7)
  $184.RateLimitServiceConfig get rateLimitService => $_getN(6);
  @$pb.TagNumber(7)
  set rateLimitService($184.RateLimitServiceConfig v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasRateLimitService() => $_has(6);
  @$pb.TagNumber(7)
  void clearRateLimitService() => clearField(7);
  @$pb.TagNumber(7)
  $184.RateLimitServiceConfig ensureRateLimitService() => $_ensure(6);
  ...
  @$pb.TagNumber(10)
  $160.HttpStatus get rateLimitedStatus => $_getN(9);
  @$pb.TagNumber(10)
  set rateLimitedStatus($160.HttpStatus v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasRateLimitedStatus() => $_has(9);
  @$pb.TagNumber(10)
  void clearRateLimitedStatus() => clearField(10);
  @$pb.TagNumber(10)
  $160.HttpStatus ensureRateLimitedStatus() => $_ensure(9);

  /// Specifies a list of HTTP headers that should be added to each response for requests that
  /// have been rate limited.
  @$pb.TagNumber(11)
  $core.List<$47.HeaderValueOption> get responseHeadersToAdd => $_getList(10);
  ...
  @$pb.TagNumber(12)
  $160.HttpStatus get statusOnError => $_getN(11);
  @$pb.TagNumber(12)
  set statusOnError($160.HttpStatus v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasStatusOnError() => $_has(11);
  @$pb.TagNumber(12)
  void clearStatusOnError() => clearField(12);
  @$pb.TagNumber(12)
  $160.HttpStatus ensureStatusOnError() => $_ensure(11);
...
class RateLimitConfig_Action_HeaderValueMatch extends $pb.GeneratedMessage {
  factory RateLimitConfig_Action_HeaderValueMatch({
    ...
    $core.Iterable<$66.HeaderMatcher>? headers,
  }) {
    final $result = create();
    if (descriptorValue != null) {
      $result.descriptorValue = descriptorValue;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimitConfig.Action.HeaderValueMatch', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.ratelimit.v3'), createEmptyInstance: create)
    ...
    ..pc<$66.HeaderMatcher>(3, _omitFieldNames ? '' : 'headers', $pb.PbFieldType.PM, subBuilder: $66.HeaderMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.List<$66.HeaderMatcher> get headers => $_getList(2);
}
...
class RateLimitConfig_Action extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(9)
  $40.TypedExtensionConfig get extension_9 => $_getN(7);
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(9)
  $40.TypedExtensionConfig ensureExtension_9() => $_ensure(7);
}
