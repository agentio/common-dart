...
class GradientControllerConfig_ConcurrencyLimitCalculationParams extends $pb.GeneratedMessage {
  factory GradientControllerConfig_ConcurrencyLimitCalculationParams({
    $26.UInt32Value? maxConcurrencyLimit,
    $28.Duration? concurrencyUpdateInterval,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GradientControllerConfig.ConcurrencyLimitCalculationParams', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.adaptive_concurrency.v3'), createEmptyInstance: create)
    ..aOM<$26.UInt32Value>(2, _omitFieldNames ? '' : 'maxConcurrencyLimit', subBuilder: $26.UInt32Value.create)
    ..aOM<$28.Duration>(3, _omitFieldNames ? '' : 'concurrencyUpdateInterval', subBuilder: $28.Duration.create)
  ...
  @$pb.TagNumber(2)
  $26.UInt32Value get maxConcurrencyLimit => $_getN(0);
  @$pb.TagNumber(2)
  set maxConcurrencyLimit($26.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMaxConcurrencyLimit() => $_has(0);
  @$pb.TagNumber(2)
  void clearMaxConcurrencyLimit() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt32Value ensureMaxConcurrencyLimit() => $_ensure(0);

  /// The period of time samples are taken to recalculate the concurrency limit.
  @$pb.TagNumber(3)
  $28.Duration get concurrencyUpdateInterval => $_getN(1);
  @$pb.TagNumber(3)
  set concurrencyUpdateInterval($28.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasConcurrencyUpdateInterval() => $_has(1);
  @$pb.TagNumber(3)
  void clearConcurrencyUpdateInterval() => clearField(3);
  @$pb.TagNumber(3)
  $28.Duration ensureConcurrencyUpdateInterval() => $_ensure(1);
}
...
class GradientControllerConfig_MinimumRTTCalculationParams extends $pb.GeneratedMessage {
  factory GradientControllerConfig_MinimumRTTCalculationParams({
    ...
    $26.UInt32Value? requestCount,
    $44.Percent? jitter,
    $26.UInt32Value? minConcurrency,
    $44.Percent? buffer,
  }) {
    final $result = create();
    if (interval != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GradientControllerConfig.MinimumRTTCalculationParams', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.adaptive_concurrency.v3'), createEmptyInstance: create)
    ..aOM<$28.Duration>(1, _omitFieldNames ? '' : 'interval', subBuilder: $28.Duration.create)
    ..aOM<$26.UInt32Value>(2, _omitFieldNames ? '' : 'requestCount', subBuilder: $26.UInt32Value.create)
    ..aOM<$44.Percent>(3, _omitFieldNames ? '' : 'jitter', subBuilder: $44.Percent.create)
    ..aOM<$26.UInt32Value>(4, _omitFieldNames ? '' : 'minConcurrency', subBuilder: $26.UInt32Value.create)
    ..aOM<$44.Percent>(5, _omitFieldNames ? '' : 'buffer', subBuilder: $44.Percent.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $26.UInt32Value get requestCount => $_getN(1);
  @$pb.TagNumber(2)
  set requestCount($26.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasRequestCount() => $_has(1);
  @$pb.TagNumber(2)
  void clearRequestCount() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt32Value ensureRequestCount() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $44.Percent get jitter => $_getN(2);
  @$pb.TagNumber(3)
  set jitter($44.Percent v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasJitter() => $_has(2);
  @$pb.TagNumber(3)
  void clearJitter() => clearField(3);
  @$pb.TagNumber(3)
  $44.Percent ensureJitter() => $_ensure(2);

  /// The concurrency limit set while measuring the minRTT. Defaults to 3.
  @$pb.TagNumber(4)
  $26.UInt32Value get minConcurrency => $_getN(3);
  @$pb.TagNumber(4)
  set minConcurrency($26.UInt32Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasMinConcurrency() => $_has(3);
  @$pb.TagNumber(4)
  void clearMinConcurrency() => clearField(4);
  @$pb.TagNumber(4)
  $26.UInt32Value ensureMinConcurrency() => $_ensure(3);
...
class GradientControllerConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GradientControllerConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.adaptive_concurrency.v3'), createEmptyInstance: create)
    ..aOM<$44.Percent>(1, _omitFieldNames ? '' : 'sampleAggregatePercentile', subBuilder: $44.Percent.create)
  ...
  @$pb.TagNumber(1)
  $44.Percent get sampleAggregatePercentile => $_getN(0);
  @$pb.TagNumber(1)
  set sampleAggregatePercentile($44.Percent v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSampleAggregatePercentile() => $_has(0);
  @$pb.TagNumber(1)
  void clearSampleAggregatePercentile() => clearField(1);
  @$pb.TagNumber(1)
  $44.Percent ensureSampleAggregatePercentile() => $_ensure(0);
...
class AdaptiveConcurrency extends $pb.GeneratedMessage {
  factory AdaptiveConcurrency({
    ...
    $160.HttpStatus? concurrencyLimitExceededStatus,
  }) {
    final $result = create();
    ...
    if (concurrencyLimitExceededStatus != null) {
      $result.concurrencyLimitExceededStatus = concurrencyLimitExceededStatus;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdaptiveConcurrency', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.adaptive_concurrency.v3'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<GradientControllerConfig>(1, _omitFieldNames ? '' : 'gradientControllerConfig', subBuilder: GradientControllerConfig.create)
    ..aOM<$47.RuntimeFeatureFlag>(2, _omitFieldNames ? '' : 'enabled', subBuilder: $47.RuntimeFeatureFlag.create)
    ..aOM<$160.HttpStatus>(3, _omitFieldNames ? '' : 'concurrencyLimitExceededStatus', subBuilder: $160.HttpStatus.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $47.RuntimeFeatureFlag get enabled => $_getN(1);
  @$pb.TagNumber(2)
  set enabled($47.RuntimeFeatureFlag v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasEnabled() => $_has(1);
  @$pb.TagNumber(2)
  void clearEnabled() => clearField(2);
  @$pb.TagNumber(2)
  $47.RuntimeFeatureFlag ensureEnabled() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $160.HttpStatus get concurrencyLimitExceededStatus => $_getN(2);
  @$pb.TagNumber(3)
  set concurrencyLimitExceededStatus($160.HttpStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasConcurrencyLimitExceededStatus() => $_has(2);
  @$pb.TagNumber(3)
  void clearConcurrencyLimitExceededStatus() => clearField(3);
  @$pb.TagNumber(3)
  $160.HttpStatus ensureConcurrencyLimitExceededStatus() => $_ensure(2);
}
