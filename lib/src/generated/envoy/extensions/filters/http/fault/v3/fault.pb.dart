...
import '../../../common/fault/v3/fault.pb.dart' as $187;
...
class FaultAbort extends $pb.GeneratedMessage {
  factory FaultAbort({
    $core.int? httpStatus,
    $44.FractionalPercent? percentage,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FaultAbort', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.fault.v3'), createEmptyInstance: create)
    ...
    ..aOM<$44.FractionalPercent>(3, _omitFieldNames ? '' : 'percentage', subBuilder: $44.FractionalPercent.create)
  ...
  /// provided.
  @$pb.TagNumber(3)
  $44.FractionalPercent get percentage => $_getN(1);
  @$pb.TagNumber(3)
  set percentage($44.FractionalPercent v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasPercentage() => $_has(1);
  @$pb.TagNumber(3)
  void clearPercentage() => clearField(3);
  @$pb.TagNumber(3)
  $44.FractionalPercent ensurePercentage() => $_ensure(1);
...
class HTTPFault extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HTTPFault', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.fault.v3'), createEmptyInstance: create)
    ..aOM<$187.FaultDelay>(1, _omitFieldNames ? '' : 'delay', subBuilder: $187.FaultDelay.create)
    ..aOM<FaultAbort>(2, _omitFieldNames ? '' : 'abort', subBuilder: FaultAbort.create)
    ..aOS(3, _omitFieldNames ? '' : 'upstreamCluster')
    ..pc<$66.HeaderMatcher>(4, _omitFieldNames ? '' : 'headers', $pb.PbFieldType.PM, subBuilder: $66.HeaderMatcher.create)
    ..pPS(5, _omitFieldNames ? '' : 'downstreamNodes')
    ..aOM<$26.UInt32Value>(6, _omitFieldNames ? '' : 'maxActiveFaults', subBuilder: $26.UInt32Value.create)
    ..aOM<$187.FaultRateLimit>(7, _omitFieldNames ? '' : 'responseRateLimit', subBuilder: $187.FaultRateLimit.create)
    ...
    ..aOM<$30.Struct>(16, _omitFieldNames ? '' : 'filterMetadata', subBuilder: $30.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  /// object.
  @$pb.TagNumber(1)
  $187.FaultDelay get delay => $_getN(0);
  @$pb.TagNumber(1)
  set delay($187.FaultDelay v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDelay() => $_has(0);
  @$pb.TagNumber(1)
  void clearDelay() => clearField(1);
  @$pb.TagNumber(1)
  $187.FaultDelay ensureDelay() => $_ensure(0);
  ...
  @$pb.TagNumber(4)
  $core.List<$66.HeaderMatcher> get headers => $_getList(3);
  ...
  @$pb.TagNumber(6)
  $26.UInt32Value get maxActiveFaults => $_getN(5);
  @$pb.TagNumber(6)
  set maxActiveFaults($26.UInt32Value v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasMaxActiveFaults() => $_has(5);
  @$pb.TagNumber(6)
  void clearMaxActiveFaults() => clearField(6);
  @$pb.TagNumber(6)
  $26.UInt32Value ensureMaxActiveFaults() => $_ensure(5);
  ...
  @$pb.TagNumber(7)
  $187.FaultRateLimit get responseRateLimit => $_getN(6);
  @$pb.TagNumber(7)
  set responseRateLimit($187.FaultRateLimit v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasResponseRateLimit() => $_has(6);
  @$pb.TagNumber(7)
  void clearResponseRateLimit() => clearField(7);
  @$pb.TagNumber(7)
  $187.FaultRateLimit ensureResponseRateLimit() => $_ensure(6);
  ...
  /// the fault filter.
  @$pb.TagNumber(16)
  $30.Struct get filterMetadata => $_getN(15);
  @$pb.TagNumber(16)
  set filterMetadata($30.Struct v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasFilterMetadata() => $_has(15);
  @$pb.TagNumber(16)
  void clearFilterMetadata() => clearField(16);
  @$pb.TagNumber(16)
  $30.Struct ensureFilterMetadata() => $_ensure(15);
}
