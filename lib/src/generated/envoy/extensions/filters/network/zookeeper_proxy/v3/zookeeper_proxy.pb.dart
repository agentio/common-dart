...
class ZooKeeperProxy extends $pb.GeneratedMessage {
  factory ZooKeeperProxy({
    ...
    $26.UInt32Value? maxPacketBytes,
    $core.bool? enableLatencyThresholdMetrics,
    $28.Duration? defaultLatencyThreshold,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ZooKeeperProxy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.zookeeper_proxy.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.UInt32Value>(3, _omitFieldNames ? '' : 'maxPacketBytes', subBuilder: $26.UInt32Value.create)
    ..aOB(4, _omitFieldNames ? '' : 'enableLatencyThresholdMetrics')
    ..aOM<$28.Duration>(5, _omitFieldNames ? '' : 'defaultLatencyThreshold', subBuilder: $28.Duration.create)
  ...
  @$pb.TagNumber(3)
  $26.UInt32Value get maxPacketBytes => $_getN(2);
  @$pb.TagNumber(3)
  set maxPacketBytes($26.UInt32Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMaxPacketBytes() => $_has(2);
  @$pb.TagNumber(3)
  void clearMaxPacketBytes() => clearField(3);
  @$pb.TagNumber(3)
  $26.UInt32Value ensureMaxPacketBytes() => $_ensure(2);
  ...
  @$pb.TagNumber(5)
  $28.Duration get defaultLatencyThreshold => $_getN(4);
  @$pb.TagNumber(5)
  set defaultLatencyThreshold($28.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDefaultLatencyThreshold() => $_has(4);
  @$pb.TagNumber(5)
  void clearDefaultLatencyThreshold() => clearField(5);
  @$pb.TagNumber(5)
  $28.Duration ensureDefaultLatencyThreshold() => $_ensure(4);
...
class LatencyThresholdOverride extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LatencyThresholdOverride', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.zookeeper_proxy.v3'), createEmptyInstance: create)
    ...
    ..aOM<$28.Duration>(2, _omitFieldNames ? '' : 'threshold', subBuilder: $28.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $28.Duration get threshold => $_getN(1);
  @$pb.TagNumber(2)
  set threshold($28.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasThreshold() => $_has(1);
  @$pb.TagNumber(2)
  void clearThreshold() => clearField(2);
  @$pb.TagNumber(2)
  $28.Duration ensureThreshold() => $_ensure(1);
}
