...
class Config extends $pb.GeneratedMessage {
  factory Config({
    $core.Iterable<$197.FilterStateValue>? onNewConnection,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Config', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.set_filter_state.v3'), createEmptyInstance: create)
    ..pc<$197.FilterStateValue>(1, _omitFieldNames ? '' : 'onNewConnection', $pb.PbFieldType.PM, subBuilder: $197.FilterStateValue.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$197.FilterStateValue> get onNewConnection => $_getList(0);
}
