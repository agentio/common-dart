...
class ExtAuthz extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExtAuthz', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.ext_authz.v3'), createEmptyInstance: create)
    ...
    ..e<$50.ApiVersion>(5, _omitFieldNames ? '' : 'transportApiVersion', $pb.PbFieldType.OE, defaultOrMaker: $50.ApiVersion.AUTO, valueOf: $50.ApiVersion.valueOf, enumValues: $50.ApiVersion.values)
    ..aOM<$62.MetadataMatcher>(6, _omitFieldNames ? '' : 'filterEnabledMetadata', subBuilder: $62.MetadataMatcher.create)
    ..aOS(7, _omitFieldNames ? '' : 'bootstrapMetadataLabelsKey')
    ..aOB(8, _omitFieldNames ? '' : 'includeTlsSession')
  ...
  @$pb.TagNumber(5)
  $50.ApiVersion get transportApiVersion => $_getN(4);
  @$pb.TagNumber(5)
  set transportApiVersion($50.ApiVersion v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  $62.MetadataMatcher get filterEnabledMetadata => $_getN(5);
  @$pb.TagNumber(6)
  set filterEnabledMetadata($62.MetadataMatcher v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasFilterEnabledMetadata() => $_has(5);
  @$pb.TagNumber(6)
  void clearFilterEnabledMetadata() => clearField(6);
  @$pb.TagNumber(6)
  $62.MetadataMatcher ensureFilterEnabledMetadata() => $_ensure(5);
  ...
  @$pb.TagNumber(8)
  $core.bool get includeTlsSession => $_getBF(7);
  @$pb.TagNumber(8)
  set includeTlsSession($core.bool v) { $_setBool(7, v); }
  @$pb.TagNumber(8)
  $core.bool hasIncludeTlsSession() => $_has(7);
  @$pb.TagNumber(8)
  void clearIncludeTlsSession() => clearField(8);
}
