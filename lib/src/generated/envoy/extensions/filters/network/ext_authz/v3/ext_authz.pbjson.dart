...
const ExtAuthz$json = {
  ...
  '2': [
    ...
    {'1': 'include_tls_session', '3': 8, '4': 1, '5': 8, '10': 'includeTlsSession'},
  ],
  '7': {},
};
...
final $typed_data.Uint8List extAuthzDescriptor = $convert.base64Decode(
    ...
    'ZWxzX2tleRgHIAEoCVIaYm9vdHN0cmFwTWV0YWRhdGFMYWJlbHNLZXkSLgoTaW5jbHVkZV90bH'
    'Nfc2Vzc2lvbhgIIAEoCFIRaW5jbHVkZVRsc1Nlc3Npb246OJrFiB4zCjFlbnZveS5jb25maWcu'
    'ZmlsdGVyLm5ldHdvcmsuZXh0X2F1dGh6LnYyLkV4dEF1dGh6');
