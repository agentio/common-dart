...
import '../../../../../type/v3/hash_policy.pb.dart' as $199;
...
class TcpProxy_TunnelingConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TcpProxy.TunnelingConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.tcp_proxy.v3'), createEmptyInstance: create)
    ...
    ..pc<$47.HeaderValueOption>(3, _omitFieldNames ? '' : 'headersToAdd', $pb.PbFieldType.PM, subBuilder: $47.HeaderValueOption.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$47.HeaderValueOption> get headersToAdd => $_getList(2);
...
class TcpProxy_OnDemand extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TcpProxy.OnDemand', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.tcp_proxy.v3'), createEmptyInstance: create)
    ..aOM<$50.ConfigSource>(1, _omitFieldNames ? '' : 'odcdsConfig', subBuilder: $50.ConfigSource.create)
  ...
  @$pb.TagNumber(1)
  $50.ConfigSource get odcdsConfig => $_getN(0);
  @$pb.TagNumber(1)
  set odcdsConfig($50.ConfigSource v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasOdcdsConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearOdcdsConfig() => clearField(1);
  @$pb.TagNumber(1)
  $50.ConfigSource ensureOdcdsConfig() => $_ensure(0);
...
class TcpProxy extends $pb.GeneratedMessage {
  factory TcpProxy({
    ...
    $core.String? cluster,
    $28.Duration? downstreamIdleTimeout,
    $28.Duration? upstreamIdleTimeout,
    ...
    $core.Iterable<$199.HashPolicy>? hashPolicy,
    TcpProxy_TunnelingConfig? tunnelingConfig,
    $28.Duration? maxDownstreamConnectionDuration,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TcpProxy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.tcp_proxy.v3'), createEmptyInstance: create)
    ...
    ..aOM<$28.Duration>(3, _omitFieldNames ? '' : 'downstreamIdleTimeout', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(4, _omitFieldNames ? '' : 'upstreamIdleTimeout', subBuilder: $28.Duration.create)
    ..pc<$72.AccessLog>(5, _omitFieldNames ? '' : 'accessLog', $pb.PbFieldType.PM, subBuilder: $72.AccessLog.create)
    ..aOM<$26.UInt32Value>(7, _omitFieldNames ? '' : 'maxConnectAttempts', subBuilder: $26.UInt32Value.create)
    ..aOM<$28.Duration>(8, _omitFieldNames ? '' : 'idleTimeout', subBuilder: $28.Duration.create)
    ..aOM<$47.Metadata>(9, _omitFieldNames ? '' : 'metadataMatch', subBuilder: $47.Metadata.create)
    ..aOM<TcpProxy_WeightedCluster>(10, _omitFieldNames ? '' : 'weightedClusters', subBuilder: TcpProxy_WeightedCluster.create)
    ..pc<$199.HashPolicy>(11, _omitFieldNames ? '' : 'hashPolicy', $pb.PbFieldType.PM, subBuilder: $199.HashPolicy.create)
    ..aOM<TcpProxy_TunnelingConfig>(12, _omitFieldNames ? '' : 'tunnelingConfig', subBuilder: TcpProxy_TunnelingConfig.create)
    ..aOM<$28.Duration>(13, _omitFieldNames ? '' : 'maxDownstreamConnectionDuration', subBuilder: $28.Duration.create)
    ..aOM<TcpProxy_OnDemand>(14, _omitFieldNames ? '' : 'onDemand', subBuilder: TcpProxy_OnDemand.create)
    ..aOM<$28.Duration>(15, _omitFieldNames ? '' : 'accessLogFlushInterval', subBuilder: $28.Duration.create)
  ...
  @$pb.TagNumber(3)
  $28.Duration get downstreamIdleTimeout => $_getN(2);
  @$pb.TagNumber(3)
  set downstreamIdleTimeout($28.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasDownstreamIdleTimeout() => $_has(2);
  @$pb.TagNumber(3)
  void clearDownstreamIdleTimeout() => clearField(3);
  @$pb.TagNumber(3)
  $28.Duration ensureDownstreamIdleTimeout() => $_ensure(2);

  /// [#not-implemented-hide:]
  @$pb.TagNumber(4)
  $28.Duration get upstreamIdleTimeout => $_getN(3);
  @$pb.TagNumber(4)
  set upstreamIdleTimeout($28.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasUpstreamIdleTimeout() => $_has(3);
  @$pb.TagNumber(4)
  void clearUpstreamIdleTimeout() => clearField(4);
  @$pb.TagNumber(4)
  $28.Duration ensureUpstreamIdleTimeout() => $_ensure(3);
  ...
  @$pb.TagNumber(7)
  $26.UInt32Value get maxConnectAttempts => $_getN(5);
  @$pb.TagNumber(7)
  set maxConnectAttempts($26.UInt32Value v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasMaxConnectAttempts() => $_has(5);
  @$pb.TagNumber(7)
  void clearMaxConnectAttempts() => clearField(7);
  @$pb.TagNumber(7)
  $26.UInt32Value ensureMaxConnectAttempts() => $_ensure(5);
  ...
  ///    FIN packets, etc.
  @$pb.TagNumber(8)
  $28.Duration get idleTimeout => $_getN(6);
  @$pb.TagNumber(8)
  set idleTimeout($28.Duration v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasIdleTimeout() => $_has(6);
  @$pb.TagNumber(8)
  void clearIdleTimeout() => clearField(8);
  @$pb.TagNumber(8)
  $28.Duration ensureIdleTimeout() => $_ensure(6);

  /// Optional endpoint metadata match criteria. Only endpoints in the upstream
  /// cluster with metadata matching that set in metadata_match will be
  /// considered. The filter name should be specified as ``envoy.lb``.
  @$pb.TagNumber(9)
  $47.Metadata get metadataMatch => $_getN(7);
  @$pb.TagNumber(9)
  set metadataMatch($47.Metadata v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasMetadataMatch() => $_has(7);
  @$pb.TagNumber(9)
  void clearMetadataMatch() => clearField(9);
  @$pb.TagNumber(9)
  $47.Metadata ensureMetadataMatch() => $_ensure(7);
  ...
  /// limited to 1.
  @$pb.TagNumber(11)
  $core.List<$199.HashPolicy> get hashPolicy => $_getList(9);
  ...
  @$pb.TagNumber(13)
  $28.Duration get maxDownstreamConnectionDuration => $_getN(11);
  @$pb.TagNumber(13)
  set maxDownstreamConnectionDuration($28.Duration v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasMaxDownstreamConnectionDuration() => $_has(11);
  @$pb.TagNumber(13)
  void clearMaxDownstreamConnectionDuration() => clearField(13);
  @$pb.TagNumber(13)
  $28.Duration ensureMaxDownstreamConnectionDuration() => $_ensure(11);
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(15)
  $28.Duration get accessLogFlushInterval => $_getN(13);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(15)
  set accessLogFlushInterval($28.Duration v) { setField(15, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(15)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(15)
  $28.Duration ensureAccessLogFlushInterval() => $_ensure(13);
