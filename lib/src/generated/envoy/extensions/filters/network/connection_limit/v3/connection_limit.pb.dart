...
class ConnectionLimit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConnectionLimit', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.connection_limit.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.UInt64Value>(2, _omitFieldNames ? '' : 'maxConnections', subBuilder: $26.UInt64Value.create)
    ..aOM<$28.Duration>(3, _omitFieldNames ? '' : 'delay', subBuilder: $28.Duration.create)
    ..aOM<$47.RuntimeFeatureFlag>(4, _omitFieldNames ? '' : 'runtimeEnabled', subBuilder: $47.RuntimeFeatureFlag.create)
  ...
  @$pb.TagNumber(2)
  $26.UInt64Value get maxConnections => $_getN(1);
  @$pb.TagNumber(2)
  set maxConnections($26.UInt64Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMaxConnections() => $_has(1);
  @$pb.TagNumber(2)
  void clearMaxConnections() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt64Value ensureMaxConnections() => $_ensure(1);
  ...
  /// to enabled.
  @$pb.TagNumber(4)
  $47.RuntimeFeatureFlag get runtimeEnabled => $_getN(3);
  @$pb.TagNumber(4)
  set runtimeEnabled($47.RuntimeFeatureFlag v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasRuntimeEnabled() => $_has(3);
  @$pb.TagNumber(4)
  void clearRuntimeEnabled() => clearField(4);
  @$pb.TagNumber(4)
  $47.RuntimeFeatureFlag ensureRuntimeEnabled() => $_ensure(3);
}
