...
class ThriftProxy extends $pb.GeneratedMessage {
  factory ThriftProxy({
    ...
    $188.RouteConfiguration? routeConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ThriftProxy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.thrift_proxy.v3'), createEmptyInstance: create)
    ...
    ..aOM<$188.RouteConfiguration>(4, _omitFieldNames ? '' : 'routeConfig', subBuilder: $188.RouteConfiguration.create)
    ...
    ..aOM<$26.UInt32Value>(7, _omitFieldNames ? '' : 'maxRequestsPerConnection', subBuilder: $26.UInt32Value.create)
    ..aOM<Trds>(8, _omitFieldNames ? '' : 'trds', subBuilder: Trds.create)
    ..pc<$72.AccessLog>(9, _omitFieldNames ? '' : 'accessLog', $pb.PbFieldType.PM, subBuilder: $72.AccessLog.create)
  ...
  @$pb.TagNumber(4)
  $188.RouteConfiguration get routeConfig => $_getN(3);
  @$pb.TagNumber(4)
  set routeConfig($188.RouteConfiguration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasRouteConfig() => $_has(3);
  @$pb.TagNumber(4)
  void clearRouteConfig() => clearField(4);
  @$pb.TagNumber(4)
  $188.RouteConfiguration ensureRouteConfig() => $_ensure(3);
  ...
  @$pb.TagNumber(7)
  $26.UInt32Value get maxRequestsPerConnection => $_getN(6);
  @$pb.TagNumber(7)
  set maxRequestsPerConnection($26.UInt32Value v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasMaxRequestsPerConnection() => $_has(6);
  @$pb.TagNumber(7)
  void clearMaxRequestsPerConnection() => clearField(7);
  @$pb.TagNumber(7)
  $26.UInt32Value ensureMaxRequestsPerConnection() => $_ensure(6);
  ...
  @$pb.TagNumber(9)
  $core.List<$72.AccessLog> get accessLog => $_getList(8);
