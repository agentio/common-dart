...
class RateLimit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimit', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.thrift_proxy.filters.ratelimit.v3'), createEmptyInstance: create)
    ...
    ..aOM<$184.RateLimitServiceConfig>(5, _omitFieldNames ? '' : 'rateLimitService', subBuilder: $184.RateLimitServiceConfig.create)
  ...
  /// success.
  @$pb.TagNumber(5)
  $184.RateLimitServiceConfig get rateLimitService => $_getN(4);
  @$pb.TagNumber(5)
  set rateLimitService($184.RateLimitServiceConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasRateLimitService() => $_has(4);
  @$pb.TagNumber(5)
  void clearRateLimitService() => clearField(5);
  @$pb.TagNumber(5)
  $184.RateLimitServiceConfig ensureRateLimitService() => $_ensure(4);
}
