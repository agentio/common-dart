...
class KeyValueMatchEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeyValueMatchEntry', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.generic_proxy.matcher.v3'), createEmptyInstance: create)
    ...
    ..aOM<$58.StringMatcher>(2, _omitFieldNames ? '' : 'stringMatch', subBuilder: $58.StringMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set stringMatch($58.StringMatcher v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class RequestMatcher extends $pb.GeneratedMessage {
  factory RequestMatcher({
    $58.StringMatcher? host,
    $58.StringMatcher? path,
    $58.StringMatcher? method,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RequestMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.generic_proxy.matcher.v3'), createEmptyInstance: create)
    ..aOM<$58.StringMatcher>(1, _omitFieldNames ? '' : 'host', subBuilder: $58.StringMatcher.create)
    ..aOM<$58.StringMatcher>(2, _omitFieldNames ? '' : 'path', subBuilder: $58.StringMatcher.create)
    ..aOM<$58.StringMatcher>(3, _omitFieldNames ? '' : 'method', subBuilder: $58.StringMatcher.create)
  ...
  @$pb.TagNumber(1)
  $58.StringMatcher get host => $_getN(0);
  @$pb.TagNumber(1)
  set host($58.StringMatcher v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasHost() => $_has(0);
  @$pb.TagNumber(1)
  void clearHost() => clearField(1);
  @$pb.TagNumber(1)
  $58.StringMatcher ensureHost() => $_ensure(0);

  /// Optional path pattern to match on. If not specified, any path will match.
  @$pb.TagNumber(2)
  $58.StringMatcher get path => $_getN(1);
  @$pb.TagNumber(2)
  set path($58.StringMatcher v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPath() => $_has(1);
  @$pb.TagNumber(2)
  void clearPath() => clearField(2);
  @$pb.TagNumber(2)
  $58.StringMatcher ensurePath() => $_ensure(1);

  /// Optional method pattern to match on. If not specified, any method will match.
  @$pb.TagNumber(3)
  $58.StringMatcher get method => $_getN(2);
  @$pb.TagNumber(3)
  set method($58.StringMatcher v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMethod() => $_has(2);
  @$pb.TagNumber(3)
  void clearMethod() => clearField(3);
  @$pb.TagNumber(3)
  $58.StringMatcher ensureMethod() => $_ensure(2);
