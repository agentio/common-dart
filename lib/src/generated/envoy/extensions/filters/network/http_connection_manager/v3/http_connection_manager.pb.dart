...
import '../../../../../config/core/v3/substitution_format_string.pb.dart' as $181;
import '../../../../../config/route/v3/route.pb.dart' as $140;
import '../../../../../config/route/v3/scoped_route.pb.dart' as $193;
import '../../../../../config/trace/v3/http_tracer.pb.dart' as $112;
import '../../../../../type/http/v3/path_transformation.pb.dart' as $192;
...
class HttpConnectionManager_Tracing extends $pb.GeneratedMessage {
  factory HttpConnectionManager_Tracing({
    $44.Percent? clientSampling,
    $44.Percent? randomSampling,
    $44.Percent? overallSampling,
    $core.bool? verbose,
    $26.UInt32Value? maxPathTagLength,
    $core.Iterable<$64.CustomTag>? customTags,
    $112.Tracing_Http? provider,
    $26.BoolValue? spawnUpstreamSpan,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpConnectionManager.Tracing', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.http_connection_manager.v3'), createEmptyInstance: create)
    ..aOM<$44.Percent>(3, _omitFieldNames ? '' : 'clientSampling', subBuilder: $44.Percent.create)
    ..aOM<$44.Percent>(4, _omitFieldNames ? '' : 'randomSampling', subBuilder: $44.Percent.create)
    ..aOM<$44.Percent>(5, _omitFieldNames ? '' : 'overallSampling', subBuilder: $44.Percent.create)
    ..aOB(6, _omitFieldNames ? '' : 'verbose')
    ..aOM<$26.UInt32Value>(7, _omitFieldNames ? '' : 'maxPathTagLength', subBuilder: $26.UInt32Value.create)
    ..pc<$64.CustomTag>(8, _omitFieldNames ? '' : 'customTags', $pb.PbFieldType.PM, subBuilder: $64.CustomTag.create)
    ..aOM<$112.Tracing_Http>(9, _omitFieldNames ? '' : 'provider', subBuilder: $112.Tracing_Http.create)
    ..aOM<$26.BoolValue>(10, _omitFieldNames ? '' : 'spawnUpstreamSpan', subBuilder: $26.BoolValue.create)
  ...
  /// Default: 100%
  @$pb.TagNumber(3)
  $44.Percent get clientSampling => $_getN(0);
  @$pb.TagNumber(3)
  set clientSampling($44.Percent v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasClientSampling() => $_has(0);
  @$pb.TagNumber(3)
  void clearClientSampling() => clearField(3);
  @$pb.TagNumber(3)
  $44.Percent ensureClientSampling() => $_ensure(0);
  ...
  /// Default: 100%
  @$pb.TagNumber(4)
  $44.Percent get randomSampling => $_getN(1);
  @$pb.TagNumber(4)
  set randomSampling($44.Percent v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasRandomSampling() => $_has(1);
  @$pb.TagNumber(4)
  void clearRandomSampling() => clearField(4);
  @$pb.TagNumber(4)
  $44.Percent ensureRandomSampling() => $_ensure(1);
  ...
  /// Default: 100%
  @$pb.TagNumber(5)
  $44.Percent get overallSampling => $_getN(2);
  @$pb.TagNumber(5)
  set overallSampling($44.Percent v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasOverallSampling() => $_has(2);
  @$pb.TagNumber(5)
  void clearOverallSampling() => clearField(5);
  @$pb.TagNumber(5)
  $44.Percent ensureOverallSampling() => $_ensure(2);
  ...
  /// Default: 256
  @$pb.TagNumber(7)
  $26.UInt32Value get maxPathTagLength => $_getN(4);
  @$pb.TagNumber(7)
  set maxPathTagLength($26.UInt32Value v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasMaxPathTagLength() => $_has(4);
  @$pb.TagNumber(7)
  void clearMaxPathTagLength() => clearField(7);
  @$pb.TagNumber(7)
  $26.UInt32Value ensureMaxPathTagLength() => $_ensure(4);

  /// A list of custom tags with unique tag name to create tags for the active span.
  @$pb.TagNumber(8)
  $core.List<$64.CustomTag> get customTags => $_getList(5);
  ...
  ///    on OpenCensus side.
  @$pb.TagNumber(9)
  $112.Tracing_Http get provider => $_getN(6);
  @$pb.TagNumber(9)
  set provider($112.Tracing_Http v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasProvider() => $_has(6);
  @$pb.TagNumber(9)
  void clearProvider() => clearField(9);
  @$pb.TagNumber(9)
  $112.Tracing_Http ensureProvider() => $_ensure(6);
  ...
  @$pb.TagNumber(10)
  $26.BoolValue get spawnUpstreamSpan => $_getN(7);
  @$pb.TagNumber(10)
  set spawnUpstreamSpan($26.BoolValue v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasSpawnUpstreamSpan() => $_has(7);
  @$pb.TagNumber(10)
  void clearSpawnUpstreamSpan() => clearField(10);
  @$pb.TagNumber(10)
  $26.BoolValue ensureSpawnUpstreamSpan() => $_ensure(7);
}
...
class HttpConnectionManager_InternalAddressConfig extends $pb.GeneratedMessage {
  factory HttpConnectionManager_InternalAddressConfig({
    ...
    $core.Iterable<$42.CidrRange>? cidrRanges,
  }) {
    final $result = create();
    if (unixSockets != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpConnectionManager.InternalAddressConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.http_connection_manager.v3'), createEmptyInstance: create)
    ...
    ..pc<$42.CidrRange>(2, _omitFieldNames ? '' : 'cidrRanges', $pb.PbFieldType.PM, subBuilder: $42.CidrRange.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$42.CidrRange> get cidrRanges => $_getList(1);
}
...
class HttpConnectionManager_SetCurrentClientCertDetails extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpConnectionManager.SetCurrentClientCertDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.http_connection_manager.v3'), createEmptyInstance: create)
    ..aOM<$26.BoolValue>(1, _omitFieldNames ? '' : 'subject', subBuilder: $26.BoolValue.create)
  ...
  @$pb.TagNumber(1)
  $26.BoolValue get subject => $_getN(0);
  @$pb.TagNumber(1)
  set subject($26.BoolValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSubject() => $_has(0);
  @$pb.TagNumber(1)
  void clearSubject() => clearField(1);
  @$pb.TagNumber(1)
  $26.BoolValue ensureSubject() => $_ensure(0);
...
class HttpConnectionManager_UpgradeConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpConnectionManager.UpgradeConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.http_connection_manager.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.BoolValue>(3, _omitFieldNames ? '' : 'enabled', subBuilder: $26.BoolValue.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $26.BoolValue get enabled => $_getN(2);
  @$pb.TagNumber(3)
  set enabled($26.BoolValue v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasEnabled() => $_has(2);
  @$pb.TagNumber(3)
  void clearEnabled() => clearField(3);
  @$pb.TagNumber(3)
  $26.BoolValue ensureEnabled() => $_ensure(2);
}
...
class HttpConnectionManager_PathNormalizationOptions extends $pb.GeneratedMessage {
  factory HttpConnectionManager_PathNormalizationOptions({
    $192.PathTransformation? forwardingTransformation,
    $192.PathTransformation? httpFilterTransformation,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpConnectionManager.PathNormalizationOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.http_connection_manager.v3'), createEmptyInstance: create)
    ..aOM<$192.PathTransformation>(1, _omitFieldNames ? '' : 'forwardingTransformation', subBuilder: $192.PathTransformation.create)
    ..aOM<$192.PathTransformation>(2, _omitFieldNames ? '' : 'httpFilterTransformation', subBuilder: $192.PathTransformation.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $192.PathTransformation get forwardingTransformation => $_getN(0);
  @$pb.TagNumber(1)
  set forwardingTransformation($192.PathTransformation v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasForwardingTransformation() => $_has(0);
  @$pb.TagNumber(1)
  void clearForwardingTransformation() => clearField(1);
  @$pb.TagNumber(1)
  $192.PathTransformation ensureForwardingTransformation() => $_ensure(0);
  ...
  /// normalization due to disallowed characters.)
  @$pb.TagNumber(2)
  $192.PathTransformation get httpFilterTransformation => $_getN(1);
  @$pb.TagNumber(2)
  set httpFilterTransformation($192.PathTransformation v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasHttpFilterTransformation() => $_has(1);
  @$pb.TagNumber(2)
  void clearHttpFilterTransformation() => clearField(2);
  @$pb.TagNumber(2)
  $192.PathTransformation ensureHttpFilterTransformation() => $_ensure(1);
}
...
class HttpConnectionManager_HcmAccessLogOptions extends $pb.GeneratedMessage {
  factory HttpConnectionManager_HcmAccessLogOptions({
    $28.Duration? accessLogFlushInterval,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpConnectionManager.HcmAccessLogOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.http_connection_manager.v3'), createEmptyInstance: create)
    ..aOM<$28.Duration>(1, _omitFieldNames ? '' : 'accessLogFlushInterval', subBuilder: $28.Duration.create)
  ...
  @$pb.TagNumber(1)
  $28.Duration get accessLogFlushInterval => $_getN(0);
  @$pb.TagNumber(1)
  set accessLogFlushInterval($28.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAccessLogFlushInterval() => $_has(0);
  @$pb.TagNumber(1)
  void clearAccessLogFlushInterval() => clearField(1);
  @$pb.TagNumber(1)
  $28.Duration ensureAccessLogFlushInterval() => $_ensure(0);
...
class HttpConnectionManager extends $pb.GeneratedMessage {
  factory HttpConnectionManager({
    ...
    Rds? rds,
    $140.RouteConfiguration? routeConfig,
    $core.Iterable<HttpFilter>? httpFilters,
    $26.BoolValue? addUserAgent,
    ...
    $28.Duration? drainTimeout,
    $core.Iterable<$72.AccessLog>? accessLog,
    $26.BoolValue? useRemoteAddress,
    $26.BoolValue? generateRequestId,
    ...
    $28.Duration? streamIdleTimeout,
    HttpConnectionManager_InternalAddressConfig? internalAddressConfig,
    $28.Duration? delayedCloseTimeout,
    $28.Duration? requestTimeout,
    $26.UInt32Value? maxRequestHeadersKb,
    $26.BoolValue? normalizePath,
    ...
    $26.BoolValue? streamErrorOnInvalidHttpMessage,
    $28.Duration? requestHeadersTimeout,
    $core.bool? stripAnyHostPort,
    HttpConnectionManager_PathNormalizationOptions? pathNormalizationOptions,
    $51.Http3ProtocolOptions? http3ProtocolOptions,
    HttpConnectionManager_PathWithEscapedSlashesAction? pathWithEscapedSlashesAction,
    $core.Iterable<$40.TypedExtensionConfig>? originalIpDetectionExtensions,
    $core.bool? stripTrailingHostDot,
    $51.SchemeHeaderTransformation? schemeHeaderTransformation,
    HttpConnectionManager_ProxyStatusConfig? proxyStatusConfig,
    $40.TypedExtensionConfig? typedHeaderValidationConfig,
    $core.bool? appendXForwardedPort,
    $core.Iterable<$40.TypedExtensionConfig>? earlyHeaderMutationExtensions,
    $26.BoolValue? addProxyProtocolConnectionState,
  @$core.Deprecated('This field is deprecated.')
    $28.Duration? accessLogFlushInterval,
  @$core.Deprecated('This field is deprecated.')
    $core.bool? flushAccessLogOnNewRequest,
    HttpConnectionManager_HcmAccessLogOptions? accessLogOptions,
    $core.bool? appendLocalOverload,
    $core.bool? http1SafeMaxConnectionDuration,
  }) {
    final $result = create();
    if (codecType != null) {
    ...
    if (appendLocalOverload != null) {
      $result.appendLocalOverload = appendLocalOverload;
    }
    if (http1SafeMaxConnectionDuration != null) {
      $result.http1SafeMaxConnectionDuration = http1SafeMaxConnectionDuration;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpConnectionManager', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.http_connection_manager.v3'), createEmptyInstance: create)
    ...
    ..aOM<$140.RouteConfiguration>(4, _omitFieldNames ? '' : 'routeConfig', subBuilder: $140.RouteConfiguration.create)
    ..pc<HttpFilter>(5, _omitFieldNames ? '' : 'httpFilters', $pb.PbFieldType.PM, subBuilder: HttpFilter.create)
    ..aOM<$26.BoolValue>(6, _omitFieldNames ? '' : 'addUserAgent', subBuilder: $26.BoolValue.create)
    ..aOM<HttpConnectionManager_Tracing>(7, _omitFieldNames ? '' : 'tracing', subBuilder: HttpConnectionManager_Tracing.create)
    ..aOM<$51.Http1ProtocolOptions>(8, _omitFieldNames ? '' : 'httpProtocolOptions', subBuilder: $51.Http1ProtocolOptions.create)
    ..aOM<$51.Http2ProtocolOptions>(9, _omitFieldNames ? '' : 'http2ProtocolOptions', subBuilder: $51.Http2ProtocolOptions.create)
    ..aOS(10, _omitFieldNames ? '' : 'serverName')
    ..aOM<$28.Duration>(12, _omitFieldNames ? '' : 'drainTimeout', subBuilder: $28.Duration.create)
    ..pc<$72.AccessLog>(13, _omitFieldNames ? '' : 'accessLog', $pb.PbFieldType.PM, subBuilder: $72.AccessLog.create)
    ..aOM<$26.BoolValue>(14, _omitFieldNames ? '' : 'useRemoteAddress', subBuilder: $26.BoolValue.create)
    ..aOM<$26.BoolValue>(15, _omitFieldNames ? '' : 'generateRequestId', subBuilder: $26.BoolValue.create)
    ...
    ..aOM<$28.Duration>(24, _omitFieldNames ? '' : 'streamIdleTimeout', subBuilder: $28.Duration.create)
    ...
    ..aOM<$28.Duration>(26, _omitFieldNames ? '' : 'delayedCloseTimeout', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(28, _omitFieldNames ? '' : 'requestTimeout', subBuilder: $28.Duration.create)
    ..aOM<$26.UInt32Value>(29, _omitFieldNames ? '' : 'maxRequestHeadersKb', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.BoolValue>(30, _omitFieldNames ? '' : 'normalizePath', subBuilder: $26.BoolValue.create)
    ...
    ..aOM<$51.HttpProtocolOptions>(35, _omitFieldNames ? '' : 'commonHttpProtocolOptions', subBuilder: $51.HttpProtocolOptions.create)
    ...
    ..aOM<$26.BoolValue>(40, _omitFieldNames ? '' : 'streamErrorOnInvalidHttpMessage', subBuilder: $26.BoolValue.create)
    ..aOM<$28.Duration>(41, _omitFieldNames ? '' : 'requestHeadersTimeout', subBuilder: $28.Duration.create)
    ...
    ..aOM<$51.Http3ProtocolOptions>(44, _omitFieldNames ? '' : 'http3ProtocolOptions', subBuilder: $51.Http3ProtocolOptions.create)
    ...
    ..pc<$40.TypedExtensionConfig>(46, _omitFieldNames ? '' : 'originalIpDetectionExtensions', $pb.PbFieldType.PM, subBuilder: $40.TypedExtensionConfig.create)
    ..aOB(47, _omitFieldNames ? '' : 'stripTrailingHostDot')
    ..aOM<$51.SchemeHeaderTransformation>(48, _omitFieldNames ? '' : 'schemeHeaderTransformation', subBuilder: $51.SchemeHeaderTransformation.create)
    ...
    ..aOM<$40.TypedExtensionConfig>(50, _omitFieldNames ? '' : 'typedHeaderValidationConfig', subBuilder: $40.TypedExtensionConfig.create)
    ..aOB(51, _omitFieldNames ? '' : 'appendXForwardedPort')
    ..pc<$40.TypedExtensionConfig>(52, _omitFieldNames ? '' : 'earlyHeaderMutationExtensions', $pb.PbFieldType.PM, subBuilder: $40.TypedExtensionConfig.create)
    ..aOM<$26.BoolValue>(53, _omitFieldNames ? '' : 'addProxyProtocolConnectionState', subBuilder: $26.BoolValue.create)
    ..aOM<$28.Duration>(54, _omitFieldNames ? '' : 'accessLogFlushInterval', subBuilder: $28.Duration.create)
    ...
    ..aOB(57, _omitFieldNames ? '' : 'appendLocalOverload')
    ..aOB(58, _omitFieldNames ? '' : 'http1SafeMaxConnectionDuration')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $140.RouteConfiguration get routeConfig => $_getN(3);
  @$pb.TagNumber(4)
  set routeConfig($140.RouteConfiguration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasRouteConfig() => $_has(3);
  @$pb.TagNumber(4)
  void clearRouteConfig() => clearField(4);
  @$pb.TagNumber(4)
  $140.RouteConfiguration ensureRouteConfig() => $_ensure(3);
  ...
  @$pb.TagNumber(6)
  $26.BoolValue get addUserAgent => $_getN(5);
  @$pb.TagNumber(6)
  set addUserAgent($26.BoolValue v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasAddUserAgent() => $_has(5);
  @$pb.TagNumber(6)
  void clearAddUserAgent() => clearField(6);
  @$pb.TagNumber(6)
  $26.BoolValue ensureAddUserAgent() => $_ensure(5);
  ...
  @$pb.TagNumber(8)
  $51.Http1ProtocolOptions get httpProtocolOptions => $_getN(7);
  @$pb.TagNumber(8)
  set httpProtocolOptions($51.Http1ProtocolOptions v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasHttpProtocolOptions() => $_has(7);
  @$pb.TagNumber(8)
  void clearHttpProtocolOptions() => clearField(8);
  @$pb.TagNumber(8)
  $51.Http1ProtocolOptions ensureHttpProtocolOptions() => $_ensure(7);

  /// Additional HTTP/2 settings that are passed directly to the HTTP/2 codec.
  @$pb.TagNumber(9)
  $51.Http2ProtocolOptions get http2ProtocolOptions => $_getN(8);
  @$pb.TagNumber(9)
  set http2ProtocolOptions($51.Http2ProtocolOptions v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasHttp2ProtocolOptions() => $_has(8);
  @$pb.TagNumber(9)
  void clearHttp2ProtocolOptions() => clearField(9);
  @$pb.TagNumber(9)
  $51.Http2ProtocolOptions ensureHttp2ProtocolOptions() => $_ensure(8);
  ...
  @$pb.TagNumber(12)
  $28.Duration get drainTimeout => $_getN(10);
  @$pb.TagNumber(12)
  set drainTimeout($28.Duration v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasDrainTimeout() => $_has(10);
  @$pb.TagNumber(12)
  void clearDrainTimeout() => clearField(12);
  @$pb.TagNumber(12)
  $28.Duration ensureDrainTimeout() => $_ensure(10);

  /// Configuration for :ref:`HTTP access logs <arch_overview_access_logs>`
  /// emitted by the connection manager.
  @$pb.TagNumber(13)
  $core.List<$72.AccessLog> get accessLog => $_getList(11);
  ...
  @$pb.TagNumber(14)
  $26.BoolValue get useRemoteAddress => $_getN(12);
  @$pb.TagNumber(14)
  set useRemoteAddress($26.BoolValue v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasUseRemoteAddress() => $_has(12);
  @$pb.TagNumber(14)
  void clearUseRemoteAddress() => clearField(14);
  @$pb.TagNumber(14)
  $26.BoolValue ensureUseRemoteAddress() => $_ensure(12);
  ...
  @$pb.TagNumber(15)
  $26.BoolValue get generateRequestId => $_getN(13);
  @$pb.TagNumber(15)
  set generateRequestId($26.BoolValue v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasGenerateRequestId() => $_has(13);
  @$pb.TagNumber(15)
  void clearGenerateRequestId() => clearField(15);
  @$pb.TagNumber(15)
  $26.BoolValue ensureGenerateRequestId() => $_ensure(13);
  ...
  @$pb.TagNumber(24)
  $28.Duration get streamIdleTimeout => $_getN(22);
  @$pb.TagNumber(24)
  set streamIdleTimeout($28.Duration v) { setField(24, v); }
  @$pb.TagNumber(24)
  $core.bool hasStreamIdleTimeout() => $_has(22);
  @$pb.TagNumber(24)
  void clearStreamIdleTimeout() => clearField(24);
  @$pb.TagNumber(24)
  $28.Duration ensureStreamIdleTimeout() => $_ensure(22);
  ...
  @$pb.TagNumber(26)
  $28.Duration get delayedCloseTimeout => $_getN(24);
  @$pb.TagNumber(26)
  set delayedCloseTimeout($28.Duration v) { setField(26, v); }
  @$pb.TagNumber(26)
  $core.bool hasDelayedCloseTimeout() => $_has(24);
  @$pb.TagNumber(26)
  void clearDelayedCloseTimeout() => clearField(26);
  @$pb.TagNumber(26)
  $28.Duration ensureDelayedCloseTimeout() => $_ensure(24);
  ...
  @$pb.TagNumber(28)
  $28.Duration get requestTimeout => $_getN(25);
  @$pb.TagNumber(28)
  set requestTimeout($28.Duration v) { setField(28, v); }
  @$pb.TagNumber(28)
  $core.bool hasRequestTimeout() => $_has(25);
  @$pb.TagNumber(28)
  void clearRequestTimeout() => clearField(28);
  @$pb.TagNumber(28)
  $28.Duration ensureRequestTimeout() => $_ensure(25);

  /// The maximum request headers size for incoming connections.
  /// If unconfigured, the default max request headers allowed is 60 KiB.
  /// Requests that exceed this limit will receive a 431 response.
  @$pb.TagNumber(29)
  $26.UInt32Value get maxRequestHeadersKb => $_getN(26);
  @$pb.TagNumber(29)
  set maxRequestHeadersKb($26.UInt32Value v) { setField(29, v); }
  @$pb.TagNumber(29)
  $core.bool hasMaxRequestHeadersKb() => $_has(26);
  @$pb.TagNumber(29)
  void clearMaxRequestHeadersKb() => clearField(29);
  @$pb.TagNumber(29)
  $26.UInt32Value ensureMaxRequestHeadersKb() => $_ensure(26);
  ...
  /// is present.]
  @$pb.TagNumber(30)
  $26.BoolValue get normalizePath => $_getN(27);
  @$pb.TagNumber(30)
  set normalizePath($26.BoolValue v) { setField(30, v); }
  @$pb.TagNumber(30)
  $core.bool hasNormalizePath() => $_has(27);
  @$pb.TagNumber(30)
  void clearNormalizePath() => clearField(30);
  @$pb.TagNumber(30)
  $26.BoolValue ensureNormalizePath() => $_ensure(27);
  ...
  @$pb.TagNumber(35)
  $51.HttpProtocolOptions get commonHttpProtocolOptions => $_getN(32);
  @$pb.TagNumber(35)
  set commonHttpProtocolOptions($51.HttpProtocolOptions v) { setField(35, v); }
  @$pb.TagNumber(35)
  $core.bool hasCommonHttpProtocolOptions() => $_has(32);
  @$pb.TagNumber(35)
  void clearCommonHttpProtocolOptions() => clearField(35);
  @$pb.TagNumber(35)
  $51.HttpProtocolOptions ensureCommonHttpProtocolOptions() => $_ensure(32);
  ...
  @$pb.TagNumber(40)
  $26.BoolValue get streamErrorOnInvalidHttpMessage => $_getN(37);
  @$pb.TagNumber(40)
  set streamErrorOnInvalidHttpMessage($26.BoolValue v) { setField(40, v); }
  @$pb.TagNumber(40)
  $core.bool hasStreamErrorOnInvalidHttpMessage() => $_has(37);
  @$pb.TagNumber(40)
  void clearStreamErrorOnInvalidHttpMessage() => clearField(40);
  @$pb.TagNumber(40)
  $26.BoolValue ensureStreamErrorOnInvalidHttpMessage() => $_ensure(37);
  ...
  @$pb.TagNumber(41)
  $28.Duration get requestHeadersTimeout => $_getN(38);
  @$pb.TagNumber(41)
  set requestHeadersTimeout($28.Duration v) { setField(41, v); }
  @$pb.TagNumber(41)
  $core.bool hasRequestHeadersTimeout() => $_has(38);
  @$pb.TagNumber(41)
  void clearRequestHeadersTimeout() => clearField(41);
  @$pb.TagNumber(41)
  $28.Duration ensureRequestHeadersTimeout() => $_ensure(38);
  ...
  /// [#not-implemented-hide:]
  @$pb.TagNumber(44)
  $51.Http3ProtocolOptions get http3ProtocolOptions => $_getN(41);
  @$pb.TagNumber(44)
  set http3ProtocolOptions($51.Http3ProtocolOptions v) { setField(44, v); }
  @$pb.TagNumber(44)
  $core.bool hasHttp3ProtocolOptions() => $_has(41);
  @$pb.TagNumber(44)
  void clearHttp3ProtocolOptions() => clearField(44);
  @$pb.TagNumber(44)
  $51.Http3ProtocolOptions ensureHttp3ProtocolOptions() => $_ensure(41);
  ...
  @$pb.TagNumber(46)
  $core.List<$40.TypedExtensionConfig> get originalIpDetectionExtensions => $_getList(43);
  ...
  /// handling applies.
  @$pb.TagNumber(48)
  $51.SchemeHeaderTransformation get schemeHeaderTransformation => $_getN(45);
  @$pb.TagNumber(48)
  set schemeHeaderTransformation($51.SchemeHeaderTransformation v) { setField(48, v); }
  @$pb.TagNumber(48)
  $core.bool hasSchemeHeaderTransformation() => $_has(45);
  @$pb.TagNumber(48)
  void clearSchemeHeaderTransformation() => clearField(48);
  @$pb.TagNumber(48)
  $51.SchemeHeaderTransformation ensureSchemeHeaderTransformation() => $_ensure(45);
  ...
  @$pb.TagNumber(50)
  $40.TypedExtensionConfig get typedHeaderValidationConfig => $_getN(47);
  @$pb.TagNumber(50)
  set typedHeaderValidationConfig($40.TypedExtensionConfig v) { setField(50, v); }
  @$pb.TagNumber(50)
  $core.bool hasTypedHeaderValidationConfig() => $_has(47);
  @$pb.TagNumber(50)
  void clearTypedHeaderValidationConfig() => clearField(50);
  @$pb.TagNumber(50)
  $40.TypedExtensionConfig ensureTypedHeaderValidationConfig() => $_ensure(47);
  ...
  @$pb.TagNumber(52)
  $core.List<$40.TypedExtensionConfig> get earlyHeaderMutationExtensions => $_getList(49);
  ...
  @$pb.TagNumber(53)
  $26.BoolValue get addProxyProtocolConnectionState => $_getN(50);
  @$pb.TagNumber(53)
  set addProxyProtocolConnectionState($26.BoolValue v) { setField(53, v); }
  @$pb.TagNumber(53)
  $core.bool hasAddProxyProtocolConnectionState() => $_has(50);
  @$pb.TagNumber(53)
  void clearAddProxyProtocolConnectionState() => clearField(53);
  @$pb.TagNumber(53)
  $26.BoolValue ensureAddProxyProtocolConnectionState() => $_ensure(50);
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(54)
  $28.Duration get accessLogFlushInterval => $_getN(51);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(54)
  set accessLogFlushInterval($28.Duration v) { setField(54, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(54)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(54)
  $28.Duration ensureAccessLogFlushInterval() => $_ensure(51);
  ...
  @$pb.TagNumber(57)
  $core.bool get appendLocalOverload => $_getBF(54);
  @$pb.TagNumber(57)
  set appendLocalOverload($core.bool v) { $_setBool(54, v); }
  @$pb.TagNumber(57)
  $core.bool hasAppendLocalOverload() => $_has(54);
  @$pb.TagNumber(57)
  void clearAppendLocalOverload() => clearField(57);
  ...
  @$pb.TagNumber(58)
  $core.bool get http1SafeMaxConnectionDuration => $_getBF(55);
  @$pb.TagNumber(58)
  set http1SafeMaxConnectionDuration($core.bool v) { $_setBool(55, v); }
  @$pb.TagNumber(58)
  $core.bool hasHttp1SafeMaxConnectionDuration() => $_has(55);
  @$pb.TagNumber(58)
  void clearHttp1SafeMaxConnectionDuration() => clearField(58);
}
...
class LocalReplyConfig extends $pb.GeneratedMessage {
  factory LocalReplyConfig({
    ...
    $181.SubstitutionFormatString? bodyFormat,
  }) {
    final $result = create();
    if (mappers != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LocalReplyConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.http_connection_manager.v3'), createEmptyInstance: create)
    ...
    ..aOM<$181.SubstitutionFormatString>(2, _omitFieldNames ? '' : 'bodyFormat', subBuilder: $181.SubstitutionFormatString.create)
    ..hasRequiredFields = false
  ;
  ...
  ///   }
  @$pb.TagNumber(2)
  $181.SubstitutionFormatString get bodyFormat => $_getN(1);
  @$pb.TagNumber(2)
  set bodyFormat($181.SubstitutionFormatString v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBodyFormat() => $_has(1);
  @$pb.TagNumber(2)
  void clearBodyFormat() => clearField(2);
  @$pb.TagNumber(2)
  $181.SubstitutionFormatString ensureBodyFormat() => $_ensure(1);
}
...
class ResponseMapper extends $pb.GeneratedMessage {
  factory ResponseMapper({
    $72.AccessLogFilter? filter,
    $26.UInt32Value? statusCode,
    $47.DataSource? body,
    $181.SubstitutionFormatString? bodyFormatOverride,
    $core.Iterable<$47.HeaderValueOption>? headersToAdd,
  }) {
    final $result = create();
    if (filter != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResponseMapper', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.http_connection_manager.v3'), createEmptyInstance: create)
    ..aOM<$72.AccessLogFilter>(1, _omitFieldNames ? '' : 'filter', subBuilder: $72.AccessLogFilter.create)
    ..aOM<$26.UInt32Value>(2, _omitFieldNames ? '' : 'statusCode', subBuilder: $26.UInt32Value.create)
    ..aOM<$47.DataSource>(3, _omitFieldNames ? '' : 'body', subBuilder: $47.DataSource.create)
    ..aOM<$181.SubstitutionFormatString>(4, _omitFieldNames ? '' : 'bodyFormatOverride', subBuilder: $181.SubstitutionFormatString.create)
    ..pc<$47.HeaderValueOption>(5, _omitFieldNames ? '' : 'headersToAdd', $pb.PbFieldType.PM, subBuilder: $47.HeaderValueOption.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $72.AccessLogFilter get filter => $_getN(0);
  @$pb.TagNumber(1)
  set filter($72.AccessLogFilter v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasFilter() => $_has(0);
  @$pb.TagNumber(1)
  void clearFilter() => clearField(1);
  @$pb.TagNumber(1)
  $72.AccessLogFilter ensureFilter() => $_ensure(0);

  /// The new response status code if specified.
  @$pb.TagNumber(2)
  $26.UInt32Value get statusCode => $_getN(1);
  @$pb.TagNumber(2)
  set statusCode($26.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasStatusCode() => $_has(1);
  @$pb.TagNumber(2)
  void clearStatusCode() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt32Value ensureStatusCode() => $_ensure(1);

  /// The new local reply body text if specified. It will be used in the ``%LOCAL_REPLY_BODY%``
  /// command operator in the ``body_format``.
  @$pb.TagNumber(3)
  $47.DataSource get body => $_getN(2);
  @$pb.TagNumber(3)
  set body($47.DataSource v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasBody() => $_has(2);
  @$pb.TagNumber(3)
  void clearBody() => clearField(3);
  @$pb.TagNumber(3)
  $47.DataSource ensureBody() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $181.SubstitutionFormatString get bodyFormatOverride => $_getN(3);
  @$pb.TagNumber(4)
  set bodyFormatOverride($181.SubstitutionFormatString v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasBodyFormatOverride() => $_has(3);
  @$pb.TagNumber(4)
  void clearBodyFormatOverride() => clearField(4);
  @$pb.TagNumber(4)
  $181.SubstitutionFormatString ensureBodyFormatOverride() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $core.List<$47.HeaderValueOption> get headersToAdd => $_getList(4);
}
...
class ScopedRouteConfigurationsList extends $pb.GeneratedMessage {
  factory ScopedRouteConfigurationsList({
    $core.Iterable<$193.ScopedRouteConfiguration>? scopedRouteConfigurations,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScopedRouteConfigurationsList', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.http_connection_manager.v3'), createEmptyInstance: create)
    ..pc<$193.ScopedRouteConfiguration>(1, _omitFieldNames ? '' : 'scopedRouteConfigurations', $pb.PbFieldType.PM, subBuilder: $193.ScopedRouteConfiguration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$193.ScopedRouteConfiguration> get scopedRouteConfigurations => $_getList(0);
}
...
class ScopedRoutes extends $pb.GeneratedMessage {
  factory ScopedRoutes({
    ...
    $50.ConfigSource? rdsConfigSource,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScopedRoutes', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.http_connection_manager.v3'), createEmptyInstance: create)
    ...
    ..aOM<$50.ConfigSource>(3, _omitFieldNames ? '' : 'rdsConfigSource', subBuilder: $50.ConfigSource.create)
  ...
  @$pb.TagNumber(3)
  $50.ConfigSource get rdsConfigSource => $_getN(2);
  @$pb.TagNumber(3)
  set rdsConfigSource($50.ConfigSource v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasRdsConfigSource() => $_has(2);
  @$pb.TagNumber(3)
  void clearRdsConfigSource() => clearField(3);
  @$pb.TagNumber(3)
  $50.ConfigSource ensureRdsConfigSource() => $_ensure(2);
...
class ScopedRds extends $pb.GeneratedMessage {
  factory ScopedRds({
    $50.ConfigSource? scopedRdsConfigSource,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScopedRds', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.http_connection_manager.v3'), createEmptyInstance: create)
    ..aOM<$50.ConfigSource>(1, _omitFieldNames ? '' : 'scopedRdsConfigSource', subBuilder: $50.ConfigSource.create)
  ...
  @$pb.TagNumber(1)
  $50.ConfigSource get scopedRdsConfigSource => $_getN(0);
  @$pb.TagNumber(1)
  set scopedRdsConfigSource($50.ConfigSource v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasScopedRdsConfigSource() => $_has(0);
  @$pb.TagNumber(1)
  void clearScopedRdsConfigSource() => clearField(1);
  @$pb.TagNumber(1)
  $50.ConfigSource ensureScopedRdsConfigSource() => $_ensure(0);
...
class HttpFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.http_connection_manager.v3'), createEmptyInstance: create)
    ..oo(0, [4, 5])
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$34.Any>(4, _omitFieldNames ? '' : 'typedConfig', subBuilder: $34.Any.create)
    ..aOM<$50.ExtensionConfigSource>(5, _omitFieldNames ? '' : 'configDiscovery', subBuilder: $50.ExtensionConfigSource.create)
  ...
  @$pb.TagNumber(4)
  set typedConfig($34.Any v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  $50.ExtensionConfigSource get configDiscovery => $_getN(2);
  @$pb.TagNumber(5)
  set configDiscovery($50.ExtensionConfigSource v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasConfigDiscovery() => $_has(2);
  @$pb.TagNumber(5)
  void clearConfigDiscovery() => clearField(5);
  @$pb.TagNumber(5)
  $50.ExtensionConfigSource ensureConfigDiscovery() => $_ensure(2);
...
class RequestIDExtension extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RequestIDExtension', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.http_connection_manager.v3'), createEmptyInstance: create)
    ..aOM<$34.Any>(1, _omitFieldNames ? '' : 'typedConfig', subBuilder: $34.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $34.Any get typedConfig => $_getN(0);
  @$pb.TagNumber(1)
  set typedConfig($34.Any v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTypedConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearTypedConfig() => clearField(1);
  @$pb.TagNumber(1)
  $34.Any ensureTypedConfig() => $_ensure(0);
}
