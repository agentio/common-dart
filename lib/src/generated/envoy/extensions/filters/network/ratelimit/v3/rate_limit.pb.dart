...
class RateLimit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimit', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.ratelimit.v3'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'statPrefix')
    ..aOS(2, _omitFieldNames ? '' : 'domain')
    ..pc<$156.RateLimitDescriptor>(3, _omitFieldNames ? '' : 'descriptors', $pb.PbFieldType.PM, subBuilder: $156.RateLimitDescriptor.create)
    ..aOM<$28.Duration>(4, _omitFieldNames ? '' : 'timeout', subBuilder: $28.Duration.create)
    ..aOB(5, _omitFieldNames ? '' : 'failureModeDeny')
    ..aOM<$184.RateLimitServiceConfig>(6, _omitFieldNames ? '' : 'rateLimitService', subBuilder: $184.RateLimitServiceConfig.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$156.RateLimitDescriptor> get descriptors => $_getList(2);
  ...
  /// success.
  @$pb.TagNumber(6)
  $184.RateLimitServiceConfig get rateLimitService => $_getN(5);
  @$pb.TagNumber(6)
  set rateLimitService($184.RateLimitServiceConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasRateLimitService() => $_has(5);
  @$pb.TagNumber(6)
  void clearRateLimitService() => clearField(6);
  @$pb.TagNumber(6)
  $184.RateLimitServiceConfig ensureRateLimitService() => $_ensure(5);
}
