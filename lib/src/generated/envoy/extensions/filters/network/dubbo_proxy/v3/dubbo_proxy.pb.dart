...
class DubboProxy extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    $core.Iterable<$201.RouteConfiguration>? routeConfig,
    $core.Iterable<DubboFilter>? dubboFilters,
    Drds? drds,
    $201.MultipleRouteConfiguration? multipleRouteConfig,
  }) {
    final $result = create();
    if (statPrefix != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DubboProxy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.dubbo_proxy.v3'), createEmptyInstance: create)
    ...
    ..pc<$201.RouteConfiguration>(4, _omitFieldNames ? '' : 'routeConfig', $pb.PbFieldType.PM, subBuilder: $201.RouteConfiguration.create)
    ...
    ..aOM<$201.MultipleRouteConfiguration>(7, _omitFieldNames ? '' : 'multipleRouteConfig', subBuilder: $201.MultipleRouteConfiguration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(4)
  $core.List<$201.RouteConfiguration> get routeConfig => $_getList(3);
  ...
  @$pb.TagNumber(7)
  $201.MultipleRouteConfiguration get multipleRouteConfig => $_getN(6);
  @$pb.TagNumber(7)
  set multipleRouteConfig($201.MultipleRouteConfiguration v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasMultipleRouteConfig() => $_has(6);
  @$pb.TagNumber(7)
  void clearMultipleRouteConfig() => clearField(7);
  @$pb.TagNumber(7)
  $201.MultipleRouteConfiguration ensureMultipleRouteConfig() => $_ensure(6);
}
...
class DubboFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DubboFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.dubbo_proxy.v3'), createEmptyInstance: create)
    ...
    ..aOM<$34.Any>(2, _omitFieldNames ? '' : 'config', subBuilder: $34.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $34.Any get config => $_getN(1);
  @$pb.TagNumber(2)
  set config($34.Any v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearConfig() => clearField(2);
  @$pb.TagNumber(2)
  $34.Any ensureConfig() => $_ensure(1);
}
