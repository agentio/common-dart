...
import '../../../../common/dynamic_forward_proxy/v3/dns_cache.pb.dart' as $191;
...
class RedisProxy_ConnPoolSettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RedisProxy.ConnPoolSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.redis_proxy.v3'), createEmptyInstance: create)
    ..aOM<$28.Duration>(1, _omitFieldNames ? '' : 'opTimeout', subBuilder: $28.Duration.create)
    ...
    ..aOM<$28.Duration>(5, _omitFieldNames ? '' : 'bufferFlushTimeout', subBuilder: $28.Duration.create)
    ..aOM<$26.UInt32Value>(6, _omitFieldNames ? '' : 'maxUpstreamUnknownConnections', subBuilder: $26.UInt32Value.create)
    ...
    ..aOM<$191.DnsCacheConfig>(9, _omitFieldNames ? '' : 'dnsCacheConfig', subBuilder: $191.DnsCacheConfig.create)
  ...
  /// is ready.
  @$pb.TagNumber(1)
  $28.Duration get opTimeout => $_getN(0);
  @$pb.TagNumber(1)
  set opTimeout($28.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasOpTimeout() => $_has(0);
  @$pb.TagNumber(1)
  void clearOpTimeout() => clearField(1);
  @$pb.TagNumber(1)
  $28.Duration ensureOpTimeout() => $_ensure(0);
  ...
  /// defaults to 3ms.
  @$pb.TagNumber(5)
  $28.Duration get bufferFlushTimeout => $_getN(4);
  @$pb.TagNumber(5)
  set bufferFlushTimeout($28.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasBufferFlushTimeout() => $_has(4);
  @$pb.TagNumber(5)
  void clearBufferFlushTimeout() => clearField(5);
  @$pb.TagNumber(5)
  $28.Duration ensureBufferFlushTimeout() => $_ensure(4);
  ...
  @$pb.TagNumber(6)
  $26.UInt32Value get maxUpstreamUnknownConnections => $_getN(5);
  @$pb.TagNumber(6)
  set maxUpstreamUnknownConnections($26.UInt32Value v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasMaxUpstreamUnknownConnections() => $_has(5);
  @$pb.TagNumber(6)
  void clearMaxUpstreamUnknownConnections() => clearField(6);
  @$pb.TagNumber(6)
  $26.UInt32Value ensureMaxUpstreamUnknownConnections() => $_ensure(5);
  ...
  @$pb.TagNumber(9)
  $191.DnsCacheConfig get dnsCacheConfig => $_getN(8);
  @$pb.TagNumber(9)
  set dnsCacheConfig($191.DnsCacheConfig v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasDnsCacheConfig() => $_has(8);
  @$pb.TagNumber(9)
  void clearDnsCacheConfig() => clearField(9);
  @$pb.TagNumber(9)
  $191.DnsCacheConfig ensureDnsCacheConfig() => $_ensure(8);
...
class RedisProxy_PrefixRoutes_Route_RequestMirrorPolicy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RedisProxy.PrefixRoutes.Route.RequestMirrorPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.redis_proxy.v3'), createEmptyInstance: create)
    ...
    ..aOM<$47.RuntimeFractionalPercent>(2, _omitFieldNames ? '' : 'runtimeFraction', subBuilder: $47.RuntimeFractionalPercent.create)
  ...
  @$pb.TagNumber(2)
  set runtimeFraction($47.RuntimeFractionalPercent v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class RedisProxy_RedisFault extends $pb.GeneratedMessage {
  factory RedisProxy_RedisFault({
    ...
    $47.RuntimeFractionalPercent? faultEnabled,
    $28.Duration? delay,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RedisProxy.RedisFault', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.redis_proxy.v3'), createEmptyInstance: create)
    ...
    ..aOM<$47.RuntimeFractionalPercent>(2, _omitFieldNames ? '' : 'faultEnabled', subBuilder: $47.RuntimeFractionalPercent.create)
    ..aOM<$28.Duration>(3, _omitFieldNames ? '' : 'delay', subBuilder: $28.Duration.create)
  ...
  @$pb.TagNumber(2)
  $47.RuntimeFractionalPercent get faultEnabled => $_getN(1);
  @$pb.TagNumber(2)
  set faultEnabled($47.RuntimeFractionalPercent v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFaultEnabled() => $_has(1);
  @$pb.TagNumber(2)
  void clearFaultEnabled() => clearField(2);
  @$pb.TagNumber(2)
  $47.RuntimeFractionalPercent ensureFaultEnabled() => $_ensure(1);

  /// Delay for all faults. If not set, defaults to zero
  @$pb.TagNumber(3)
  $28.Duration get delay => $_getN(2);
  @$pb.TagNumber(3)
  set delay($28.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasDelay() => $_has(2);
  @$pb.TagNumber(3)
  void clearDelay() => clearField(3);
  @$pb.TagNumber(3)
  $28.Duration ensureDelay() => $_ensure(2);
...
class RedisProxy extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    $47.DataSource? downstreamAuthPassword,
    $47.DataSource? downstreamAuthUsername,
    $core.Iterable<RedisProxy_RedisFault>? faults,
    $core.Iterable<$47.DataSource>? downstreamAuthPasswords,
  }) {
    final $result = create();
    if (statPrefix != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RedisProxy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.redis_proxy.v3'), createEmptyInstance: create)
    ...
    ..aOM<$47.DataSource>(6, _omitFieldNames ? '' : 'downstreamAuthPassword', subBuilder: $47.DataSource.create)
    ..aOM<$47.DataSource>(7, _omitFieldNames ? '' : 'downstreamAuthUsername', subBuilder: $47.DataSource.create)
    ..pc<RedisProxy_RedisFault>(8, _omitFieldNames ? '' : 'faults', $pb.PbFieldType.PM, subBuilder: RedisProxy_RedisFault.create)
    ..pc<$47.DataSource>(9, _omitFieldNames ? '' : 'downstreamAuthPasswords', $pb.PbFieldType.PM, subBuilder: $47.DataSource.create)
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(6)
  $47.DataSource get downstreamAuthPassword => $_getN(4);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(6)
  set downstreamAuthPassword($47.DataSource v) { setField(6, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(6)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(6)
  $47.DataSource ensureDownstreamAuthPassword() => $_ensure(4);
  ...
  @$pb.TagNumber(7)
  $47.DataSource get downstreamAuthUsername => $_getN(5);
  @$pb.TagNumber(7)
  set downstreamAuthUsername($47.DataSource v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasDownstreamAuthUsername() => $_has(5);
  @$pb.TagNumber(7)
  void clearDownstreamAuthUsername() => clearField(7);
  @$pb.TagNumber(7)
  $47.DataSource ensureDownstreamAuthUsername() => $_ensure(5);
  ...
  /// AUTH, but no password is set" error will be returned.
  @$pb.TagNumber(9)
  $core.List<$47.DataSource> get downstreamAuthPasswords => $_getList(7);
}
...
class RedisProtocolOptions extends $pb.GeneratedMessage {
  factory RedisProtocolOptions({
    $47.DataSource? authPassword,
    $47.DataSource? authUsername,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RedisProtocolOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.redis_proxy.v3'), createEmptyInstance: create)
    ..aOM<$47.DataSource>(1, _omitFieldNames ? '' : 'authPassword', subBuilder: $47.DataSource.create)
    ..aOM<$47.DataSource>(2, _omitFieldNames ? '' : 'authUsername', subBuilder: $47.DataSource.create)
    ..hasRequiredFields = false
  ;
