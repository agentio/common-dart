...
import '../../../../../data/dns/v3/dns_table.pb.dart' as $198;
...
class DnsFilterConfig_ServerContextConfig extends $pb.GeneratedMessage {
  factory DnsFilterConfig_ServerContextConfig({
    $198.DnsTable? inlineDnsTable,
    $47.DataSource? externalDnsTable,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DnsFilterConfig.ServerContextConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.udp.dns_filter.v3'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$198.DnsTable>(1, _omitFieldNames ? '' : 'inlineDnsTable', subBuilder: $198.DnsTable.create)
    ..aOM<$47.DataSource>(2, _omitFieldNames ? '' : 'externalDnsTable', subBuilder: $47.DataSource.create)
  ...
  @$pb.TagNumber(1)
  $198.DnsTable get inlineDnsTable => $_getN(0);
  @$pb.TagNumber(1)
  set inlineDnsTable($198.DnsTable v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasInlineDnsTable() => $_has(0);
  @$pb.TagNumber(1)
  void clearInlineDnsTable() => clearField(1);
  @$pb.TagNumber(1)
  $198.DnsTable ensureInlineDnsTable() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $47.DataSource get externalDnsTable => $_getN(1);
  @$pb.TagNumber(2)
  set externalDnsTable($47.DataSource v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasExternalDnsTable() => $_has(1);
  @$pb.TagNumber(2)
  void clearExternalDnsTable() => clearField(2);
  @$pb.TagNumber(2)
  $47.DataSource ensureExternalDnsTable() => $_ensure(1);
}
...
class DnsFilterConfig_ClientContextConfig extends $pb.GeneratedMessage {
  factory DnsFilterConfig_ClientContextConfig({
    $28.Duration? resolverTimeout,
  @$core.Deprecated('This field is deprecated.')
    $core.Iterable<$42.Address>? upstreamResolvers,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DnsFilterConfig.ClientContextConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.udp.dns_filter.v3'), createEmptyInstance: create)
    ..aOM<$28.Duration>(1, _omitFieldNames ? '' : 'resolverTimeout', subBuilder: $28.Duration.create)
    ..pc<$42.Address>(2, _omitFieldNames ? '' : 'upstreamResolvers', $pb.PbFieldType.PM, subBuilder: $42.Address.create)
    ..a<$fixnum.Int64>(3, _omitFieldNames ? '' : 'maxPendingLookups', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<$40.TypedExtensionConfig>(4, _omitFieldNames ? '' : 'typedDnsResolverConfig', subBuilder: $40.TypedExtensionConfig.create)
    ..aOM<$109.DnsResolutionConfig>(5, _omitFieldNames ? '' : 'dnsResolutionConfig', subBuilder: $109.DnsResolutionConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $28.Duration get resolverTimeout => $_getN(0);
  @$pb.TagNumber(1)
  set resolverTimeout($28.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasResolverTimeout() => $_has(0);
  @$pb.TagNumber(1)
  void clearResolverTimeout() => clearField(1);
  @$pb.TagNumber(1)
  $28.Duration ensureResolverTimeout() => $_ensure(0);
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  $core.List<$42.Address> get upstreamResolvers => $_getList(1);
  ...
  @$pb.TagNumber(4)
  $40.TypedExtensionConfig get typedDnsResolverConfig => $_getN(3);
  @$pb.TagNumber(4)
  set typedDnsResolverConfig($40.TypedExtensionConfig v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTypedDnsResolverConfig() => $_has(3);
  @$pb.TagNumber(4)
  void clearTypedDnsResolverConfig() => clearField(4);
  @$pb.TagNumber(4)
  $40.TypedExtensionConfig ensureTypedDnsResolverConfig() => $_ensure(3);
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  $109.DnsResolutionConfig get dnsResolutionConfig => $_getN(4);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  set dnsResolutionConfig($109.DnsResolutionConfig v) { setField(5, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  $109.DnsResolutionConfig ensureDnsResolutionConfig() => $_ensure(4);
}
