...
import '../../../../../config/core/v3/udp_socket_config.pb.dart' as $52;
...
class UdpProxyConfig_UdpTunnelingConfig_BufferOptions extends $pb.GeneratedMessage {
  factory UdpProxyConfig_UdpTunnelingConfig_BufferOptions({
    $26.UInt32Value? maxBufferedDatagrams,
    $26.UInt64Value? maxBufferedBytes,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UdpProxyConfig.UdpTunnelingConfig.BufferOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.udp.udp_proxy.v3'), createEmptyInstance: create)
    ..aOM<$26.UInt32Value>(1, _omitFieldNames ? '' : 'maxBufferedDatagrams', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt64Value>(2, _omitFieldNames ? '' : 'maxBufferedBytes', subBuilder: $26.UInt64Value.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $26.UInt32Value get maxBufferedDatagrams => $_getN(0);
  @$pb.TagNumber(1)
  set maxBufferedDatagrams($26.UInt32Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasMaxBufferedDatagrams() => $_has(0);
  @$pb.TagNumber(1)
  void clearMaxBufferedDatagrams() => clearField(1);
  @$pb.TagNumber(1)
  $26.UInt32Value ensureMaxBufferedDatagrams() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $26.UInt64Value get maxBufferedBytes => $_getN(1);
  @$pb.TagNumber(2)
  set maxBufferedBytes($26.UInt64Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMaxBufferedBytes() => $_has(1);
  @$pb.TagNumber(2)
  void clearMaxBufferedBytes() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt64Value ensureMaxBufferedBytes() => $_ensure(1);
}
...
class UdpProxyConfig_UdpTunnelingConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UdpProxyConfig.UdpTunnelingConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.udp.udp_proxy.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.UInt32Value>(2, _omitFieldNames ? '' : 'proxyPort', subBuilder: $26.UInt32Value.create)
    ...
    ..pc<$47.HeaderValueOption>(8, _omitFieldNames ? '' : 'headersToAdd', $pb.PbFieldType.PM, subBuilder: $47.HeaderValueOption.create)
  ...
  @$pb.TagNumber(2)
  $26.UInt32Value get proxyPort => $_getN(1);
  @$pb.TagNumber(2)
  set proxyPort($26.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasProxyPort() => $_has(1);
  @$pb.TagNumber(2)
  void clearProxyPort() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt32Value ensureProxyPort() => $_ensure(1);
  ...
  @$pb.TagNumber(8)
  $core.List<$47.HeaderValueOption> get headersToAdd => $_getList(7);
...
class UdpProxyConfig extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    $52.UdpSocketConfig? upstreamSocketConfig,
    $core.bool? usePerPacketLoadBalancing,
    $core.Iterable<$72.AccessLog>? accessLog,
    $61.Matcher? matcher,
    $core.Iterable<$72.AccessLog>? proxyAccessLog,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UdpProxyConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.udp.udp_proxy.v3'), createEmptyInstance: create)
    ...
    ..aOM<$28.Duration>(3, _omitFieldNames ? '' : 'idleTimeout', subBuilder: $28.Duration.create)
    ...
    ..aOM<$52.UdpSocketConfig>(6, _omitFieldNames ? '' : 'upstreamSocketConfig', subBuilder: $52.UdpSocketConfig.create)
    ..aOB(7, _omitFieldNames ? '' : 'usePerPacketLoadBalancing')
    ..pc<$72.AccessLog>(8, _omitFieldNames ? '' : 'accessLog', $pb.PbFieldType.PM, subBuilder: $72.AccessLog.create)
    ..aOM<$61.Matcher>(9, _omitFieldNames ? '' : 'matcher', subBuilder: $61.Matcher.create)
    ..pc<$72.AccessLog>(10, _omitFieldNames ? '' : 'proxyAccessLog', $pb.PbFieldType.PM, subBuilder: $72.AccessLog.create)
  ...
  @$pb.TagNumber(3)
  $28.Duration get idleTimeout => $_getN(2);
  @$pb.TagNumber(3)
  set idleTimeout($28.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasIdleTimeout() => $_has(2);
  @$pb.TagNumber(3)
  void clearIdleTimeout() => clearField(3);
  @$pb.TagNumber(3)
  $28.Duration ensureIdleTimeout() => $_ensure(2);
  ...
  @$pb.TagNumber(6)
  $52.UdpSocketConfig get upstreamSocketConfig => $_getN(5);
  @$pb.TagNumber(6)
  set upstreamSocketConfig($52.UdpSocketConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasUpstreamSocketConfig() => $_has(5);
  @$pb.TagNumber(6)
  void clearUpstreamSocketConfig() => clearField(6);
  @$pb.TagNumber(6)
  $52.UdpSocketConfig ensureUpstreamSocketConfig() => $_ensure(5);
  ...
  @$pb.TagNumber(10)
  $core.List<$72.AccessLog> get proxyAccessLog => $_getList(9);
