...
class FilterStateValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FilterStateValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.common.set_filter_state.v3'), createEmptyInstance: create)
    ...
    ..aOM<$181.SubstitutionFormatString>(2, _omitFieldNames ? '' : 'formatString', subBuilder: $181.SubstitutionFormatString.create)
    ...
    ..aOS(6, _omitFieldNames ? '' : 'factoryKey')
  ...
  @$pb.TagNumber(2)
  $181.SubstitutionFormatString get formatString => $_getN(1);
  @$pb.TagNumber(2)
  set formatString($181.SubstitutionFormatString v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFormatString() => $_has(1);
  @$pb.TagNumber(2)
  void clearFormatString() => clearField(2);
  @$pb.TagNumber(2)
  $181.SubstitutionFormatString ensureFormatString() => $_ensure(1);
  ...
  @$pb.TagNumber(6)
  $core.String get factoryKey => $_getSZ(5);
  @$pb.TagNumber(6)
  set factoryKey($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
  $core.bool hasFactoryKey() => $_has(5);
  @$pb.TagNumber(6)
  void clearFactoryKey() => clearField(6);
}
