...
class FaultDelay extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FaultDelay', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.common.fault.v3'), createEmptyInstance: create)
    ...
    ..aOM<$44.FractionalPercent>(4, _omitFieldNames ? '' : 'percentage', subBuilder: $44.FractionalPercent.create)
  ...
  @$pb.TagNumber(3)
  $28.Duration get fixedDelay => $_getN(0);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(3)
  $28.Duration ensureFixedDelay() => $_ensure(0);

  /// The percentage of operations/connections/requests on which the delay will be injected.
  @$pb.TagNumber(4)
  $44.FractionalPercent get percentage => $_getN(1);
  @$pb.TagNumber(4)
  set percentage($44.FractionalPercent v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class FaultRateLimit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FaultRateLimit', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.common.fault.v3'), createEmptyInstance: create)
    ...
    ..aOM<$44.FractionalPercent>(2, _omitFieldNames ? '' : 'percentage', subBuilder: $44.FractionalPercent.create)
  ...
  $44.FractionalPercent get percentage => $_getN(1);
  @$pb.TagNumber(2)
  set percentage($44.FractionalPercent v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPercentage() => $_has(1);
  @$pb.TagNumber(2)
