...
import '../../../../../config/core/v3/proxy_protocol.pb.dart' as $63;
import '../../../../../config/core/v3/proxy_protocol.pbenum.dart' as $63;
...
class ProxyProtocol extends $pb.GeneratedMessage {
  factory ProxyProtocol({
    ...
    $63.ProxyProtocolPassThroughTLVs? passThroughTlvs,
    $core.Iterable<$63.ProxyProtocolConfig_Version>? disallowedVersions,
    ...
    if (disallowedVersions != null) {
      $result.disallowedVersions.addAll(disallowedVersions);
    }
    if (statPrefix != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProxyProtocol', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.listener.proxy_protocol.v3'), createEmptyInstance: create)
    ...
    ..aOM<$63.ProxyProtocolPassThroughTLVs>(3, _omitFieldNames ? '' : 'passThroughTlvs', subBuilder: $63.ProxyProtocolPassThroughTLVs.create)
    ..pc<$63.ProxyProtocolConfig_Version>(4, _omitFieldNames ? '' : 'disallowedVersions', $pb.PbFieldType.KE, valueOf: $63.ProxyProtocolConfig_Version.valueOf, enumValues: $63.ProxyProtocolConfig_Version.values, defaultEnumValue: $63.ProxyProtocolConfig_Version.V1)
    ..aOS(5, _omitFieldNames ? '' : 'statPrefix')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $63.ProxyProtocolPassThroughTLVs get passThroughTlvs => $_getN(2);
  @$pb.TagNumber(3)
  set passThroughTlvs($63.ProxyProtocolPassThroughTLVs v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasPassThroughTlvs() => $_has(2);
  @$pb.TagNumber(3)
  void clearPassThroughTlvs() => clearField(3);
  @$pb.TagNumber(3)
  $63.ProxyProtocolPassThroughTLVs ensurePassThroughTlvs() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $core.List<$63.ProxyProtocolConfig_Version> get disallowedVersions => $_getList(3);
  ...
  /// more information.
  @$pb.TagNumber(5)
  $core.String get statPrefix => $_getSZ(4);
  @$pb.TagNumber(5)
  set statPrefix($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasStatPrefix() => $_has(4);
  @$pb.TagNumber(5)
  void clearStatPrefix() => clearField(5);
}
