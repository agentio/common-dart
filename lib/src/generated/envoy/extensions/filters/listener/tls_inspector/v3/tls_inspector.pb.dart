...
class TlsInspector extends $pb.GeneratedMessage {
  factory TlsInspector({
    $26.BoolValue? enableJa3Fingerprinting,
    $26.UInt32Value? initialReadBufferSize,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TlsInspector', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.listener.tls_inspector.v3'), createEmptyInstance: create)
    ..aOM<$26.BoolValue>(1, _omitFieldNames ? '' : 'enableJa3Fingerprinting', subBuilder: $26.BoolValue.create)
    ..aOM<$26.UInt32Value>(2, _omitFieldNames ? '' : 'initialReadBufferSize', subBuilder: $26.UInt32Value.create)
  ...
  @$pb.TagNumber(1)
  $26.BoolValue get enableJa3Fingerprinting => $_getN(0);
  @$pb.TagNumber(1)
  set enableJa3Fingerprinting($26.BoolValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasEnableJa3Fingerprinting() => $_has(0);
  @$pb.TagNumber(1)
  void clearEnableJa3Fingerprinting() => clearField(1);
  @$pb.TagNumber(1)
  $26.BoolValue ensureEnableJa3Fingerprinting() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $26.UInt32Value get initialReadBufferSize => $_getN(1);
  @$pb.TagNumber(2)
  set initialReadBufferSize($26.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasInitialReadBufferSize() => $_has(1);
  @$pb.TagNumber(2)
  void clearInitialReadBufferSize() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt32Value ensureInitialReadBufferSize() => $_ensure(1);
}
