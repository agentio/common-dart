...
class OAuth2_ClientCredentials extends $pb.GeneratedMessage {
  factory OAuth2_ClientCredentials({
    ...
    $116.SdsSecretConfig? clientSecret,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OAuth2.ClientCredentials', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.http.injected_credentials.oauth2.v3'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'clientId')
    ..aOM<$116.SdsSecretConfig>(2, _omitFieldNames ? '' : 'clientSecret', subBuilder: $116.SdsSecretConfig.create)
  ...
  /// Refer to [RFC 6749: The OAuth 2.0 Authorization Framework](https://www.rfc-editor.org/rfc/rfc6749#section-2.3.1) for details.
  @$pb.TagNumber(2)
  $116.SdsSecretConfig get clientSecret => $_getN(1);
  @$pb.TagNumber(2)
  set clientSecret($116.SdsSecretConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasClientSecret() => $_has(1);
  @$pb.TagNumber(2)
  void clearClientSecret() => clearField(2);
  @$pb.TagNumber(2)
  $116.SdsSecretConfig ensureClientSecret() => $_ensure(1);
...
class OAuth2 extends $pb.GeneratedMessage {
  factory OAuth2({
    ...
    $28.Duration? tokenFetchRetryInterval,
  }) {
    final $result = create();
    ...
    if (tokenFetchRetryInterval != null) {
      $result.tokenFetchRetryInterval = tokenFetchRetryInterval;
    }
    return $result;
  }
  OAuth2._() : super();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OAuth2', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.http.injected_credentials.oauth2.v3'), createEmptyInstance: create)
    ..oo(0, [3])
    ...
    ..aOM<$28.Duration>(4, _omitFieldNames ? '' : 'tokenFetchRetryInterval', subBuilder: $28.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $28.Duration get tokenFetchRetryInterval => $_getN(3);
  @$pb.TagNumber(4)
  set tokenFetchRetryInterval($28.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTokenFetchRetryInterval() => $_has(3);
  @$pb.TagNumber(4)
  void clearTokenFetchRetryInterval() => clearField(4);
  @$pb.TagNumber(4)
  $28.Duration ensureTokenFetchRetryInterval() => $_ensure(3);
}
