...
class Generic extends $pb.GeneratedMessage {
  factory Generic({
    $116.SdsSecretConfig? credential,
    $core.String? header,
  }) {
    final $result = create();
    if (credential != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Generic', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.http.injected_credentials.generic.v3'), createEmptyInstance: create)
    ..aOM<$116.SdsSecretConfig>(1, _omitFieldNames ? '' : 'credential', subBuilder: $116.SdsSecretConfig.create)
  ...
  @$pb.TagNumber(1)
  $116.SdsSecretConfig get credential => $_getN(0);
  @$pb.TagNumber(1)
  set credential($116.SdsSecretConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCredential() => $_has(0);
  @$pb.TagNumber(1)
  void clearCredential() => clearField(1);
  @$pb.TagNumber(1)
  $116.SdsSecretConfig ensureCredential() => $_ensure(0);
