...
import '../../../../common/async_files/v3/async_file_manager.pb.dart' as $180;
...
class FileSystemHttpCacheConfig extends $pb.GeneratedMessage {
  factory FileSystemHttpCacheConfig({
    $180.AsyncFileManagerConfig? managerConfig,
    $core.String? cachePath,
    $26.UInt64Value? maxCacheSizeBytes,
    $26.UInt64Value? maxIndividualCacheEntrySizeBytes,
    $26.UInt64Value? maxCacheEntryCount,
    $core.int? cacheSubdivisions,
    $core.double? evictFraction,
    $28.Duration? maxEvictionPeriod,
    $28.Duration? minEvictionPeriod,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FileSystemHttpCacheConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.http.cache.file_system_http_cache.v3'), createEmptyInstance: create)
    ..aOM<$180.AsyncFileManagerConfig>(1, _omitFieldNames ? '' : 'managerConfig', subBuilder: $180.AsyncFileManagerConfig.create)
    ..aOS(2, _omitFieldNames ? '' : 'cachePath')
    ..aOM<$26.UInt64Value>(3, _omitFieldNames ? '' : 'maxCacheSizeBytes', subBuilder: $26.UInt64Value.create)
    ..aOM<$26.UInt64Value>(4, _omitFieldNames ? '' : 'maxIndividualCacheEntrySizeBytes', subBuilder: $26.UInt64Value.create)
    ..aOM<$26.UInt64Value>(5, _omitFieldNames ? '' : 'maxCacheEntryCount', subBuilder: $26.UInt64Value.create)
    ...
    ..aOM<$28.Duration>(8, _omitFieldNames ? '' : 'maxEvictionPeriod', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(9, _omitFieldNames ? '' : 'minEvictionPeriod', subBuilder: $28.Duration.create)
  ...
  @$pb.TagNumber(1)
  $180.AsyncFileManagerConfig get managerConfig => $_getN(0);
  @$pb.TagNumber(1)
  set managerConfig($180.AsyncFileManagerConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasManagerConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearManagerConfig() => clearField(1);
  @$pb.TagNumber(1)
  $180.AsyncFileManagerConfig ensureManagerConfig() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $26.UInt64Value get maxCacheSizeBytes => $_getN(2);
  @$pb.TagNumber(3)
  set maxCacheSizeBytes($26.UInt64Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMaxCacheSizeBytes() => $_has(2);
  @$pb.TagNumber(3)
  void clearMaxCacheSizeBytes() => clearField(3);
  @$pb.TagNumber(3)
  $26.UInt64Value ensureMaxCacheSizeBytes() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $26.UInt64Value get maxIndividualCacheEntrySizeBytes => $_getN(3);
  @$pb.TagNumber(4)
  set maxIndividualCacheEntrySizeBytes($26.UInt64Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasMaxIndividualCacheEntrySizeBytes() => $_has(3);
  @$pb.TagNumber(4)
  void clearMaxIndividualCacheEntrySizeBytes() => clearField(4);
  @$pb.TagNumber(4)
  $26.UInt64Value ensureMaxIndividualCacheEntrySizeBytes() => $_ensure(3);

  ///  The maximum number of cache entries - when reached, cache eviction is triggered.
  ///
  ///  If unset there is no limit.
  @$pb.TagNumber(5)
  $26.UInt64Value get maxCacheEntryCount => $_getN(4);
  @$pb.TagNumber(5)
  set maxCacheEntryCount($26.UInt64Value v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasMaxCacheEntryCount() => $_has(4);
  @$pb.TagNumber(5)
  void clearMaxCacheEntryCount() => clearField(5);
  @$pb.TagNumber(5)
  $26.UInt64Value ensureMaxCacheEntryCount() => $_ensure(4);
  ...
  ///  [#not-implemented-hide:]
  @$pb.TagNumber(8)
  $28.Duration get maxEvictionPeriod => $_getN(7);
  @$pb.TagNumber(8)
  set maxEvictionPeriod($28.Duration v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasMaxEvictionPeriod() => $_has(7);
  @$pb.TagNumber(8)
  void clearMaxEvictionPeriod() => clearField(8);
  @$pb.TagNumber(8)
  $28.Duration ensureMaxEvictionPeriod() => $_ensure(7);
  ...
  ///  [#not-implemented-hide:]
  @$pb.TagNumber(9)
  $28.Duration get minEvictionPeriod => $_getN(8);
  @$pb.TagNumber(9)
  set minEvictionPeriod($28.Duration v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasMinEvictionPeriod() => $_has(8);
  @$pb.TagNumber(9)
  void clearMinEvictionPeriod() => clearField(9);
  @$pb.TagNumber(9)
  $28.Duration ensureMinEvictionPeriod() => $_ensure(8);
