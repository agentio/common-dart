...
class RedirectPolicy extends $pb.GeneratedMessage {
  factory RedirectPolicy({
    $core.String? uri,
    $66.RedirectAction? redirectAction,
    ...
    $40.TypedExtensionConfig? modifyRequestHeadersAction,
  }) {
    final $result = create();
    if (uri != null) {
      $result.uri = uri;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RedirectPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.http.custom_response.redirect_policy.v3'), createEmptyInstance: create)
    ...
    ..aOM<$66.RedirectAction>(2, _omitFieldNames ? '' : 'redirectAction', subBuilder: $66.RedirectAction.create)
    ..aOM<$26.UInt32Value>(3, _omitFieldNames ? '' : 'statusCode', subBuilder: $26.UInt32Value.create)
    ..pc<$47.HeaderValueOption>(4, _omitFieldNames ? '' : 'responseHeadersToAdd', $pb.PbFieldType.PM, subBuilder: $47.HeaderValueOption.create)
    ..pc<$47.HeaderValueOption>(5, _omitFieldNames ? '' : 'requestHeadersToAdd', $pb.PbFieldType.PM, subBuilder: $47.HeaderValueOption.create)
    ..aOM<$40.TypedExtensionConfig>(6, _omitFieldNames ? '' : 'modifyRequestHeadersAction', subBuilder: $40.TypedExtensionConfig.create)
  ...
  /// - ``regex_rewrite``
  @$pb.TagNumber(2)
  $66.RedirectAction get redirectAction => $_getN(1);
  @$pb.TagNumber(2)
  set redirectAction($66.RedirectAction v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasRedirectAction() => $_has(1);
  @$pb.TagNumber(2)
  void clearRedirectAction() => clearField(2);
  @$pb.TagNumber(2)
  $66.RedirectAction ensureRedirectAction() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $26.UInt32Value get statusCode => $_getN(2);
  @$pb.TagNumber(3)
  set statusCode($26.UInt32Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasStatusCode() => $_has(2);
  @$pb.TagNumber(3)
  void clearStatusCode() => clearField(3);
  @$pb.TagNumber(3)
  $26.UInt32Value ensureStatusCode() => $_ensure(2);
  ...
  @$pb.TagNumber(6)
  $40.TypedExtensionConfig get modifyRequestHeadersAction => $_getN(5);
  @$pb.TagNumber(6)
  set modifyRequestHeadersAction($40.TypedExtensionConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasModifyRequestHeadersAction() => $_has(5);
  @$pb.TagNumber(6)
  void clearModifyRequestHeadersAction() => clearField(6);
  @$pb.TagNumber(6)
  $40.TypedExtensionConfig ensureModifyRequestHeadersAction() => $_ensure(5);
}
