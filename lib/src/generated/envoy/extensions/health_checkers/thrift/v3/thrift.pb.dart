...
import '../../../filters/network/thrift_proxy/v3/thrift_proxy.pbenum.dart' as $189;
...
class Thrift extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Thrift', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.health_checkers.thrift.v3'), createEmptyInstance: create)
    ...
    ..e<$189.TransportType>(2, _omitFieldNames ? '' : 'transport', $pb.PbFieldType.OE, defaultOrMaker: $189.TransportType.AUTO_TRANSPORT, valueOf: $189.TransportType.valueOf, enumValues: $189.TransportType.values)
    ..e<$189.ProtocolType>(3, _omitFieldNames ? '' : 'protocol', $pb.PbFieldType.OE, defaultOrMaker: $189.ProtocolType.AUTO_PROTOCOL, valueOf: $189.ProtocolType.valueOf, enumValues: $189.ProtocolType.values)
  ...
  @$pb.TagNumber(2)
  $189.TransportType get transport => $_getN(1);
  @$pb.TagNumber(2)
  set transport($189.TransportType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  $189.ProtocolType get protocol => $_getN(2);
  @$pb.TagNumber(3)
  set protocol($189.ProtocolType v) { setField(3, v); }
  @$pb.TagNumber(3)
