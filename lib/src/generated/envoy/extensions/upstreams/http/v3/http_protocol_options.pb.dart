...
import '../../../filters/network/http_connection_manager/v3/http_connection_manager.pb.dart' as $194;
...
class HttpProtocolOptions_ExplicitHttpConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpProtocolOptions.ExplicitHttpConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.upstreams.http.v3'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$51.Http1ProtocolOptions>(1, _omitFieldNames ? '' : 'httpProtocolOptions', subBuilder: $51.Http1ProtocolOptions.create)
    ..aOM<$51.Http2ProtocolOptions>(2, _omitFieldNames ? '' : 'http2ProtocolOptions', subBuilder: $51.Http2ProtocolOptions.create)
    ..aOM<$51.Http3ProtocolOptions>(3, _omitFieldNames ? '' : 'http3ProtocolOptions', subBuilder: $51.Http3ProtocolOptions.create)
  ...
  @$pb.TagNumber(1)
  $51.Http1ProtocolOptions get httpProtocolOptions => $_getN(0);
  @$pb.TagNumber(1)
  set httpProtocolOptions($51.Http1ProtocolOptions v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasHttpProtocolOptions() => $_has(0);
  @$pb.TagNumber(1)
  void clearHttpProtocolOptions() => clearField(1);
  @$pb.TagNumber(1)
  $51.Http1ProtocolOptions ensureHttpProtocolOptions() => $_ensure(0);

  @$pb.TagNumber(2)
  $51.Http2ProtocolOptions get http2ProtocolOptions => $_getN(1);
  @$pb.TagNumber(2)
  set http2ProtocolOptions($51.Http2ProtocolOptions v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasHttp2ProtocolOptions() => $_has(1);
  @$pb.TagNumber(2)
  void clearHttp2ProtocolOptions() => clearField(2);
  @$pb.TagNumber(2)
  $51.Http2ProtocolOptions ensureHttp2ProtocolOptions() => $_ensure(1);

  /// .. warning::
  ///   QUIC upstream support is currently not ready for internet use.
  ///   Please see :ref:`here <arch_overview_http3>` for details.
  @$pb.TagNumber(3)
  $51.Http3ProtocolOptions get http3ProtocolOptions => $_getN(2);
  @$pb.TagNumber(3)
  set http3ProtocolOptions($51.Http3ProtocolOptions v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasHttp3ProtocolOptions() => $_has(2);
  @$pb.TagNumber(3)
  void clearHttp3ProtocolOptions() => clearField(3);
  @$pb.TagNumber(3)
  $51.Http3ProtocolOptions ensureHttp3ProtocolOptions() => $_ensure(2);
}
...
class HttpProtocolOptions_AutoHttpConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpProtocolOptions.AutoHttpConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.upstreams.http.v3'), createEmptyInstance: create)
    ...
    ..aOM<$51.Http2ProtocolOptions>(2, _omitFieldNames ? '' : 'http2ProtocolOptions', subBuilder: $51.Http2ProtocolOptions.create)
    ..aOM<$51.Http3ProtocolOptions>(3, _omitFieldNames ? '' : 'http3ProtocolOptions', subBuilder: $51.Http3ProtocolOptions.create)
    ..aOM<$51.AlternateProtocolsCacheOptions>(4, _omitFieldNames ? '' : 'alternateProtocolsCacheOptions', subBuilder: $51.AlternateProtocolsCacheOptions.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $51.AlternateProtocolsCacheOptions get alternateProtocolsCacheOptions => $_getN(3);
  @$pb.TagNumber(4)
  set alternateProtocolsCacheOptions($51.AlternateProtocolsCacheOptions v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAlternateProtocolsCacheOptions() => $_has(3);
  @$pb.TagNumber(4)
  void clearAlternateProtocolsCacheOptions() => clearField(4);
  @$pb.TagNumber(4)
  $51.AlternateProtocolsCacheOptions ensureAlternateProtocolsCacheOptions() => $_ensure(3);
}
...
class HttpProtocolOptions extends $pb.GeneratedMessage {
  factory HttpProtocolOptions({
    ...
    $core.Iterable<$194.HttpFilter>? httpFilters,
    $40.TypedExtensionConfig? headerValidationConfig,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpProtocolOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.upstreams.http.v3'), createEmptyInstance: create)
    ..oo(0, [3, 4, 5])
    ..aOM<$51.HttpProtocolOptions>(1, _omitFieldNames ? '' : 'commonHttpProtocolOptions', subBuilder: $51.HttpProtocolOptions.create)
    ..aOM<$51.UpstreamHttpProtocolOptions>(2, _omitFieldNames ? '' : 'upstreamHttpProtocolOptions', subBuilder: $51.UpstreamHttpProtocolOptions.create)
    ...
    ..pc<$194.HttpFilter>(6, _omitFieldNames ? '' : 'httpFilters', $pb.PbFieldType.PM, subBuilder: $194.HttpFilter.create)
    ..aOM<$40.TypedExtensionConfig>(7, _omitFieldNames ? '' : 'headerValidationConfig', subBuilder: $40.TypedExtensionConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $51.HttpProtocolOptions get commonHttpProtocolOptions => $_getN(0);
  @$pb.TagNumber(1)
  set commonHttpProtocolOptions($51.HttpProtocolOptions v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCommonHttpProtocolOptions() => $_has(0);
  @$pb.TagNumber(1)
  void clearCommonHttpProtocolOptions() => clearField(1);
  @$pb.TagNumber(1)
  $51.HttpProtocolOptions ensureCommonHttpProtocolOptions() => $_ensure(0);

  /// This contains common protocol options which are only applied upstream.
  @$pb.TagNumber(2)
  $51.UpstreamHttpProtocolOptions get upstreamHttpProtocolOptions => $_getN(1);
  @$pb.TagNumber(2)
  set upstreamHttpProtocolOptions($51.UpstreamHttpProtocolOptions v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpstreamHttpProtocolOptions() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpstreamHttpProtocolOptions() => clearField(2);
  @$pb.TagNumber(2)
  $51.UpstreamHttpProtocolOptions ensureUpstreamHttpProtocolOptions() => $_ensure(1);
  ...
  @$pb.TagNumber(6)
  $core.List<$194.HttpFilter> get httpFilters => $_getList(5);
  ...
  @$pb.TagNumber(7)
  $40.TypedExtensionConfig get headerValidationConfig => $_getN(6);
  @$pb.TagNumber(7)
  set headerValidationConfig($40.TypedExtensionConfig v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasHeaderValidationConfig() => $_has(6);
  @$pb.TagNumber(7)
  void clearHeaderValidationConfig() => clearField(7);
  @$pb.TagNumber(7)
  $40.TypedExtensionConfig ensureHeaderValidationConfig() => $_ensure(6);
}
