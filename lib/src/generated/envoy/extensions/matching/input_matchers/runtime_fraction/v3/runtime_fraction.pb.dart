...
class RuntimeFraction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RuntimeFraction', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.matching.input_matchers.runtime_fraction.v3'), createEmptyInstance: create)
    ..aOM<$47.RuntimeFractionalPercent>(1, _omitFieldNames ? '' : 'runtimeFraction', subBuilder: $47.RuntimeFractionalPercent.create)
  ...
  @$pb.TagNumber(1)
  $47.RuntimeFractionalPercent get runtimeFraction => $_getN(0);
  @$pb.TagNumber(1)
  set runtimeFraction($47.RuntimeFractionalPercent v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasRuntimeFraction() => $_has(0);
  @$pb.TagNumber(1)
  void clearRuntimeFraction() => clearField(1);
  @$pb.TagNumber(1)
  $47.RuntimeFractionalPercent ensureRuntimeFraction() => $_ensure(0);
