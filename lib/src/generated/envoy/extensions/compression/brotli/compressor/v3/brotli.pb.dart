...
class Brotli extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Brotli', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.compression.brotli.compressor.v3'), createEmptyInstance: create)
    ..aOM<$26.UInt32Value>(1, _omitFieldNames ? '' : 'quality', subBuilder: $26.UInt32Value.create)
    ...
    ..aOM<$26.UInt32Value>(3, _omitFieldNames ? '' : 'windowBits', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(4, _omitFieldNames ? '' : 'inputBlockBits', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(5, _omitFieldNames ? '' : 'chunkSize', subBuilder: $26.UInt32Value.create)
  ...
  @$pb.TagNumber(1)
  $26.UInt32Value get quality => $_getN(0);
  @$pb.TagNumber(1)
  set quality($26.UInt32Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasQuality() => $_has(0);
  @$pb.TagNumber(1)
  void clearQuality() => clearField(1);
  @$pb.TagNumber(1)
  $26.UInt32Value ensureQuality() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $26.UInt32Value get windowBits => $_getN(2);
  @$pb.TagNumber(3)
  set windowBits($26.UInt32Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasWindowBits() => $_has(2);
  @$pb.TagNumber(3)
  void clearWindowBits() => clearField(3);
  @$pb.TagNumber(3)
  $26.UInt32Value ensureWindowBits() => $_ensure(2);
  ...
  /// https://brotli.org/encode.html#a9a8
  @$pb.TagNumber(4)
  $26.UInt32Value get inputBlockBits => $_getN(3);
  @$pb.TagNumber(4)
  set inputBlockBits($26.UInt32Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasInputBlockBits() => $_has(3);
  @$pb.TagNumber(4)
  void clearInputBlockBits() => clearField(4);
  @$pb.TagNumber(4)
  $26.UInt32Value ensureInputBlockBits() => $_ensure(3);

  /// Value for compressor's next output buffer. If not set, defaults to 4096.
  @$pb.TagNumber(5)
  $26.UInt32Value get chunkSize => $_getN(4);
  @$pb.TagNumber(5)
  set chunkSize($26.UInt32Value v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasChunkSize() => $_has(4);
  @$pb.TagNumber(5)
  void clearChunkSize() => clearField(5);
  @$pb.TagNumber(5)
  $26.UInt32Value ensureChunkSize() => $_ensure(4);
