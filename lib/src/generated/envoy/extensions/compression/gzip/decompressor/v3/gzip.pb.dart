...
class Gzip extends $pb.GeneratedMessage {
  factory Gzip({
    ...
    $26.UInt32Value? maxInflateRatio,
  }) {
    final $result = create();
    if (windowBits != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Gzip', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.compression.gzip.decompressor.v3'), createEmptyInstance: create)
    ..aOM<$26.UInt32Value>(1, _omitFieldNames ? '' : 'windowBits', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(2, _omitFieldNames ? '' : 'chunkSize', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(3, _omitFieldNames ? '' : 'maxInflateRatio', subBuilder: $26.UInt32Value.create)
  ...
  @$pb.TagNumber(1)
  $26.UInt32Value get windowBits => $_getN(0);
  @$pb.TagNumber(1)
  set windowBits($26.UInt32Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasWindowBits() => $_has(0);
  @$pb.TagNumber(1)
  void clearWindowBits() => clearField(1);
  @$pb.TagNumber(1)
  $26.UInt32Value ensureWindowBits() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $26.UInt32Value get chunkSize => $_getN(1);
  @$pb.TagNumber(2)
  set chunkSize($26.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasChunkSize() => $_has(1);
  @$pb.TagNumber(2)
  void clearChunkSize() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt32Value ensureChunkSize() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $26.UInt32Value get maxInflateRatio => $_getN(2);
  @$pb.TagNumber(3)
  set maxInflateRatio($26.UInt32Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMaxInflateRatio() => $_has(2);
  @$pb.TagNumber(3)
  void clearMaxInflateRatio() => clearField(3);
  @$pb.TagNumber(3)
  $26.UInt32Value ensureMaxInflateRatio() => $_ensure(2);
}
