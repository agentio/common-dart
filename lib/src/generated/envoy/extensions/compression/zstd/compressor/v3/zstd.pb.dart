...
class Zstd extends $pb.GeneratedMessage {
  factory Zstd({
    $26.UInt32Value? compressionLevel,
    $core.bool? enableChecksum,
    Zstd_Strategy? strategy,
    $47.DataSource? dictionary,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Zstd', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.compression.zstd.compressor.v3'), createEmptyInstance: create)
    ..aOM<$26.UInt32Value>(1, _omitFieldNames ? '' : 'compressionLevel', subBuilder: $26.UInt32Value.create)
    ...
    ..aOM<$47.DataSource>(4, _omitFieldNames ? '' : 'dictionary', subBuilder: $47.DataSource.create)
  ...
  /// ones will 'stick'.
  @$pb.TagNumber(1)
  $26.UInt32Value get compressionLevel => $_getN(0);
  @$pb.TagNumber(1)
  set compressionLevel($26.UInt32Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCompressionLevel() => $_has(0);
  @$pb.TagNumber(1)
  void clearCompressionLevel() => clearField(1);
  @$pb.TagNumber(1)
  $26.UInt32Value ensureCompressionLevel() => $_ensure(0);
  ...
  @$pb.TagNumber(4)
  $47.DataSource get dictionary => $_getN(3);
  @$pb.TagNumber(4)
  set dictionary($47.DataSource v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDictionary() => $_has(3);
  @$pb.TagNumber(4)
  void clearDictionary() => clearField(4);
  @$pb.TagNumber(4)
  $47.DataSource ensureDictionary() => $_ensure(3);
