...
class SinkConfig extends $pb.GeneratedMessage {
  factory SinkConfig({
    ...
    $26.BoolValue? emitTagsAsAttributes,
    $26.BoolValue? useTagExtractedName,
    $core.String? prefix,
  }) {
    final $result = create();
    if (grpcService != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SinkConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.stat_sinks.open_telemetry.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.BoolValue>(4, _omitFieldNames ? '' : 'emitTagsAsAttributes', subBuilder: $26.BoolValue.create)
    ..aOM<$26.BoolValue>(5, _omitFieldNames ? '' : 'useTagExtractedName', subBuilder: $26.BoolValue.create)
  ...
  @$pb.TagNumber(4)
  $26.BoolValue get emitTagsAsAttributes => $_getN(3);
  @$pb.TagNumber(4)
  set emitTagsAsAttributes($26.BoolValue v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasEmitTagsAsAttributes() => $_has(3);
  @$pb.TagNumber(4)
  void clearEmitTagsAsAttributes() => clearField(4);
  @$pb.TagNumber(4)
  $26.BoolValue ensureEmitTagsAsAttributes() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $26.BoolValue get useTagExtractedName => $_getN(4);
  @$pb.TagNumber(5)
  set useTagExtractedName($26.BoolValue v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasUseTagExtractedName() => $_has(4);
  @$pb.TagNumber(5)
  void clearUseTagExtractedName() => clearField(5);
  @$pb.TagNumber(5)
  $26.BoolValue ensureUseTagExtractedName() => $_ensure(4);
