...
class CommonGrpcAccessLogConfig extends $pb.GeneratedMessage {
  factory CommonGrpcAccessLogConfig({
    ...
    $47.RetryPolicy? grpcStreamRetryPolicy,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommonGrpcAccessLogConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.access_loggers.grpc.v3'), createEmptyInstance: create)
    ...
    ..e<$50.ApiVersion>(6, _omitFieldNames ? '' : 'transportApiVersion', $pb.PbFieldType.OE, defaultOrMaker: $50.ApiVersion.AUTO, valueOf: $50.ApiVersion.valueOf, enumValues: $50.ApiVersion.values)
    ..aOM<$47.RetryPolicy>(7, _omitFieldNames ? '' : 'grpcStreamRetryPolicy', subBuilder: $47.RetryPolicy.create)
  ...
  @$pb.TagNumber(6)
  $50.ApiVersion get transportApiVersion => $_getN(5);
  @$pb.TagNumber(6)
  set transportApiVersion($50.ApiVersion v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  $47.RetryPolicy get grpcStreamRetryPolicy => $_getN(6);
  @$pb.TagNumber(7)
  set grpcStreamRetryPolicy($47.RetryPolicy v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasGrpcStreamRetryPolicy() => $_has(6);
  @$pb.TagNumber(7)
  void clearGrpcStreamRetryPolicy() => clearField(7);
  @$pb.TagNumber(7)
  $47.RetryPolicy ensureGrpcStreamRetryPolicy() => $_ensure(6);

  /// A list of custom tags with unique tag name to create tags for the logs.
  @$pb.TagNumber(8)
  $core.List<$64.CustomTag> get customTags => $_getList(7);
}
