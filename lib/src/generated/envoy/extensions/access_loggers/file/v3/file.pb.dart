...
class FileAccessLog extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    $30.Struct? typedJsonFormat,
    $181.SubstitutionFormatString? logFormat,
  }) {
    final $result = create();
    if (path != null) {
      $result.path = path;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FileAccessLog', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.access_loggers.file.v3'), createEmptyInstance: create)
    ...
    ..aOM<$30.Struct>(3, _omitFieldNames ? '' : 'jsonFormat', subBuilder: $30.Struct.create)
    ..aOM<$30.Struct>(4, _omitFieldNames ? '' : 'typedJsonFormat', subBuilder: $30.Struct.create)
    ..aOM<$181.SubstitutionFormatString>(5, _omitFieldNames ? '' : 'logFormat', subBuilder: $181.SubstitutionFormatString.create)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(3)
  $30.Struct get jsonFormat => $_getN(2);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(3)
  set jsonFormat($30.Struct v) { setField(3, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(3)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(3)
  $30.Struct ensureJsonFormat() => $_ensure(2);
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(4)
  $30.Struct get typedJsonFormat => $_getN(3);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(4)
  set typedJsonFormat($30.Struct v) { setField(4, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(4)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(4)
  $30.Struct ensureTypedJsonFormat() => $_ensure(3);

  /// Configuration to form access log data and format.
  /// If not specified, use :ref:`default format <config_access_log_default_format>`.
  @$pb.TagNumber(5)
  $181.SubstitutionFormatString get logFormat => $_getN(4);
  @$pb.TagNumber(5)
  set logFormat($181.SubstitutionFormatString v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasLogFormat() => $_has(4);
  @$pb.TagNumber(5)
  void clearLogFormat() => clearField(5);
  @$pb.TagNumber(5)
  $181.SubstitutionFormatString ensureLogFormat() => $_ensure(4);
}
