...
class StdoutAccessLog extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StdoutAccessLog', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.access_loggers.stream.v3'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<$181.SubstitutionFormatString>(1, _omitFieldNames ? '' : 'logFormat', subBuilder: $181.SubstitutionFormatString.create)
  ...
  @$pb.TagNumber(1)
  $181.SubstitutionFormatString get logFormat => $_getN(0);
  @$pb.TagNumber(1)
  set logFormat($181.SubstitutionFormatString v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasLogFormat() => $_has(0);
  @$pb.TagNumber(1)
  void clearLogFormat() => clearField(1);
  @$pb.TagNumber(1)
  $181.SubstitutionFormatString ensureLogFormat() => $_ensure(0);
}
