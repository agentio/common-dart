...
const OpenTelemetryAccessLogConfig$json = {
  ...
  '2': [
    ...
    {'1': 'stat_prefix', '3': 6, '4': 1, '5': 9, '10': 'statPrefix'},
    {'1': 'formatters', '3': 7, '4': 3, '5': 11, '6': '.envoy.config.core.v3.TypedExtensionConfig', '10': 'formatters'},
  ],
};
...
final $typed_data.Uint8List openTelemetryAccessLogConfigDescriptor = $convert.base64Decode(
    ...
    'J5LnByb3RvLmNvbW1vbi52MS5LZXlWYWx1ZUxpc3RSCmF0dHJpYnV0ZXMSHwoLc3RhdF9wcmVm'
    'aXgYBiABKAlSCnN0YXRQcmVmaXgSSgoKZm9ybWF0dGVycxgHIAMoCzIqLmVudm95LmNvbmZpZy'
    '5jb3JlLnYzLlR5cGVkRXh0ZW5zaW9uQ29uZmlnUgpmb3JtYXR0ZXJz');
