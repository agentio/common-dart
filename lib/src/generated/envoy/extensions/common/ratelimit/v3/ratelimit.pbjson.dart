...
@$core.Deprecated('Use localClusterRateLimitDescriptor instead')
const LocalClusterRateLimit$json = {
  '1': 'LocalClusterRateLimit',
};

/// Descriptor for `LocalClusterRateLimit`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List localClusterRateLimitDescriptor = $convert.base64Decode(
    'ChVMb2NhbENsdXN0ZXJSYXRlTGltaXQ=');
