...
import '../../../../config/cluster/v3/cluster.pb.dart' as $115;
import '../../../../config/cluster/v3/cluster.pbenum.dart' as $115;
import '../../../../config/common/key_value/v3/config.pb.dart' as $190;
import '../../../../config/core/v3/address.pb.dart' as $42;
import '../../../../config/core/v3/extension.pb.dart' as $40;
import '../../../../config/core/v3/resolver.pb.dart' as $109;
...
class DnsCacheCircuitBreakers extends $pb.GeneratedMessage {
  factory DnsCacheCircuitBreakers({
    $26.UInt32Value? maxPendingRequests,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DnsCacheCircuitBreakers', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.common.dynamic_forward_proxy.v3'), createEmptyInstance: create)
    ..aOM<$26.UInt32Value>(1, _omitFieldNames ? '' : 'maxPendingRequests', subBuilder: $26.UInt32Value.create)
  ...
  @$pb.TagNumber(1)
  $26.UInt32Value get maxPendingRequests => $_getN(0);
  @$pb.TagNumber(1)
  set maxPendingRequests($26.UInt32Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasMaxPendingRequests() => $_has(0);
  @$pb.TagNumber(1)
  void clearMaxPendingRequests() => clearField(1);
  @$pb.TagNumber(1)
  $26.UInt32Value ensureMaxPendingRequests() => $_ensure(0);
}
...
class DnsCacheConfig extends $pb.GeneratedMessage {
  factory DnsCacheConfig({
    $core.String? name,
    $115.Cluster_DnsLookupFamily? dnsLookupFamily,
    $28.Duration? dnsRefreshRate,
    $28.Duration? hostTtl,
    $26.UInt32Value? maxHosts,
    $115.Cluster_RefreshRate? dnsFailureRefreshRate,
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    $core.Iterable<$42.SocketAddress>? preresolveHostnames,
    $28.Duration? dnsQueryTimeout,
    $40.TypedExtensionConfig? typedDnsResolverConfig,
    $190.KeyValueStoreConfig? keyValueConfig,
    $28.Duration? dnsMinRefreshRate,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DnsCacheConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.common.dynamic_forward_proxy.v3'), createEmptyInstance: create)
    ...
    ..e<$115.Cluster_DnsLookupFamily>(2, _omitFieldNames ? '' : 'dnsLookupFamily', $pb.PbFieldType.OE, defaultOrMaker: $115.Cluster_DnsLookupFamily.AUTO, valueOf: $115.Cluster_DnsLookupFamily.valueOf, enumValues: $115.Cluster_DnsLookupFamily.values)
    ..aOM<$28.Duration>(3, _omitFieldNames ? '' : 'dnsRefreshRate', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(4, _omitFieldNames ? '' : 'hostTtl', subBuilder: $28.Duration.create)
    ..aOM<$26.UInt32Value>(5, _omitFieldNames ? '' : 'maxHosts', subBuilder: $26.UInt32Value.create)
    ..aOM<$115.Cluster_RefreshRate>(6, _omitFieldNames ? '' : 'dnsFailureRefreshRate', subBuilder: $115.Cluster_RefreshRate.create)
    ...
    ..aOM<$109.DnsResolutionConfig>(9, _omitFieldNames ? '' : 'dnsResolutionConfig', subBuilder: $109.DnsResolutionConfig.create)
    ..pc<$42.SocketAddress>(10, _omitFieldNames ? '' : 'preresolveHostnames', $pb.PbFieldType.PM, subBuilder: $42.SocketAddress.create)
    ..aOM<$28.Duration>(11, _omitFieldNames ? '' : 'dnsQueryTimeout', subBuilder: $28.Duration.create)
    ..aOM<$40.TypedExtensionConfig>(12, _omitFieldNames ? '' : 'typedDnsResolverConfig', subBuilder: $40.TypedExtensionConfig.create)
    ..aOM<$190.KeyValueStoreConfig>(13, _omitFieldNames ? '' : 'keyValueConfig', subBuilder: $190.KeyValueStoreConfig.create)
    ..aOM<$28.Duration>(14, _omitFieldNames ? '' : 'dnsMinRefreshRate', subBuilder: $28.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $115.Cluster_DnsLookupFamily get dnsLookupFamily => $_getN(1);
  @$pb.TagNumber(2)
  set dnsLookupFamily($115.Cluster_DnsLookupFamily v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  $28.Duration get dnsRefreshRate => $_getN(2);
  @$pb.TagNumber(3)
  set dnsRefreshRate($28.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasDnsRefreshRate() => $_has(2);
  @$pb.TagNumber(3)
  void clearDnsRefreshRate() => clearField(3);
  @$pb.TagNumber(3)
  $28.Duration ensureDnsRefreshRate() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $28.Duration get hostTtl => $_getN(3);
  @$pb.TagNumber(4)
  set hostTtl($28.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasHostTtl() => $_has(3);
  @$pb.TagNumber(4)
  void clearHostTtl() => clearField(4);
  @$pb.TagNumber(4)
  $28.Duration ensureHostTtl() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $26.UInt32Value get maxHosts => $_getN(4);
  @$pb.TagNumber(5)
  set maxHosts($26.UInt32Value v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasMaxHosts() => $_has(4);
  @$pb.TagNumber(5)
  void clearMaxHosts() => clearField(5);
  @$pb.TagNumber(5)
  $26.UInt32Value ensureMaxHosts() => $_ensure(4);

  /// If the DNS failure refresh rate is specified,
  /// this is used as the cache's DNS refresh rate when DNS requests are failing. If this setting is
  /// not specified, the failure refresh rate defaults to the dns_refresh_rate.
  @$pb.TagNumber(6)
  $115.Cluster_RefreshRate get dnsFailureRefreshRate => $_getN(5);
  @$pb.TagNumber(6)
  set dnsFailureRefreshRate($115.Cluster_RefreshRate v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasDnsFailureRefreshRate() => $_has(5);
  @$pb.TagNumber(6)
  void clearDnsFailureRefreshRate() => clearField(6);
  @$pb.TagNumber(6)
  $115.Cluster_RefreshRate ensureDnsFailureRefreshRate() => $_ensure(5);
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
  $109.DnsResolutionConfig get dnsResolutionConfig => $_getN(8);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
  set dnsResolutionConfig($109.DnsResolutionConfig v) { setField(9, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
  $109.DnsResolutionConfig ensureDnsResolutionConfig() => $_ensure(8);
  ...
  @$pb.TagNumber(10)
  $core.List<$42.SocketAddress> get preresolveHostnames => $_getList(9);
  ...
  @$pb.TagNumber(11)
  $28.Duration get dnsQueryTimeout => $_getN(10);
  @$pb.TagNumber(11)
  set dnsQueryTimeout($28.Duration v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasDnsQueryTimeout() => $_has(10);
  @$pb.TagNumber(11)
  void clearDnsQueryTimeout() => clearField(11);
  @$pb.TagNumber(11)
  $28.Duration ensureDnsQueryTimeout() => $_ensure(10);
  ...
  @$pb.TagNumber(12)
  $40.TypedExtensionConfig get typedDnsResolverConfig => $_getN(11);
  @$pb.TagNumber(12)
  set typedDnsResolverConfig($40.TypedExtensionConfig v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasTypedDnsResolverConfig() => $_has(11);
  @$pb.TagNumber(12)
  void clearTypedDnsResolverConfig() => clearField(12);
  @$pb.TagNumber(12)
  $40.TypedExtensionConfig ensureTypedDnsResolverConfig() => $_ensure(11);

  /// Configuration to flush the DNS cache to long term storage.
  @$pb.TagNumber(13)
  $190.KeyValueStoreConfig get keyValueConfig => $_getN(12);
  @$pb.TagNumber(13)
  set keyValueConfig($190.KeyValueStoreConfig v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasKeyValueConfig() => $_has(12);
  @$pb.TagNumber(13)
  void clearKeyValueConfig() => clearField(13);
  @$pb.TagNumber(13)
  $190.KeyValueStoreConfig ensureKeyValueConfig() => $_ensure(12);
  ...
  @$pb.TagNumber(14)
  $28.Duration get dnsMinRefreshRate => $_getN(13);
  @$pb.TagNumber(14)
  set dnsMinRefreshRate($28.Duration v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasDnsMinRefreshRate() => $_has(13);
  @$pb.TagNumber(14)
  void clearDnsMinRefreshRate() => clearField(14);
  @$pb.TagNumber(14)
  $28.Duration ensureDnsMinRefreshRate() => $_ensure(13);
}
