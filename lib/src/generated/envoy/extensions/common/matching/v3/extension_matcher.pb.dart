...
import '../../../../config/common/matcher/v3/matcher.pb.dart' as $144;
...
class ExtensionWithMatcher extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    $144.Matcher? matcher,
    $40.TypedExtensionConfig? extensionConfig,
    $61.Matcher? xdsMatcher,
  }) {
    final $result = create();
    if (matcher != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExtensionWithMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.common.matching.v3'), createEmptyInstance: create)
    ..aOM<$144.Matcher>(1, _omitFieldNames ? '' : 'matcher', subBuilder: $144.Matcher.create)
    ..aOM<$40.TypedExtensionConfig>(2, _omitFieldNames ? '' : 'extensionConfig', subBuilder: $40.TypedExtensionConfig.create)
    ..aOM<$61.Matcher>(3, _omitFieldNames ? '' : 'xdsMatcher', subBuilder: $61.Matcher.create)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  $144.Matcher get matcher => $_getN(0);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  set matcher($144.Matcher v) { setField(1, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  $144.Matcher ensureMatcher() => $_ensure(0);

  /// The underlying extension config.
  @$pb.TagNumber(2)
  $40.TypedExtensionConfig get extensionConfig => $_getN(1);
  @$pb.TagNumber(2)
  set extensionConfig($40.TypedExtensionConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasExtensionConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearExtensionConfig() => clearField(2);
  @$pb.TagNumber(2)
  $40.TypedExtensionConfig ensureExtensionConfig() => $_ensure(1);

  /// The associated matcher.
  @$pb.TagNumber(3)
  $61.Matcher get xdsMatcher => $_getN(2);
  @$pb.TagNumber(3)
  set xdsMatcher($61.Matcher v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasXdsMatcher() => $_has(2);
  @$pb.TagNumber(3)
  void clearXdsMatcher() => clearField(3);
  @$pb.TagNumber(3)
  $61.Matcher ensureXdsMatcher() => $_ensure(2);
}
...
class ExtensionWithMatcherPerRoute extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExtensionWithMatcherPerRoute', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.common.matching.v3'), createEmptyInstance: create)
    ..aOM<$61.Matcher>(1, _omitFieldNames ? '' : 'xdsMatcher', subBuilder: $61.Matcher.create)
    ..hasRequiredFields = false
  ;
  ...
  /// Matcher override.
  @$pb.TagNumber(1)
  $61.Matcher get xdsMatcher => $_getN(0);
  @$pb.TagNumber(1)
  set xdsMatcher($61.Matcher v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasXdsMatcher() => $_has(0);
  @$pb.TagNumber(1)
  void clearXdsMatcher() => clearField(1);
  @$pb.TagNumber(1)
  $61.Matcher ensureXdsMatcher() => $_ensure(0);
}
