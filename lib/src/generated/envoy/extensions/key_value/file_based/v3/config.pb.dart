...
class FileBasedKeyValueStoreConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FileBasedKeyValueStoreConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.key_value.file_based.v3'), createEmptyInstance: create)
    ...
    ..aOM<$28.Duration>(2, _omitFieldNames ? '' : 'flushInterval', subBuilder: $28.Duration.create)
    ..aOM<$26.UInt32Value>(3, _omitFieldNames ? '' : 'maxEntries', subBuilder: $26.UInt32Value.create)
  ...
  @$pb.TagNumber(2)
  $28.Duration get flushInterval => $_getN(1);
  @$pb.TagNumber(2)
  set flushInterval($28.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFlushInterval() => $_has(1);
  @$pb.TagNumber(2)
  void clearFlushInterval() => clearField(2);
  @$pb.TagNumber(2)
  $28.Duration ensureFlushInterval() => $_ensure(1);

  /// The maximum number of entries to cache, or 0 to allow for unlimited entries.
  /// Defaults to 1000 if not present.
  @$pb.TagNumber(3)
  $26.UInt32Value get maxEntries => $_getN(2);
  @$pb.TagNumber(3)
  set maxEntries($26.UInt32Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMaxEntries() => $_has(2);
  @$pb.TagNumber(3)
  void clearMaxEntries() => clearField(3);
  @$pb.TagNumber(3)
  $26.UInt32Value ensureMaxEntries() => $_ensure(2);
}
