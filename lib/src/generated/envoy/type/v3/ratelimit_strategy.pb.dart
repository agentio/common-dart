...
import 'ratelimit_unit.pbenum.dart' as $154;
import 'token_bucket.pb.dart' as $153;
...
class RateLimitStrategy_RequestsPerTimeUnit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimitStrategy.RequestsPerTimeUnit', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type.v3'), createEmptyInstance: create)
    ...
    ..e<$154.RateLimitUnit>(2, _omitFieldNames ? '' : 'timeUnit', $pb.PbFieldType.OE, defaultOrMaker: $154.RateLimitUnit.UNKNOWN, valueOf: $154.RateLimitUnit.valueOf, enumValues: $154.RateLimitUnit.values)
  ...
  /// is ``0`` (deny all).
  @$pb.TagNumber(2)
  $154.RateLimitUnit get timeUnit => $_getN(1);
  @$pb.TagNumber(2)
  set timeUnit($154.RateLimitUnit v) { setField(2, v); }
  @$pb.TagNumber(2)
