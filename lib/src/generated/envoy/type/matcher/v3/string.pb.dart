...
import '../../../../xds/core/v3/extension.pb.dart' as $56;
import 'regex.pb.dart' as $55;
...
class StringMatcher extends $pb.GeneratedMessage {
  factory StringMatcher({
    ...
    $56.TypedExtensionConfig? custom,
  }) {
    final $result = create();
    if (exact != null) {
      $result.exact = exact;
  ...
  static const $core.Map<$core.int, StringMatcher_MatchPattern> _StringMatcher_MatchPatternByTag = {
    ...
    8 : StringMatcher_MatchPattern.custom,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StringMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type.matcher.v3'), createEmptyInstance: create)
    ...
    ..aOM<$55.RegexMatcher>(5, _omitFieldNames ? '' : 'safeRegex', subBuilder: $55.RegexMatcher.create)
    ..aOB(6, _omitFieldNames ? '' : 'ignoreCase')
    ..aOS(7, _omitFieldNames ? '' : 'contains')
    ..aOM<$56.TypedExtensionConfig>(8, _omitFieldNames ? '' : 'custom', subBuilder: $56.TypedExtensionConfig.create)
  ...
  @$pb.TagNumber(5)
  $55.RegexMatcher get safeRegex => $_getN(3);
  @$pb.TagNumber(5)
  set safeRegex($55.RegexMatcher v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasSafeRegex() => $_has(3);
  @$pb.TagNumber(5)
  void clearSafeRegex() => clearField(5);
  @$pb.TagNumber(5)
  $55.RegexMatcher ensureSafeRegex() => $_ensure(3);
  ...
  @$pb.TagNumber(8)
  $56.TypedExtensionConfig get custom => $_getN(6);
  @$pb.TagNumber(8)
  set custom($56.TypedExtensionConfig v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasCustom() => $_has(6);
  @$pb.TagNumber(8)
  void clearCustom() => clearField(8);
  @$pb.TagNumber(8)
  $56.TypedExtensionConfig ensureCustom() => $_ensure(6);
}
