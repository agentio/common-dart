...
import 'string.pb.dart' as $58;
import 'struct.pb.dart' as $151;

/// Specifies the way to match a Node.
/// The match follows AND semantics.
class NodeMatcher extends $pb.GeneratedMessage {
  factory NodeMatcher({
    $58.StringMatcher? nodeId,
    $core.Iterable<$151.StructMatcher>? nodeMetadatas,
  }) {
    final $result = create();
    if (nodeId != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NodeMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type.matcher.v3'), createEmptyInstance: create)
    ..aOM<$58.StringMatcher>(1, _omitFieldNames ? '' : 'nodeId', subBuilder: $58.StringMatcher.create)
    ..pc<$151.StructMatcher>(2, _omitFieldNames ? '' : 'nodeMetadatas', $pb.PbFieldType.PM, subBuilder: $151.StructMatcher.create)
  ...
  @$pb.TagNumber(1)
  $58.StringMatcher get nodeId => $_getN(0);
  @$pb.TagNumber(1)
  set nodeId($58.StringMatcher v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasNodeId() => $_has(0);
  @$pb.TagNumber(1)
  void clearNodeId() => clearField(1);
  @$pb.TagNumber(1)
  $58.StringMatcher ensureNodeId() => $_ensure(0);

  /// Specifies match criteria on the node metadata.
  @$pb.TagNumber(2)
  $core.List<$151.StructMatcher> get nodeMetadatas => $_getList(1);
}
