...
const StringMatcher$json = {
  ...
  '2': [
    ...
    {'1': 'custom', '3': 8, '4': 1, '5': 11, '6': '.xds.core.v3.TypedExtensionConfig', '9': 0, '10': 'custom'},
...
final $typed_data.Uint8List stringMatcherDescriptor = $convert.base64Decode(
    ...
    'bnRhaW5zEjsKBmN1c3RvbRgIIAEoCzIhLnhkcy5jb3JlLnYzLlR5cGVkRXh0ZW5zaW9uQ29uZm'
    'lnSABSBmN1c3RvbRIfCgtpZ25vcmVfY2FzZRgGIAEoCFIKaWdub3JlQ2FzZTonmsWIHiIKIGVu'
    'dm95LnR5cGUubWF0Y2hlci5TdHJpbmdNYXRjaGVyQhQKDW1hdGNoX3BhdHRlcm4SA/hCAUoECA'
    'QQBVIFcmVnZXg=');
