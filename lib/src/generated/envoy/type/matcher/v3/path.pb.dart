...
class PathMatcher extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PathMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type.matcher.v3'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<$58.StringMatcher>(1, _omitFieldNames ? '' : 'path', subBuilder: $58.StringMatcher.create)
  ...
  @$pb.TagNumber(1)
  $58.StringMatcher get path => $_getN(0);
  @$pb.TagNumber(1)
  set path($58.StringMatcher v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPath() => $_has(0);
  @$pb.TagNumber(1)
  void clearPath() => clearField(1);
  @$pb.TagNumber(1)
  $58.StringMatcher ensurePath() => $_ensure(0);
}
