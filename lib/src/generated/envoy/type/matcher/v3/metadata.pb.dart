...
class MetadataMatcher_PathSegment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MetadataMatcher.PathSegment', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type.matcher.v3'), createEmptyInstance: create)
    ..oo(0, [1])
...
class MetadataMatcher extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MetadataMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type.matcher.v3'), createEmptyInstance: create)
    ...
    ..aOM<$59.ValueMatcher>(3, _omitFieldNames ? '' : 'value', subBuilder: $59.ValueMatcher.create)
  ...
  @$pb.TagNumber(3)
  $59.ValueMatcher get value => $_getN(2);
  @$pb.TagNumber(3)
  set value($59.ValueMatcher v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasValue() => $_has(2);
  @$pb.TagNumber(3)
  void clearValue() => clearField(3);
  @$pb.TagNumber(3)
  $59.ValueMatcher ensureValue() => $_ensure(2);

  /// If true, the match result will be inverted.
  @$pb.TagNumber(4)
  $core.bool get invert => $_getBF(3);
  @$pb.TagNumber(4)
  set invert($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasInvert() => $_has(3);
  @$pb.TagNumber(4)
