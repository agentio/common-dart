...
class ValueMatcher extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ValueMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type.matcher.v3'), createEmptyInstance: create)
    ...
    ..aOM<$57.DoubleMatcher>(2, _omitFieldNames ? '' : 'doubleMatch', subBuilder: $57.DoubleMatcher.create)
    ..aOM<$58.StringMatcher>(3, _omitFieldNames ? '' : 'stringMatch', subBuilder: $58.StringMatcher.create)
  ...
  @$pb.TagNumber(2)
  $57.DoubleMatcher get doubleMatch => $_getN(1);
  @$pb.TagNumber(2)
  set doubleMatch($57.DoubleMatcher v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDoubleMatch() => $_has(1);
  @$pb.TagNumber(2)
  void clearDoubleMatch() => clearField(2);
  @$pb.TagNumber(2)
  $57.DoubleMatcher ensureDoubleMatch() => $_ensure(1);

  /// If specified, a match occurs if and only if the target value is a string value and is
  /// matched to this field.
  @$pb.TagNumber(3)
  $58.StringMatcher get stringMatch => $_getN(2);
  @$pb.TagNumber(3)
  set stringMatch($58.StringMatcher v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasStringMatch() => $_has(2);
  @$pb.TagNumber(3)
  void clearStringMatch() => clearField(3);
  @$pb.TagNumber(3)
  $58.StringMatcher ensureStringMatch() => $_ensure(2);
