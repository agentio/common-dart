...
class StructMatcher_PathSegment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StructMatcher.PathSegment', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type.matcher.v3'), createEmptyInstance: create)
    ..oo(0, [1])
...
class StructMatcher extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StructMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type.matcher.v3'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(3)
  $59.ValueMatcher get value => $_getN(1);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(3)
  $59.ValueMatcher ensureValue() => $_ensure(1);
}
