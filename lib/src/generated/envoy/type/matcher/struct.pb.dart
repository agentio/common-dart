...
class StructMatcher extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StructMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type.matcher'), createEmptyInstance: create)
    ...
    ..aOM<$124.ValueMatcher>(3, _omitFieldNames ? '' : 'value', subBuilder: $124.ValueMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $124.ValueMatcher get value => $_getN(1);
  @$pb.TagNumber(3)
  set value($124.ValueMatcher v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasValue() => $_has(1);
  @$pb.TagNumber(3)
  void clearValue() => clearField(3);
  @$pb.TagNumber(3)
  $124.ValueMatcher ensureValue() => $_ensure(1);
}
