...
class TokenBucket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TokenBucket', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'maxTokens', $pb.PbFieldType.OU3)
    ..aOM<$26.UInt32Value>(2, _omitFieldNames ? '' : 'tokensPerFill', subBuilder: $26.UInt32Value.create)
    ..aOM<$28.Duration>(3, _omitFieldNames ? '' : 'fillInterval', subBuilder: $28.Duration.create)
  ...
  /// to a single token.
  @$pb.TagNumber(2)
  $26.UInt32Value get tokensPerFill => $_getN(1);
  @$pb.TagNumber(2)
  set tokensPerFill($26.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTokensPerFill() => $_has(1);
  @$pb.TagNumber(2)
  void clearTokensPerFill() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt32Value ensureTokensPerFill() => $_ensure(1);

  /// The fill interval that tokens are added to the bucket. During each fill interval
  /// `tokens_per_fill` are added to the bucket. The bucket will never contain more than
  /// `max_tokens` tokens.
  @$pb.TagNumber(3)
  $28.Duration get fillInterval => $_getN(2);
  @$pb.TagNumber(3)
  set fillInterval($28.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasFillInterval() => $_has(2);
  @$pb.TagNumber(3)
  void clearFillInterval() => clearField(3);
  @$pb.TagNumber(3)
  $28.Duration ensureFillInterval() => $_ensure(2);
}
