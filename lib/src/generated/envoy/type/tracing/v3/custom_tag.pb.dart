...
import '../../metadata/v3/metadata.pb.dart' as $60;
...
class CustomTag_Metadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomTag.Metadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type.tracing.v3'), createEmptyInstance: create)
    ..aOM<$60.MetadataKind>(1, _omitFieldNames ? '' : 'kind', subBuilder: $60.MetadataKind.create)
  ...
  @$pb.TagNumber(1)
  $60.MetadataKind get kind => $_getN(0);
  @$pb.TagNumber(1)
  set kind($60.MetadataKind v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasKind() => $_has(0);
  @$pb.TagNumber(1)
  void clearKind() => clearField(1);
  @$pb.TagNumber(1)
  $60.MetadataKind ensureKind() => $_ensure(0);
