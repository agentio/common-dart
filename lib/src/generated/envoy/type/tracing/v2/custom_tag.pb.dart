...
import '../../metadata/v2/metadata.pb.dart' as $89;
...
class CustomTag_Literal extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomTag.Literal', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type.tracing.v2'), createEmptyInstance: create)
...
class CustomTag_Environment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomTag.Environment', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type.tracing.v2'), createEmptyInstance: create)
...
class CustomTag_Header extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomTag.Header', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type.tracing.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'defaultValue')
    ..hasRequiredFields = false
  ;
...
class CustomTag_Metadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomTag.Metadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type.tracing.v2'), createEmptyInstance: create)
    ..aOM<$89.MetadataKind>(1, _omitFieldNames ? '' : 'kind', subBuilder: $89.MetadataKind.create)
    ..aOM<$89.MetadataKey>(2, _omitFieldNames ? '' : 'metadataKey', subBuilder: $89.MetadataKey.create)
  ...
  @$pb.TagNumber(1)
  $89.MetadataKind get kind => $_getN(0);
  @$pb.TagNumber(1)
  set kind($89.MetadataKind v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasKind() => $_has(0);
  @$pb.TagNumber(1)
  void clearKind() => clearField(1);
  @$pb.TagNumber(1)
  $89.MetadataKind ensureKind() => $_ensure(0);

  /// Metadata key to define the path to retrieve the tag value.
  @$pb.TagNumber(2)
  $89.MetadataKey get metadataKey => $_getN(1);
  @$pb.TagNumber(2)
  set metadataKey($89.MetadataKey v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMetadataKey() => $_has(1);
  @$pb.TagNumber(2)
  void clearMetadataKey() => clearField(2);
  @$pb.TagNumber(2)
  $89.MetadataKey ensureMetadataKey() => $_ensure(1);
...
class CustomTag extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomTag', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type.tracing.v2'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5])
