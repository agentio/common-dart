...
import '../../../../common/dynamic_forward_proxy/v2alpha/dns_cache.pb.dart' as $121;
...
class FilterConfig extends $pb.GeneratedMessage {
  factory FilterConfig({
    $121.DnsCacheConfig? dnsCacheConfig,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FilterConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.http.dynamic_forward_proxy.v2alpha'), createEmptyInstance: create)
    ..aOM<$121.DnsCacheConfig>(1, _omitFieldNames ? '' : 'dnsCacheConfig', subBuilder: $121.DnsCacheConfig.create)
  ...
  @$pb.TagNumber(1)
  $121.DnsCacheConfig get dnsCacheConfig => $_getN(0);
  @$pb.TagNumber(1)
  set dnsCacheConfig($121.DnsCacheConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDnsCacheConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearDnsCacheConfig() => clearField(1);
  @$pb.TagNumber(1)
  $121.DnsCacheConfig ensureDnsCacheConfig() => $_ensure(0);
}
