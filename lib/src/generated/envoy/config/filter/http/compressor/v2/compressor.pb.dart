...
class Compressor extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Compressor', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.http.compressor.v2'), createEmptyInstance: create)
    ...
    ..aOM<$36.RuntimeFeatureFlag>(5, _omitFieldNames ? '' : 'runtimeEnabled', subBuilder: $36.RuntimeFeatureFlag.create)
  ...
  @$pb.TagNumber(5)
  $36.RuntimeFeatureFlag get runtimeEnabled => $_getN(4);
  @$pb.TagNumber(5)
  set runtimeEnabled($36.RuntimeFeatureFlag v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasRuntimeEnabled() => $_has(4);
  @$pb.TagNumber(5)
  void clearRuntimeEnabled() => clearField(5);
  @$pb.TagNumber(5)
  $36.RuntimeFeatureFlag ensureRuntimeEnabled() => $_ensure(4);
}
