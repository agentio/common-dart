...
class Buffer extends $pb.GeneratedMessage {
  factory Buffer({
    $26.UInt32Value? maxRequestBytes,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Buffer', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.http.buffer.v2'), createEmptyInstance: create)
    ..aOM<$26.UInt32Value>(1, _omitFieldNames ? '' : 'maxRequestBytes', subBuilder: $26.UInt32Value.create)
  ...
  @$pb.TagNumber(1)
  $26.UInt32Value get maxRequestBytes => $_getN(0);
  @$pb.TagNumber(1)
  set maxRequestBytes($26.UInt32Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasMaxRequestBytes() => $_has(0);
  @$pb.TagNumber(1)
  void clearMaxRequestBytes() => clearField(1);
  @$pb.TagNumber(1)
  $26.UInt32Value ensureMaxRequestBytes() => $_ensure(0);
}
...
class BufferPerRoute extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BufferPerRoute', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.http.buffer.v2'), createEmptyInstance: create)
    ..oo(0, [1, 2])
