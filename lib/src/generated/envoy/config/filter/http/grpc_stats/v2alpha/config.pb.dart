...
import '../../../../../api/v2/core/grpc_method_list.pb.dart' as $117;
...
class FilterConfig extends $pb.GeneratedMessage {
  factory FilterConfig({
    ...
    $117.GrpcMethodList? individualMethodStatsAllowlist,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FilterConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.http.grpc_stats.v2alpha'), createEmptyInstance: create)
    ...
    ..aOM<$117.GrpcMethodList>(2, _omitFieldNames ? '' : 'individualMethodStatsAllowlist', subBuilder: $117.GrpcMethodList.create)
  ...
  @$pb.TagNumber(2)
  $117.GrpcMethodList get individualMethodStatsAllowlist => $_getN(1);
  @$pb.TagNumber(2)
  set individualMethodStatsAllowlist($117.GrpcMethodList v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasIndividualMethodStatsAllowlist() => $_has(1);
  @$pb.TagNumber(2)
  void clearIndividualMethodStatsAllowlist() => clearField(2);
  @$pb.TagNumber(2)
  $117.GrpcMethodList ensureIndividualMethodStatsAllowlist() => $_ensure(1);
