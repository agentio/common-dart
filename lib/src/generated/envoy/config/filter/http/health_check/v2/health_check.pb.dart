...
class HealthCheck extends $pb.GeneratedMessage {
  factory HealthCheck({
    $26.BoolValue? passThroughMode,
    $28.Duration? cacheTime,
    $core.Map<$core.String, $35.Percent>? clusterMinHealthyPercentages,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HealthCheck', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.http.health_check.v2'), createEmptyInstance: create)
    ..aOM<$26.BoolValue>(1, _omitFieldNames ? '' : 'passThroughMode', subBuilder: $26.BoolValue.create)
    ..aOM<$28.Duration>(3, _omitFieldNames ? '' : 'cacheTime', subBuilder: $28.Duration.create)
    ..m<$core.String, $35.Percent>(4, _omitFieldNames ? '' : 'clusterMinHealthyPercentages', entryClassName: 'HealthCheck.ClusterMinHealthyPercentagesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $35.Percent.create, valueDefaultOrMaker: $35.Percent.getDefault, packageName: const $pb.PackageName('envoy.config.filter.http.health_check.v2'))
    ..pc<$91.HeaderMatcher>(5, _omitFieldNames ? '' : 'headers', $pb.PbFieldType.PM, subBuilder: $91.HeaderMatcher.create)
  ...
  @$pb.TagNumber(1)
  $26.BoolValue get passThroughMode => $_getN(0);
  @$pb.TagNumber(1)
  set passThroughMode($26.BoolValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPassThroughMode() => $_has(0);
  @$pb.TagNumber(1)
  void clearPassThroughMode() => clearField(1);
  @$pb.TagNumber(1)
  $26.BoolValue ensurePassThroughMode() => $_ensure(0);

  /// If operating in pass through mode, the amount of time in milliseconds
  /// that the filter should cache the upstream response.
  @$pb.TagNumber(3)
  $28.Duration get cacheTime => $_getN(1);
  @$pb.TagNumber(3)
  set cacheTime($28.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCacheTime() => $_has(1);
  @$pb.TagNumber(3)
  void clearCacheTime() => clearField(3);
  @$pb.TagNumber(3)
  $28.Duration ensureCacheTime() => $_ensure(1);
  ...
  ///     as if it were 12%.
  @$pb.TagNumber(4)
  $core.Map<$core.String, $35.Percent> get clusterMinHealthyPercentages => $_getMap(2);
