...
import '../../compressor/v2/compressor.pb.dart' as $118;
...
class Gzip extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Gzip', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.http.gzip.v2'), createEmptyInstance: create)
    ..aOM<$26.UInt32Value>(1, _omitFieldNames ? '' : 'memoryLevel', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(2, _omitFieldNames ? '' : 'contentLength', subBuilder: $26.UInt32Value.create)
    ...
    ..aOM<$26.UInt32Value>(9, _omitFieldNames ? '' : 'windowBits', subBuilder: $26.UInt32Value.create)
    ..aOM<$118.Compressor>(10, _omitFieldNames ? '' : 'compressor', subBuilder: $118.Compressor.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $26.UInt32Value get memoryLevel => $_getN(0);
  @$pb.TagNumber(1)
  set memoryLevel($26.UInt32Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasMemoryLevel() => $_has(0);
  @$pb.TagNumber(1)
  void clearMemoryLevel() => clearField(1);
  @$pb.TagNumber(1)
  $26.UInt32Value ensureMemoryLevel() => $_ensure(0);
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  $26.UInt32Value get contentLength => $_getN(1);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  set contentLength($26.UInt32Value v) { setField(2, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  $26.UInt32Value ensureContentLength() => $_ensure(1);
  ...
  @$pb.TagNumber(9)
  $26.UInt32Value get windowBits => $_getN(7);
  @$pb.TagNumber(9)
  set windowBits($26.UInt32Value v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasWindowBits() => $_has(7);
  @$pb.TagNumber(9)
  void clearWindowBits() => clearField(9);
  @$pb.TagNumber(9)
  $26.UInt32Value ensureWindowBits() => $_ensure(7);
  ...
  @$pb.TagNumber(10)
  $118.Compressor get compressor => $_getN(8);
  @$pb.TagNumber(10)
  set compressor($118.Compressor v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasCompressor() => $_has(8);
  @$pb.TagNumber(10)
  void clearCompressor() => clearField(10);
  @$pb.TagNumber(10)
  $118.Compressor ensureCompressor() => $_ensure(8);
}
