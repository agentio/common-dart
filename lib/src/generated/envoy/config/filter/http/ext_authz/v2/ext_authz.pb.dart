...
import '../../../../../api/v2/core/http_uri.pb.dart' as $33;
import '../../../../../type/http_status.pb.dart' as $120;
...
class ExtAuthz extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    $36.RuntimeFeatureFlag? denyAtDisable,
  }) {
    final $result = create();
    if (grpcService != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExtAuthz', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.http.ext_authz.v2'), createEmptyInstance: create)
    ...
    ..aOM<$120.HttpStatus>(7, _omitFieldNames ? '' : 'statusOnError', subBuilder: $120.HttpStatus.create)
    ...
    ..aOM<$36.RuntimeFeatureFlag>(11, _omitFieldNames ? '' : 'denyAtDisable', subBuilder: $36.RuntimeFeatureFlag.create)
  ...
  @$pb.TagNumber(7)
  $120.HttpStatus get statusOnError => $_getN(6);
  @$pb.TagNumber(7)
  set statusOnError($120.HttpStatus v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasStatusOnError() => $_has(6);
  @$pb.TagNumber(7)
  void clearStatusOnError() => clearField(7);
  @$pb.TagNumber(7)
  $120.HttpStatus ensureStatusOnError() => $_ensure(6);
  ...
  @$pb.TagNumber(11)
  $36.RuntimeFeatureFlag get denyAtDisable => $_getN(10);
  @$pb.TagNumber(11)
  set denyAtDisable($36.RuntimeFeatureFlag v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasDenyAtDisable() => $_has(10);
  @$pb.TagNumber(11)
  void clearDenyAtDisable() => clearField(11);
  @$pb.TagNumber(11)
  $36.RuntimeFeatureFlag ensureDenyAtDisable() => $_ensure(10);
}
...
class HttpService extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpService', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.http.ext_authz.v2'), createEmptyInstance: create)
    ..aOM<$33.HttpUri>(1, _omitFieldNames ? '' : 'serverUri', subBuilder: $33.HttpUri.create)
  ...
  @$pb.TagNumber(1)
  $33.HttpUri get serverUri => $_getN(0);
  @$pb.TagNumber(1)
  set serverUri($33.HttpUri v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasServerUri() => $_has(0);
  @$pb.TagNumber(1)
  void clearServerUri() => clearField(1);
  @$pb.TagNumber(1)
  $33.HttpUri ensureServerUri() => $_ensure(0);
...
class AuthorizationRequest extends $pb.GeneratedMessage {
  factory AuthorizationRequest({
    $74.ListStringMatcher? allowedHeaders,
    $core.Iterable<$36.HeaderValue>? headersToAdd,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuthorizationRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.http.ext_authz.v2'), createEmptyInstance: create)
    ..aOM<$74.ListStringMatcher>(1, _omitFieldNames ? '' : 'allowedHeaders', subBuilder: $74.ListStringMatcher.create)
    ..pc<$36.HeaderValue>(2, _omitFieldNames ? '' : 'headersToAdd', $pb.PbFieldType.PM, subBuilder: $36.HeaderValue.create)
    ..hasRequiredFields = false
  ;
  ...
  ///  its payload size.
  @$pb.TagNumber(1)
  $74.ListStringMatcher get allowedHeaders => $_getN(0);
  @$pb.TagNumber(1)
  set allowedHeaders($74.ListStringMatcher v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAllowedHeaders() => $_has(0);
  @$pb.TagNumber(1)
  void clearAllowedHeaders() => clearField(1);
  @$pb.TagNumber(1)
  $74.ListStringMatcher ensureAllowedHeaders() => $_ensure(0);

  /// Sets a list of headers that will be included to the request to authorization service. Note that
  /// client request of the same key will be overridden.
  @$pb.TagNumber(2)
  $core.List<$36.HeaderValue> get headersToAdd => $_getList(1);
}

class AuthorizationResponse extends $pb.GeneratedMessage {
  factory AuthorizationResponse({
    $74.ListStringMatcher? allowedUpstreamHeaders,
    $74.ListStringMatcher? allowedClientHeaders,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuthorizationResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.http.ext_authz.v2'), createEmptyInstance: create)
    ..aOM<$74.ListStringMatcher>(1, _omitFieldNames ? '' : 'allowedUpstreamHeaders', subBuilder: $74.ListStringMatcher.create)
    ..aOM<$74.ListStringMatcher>(2, _omitFieldNames ? '' : 'allowedClientHeaders', subBuilder: $74.ListStringMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $74.ListStringMatcher get allowedUpstreamHeaders => $_getN(0);
  @$pb.TagNumber(1)
  set allowedUpstreamHeaders($74.ListStringMatcher v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAllowedUpstreamHeaders() => $_has(0);
  @$pb.TagNumber(1)
  void clearAllowedUpstreamHeaders() => clearField(1);
  @$pb.TagNumber(1)
  $74.ListStringMatcher ensureAllowedUpstreamHeaders() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $74.ListStringMatcher get allowedClientHeaders => $_getN(1);
  @$pb.TagNumber(2)
  set allowedClientHeaders($74.ListStringMatcher v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAllowedClientHeaders() => $_has(1);
  @$pb.TagNumber(2)
  void clearAllowedClientHeaders() => clearField(2);
  @$pb.TagNumber(2)
  $74.ListStringMatcher ensureAllowedClientHeaders() => $_ensure(1);
}
