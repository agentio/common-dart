...
class CacheConfig_KeyCreatorParams extends $pb.GeneratedMessage {
  factory CacheConfig_KeyCreatorParams({
    ...
    $core.Iterable<$91.QueryParameterMatcher>? queryParametersIncluded,
    $core.Iterable<$91.QueryParameterMatcher>? queryParametersExcluded,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CacheConfig.KeyCreatorParams', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.http.cache.v2alpha'), createEmptyInstance: create)
    ...
    ..pc<$91.QueryParameterMatcher>(3, _omitFieldNames ? '' : 'queryParametersIncluded', $pb.PbFieldType.PM, subBuilder: $91.QueryParameterMatcher.create)
    ..pc<$91.QueryParameterMatcher>(4, _omitFieldNames ? '' : 'queryParametersExcluded', $pb.PbFieldType.PM, subBuilder: $91.QueryParameterMatcher.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$91.QueryParameterMatcher> get queryParametersIncluded => $_getList(2);
  ...
  @$pb.TagNumber(4)
  $core.List<$91.QueryParameterMatcher> get queryParametersExcluded => $_getList(3);
}

class CacheConfig extends $pb.GeneratedMessage {
  factory CacheConfig({
    $34.Any? typedConfig,
    $core.Iterable<$74.StringMatcher>? allowedVaryHeaders,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CacheConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.http.cache.v2alpha'), createEmptyInstance: create)
    ...
    ..pc<$74.StringMatcher>(2, _omitFieldNames ? '' : 'allowedVaryHeaders', $pb.PbFieldType.PM, subBuilder: $74.StringMatcher.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$74.StringMatcher> get allowedVaryHeaders => $_getList(1);
