...
class CsrfPolicy extends $pb.GeneratedMessage {
  factory CsrfPolicy({
    ...
    $core.Iterable<$74.StringMatcher>? additionalOrigins,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CsrfPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.http.csrf.v2'), createEmptyInstance: create)
    ..aOM<$36.RuntimeFractionalPercent>(1, _omitFieldNames ? '' : 'filterEnabled', subBuilder: $36.RuntimeFractionalPercent.create)
    ..aOM<$36.RuntimeFractionalPercent>(2, _omitFieldNames ? '' : 'shadowEnabled', subBuilder: $36.RuntimeFractionalPercent.create)
    ..pc<$74.StringMatcher>(3, _omitFieldNames ? '' : 'additionalOrigins', $pb.PbFieldType.PM, subBuilder: $74.StringMatcher.create)
  ...
  @$pb.TagNumber(1)
  $36.RuntimeFractionalPercent get filterEnabled => $_getN(0);
  @$pb.TagNumber(1)
  set filterEnabled($36.RuntimeFractionalPercent v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasFilterEnabled() => $_has(0);
  @$pb.TagNumber(1)
  void clearFilterEnabled() => clearField(1);
  @$pb.TagNumber(1)
  $36.RuntimeFractionalPercent ensureFilterEnabled() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $36.RuntimeFractionalPercent get shadowEnabled => $_getN(1);
  @$pb.TagNumber(2)
  set shadowEnabled($36.RuntimeFractionalPercent v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasShadowEnabled() => $_has(1);
  @$pb.TagNumber(2)
  void clearShadowEnabled() => clearField(2);
  @$pb.TagNumber(2)
  $36.RuntimeFractionalPercent ensureShadowEnabled() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $core.List<$74.StringMatcher> get additionalOrigins => $_getList(2);
}
