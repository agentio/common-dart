...
class RateLimit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimit', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.http.rate_limit.v2'), createEmptyInstance: create)
    ...
    ..aOM<$122.RateLimitServiceConfig>(7, _omitFieldNames ? '' : 'rateLimitService', subBuilder: $122.RateLimitServiceConfig.create)
  ...
  /// success.
  @$pb.TagNumber(7)
  $122.RateLimitServiceConfig get rateLimitService => $_getN(6);
  @$pb.TagNumber(7)
  set rateLimitService($122.RateLimitServiceConfig v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasRateLimitService() => $_has(6);
  @$pb.TagNumber(7)
  void clearRateLimitService() => clearField(7);
  @$pb.TagNumber(7)
  $122.RateLimitServiceConfig ensureRateLimitService() => $_ensure(6);
}
