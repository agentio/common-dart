...
import '../../../fault/v2/fault.pb.dart' as $119;
...
class FaultAbort extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FaultAbort', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.http.fault.v2'), createEmptyInstance: create)
    ...
    ..aOM<$35.FractionalPercent>(3, _omitFieldNames ? '' : 'percentage', subBuilder: $35.FractionalPercent.create)
  ...
  @$pb.TagNumber(3)
  set percentage($35.FractionalPercent v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class HTTPFault extends $pb.GeneratedMessage {
  factory HTTPFault({
    ...
    $119.FaultRateLimit? responseRateLimit,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HTTPFault', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.http.fault.v2'), createEmptyInstance: create)
    ..aOM<$119.FaultDelay>(1, _omitFieldNames ? '' : 'delay', subBuilder: $119.FaultDelay.create)
    ..aOM<FaultAbort>(2, _omitFieldNames ? '' : 'abort', subBuilder: FaultAbort.create)
    ..aOS(3, _omitFieldNames ? '' : 'upstreamCluster')
    ..pc<$91.HeaderMatcher>(4, _omitFieldNames ? '' : 'headers', $pb.PbFieldType.PM, subBuilder: $91.HeaderMatcher.create)
    ...
    ..aOM<$119.FaultRateLimit>(7, _omitFieldNames ? '' : 'responseRateLimit', subBuilder: $119.FaultRateLimit.create)
  ...
  /// object.
  @$pb.TagNumber(1)
  $119.FaultDelay get delay => $_getN(0);
  @$pb.TagNumber(1)
  set delay($119.FaultDelay v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDelay() => $_has(0);
  @$pb.TagNumber(1)
  void clearDelay() => clearField(1);
  @$pb.TagNumber(1)
  $119.FaultDelay ensureDelay() => $_ensure(0);
  ...
  @$pb.TagNumber(4)
  $core.List<$91.HeaderMatcher> get headers => $_getList(3);
  ...
  @$pb.TagNumber(7)
  $119.FaultRateLimit get responseRateLimit => $_getN(6);
  @$pb.TagNumber(7)
  set responseRateLimit($119.FaultRateLimit v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasResponseRateLimit() => $_has(6);
  @$pb.TagNumber(7)
  void clearResponseRateLimit() => clearField(7);
  @$pb.TagNumber(7)
  $119.FaultRateLimit ensureResponseRateLimit() => $_ensure(6);
