...
class FaultDelay_HeaderDelay extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FaultDelay.HeaderDelay', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.fault.v2'), createEmptyInstance: create)
...
class FaultDelay extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    FaultDelay_FaultDelayType? type,
    $28.Duration? fixedDelay,
    $35.FractionalPercent? percentage,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FaultDelay', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.fault.v2'), createEmptyInstance: create)
    ..oo(0, [3, 5])
    ..e<FaultDelay_FaultDelayType>(1, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: FaultDelay_FaultDelayType.FIXED, valueOf: FaultDelay_FaultDelayType.valueOf, enumValues: FaultDelay_FaultDelayType.values)
    ..aOM<$28.Duration>(3, _omitFieldNames ? '' : 'fixedDelay', subBuilder: $28.Duration.create)
    ..aOM<$35.FractionalPercent>(4, _omitFieldNames ? '' : 'percentage', subBuilder: $35.FractionalPercent.create)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  FaultDelay_FaultDelayType get type => $_getN(0);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  set type(FaultDelay_FaultDelayType v) { setField(1, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  $28.Duration get fixedDelay => $_getN(1);
  @$pb.TagNumber(3)
  set fixedDelay($28.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasFixedDelay() => $_has(1);
  @$pb.TagNumber(3)
  void clearFixedDelay() => clearField(3);
  @$pb.TagNumber(3)
  $28.Duration ensureFixedDelay() => $_ensure(1);

  /// The percentage of operations/connections/requests on which the delay will be injected.
  @$pb.TagNumber(4)
  $35.FractionalPercent get percentage => $_getN(2);
  @$pb.TagNumber(4)
  set percentage($35.FractionalPercent v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasPercentage() => $_has(2);
  @$pb.TagNumber(4)
  void clearPercentage() => clearField(4);
  @$pb.TagNumber(4)
  $35.FractionalPercent ensurePercentage() => $_ensure(2);

  /// Fault delays are controlled via an HTTP header (if applicable).
  @$pb.TagNumber(5)
  FaultDelay_HeaderDelay get headerDelay => $_getN(3);
  @$pb.TagNumber(5)
  set headerDelay(FaultDelay_HeaderDelay v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasHeaderDelay() => $_has(3);
  @$pb.TagNumber(5)
  void clearHeaderDelay() => clearField(5);
  @$pb.TagNumber(5)
  FaultDelay_HeaderDelay ensureHeaderDelay() => $_ensure(3);
}
...
class FaultRateLimit_FixedLimit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FaultRateLimit.FixedLimit', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.fault.v2'), createEmptyInstance: create)
...
class FaultRateLimit_HeaderLimit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FaultRateLimit.HeaderLimit', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.fault.v2'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class FaultRateLimit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FaultRateLimit', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.fault.v2'), createEmptyInstance: create)
    ..oo(0, [1, 3])
    ..aOM<FaultRateLimit_FixedLimit>(1, _omitFieldNames ? '' : 'fixedLimit', subBuilder: FaultRateLimit_FixedLimit.create)
    ..aOM<$35.FractionalPercent>(2, _omitFieldNames ? '' : 'percentage', subBuilder: $35.FractionalPercent.create)
  ...
  @$pb.TagNumber(2)
  $35.FractionalPercent get percentage => $_getN(1);
  @$pb.TagNumber(2)
  set percentage($35.FractionalPercent v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPercentage() => $_has(1);
  @$pb.TagNumber(2)
  void clearPercentage() => clearField(2);
  @$pb.TagNumber(2)
  $35.FractionalPercent ensurePercentage() => $_ensure(1);
