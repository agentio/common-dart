...
class RateLimit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimit', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.thrift.rate_limit.v2alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$122.RateLimitServiceConfig>(5, _omitFieldNames ? '' : 'rateLimitService', subBuilder: $122.RateLimitServiceConfig.create)
  ...
  /// success.
  @$pb.TagNumber(5)
  $122.RateLimitServiceConfig get rateLimitService => $_getN(4);
  @$pb.TagNumber(5)
  set rateLimitService($122.RateLimitServiceConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasRateLimitService() => $_has(4);
  @$pb.TagNumber(5)
  void clearRateLimitService() => clearField(5);
  @$pb.TagNumber(5)
  $122.RateLimitServiceConfig ensureRateLimitService() => $_ensure(4);
}
