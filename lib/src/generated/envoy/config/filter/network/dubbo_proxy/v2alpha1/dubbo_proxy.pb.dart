...
class DubboProxy extends $pb.GeneratedMessage {
  factory DubboProxy({
    ...
    $core.Iterable<$135.RouteConfiguration>? routeConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DubboProxy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.network.dubbo_proxy.v2alpha1'), createEmptyInstance: create)
    ...
    ..pc<$135.RouteConfiguration>(4, _omitFieldNames ? '' : 'routeConfig', $pb.PbFieldType.PM, subBuilder: $135.RouteConfiguration.create)
  ...
  @$pb.TagNumber(4)
  $core.List<$135.RouteConfiguration> get routeConfig => $_getList(3);
