...
class ThriftProxy extends $pb.GeneratedMessage {
  factory ThriftProxy({
    ...
    $134.RouteConfiguration? routeConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ThriftProxy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.network.thrift_proxy.v2alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$134.RouteConfiguration>(4, _omitFieldNames ? '' : 'routeConfig', subBuilder: $134.RouteConfiguration.create)
  ...
  @$pb.TagNumber(4)
  $134.RouteConfiguration get routeConfig => $_getN(3);
  @$pb.TagNumber(4)
  set routeConfig($134.RouteConfiguration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasRouteConfig() => $_has(3);
  @$pb.TagNumber(4)
  void clearRouteConfig() => clearField(4);
  @$pb.TagNumber(4)
  $134.RouteConfiguration ensureRouteConfig() => $_ensure(3);
