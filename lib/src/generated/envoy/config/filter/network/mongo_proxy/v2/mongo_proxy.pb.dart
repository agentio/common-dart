...
class MongoProxy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MongoProxy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.network.mongo_proxy.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'statPrefix')
    ..aOS(2, _omitFieldNames ? '' : 'accessLog')
    ..aOM<$119.FaultDelay>(3, _omitFieldNames ? '' : 'delay', subBuilder: $119.FaultDelay.create)
  ...
  @$pb.TagNumber(3)
  $119.FaultDelay get delay => $_getN(2);
  @$pb.TagNumber(3)
  set delay($119.FaultDelay v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasDelay() => $_has(2);
  @$pb.TagNumber(3)
  void clearDelay() => clearField(3);
  @$pb.TagNumber(3)
  $119.FaultDelay ensureDelay() => $_ensure(2);
