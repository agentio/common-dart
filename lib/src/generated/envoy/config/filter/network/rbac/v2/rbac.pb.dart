...
import '../../../../rbac/v2/rbac.pb.dart' as $128;
...
class RBAC extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RBAC', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.network.rbac.v2'), createEmptyInstance: create)
    ..aOM<$128.RBAC>(1, _omitFieldNames ? '' : 'rules', subBuilder: $128.RBAC.create)
    ..aOM<$128.RBAC>(2, _omitFieldNames ? '' : 'shadowRules', subBuilder: $128.RBAC.create)
  ...
  @$pb.TagNumber(1)
  $128.RBAC get rules => $_getN(0);
  @$pb.TagNumber(1)
  set rules($128.RBAC v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasRules() => $_has(0);
  @$pb.TagNumber(1)
  void clearRules() => clearField(1);
  @$pb.TagNumber(1)
  $128.RBAC ensureRules() => $_ensure(0);

  /// Shadow rules are not enforced by the filter but will emit stats and logs
  /// and can be used for rule testing.
  /// If absent, no shadow RBAC policy will be applied.
  @$pb.TagNumber(2)
  $128.RBAC get shadowRules => $_getN(1);
  @$pb.TagNumber(2)
  set shadowRules($128.RBAC v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasShadowRules() => $_has(1);
  @$pb.TagNumber(2)
  void clearShadowRules() => clearField(2);
  @$pb.TagNumber(2)
  $128.RBAC ensureShadowRules() => $_ensure(1);
