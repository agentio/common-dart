...
import '../../../../../api/v2/ratelimit/ratelimit.pb.dart' as $132;
import '../../../../ratelimit/v2/rls.pb.dart' as $122;
...
class RateLimit extends $pb.GeneratedMessage {
  factory RateLimit({
    ...
    $core.String? domain,
    $core.Iterable<$132.RateLimitDescriptor>? descriptors,
    $28.Duration? timeout,
    $core.bool? failureModeDeny,
    $122.RateLimitServiceConfig? rateLimitService,
  }) {
    final $result = create();
    if (statPrefix != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimit', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.network.rate_limit.v2'), createEmptyInstance: create)
    ...
    ..pc<$132.RateLimitDescriptor>(3, _omitFieldNames ? '' : 'descriptors', $pb.PbFieldType.PM, subBuilder: $132.RateLimitDescriptor.create)
    ..aOM<$28.Duration>(4, _omitFieldNames ? '' : 'timeout', subBuilder: $28.Duration.create)
    ..aOB(5, _omitFieldNames ? '' : 'failureModeDeny')
    ..aOM<$122.RateLimitServiceConfig>(6, _omitFieldNames ? '' : 'rateLimitService', subBuilder: $122.RateLimitServiceConfig.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$132.RateLimitDescriptor> get descriptors => $_getList(2);
  ...
  /// success.
  @$pb.TagNumber(6)
  $122.RateLimitServiceConfig get rateLimitService => $_getN(5);
  @$pb.TagNumber(6)
  set rateLimitService($122.RateLimitServiceConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasRateLimitService() => $_has(5);
  @$pb.TagNumber(6)
  void clearRateLimitService() => clearField(6);
  @$pb.TagNumber(6)
  $122.RateLimitServiceConfig ensureRateLimitService() => $_ensure(5);
}
