...
class Matcher_OnMatch extends $pb.GeneratedMessage {
  factory Matcher_OnMatch({
    Matcher? matcher,
    $40.TypedExtensionConfig? action,
  }) {
    final $result = create();
    if (matcher != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Matcher.OnMatch', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.common.matcher.v3'), createEmptyInstance: create)
    ...
    ..aOM<$40.TypedExtensionConfig>(2, _omitFieldNames ? '' : 'action', subBuilder: $40.TypedExtensionConfig.create)
  ...
  @$pb.TagNumber(2)
  $40.TypedExtensionConfig get action => $_getN(1);
  @$pb.TagNumber(2)
  set action($40.TypedExtensionConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAction() => $_has(1);
  @$pb.TagNumber(2)
  void clearAction() => clearField(2);
  @$pb.TagNumber(2)
  $40.TypedExtensionConfig ensureAction() => $_ensure(1);
}
...
class Matcher_MatcherList_Predicate_SinglePredicate extends $pb.GeneratedMessage {
  factory Matcher_MatcherList_Predicate_SinglePredicate({
    $40.TypedExtensionConfig? input,
    $58.StringMatcher? valueMatch,
    $40.TypedExtensionConfig? customMatch,
  }) {
    final $result = create();
    if (input != null) {
      $result.input = input;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Matcher.MatcherList.Predicate.SinglePredicate', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.common.matcher.v3'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOM<$40.TypedExtensionConfig>(1, _omitFieldNames ? '' : 'input', subBuilder: $40.TypedExtensionConfig.create)
    ..aOM<$58.StringMatcher>(2, _omitFieldNames ? '' : 'valueMatch', subBuilder: $58.StringMatcher.create)
    ..aOM<$40.TypedExtensionConfig>(3, _omitFieldNames ? '' : 'customMatch', subBuilder: $40.TypedExtensionConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $40.TypedExtensionConfig get input => $_getN(0);
  @$pb.TagNumber(1)
  set input($40.TypedExtensionConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasInput() => $_has(0);
  @$pb.TagNumber(1)
  void clearInput() => clearField(1);
  @$pb.TagNumber(1)
  $40.TypedExtensionConfig ensureInput() => $_ensure(0);

  /// Built-in string matcher.
  @$pb.TagNumber(2)
  $58.StringMatcher get valueMatch => $_getN(1);
  @$pb.TagNumber(2)
  set valueMatch($58.StringMatcher v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValueMatch() => $_has(1);
  @$pb.TagNumber(2)
  void clearValueMatch() => clearField(2);
  @$pb.TagNumber(2)
  $58.StringMatcher ensureValueMatch() => $_ensure(1);

  /// Extension for custom matching logic.
  /// [#extension-category: envoy.matching.input_matchers]
  @$pb.TagNumber(3)
  $40.TypedExtensionConfig get customMatch => $_getN(2);
  @$pb.TagNumber(3)
  set customMatch($40.TypedExtensionConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCustomMatch() => $_has(2);
  @$pb.TagNumber(3)
  void clearCustomMatch() => clearField(3);
  @$pb.TagNumber(3)
  $40.TypedExtensionConfig ensureCustomMatch() => $_ensure(2);
}
...
class Matcher_MatcherTree extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Matcher.MatcherTree', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.common.matcher.v3'), createEmptyInstance: create)
    ...
    ..aOM<$40.TypedExtensionConfig>(4, _omitFieldNames ? '' : 'customMatch', subBuilder: $40.TypedExtensionConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  /// Extension for custom matching logic.
  @$pb.TagNumber(4)
  $40.TypedExtensionConfig get customMatch => $_getN(3);
  @$pb.TagNumber(4)
  set customMatch($40.TypedExtensionConfig v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCustomMatch() => $_has(3);
  @$pb.TagNumber(4)
  void clearCustomMatch() => clearField(4);
  @$pb.TagNumber(4)
  $40.TypedExtensionConfig ensureCustomMatch() => $_ensure(3);
}
...
class HttpHeadersMatch extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpHeadersMatch', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.common.matcher.v3'), createEmptyInstance: create)
    ..pc<$66.HeaderMatcher>(1, _omitFieldNames ? '' : 'headers', $pb.PbFieldType.PM, subBuilder: $66.HeaderMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$66.HeaderMatcher> get headers => $_getList(0);
}
