...
class HeaderMutationRules extends $pb.GeneratedMessage {
  factory HeaderMutationRules({
    $26.BoolValue? allowAllRouting,
    $26.BoolValue? allowEnvoy,
    $26.BoolValue? disallowSystem,
    $26.BoolValue? disallowAll,
    $55.RegexMatcher? allowExpression,
    $55.RegexMatcher? disallowExpression,
    $26.BoolValue? disallowIsError,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HeaderMutationRules', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.common.mutation_rules.v3'), createEmptyInstance: create)
    ..aOM<$26.BoolValue>(1, _omitFieldNames ? '' : 'allowAllRouting', subBuilder: $26.BoolValue.create)
    ..aOM<$26.BoolValue>(2, _omitFieldNames ? '' : 'allowEnvoy', subBuilder: $26.BoolValue.create)
    ..aOM<$26.BoolValue>(3, _omitFieldNames ? '' : 'disallowSystem', subBuilder: $26.BoolValue.create)
    ..aOM<$26.BoolValue>(4, _omitFieldNames ? '' : 'disallowAll', subBuilder: $26.BoolValue.create)
    ..aOM<$55.RegexMatcher>(5, _omitFieldNames ? '' : 'allowExpression', subBuilder: $55.RegexMatcher.create)
    ..aOM<$55.RegexMatcher>(6, _omitFieldNames ? '' : 'disallowExpression', subBuilder: $55.RegexMatcher.create)
    ..aOM<$26.BoolValue>(7, _omitFieldNames ? '' : 'disallowIsError', subBuilder: $26.BoolValue.create)
  ...
  @$pb.TagNumber(1)
  $26.BoolValue get allowAllRouting => $_getN(0);
  @$pb.TagNumber(1)
  set allowAllRouting($26.BoolValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAllowAllRouting() => $_has(0);
  @$pb.TagNumber(1)
  void clearAllowAllRouting() => clearField(1);
  @$pb.TagNumber(1)
  $26.BoolValue ensureAllowAllRouting() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $26.BoolValue get allowEnvoy => $_getN(1);
  @$pb.TagNumber(2)
  set allowEnvoy($26.BoolValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAllowEnvoy() => $_has(1);
  @$pb.TagNumber(2)
  void clearAllowEnvoy() => clearField(2);
  @$pb.TagNumber(2)
  $26.BoolValue ensureAllowEnvoy() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $26.BoolValue get disallowSystem => $_getN(2);
  @$pb.TagNumber(3)
  set disallowSystem($26.BoolValue v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasDisallowSystem() => $_has(2);
  @$pb.TagNumber(3)
  void clearDisallowSystem() => clearField(3);
  @$pb.TagNumber(3)
  $26.BoolValue ensureDisallowSystem() => $_ensure(2);
  ...
  /// Default is false.
  @$pb.TagNumber(7)
  $26.BoolValue get disallowIsError => $_getN(6);
  @$pb.TagNumber(7)
  set disallowIsError($26.BoolValue v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasDisallowIsError() => $_has(6);
  @$pb.TagNumber(7)
  void clearDisallowIsError() => clearField(7);
  @$pb.TagNumber(7)
  $26.BoolValue ensureDisallowIsError() => $_ensure(6);
}
...
class HeaderMutation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HeaderMutation', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.common.mutation_rules.v3'), createEmptyInstance: create)
    ...
    ..aOM<$47.HeaderValueOption>(2, _omitFieldNames ? '' : 'append', subBuilder: $47.HeaderValueOption.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $47.HeaderValueOption get append => $_getN(1);
  @$pb.TagNumber(2)
  set append($47.HeaderValueOption v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAppend() => $_has(1);
  @$pb.TagNumber(2)
  void clearAppend() => clearField(2);
  @$pb.TagNumber(2)
  $47.HeaderValueOption ensureAppend() => $_ensure(1);
}
