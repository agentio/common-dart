...
import '../../../../api/v2/cluster.pbenum.dart' as $100;
...
class DnsCacheConfig extends $pb.GeneratedMessage {
  factory DnsCacheConfig({
    $core.String? name,
    $100.Cluster_DnsLookupFamily? dnsLookupFamily,
    $28.Duration? dnsRefreshRate,
    $28.Duration? hostTtl,
    $26.UInt32Value? maxHosts,
    $100.Cluster_RefreshRate? dnsFailureRefreshRate,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DnsCacheConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.common.dynamic_forward_proxy.v2alpha'), createEmptyInstance: create)
    ...
    ..e<$100.Cluster_DnsLookupFamily>(2, _omitFieldNames ? '' : 'dnsLookupFamily', $pb.PbFieldType.OE, defaultOrMaker: $100.Cluster_DnsLookupFamily.AUTO, valueOf: $100.Cluster_DnsLookupFamily.valueOf, enumValues: $100.Cluster_DnsLookupFamily.values)
    ...
    ..aOM<$100.Cluster_RefreshRate>(6, _omitFieldNames ? '' : 'dnsFailureRefreshRate', subBuilder: $100.Cluster_RefreshRate.create)
  ...
  @$pb.TagNumber(2)
  $100.Cluster_DnsLookupFamily get dnsLookupFamily => $_getN(1);
  @$pb.TagNumber(2)
  set dnsLookupFamily($100.Cluster_DnsLookupFamily v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(6)
  $100.Cluster_RefreshRate get dnsFailureRefreshRate => $_getN(5);
  @$pb.TagNumber(6)
  set dnsFailureRefreshRate($100.Cluster_RefreshRate v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasDnsFailureRefreshRate() => $_has(5);
  @$pb.TagNumber(6)
  void clearDnsFailureRefreshRate() => clearField(6);
  @$pb.TagNumber(6)
  $100.Cluster_RefreshRate ensureDnsFailureRefreshRate() => $_ensure(5);
}
