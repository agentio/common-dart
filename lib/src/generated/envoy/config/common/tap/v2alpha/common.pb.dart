...
import '../../../../service/tap/v2alpha/common.pb.dart' as $129;
...
class CommonExtensionConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommonExtensionConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.common.tap.v2alpha'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<AdminConfig>(1, _omitFieldNames ? '' : 'adminConfig', subBuilder: AdminConfig.create)
    ..aOM<$129.TapConfig>(2, _omitFieldNames ? '' : 'staticConfig', subBuilder: $129.TapConfig.create)
  ...
  /// changed.
  @$pb.TagNumber(2)
  $129.TapConfig get staticConfig => $_getN(1);
  @$pb.TagNumber(2)
  set staticConfig($129.TapConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasStaticConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearStaticConfig() => clearField(2);
  @$pb.TagNumber(2)
  $129.TapConfig ensureStaticConfig() => $_ensure(1);
}
...
class AdminConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdminConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.common.tap.v2alpha'), createEmptyInstance: create)
