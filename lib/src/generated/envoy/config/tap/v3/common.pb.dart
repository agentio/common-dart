...
import '../../common/matcher/v3/matcher.pb.dart' as $144;
import '../../core/v3/base.pb.dart' as $47;
import '../../core/v3/extension.pb.dart' as $40;
import '../../core/v3/grpc_service.pb.dart' as $48;
...
class TapConfig extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    $47.RuntimeFractionalPercent? tapEnabled,
    $144.MatchPredicate? match,
  }) {
    final $result = create();
    if (matchConfig != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TapConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.tap.v3'), createEmptyInstance: create)
    ...
    ..aOM<$47.RuntimeFractionalPercent>(3, _omitFieldNames ? '' : 'tapEnabled', subBuilder: $47.RuntimeFractionalPercent.create)
    ..aOM<$144.MatchPredicate>(4, _omitFieldNames ? '' : 'match', subBuilder: $144.MatchPredicate.create)
  ...
  @$pb.TagNumber(3)
  $47.RuntimeFractionalPercent get tapEnabled => $_getN(2);
  @$pb.TagNumber(3)
  set tapEnabled($47.RuntimeFractionalPercent v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasTapEnabled() => $_has(2);
  @$pb.TagNumber(3)
  void clearTapEnabled() => clearField(3);
  @$pb.TagNumber(3)
  $47.RuntimeFractionalPercent ensureTapEnabled() => $_ensure(2);
  ...
  /// are set, the :ref:`match <envoy_v3_api_field_config.tap.v3.TapConfig.match>` will be used.
  @$pb.TagNumber(4)
  $144.MatchPredicate get match => $_getN(3);
  @$pb.TagNumber(4)
  set match($144.MatchPredicate v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasMatch() => $_has(3);
  @$pb.TagNumber(4)
  void clearMatch() => clearField(4);
  @$pb.TagNumber(4)
  $144.MatchPredicate ensureMatch() => $_ensure(3);
}
...
class OutputSink extends $pb.GeneratedMessage {
  factory OutputSink({
    ...
    $40.TypedExtensionConfig? customSink,
  }) {
    final $result = create();
    if (format != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OutputSink', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.tap.v3'), createEmptyInstance: create)
    ...
    ..aOM<$40.TypedExtensionConfig>(6, _omitFieldNames ? '' : 'customSink', subBuilder: $40.TypedExtensionConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $40.TypedExtensionConfig get customSink => $_getN(5);
  @$pb.TagNumber(6)
  set customSink($40.TypedExtensionConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasCustomSink() => $_has(5);
  @$pb.TagNumber(6)
  void clearCustomSink() => clearField(6);
  @$pb.TagNumber(6)
  $40.TypedExtensionConfig ensureCustomSink() => $_ensure(5);
}
...
class StreamingGrpcSink extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamingGrpcSink', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.tap.v3'), createEmptyInstance: create)
    ...
    ..aOM<$48.GrpcService>(2, _omitFieldNames ? '' : 'grpcService', subBuilder: $48.GrpcService.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $48.GrpcService get grpcService => $_getN(1);
  @$pb.TagNumber(2)
  set grpcService($48.GrpcService v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasGrpcService() => $_has(1);
  @$pb.TagNumber(2)
  void clearGrpcService() => clearField(2);
  @$pb.TagNumber(2)
  $48.GrpcService ensureGrpcService() => $_ensure(1);
}
