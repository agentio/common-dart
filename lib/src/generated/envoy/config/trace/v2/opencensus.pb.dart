...
class OpenCensusConfig extends $pb.GeneratedMessage {
  factory OpenCensusConfig({
    ...
    $38.GrpcService? stackdriverGrpcService,
    $38.GrpcService? ocagentGrpcService,
  }) {
    final $result = create();
    if (traceConfig != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OpenCensusConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.trace.v2'), createEmptyInstance: create)
    ...
    ..aOM<$38.GrpcService>(13, _omitFieldNames ? '' : 'stackdriverGrpcService', subBuilder: $38.GrpcService.create)
    ..aOM<$38.GrpcService>(14, _omitFieldNames ? '' : 'ocagentGrpcService', subBuilder: $38.GrpcService.create)
  ...
  @$pb.TagNumber(13)
  $38.GrpcService get stackdriverGrpcService => $_getN(11);
  @$pb.TagNumber(13)
  set stackdriverGrpcService($38.GrpcService v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasStackdriverGrpcService() => $_has(11);
  @$pb.TagNumber(13)
  void clearStackdriverGrpcService() => clearField(13);
  @$pb.TagNumber(13)
  $38.GrpcService ensureStackdriverGrpcService() => $_ensure(11);
  ...
  @$pb.TagNumber(14)
  $38.GrpcService get ocagentGrpcService => $_getN(12);
  @$pb.TagNumber(14)
  set ocagentGrpcService($38.GrpcService v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasOcagentGrpcService() => $_has(12);
  @$pb.TagNumber(14)
  void clearOcagentGrpcService() => clearField(14);
  @$pb.TagNumber(14)
  $38.GrpcService ensureOcagentGrpcService() => $_ensure(12);
}
