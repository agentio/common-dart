...
class XRayConfig extends $pb.GeneratedMessage {
  factory XRayConfig({
    $31.SocketAddress? daemonEndpoint,
    $core.String? segmentName,
    $36.DataSource? samplingRuleManifest,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'XRayConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.trace.v2alpha'), createEmptyInstance: create)
    ..aOM<$31.SocketAddress>(1, _omitFieldNames ? '' : 'daemonEndpoint', subBuilder: $31.SocketAddress.create)
    ..aOS(2, _omitFieldNames ? '' : 'segmentName')
    ..aOM<$36.DataSource>(3, _omitFieldNames ? '' : 'samplingRuleManifest', subBuilder: $36.DataSource.create)
  ...
  @$pb.TagNumber(1)
  $31.SocketAddress get daemonEndpoint => $_getN(0);
  @$pb.TagNumber(1)
  set daemonEndpoint($31.SocketAddress v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDaemonEndpoint() => $_has(0);
  @$pb.TagNumber(1)
  void clearDaemonEndpoint() => clearField(1);
  @$pb.TagNumber(1)
  $31.SocketAddress ensureDaemonEndpoint() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $36.DataSource get samplingRuleManifest => $_getN(2);
  @$pb.TagNumber(3)
  set samplingRuleManifest($36.DataSource v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSamplingRuleManifest() => $_has(2);
  @$pb.TagNumber(3)
  void clearSamplingRuleManifest() => clearField(3);
  @$pb.TagNumber(3)
  $36.DataSource ensureSamplingRuleManifest() => $_ensure(2);
}
