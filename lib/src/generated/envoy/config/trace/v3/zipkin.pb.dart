...
class ZipkinConfig extends $pb.GeneratedMessage {
  factory ZipkinConfig({
    ...
    $26.BoolValue? sharedSpanContext,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ZipkinConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.trace.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.BoolValue>(4, _omitFieldNames ? '' : 'sharedSpanContext', subBuilder: $26.BoolValue.create)
  ...
  @$pb.TagNumber(4)
  $26.BoolValue get sharedSpanContext => $_getN(3);
  @$pb.TagNumber(4)
  set sharedSpanContext($26.BoolValue v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasSharedSpanContext() => $_has(3);
  @$pb.TagNumber(4)
  void clearSharedSpanContext() => clearField(4);
  @$pb.TagNumber(4)
  $26.BoolValue ensureSharedSpanContext() => $_ensure(3);
