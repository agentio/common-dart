...
class ClientConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.trace.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.UInt32Value>(4, _omitFieldNames ? '' : 'maxCacheSize', subBuilder: $26.UInt32Value.create)
    ..hasRequiredFields = false
  ;
  ...
  /// default is 1024.
  @$pb.TagNumber(4)
  $26.UInt32Value get maxCacheSize => $_getN(3);
  @$pb.TagNumber(4)
  set maxCacheSize($26.UInt32Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasMaxCacheSize() => $_has(3);
  @$pb.TagNumber(4)
  void clearMaxCacheSize() => clearField(4);
  @$pb.TagNumber(4)
  $26.UInt32Value ensureMaxCacheSize() => $_ensure(3);
}
