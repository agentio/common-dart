...
import '../../core/v3/http_service.pb.dart' as $139;
...
class OpenTelemetryConfig extends $pb.GeneratedMessage {
  factory OpenTelemetryConfig({
    ...
    $core.Iterable<$40.TypedExtensionConfig>? resourceDetectors,
    $40.TypedExtensionConfig? sampler,
  }) {
    final $result = create();
    if (grpcService != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OpenTelemetryConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.trace.v3'), createEmptyInstance: create)
    ...
    ..pc<$40.TypedExtensionConfig>(4, _omitFieldNames ? '' : 'resourceDetectors', $pb.PbFieldType.PM, subBuilder: $40.TypedExtensionConfig.create)
    ..aOM<$40.TypedExtensionConfig>(5, _omitFieldNames ? '' : 'sampler', subBuilder: $40.TypedExtensionConfig.create)
  ...
  @$pb.TagNumber(4)
  $core.List<$40.TypedExtensionConfig> get resourceDetectors => $_getList(3);
  ...
  @$pb.TagNumber(5)
  $40.TypedExtensionConfig get sampler => $_getN(4);
  @$pb.TagNumber(5)
  set sampler($40.TypedExtensionConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasSampler() => $_has(4);
  @$pb.TagNumber(5)
  void clearSampler() => clearField(5);
  @$pb.TagNumber(5)
  $40.TypedExtensionConfig ensureSampler() => $_ensure(4);
}
