...
class XRayConfig_SegmentFields extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'XRayConfig.SegmentFields', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.trace.v3'), createEmptyInstance: create)
    ...
    ..aOM<$30.Struct>(2, _omitFieldNames ? '' : 'aws', subBuilder: $30.Struct.create)
  ...
  @$pb.TagNumber(2)
  $30.Struct get aws => $_getN(1);
  @$pb.TagNumber(2)
  set aws($30.Struct v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAws() => $_has(1);
  @$pb.TagNumber(2)
  void clearAws() => clearField(2);
  @$pb.TagNumber(2)
  $30.Struct ensureAws() => $_ensure(1);
}

/// [#extension: envoy.tracers.xray]
class XRayConfig extends $pb.GeneratedMessage {
  factory XRayConfig({
    $42.SocketAddress? daemonEndpoint,
    $core.String? segmentName,
    $47.DataSource? samplingRuleManifest,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'XRayConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.trace.v3'), createEmptyInstance: create)
    ..aOM<$42.SocketAddress>(1, _omitFieldNames ? '' : 'daemonEndpoint', subBuilder: $42.SocketAddress.create)
    ..aOS(2, _omitFieldNames ? '' : 'segmentName')
    ..aOM<$47.DataSource>(3, _omitFieldNames ? '' : 'samplingRuleManifest', subBuilder: $47.DataSource.create)
  ...
  @$pb.TagNumber(1)
  $42.SocketAddress get daemonEndpoint => $_getN(0);
  @$pb.TagNumber(1)
  set daemonEndpoint($42.SocketAddress v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDaemonEndpoint() => $_has(0);
  @$pb.TagNumber(1)
  void clearDaemonEndpoint() => clearField(1);
  @$pb.TagNumber(1)
  $42.SocketAddress ensureDaemonEndpoint() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $47.DataSource get samplingRuleManifest => $_getN(2);
  @$pb.TagNumber(3)
  set samplingRuleManifest($47.DataSource v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSamplingRuleManifest() => $_has(2);
  @$pb.TagNumber(3)
  void clearSamplingRuleManifest() => clearField(3);
  @$pb.TagNumber(3)
  $47.DataSource ensureSamplingRuleManifest() => $_ensure(2);
