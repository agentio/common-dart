...
const ZipkinConfig$json = {
  ...
  '2': [
    ...
    {
      '1': 'split_spans_for_request',
      '3': 7,
      '4': 1,
      '5': 8,
      '8': {'3': true},
      '10': 'splitSpansForRequest',
    },
  ],
...
final $typed_data.Uint8List zipkinConfigDescriptor = $convert.base64Decode(
    ...
    'ABKAlSEWNvbGxlY3Rvckhvc3RuYW1lEkIKF3NwbGl0X3NwYW5zX2Zvcl9yZXF1ZXN0GAcgASgI'
    'QgsYAZLHhtgEAzMuMFIUc3BsaXRTcGFuc0ZvclJlcXVlc3QieAoYQ29sbGVjdG9yRW5kcG9pbn'
    'RWZXJzaW9uEjMKJURFUFJFQ0FURURfQU5EX1VOQVZBSUxBQkxFX0RPX05PVF9VU0UQABoICAGo'
    '97SLAgESDQoJSFRUUF9KU09OEAESDgoKSFRUUF9QUk9UTxACEggKBEdSUEMQAzopmsWIHiQKIm'
    'Vudm95LmNvbmZpZy50cmFjZS52Mi5aaXBraW5Db25maWc=');
