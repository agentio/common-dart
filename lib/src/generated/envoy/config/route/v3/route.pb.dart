...
import 'route_components.pb.dart' as $66;

/// [#next-free-field: 18]
class RouteConfiguration extends $pb.GeneratedMessage {
  factory RouteConfiguration({
    $core.String? name,
    $core.Iterable<$66.VirtualHost>? virtualHosts,
    ...
    $26.BoolValue? validateClusters,
    $core.Iterable<$core.String>? requestHeadersToRemove,
    Vhds? vhds,
    $core.bool? mostSpecificHeaderMutationsWins,
    $26.UInt32Value? maxDirectResponseBodySizeBytes,
    $core.Iterable<$66.ClusterSpecifierPlugin>? clusterSpecifierPlugins,
    $core.Iterable<$66.RouteAction_RequestMirrorPolicy>? requestMirrorPolicies,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RouteConfiguration', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.route.v3'), createEmptyInstance: create)
    ...
    ..pc<$66.VirtualHost>(2, _omitFieldNames ? '' : 'virtualHosts', $pb.PbFieldType.PM, subBuilder: $66.VirtualHost.create)
    ...
    ..aOM<$26.BoolValue>(7, _omitFieldNames ? '' : 'validateClusters', subBuilder: $26.BoolValue.create)
    ...
    ..aOM<$26.UInt32Value>(11, _omitFieldNames ? '' : 'maxDirectResponseBodySizeBytes', subBuilder: $26.UInt32Value.create)
    ..pc<$66.ClusterSpecifierPlugin>(12, _omitFieldNames ? '' : 'clusterSpecifierPlugins', $pb.PbFieldType.PM, subBuilder: $66.ClusterSpecifierPlugin.create)
    ..pc<$66.RouteAction_RequestMirrorPolicy>(13, _omitFieldNames ? '' : 'requestMirrorPolicies', $pb.PbFieldType.PM, subBuilder: $66.RouteAction_RequestMirrorPolicy.create)
    ..aOB(14, _omitFieldNames ? '' : 'ignorePortInHostMatching')
    ..aOB(15, _omitFieldNames ? '' : 'ignorePathParametersInPathMatching')
    ..m<$core.String, $34.Any>(16, _omitFieldNames ? '' : 'typedPerFilterConfig', entryClassName: 'RouteConfiguration.TypedPerFilterConfigEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $34.Any.create, valueDefaultOrMaker: $34.Any.getDefault, packageName: const $pb.PackageName('envoy.config.route.v3'))
  ...
  @$pb.TagNumber(2)
  $core.List<$66.VirtualHost> get virtualHosts => $_getList(1);
  ...
  /// <config_http_conn_man_headers_custom_request_headers>`.
  @$pb.TagNumber(6)
  $core.List<$47.HeaderValueOption> get requestHeadersToAdd => $_getList(5);
  ...
  @$pb.TagNumber(7)
  $26.BoolValue get validateClusters => $_getN(6);
  @$pb.TagNumber(7)
  set validateClusters($26.BoolValue v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasValidateClusters() => $_has(6);
  @$pb.TagNumber(7)
  void clearValidateClusters() => clearField(7);
  @$pb.TagNumber(7)
  $26.BoolValue ensureValidateClusters() => $_ensure(6);
  ...
  @$pb.TagNumber(11)
  $26.UInt32Value get maxDirectResponseBodySizeBytes => $_getN(10);
  @$pb.TagNumber(11)
  set maxDirectResponseBodySizeBytes($26.UInt32Value v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasMaxDirectResponseBodySizeBytes() => $_has(10);
  @$pb.TagNumber(11)
  void clearMaxDirectResponseBodySizeBytes() => clearField(11);
  @$pb.TagNumber(11)
  $26.UInt32Value ensureMaxDirectResponseBodySizeBytes() => $_ensure(10);
  ...
  @$pb.TagNumber(12)
  $core.List<$66.ClusterSpecifierPlugin> get clusterSpecifierPlugins => $_getList(11);
  ...
  @$pb.TagNumber(13)
  $core.List<$66.RouteAction_RequestMirrorPolicy> get requestMirrorPolicies => $_getList(12);
  ...
  @$pb.TagNumber(16)
  $core.Map<$core.String, $34.Any> get typedPerFilterConfig => $_getMap(15);
