...
class ScopedRouteConfiguration_Key_Fragment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScopedRouteConfiguration.Key.Fragment', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.route.v3'), createEmptyInstance: create)
    ..oo(0, [1])
...
class ScopedRouteConfiguration_Key extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScopedRouteConfiguration.Key', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.route.v3'), createEmptyInstance: create)
...
class ScopedRouteConfiguration extends $pb.GeneratedMessage {
  factory ScopedRouteConfiguration({
    ...
    $core.bool? onDemand,
    $140.RouteConfiguration? routeConfiguration,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
    ...
    if (routeConfiguration != null) {
      $result.routeConfiguration = routeConfiguration;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScopedRouteConfiguration', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.route.v3'), createEmptyInstance: create)
    ...
    ..aOB(4, _omitFieldNames ? '' : 'onDemand')
    ..aOM<$140.RouteConfiguration>(5, _omitFieldNames ? '' : 'routeConfiguration', subBuilder: $140.RouteConfiguration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $core.bool get onDemand => $_getBF(3);
  @$pb.TagNumber(4)
  set onDemand($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasOnDemand() => $_has(3);
  @$pb.TagNumber(4)
  void clearOnDemand() => clearField(4);

  /// The :ref:`envoy_v3_api_msg_config.route.v3.RouteConfiguration` associated with the scope.
  @$pb.TagNumber(5)
  $140.RouteConfiguration get routeConfiguration => $_getN(4);
  @$pb.TagNumber(5)
  set routeConfiguration($140.RouteConfiguration v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasRouteConfiguration() => $_has(4);
  @$pb.TagNumber(5)
  void clearRouteConfiguration() => clearField(5);
  @$pb.TagNumber(5)
  $140.RouteConfiguration ensureRouteConfiguration() => $_ensure(4);
}
