...
final $typed_data.Uint8List virtualHostDescriptor = $convert.base64Decode(
    ...
    'ADKAlCEvpCD5IBDAgBIghyBsABAsgBAFIHZG9tYWlucxI0CgZyb3V0ZXMYAyADKAsyHC5lbnZv'
    ...
    'VG9BZGQSTQoZcmVxdWVzdF9oZWFkZXJzX3RvX3JlbW92ZRgNIAMoCUIS+kIPkgEMIgpyCBABwA'
    'EByAEAUhZyZXF1ZXN0SGVhZGVyc1RvUmVtb3ZlEmkKF3Jlc3BvbnNlX2hlYWRlcnNfdG9fYWRk'
    ...
    'CyADKAlCEvpCD5IBDCIKcggQAcABAcgBAFIXcmVzcG9uc2VIZWFkZXJzVG9SZW1vdmUSQgoEY2'
...
final $typed_data.Uint8List routeDescriptor = $convert.base64Decode(
    ...
    'Vlc3RfaGVhZGVyc190b19yZW1vdmUYDCADKAlCEvpCD5IBDCIKcggQAcABAcgBAFIWcmVxdWVz'
    ...
    'wiCnIIEAHAAQHIAQBSF3Jlc3BvbnNlSGVhZGVyc1RvUmVtb3ZlEjgKB3RyYWNpbmcYDyABKAsy'
...
final $typed_data.Uint8List weightedClusterDescriptor = $convert.base64Decode(
    ...
    'bWVLZXlQcmVmaXgSLgoLaGVhZGVyX25hbWUYBCABKAlCC/pCCHIGwAEByAEASABSCmhlYWRlck'
    '5hbWUakggKDUNsdXN0ZXJXZWlnaHQSLQoEbmFtZRgBIAEoCUIZ8pj+jwUTEhFjbHVzdGVyX3Nw'
    'ZWNpZmllclIEbmFtZRJLCg5jbHVzdGVyX2hlYWRlchgMIAEoCUIk+kIIcgbAAQHIAQDymP6PBR'
    ...
    'ZWFkZXJzX3RvX3JlbW92ZRgJIAMoCUIQ+kINkgEKIghyBsABAcgBAFIWcmVxdWVzdEhlYWRlcn'
    ...
    'RvQWRkEk0KGnJlc3BvbnNlX2hlYWRlcnNfdG9fcmVtb3ZlGAYgAygJQhD6Qg2SAQoiCHIGwAEB'
    'yAEAUhdyZXNwb25zZUhlYWRlcnNUb1JlbW92ZRKFAQoXdHlwZWRfcGVyX2ZpbHRlcl9jb25maW'
    ...
    'oUaG9zdF9yZXdyaXRlX2xpdGVyYWwYCyABKAlCC/pCCHIGwAECyAEASABSEmhvc3RSZXdyaXRl'
...
const CorsPolicy$json = {
  ...
  '2': [
    ...
    {'1': 'forward_not_matching_preflights', '3': 13, '4': 1, '5': 11, '6': '.google.protobuf.BoolValue', '10': 'forwardNotMatchingPreflights'},
  ],
  '7': {},
  '8': [
    {'1': 'enabled_specifier'},
...
final $typed_data.Uint8List corsPolicyDescriptor = $convert.base64Decode(
    ...
    'b2xWYWx1ZVIZYWxsb3dQcml2YXRlTmV0d29ya0FjY2VzcxJhCh9mb3J3YXJkX25vdF9tYXRjaG'
    'luZ19wcmVmbGlnaHRzGA0gASgLMhouZ29vZ2xlLnByb3RvYnVmLkJvb2xWYWx1ZVIcZm9yd2Fy'
    'ZE5vdE1hdGNoaW5nUHJlZmxpZ2h0czokmsWIHh8KHWVudm95LmFwaS52Mi5yb3V0ZS5Db3JzUG'
    '9saWN5QhMKEWVuYWJsZWRfc3BlY2lmaWVySgQIARACSgQICBAJSgQIBxAIUgxhbGxvd19vcmln'
    'aW5SEmFsbG93X29yaWdpbl9yZWdleFIHZW5hYmxlZA==');
...
const RouteAction_RequestMirrorPolicy$json = {
  ...
  '2': [
    ...
    {'1': 'disable_shadow_host_suffix_append', '3': 6, '4': 1, '5': 8, '10': 'disableShadowHostSuffixAppend'},
  ],
  '7': {},
  '9': [
    {'1': 2, '2': 3},
...
final $typed_data.Uint8List routeActionDescriptor = $convert.base64Decode(
    ...
    'x1c3Rlcl9oZWFkZXIYAiABKAlCDfpCCnIIEAHAAQHIAQBIAFINY2x1c3RlckhlYWRlchJVChF3'
    ...
    'EoCUIL+kIIcgbAAQLIAQBSDXByZWZpeFJld3JpdGUSUwoNcmVnZXhfcmV3cml0ZRggIAEoCzIu'
    ...
    'RlX2xpdGVyYWwYBiABKAlCC/pCCHIGwAECyAEASAFSEmhvc3RSZXdyaXRlTGl0ZXJhbBJIChFh'
    'dXRvX2hvc3RfcmV3cml0ZRgHIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5Cb29sVmFsdWVIAVIPYX'
    'V0b0hvc3RSZXdyaXRlEj0KE2hvc3RfcmV3cml0ZV9oZWFkZXIYHSABKAlCC/pCCHIGwAEByAEA'
    ...
    'cmF0aW9uUhFtYXhTdHJlYW1EdXJhdGlvbhrLAwoTUmVxdWVzdE1pcnJvclBvbGljeRIzCgdjbH'
    'VzdGVyGAEgASgJQhnymP6PBRMSEWNsdXN0ZXJfc3BlY2lmaWVyUgdjbHVzdGVyEksKDmNsdXN0'
    'ZXJfaGVhZGVyGAUgASgJQiT6QghyBsABAcgBAPKY/o8FExIRY2x1c3Rlcl9zcGVjaWZpZXJSDW'
    ...
    'ZWQSSAohZGlzYWJsZV9zaGFkb3dfaG9zdF9zdWZmaXhfYXBwZW5kGAYgASgIUh1kaXNhYmxlU2'
    'hhZG93SG9zdFN1ZmZpeEFwcGVuZDo5msWIHjQKMmVudm95LmFwaS52Mi5yb3V0ZS5Sb3V0ZUFj'
    'dGlvbi5SZXF1ZXN0TWlycm9yUG9saWN5SgQIAhADUgtydW50aW1lX2tleRrWCwoKSGFzaFBvbG'
    'ljeRJOCgZoZWFkZXIYASABKAsyNC5lbnZveS5jb25maWcucm91dGUudjMuUm91dGVBY3Rpb24u'
    'SGFzaFBvbGljeS5IZWFkZXJIAFIGaGVhZGVyEk4KBmNvb2tpZRgCIAEoCzI0LmVudm95LmNvbm'
    'ZpZy5yb3V0ZS52My5Sb3V0ZUFjdGlvbi5IYXNoUG9saWN5LkNvb2tpZUgAUgZjb29raWUSeQoV'
    'Y29ubmVjdGlvbl9wcm9wZXJ0aWVzGAMgASgLMkIuZW52b3kuY29uZmlnLnJvdXRlLnYzLlJvdX'
    'RlQWN0aW9uLkhhc2hQb2xpY3kuQ29ubmVjdGlvblByb3BlcnRpZXNIAFIUY29ubmVjdGlvblBy'
    'b3BlcnRpZXMSZwoPcXVlcnlfcGFyYW1ldGVyGAUgASgLMjwuZW52b3kuY29uZmlnLnJvdXRlLn'
    'YzLlJvdXRlQWN0aW9uLkhhc2hQb2xpY3kuUXVlcnlQYXJhbWV0ZXJIAFIOcXVlcnlQYXJhbWV0'
    'ZXISXgoMZmlsdGVyX3N0YXRlGAYgASgLMjkuZW52b3kuY29uZmlnLnJvdXRlLnYzLlJvdXRlQW'
    'N0aW9uLkhhc2hQb2xpY3kuRmlsdGVyU3RhdGVIAFILZmlsdGVyU3RhdGUSGgoIdGVybWluYWwY'
    'BCABKAhSCHRlcm1pbmFsGsYBCgZIZWFkZXISLgoLaGVhZGVyX25hbWUYASABKAlCDfpCCnIIEA'
    'HAAQHIAQBSCmhlYWRlck5hbWUSUwoNcmVnZXhfcmV3cml0ZRgCIAEoCzIuLmVudm95LnR5cGUu'
    'bWF0Y2hlci52My5SZWdleE1hdGNoQW5kU3Vic3RpdHV0ZVIMcmVnZXhSZXdyaXRlOjeaxYgeMg'
    'owZW52b3kuYXBpLnYyLnJvdXRlLlJvdXRlQWN0aW9uLkhhc2hQb2xpY3kuSGVhZGVyGl8KD0Nv'
    'b2tpZUF0dHJpYnV0ZRIlCgRuYW1lGAEgASgJQhH6Qg5yDBABKICAAcABAcgBAFIEbmFtZRIlCg'
    'V2YWx1ZRgCIAEoCUIP+kIMcgoogIABwAECyAEAUgV2YWx1ZRr+AQoGQ29va2llEhsKBG5hbWUY'
    'ASABKAlCB/pCBHICEAFSBG5hbWUSKwoDdHRsGAIgASgLMhkuZ29vZ2xlLnByb3RvYnVmLkR1cm'
    'F0aW9uUgN0dGwSEgoEcGF0aBgDIAEoCVIEcGF0aBJdCgphdHRyaWJ1dGVzGAQgAygLMj0uZW52'
    'b3kuY29uZmlnLnJvdXRlLnYzLlJvdXRlQWN0aW9uLkhhc2hQb2xpY3kuQ29va2llQXR0cmlidX'
    'RlUgphdHRyaWJ1dGVzOjeaxYgeMgowZW52b3kuYXBpLnYyLnJvdXRlLlJvdXRlQWN0aW9uLkhh'
    'c2hQb2xpY3kuQ29va2llGnoKFENvbm5lY3Rpb25Qcm9wZXJ0aWVzEhsKCXNvdXJjZV9pcBgBIA'
    'EoCFIIc291cmNlSXA6RZrFiB5ACj5lbnZveS5hcGkudjIucm91dGUuUm91dGVBY3Rpb24uSGFz'
    'aFBvbGljeS5Db25uZWN0aW9uUHJvcGVydGllcxpuCg5RdWVyeVBhcmFtZXRlchIbCgRuYW1lGA'
    'EgASgJQgf6QgRyAhABUgRuYW1lOj+axYgeOgo4ZW52b3kuYXBpLnYyLnJvdXRlLlJvdXRlQWN0'
    'aW9uLkhhc2hQb2xpY3kuUXVlcnlQYXJhbWV0ZXIaZgoLRmlsdGVyU3RhdGUSGQoDa2V5GAEgAS'
    'gJQgf6QgRyAhABUgNrZXk6PJrFiB43CjVlbnZveS5hcGkudjIucm91dGUuUm91dGVBY3Rpb24u'
    'SGFzaFBvbGljeS5GaWx0ZXJTdGF0ZTowmsWIHisKKWVudm95LmFwaS52Mi5yb3V0ZS5Sb3V0ZU'
    'FjdGlvbi5IYXNoUG9saWN5QhcKEHBvbGljeV9zcGVjaWZpZXISA/hCARqjAwoNVXBncmFkZUNv'
    'bmZpZxIwCgx1cGdyYWRlX3R5cGUYASABKAlCDfpCCnIIEAHAAQLIAQBSC3VwZ3JhZGVUeXBlEj'
    'QKB2VuYWJsZWQYAiABKAsyGi5nb29nbGUucHJvdG9idWYuQm9vbFZhbHVlUgdlbmFibGVkEmUK'
    'DmNvbm5lY3RfY29uZmlnGAMgASgLMj4uZW52b3kuY29uZmlnLnJvdXRlLnYzLlJvdXRlQWN0aW'
    '9uLlVwZ3JhZGVDb25maWcuQ29ubmVjdENvbmZpZ1INY29ubmVjdENvbmZpZxqNAQoNQ29ubmVj'
    'dENvbmZpZxJdChVwcm94eV9wcm90b2NvbF9jb25maWcYASABKAsyKS5lbnZveS5jb25maWcuY2'
    '9yZS52My5Qcm94eVByb3RvY29sQ29uZmlnUhNwcm94eVByb3RvY29sQ29uZmlnEh0KCmFsbG93'
    'X3Bvc3QYAiABKAhSCWFsbG93UG9zdDozmsWIHi4KLGVudm95LmFwaS52Mi5yb3V0ZS5Sb3V0ZU'
    'FjdGlvbi5VcGdyYWRlQ29uZmlnGogCChFNYXhTdHJlYW1EdXJhdGlvbhJJChNtYXhfc3RyZWFt'
    'X2R1cmF0aW9uGAEgASgLMhkuZ29vZ2xlLnByb3RvYnVmLkR1cmF0aW9uUhFtYXhTdHJlYW1EdX'
    'JhdGlvbhJQChdncnBjX3RpbWVvdXRfaGVhZGVyX21heBgCIAEoCzIZLmdvb2dsZS5wcm90b2J1'
    'Zi5EdXJhdGlvblIUZ3JwY1RpbWVvdXRIZWFkZXJNYXgSVgoaZ3JwY190aW1lb3V0X2hlYWRlcl'
    '9vZmZzZXQYAyABKAsyGS5nb29nbGUucHJvdG9idWYuRHVyYXRpb25SF2dycGNUaW1lb3V0SGVh'
    'ZGVyT2Zmc2V0ImAKG0NsdXN0ZXJOb3RGb3VuZFJlc3BvbnNlQ29kZRIXChNTRVJWSUNFX1VOQV'
    'ZBSUxBQkxFEAASDQoJTk9UX0ZPVU5EEAESGQoVSU5URVJOQUxfU0VSVkVSX0VSUk9SEAIiXgoW'
    'SW50ZXJuYWxSZWRpcmVjdEFjdGlvbhIiCh5QQVNTX1RIUk9VR0hfSU5URVJOQUxfUkVESVJFQ1'
    'QQABIcChhIQU5ETEVfSU5URVJOQUxfUkVESVJFQ1QQARoCGAE6JZrFiB4gCh5lbnZveS5hcGku'
    'djIucm91dGUuUm91dGVBY3Rpb25CGAoRY2x1c3Rlcl9zcGVjaWZpZXISA/hCAUIYChZob3N0X3'
    'Jld3JpdGVfc3BlY2lmaWVySgQIDBANSgQIEhATSgQIExAUSgQIEBARSgQIFhAXSgQIFRAWSgQI'
    'ChALUhVyZXF1ZXN0X21pcnJvcl9wb2xpY3k=');
...
final $typed_data.Uint8List retryPolicyDescriptor = $convert.base64Decode(
    ...
    'gQAcABAcgBAFIEbmFtZRJWCgZmb3JtYXQYAiABKA4yNC5lbnZveS5jb25maWcucm91dGUudjMu'
...
final $typed_data.Uint8List redirectActionDescriptor = $convert.base64Decode(
    ...
    'ZGlyZWN0GAEgASgJQgv6QghyBsABAsgBAFIMaG9zdFJlZGlyZWN0EiMKDXBvcnRfcmVkaXJlY3'
    'QYCCABKA1SDHBvcnRSZWRpcmVjdBIyCg1wYXRoX3JlZGlyZWN0GAIgASgJQgv6QghyBsABAsgB'
    'AEgBUgxwYXRoUmVkaXJlY3QSNAoOcHJlZml4X3Jld3JpdGUYBSABKAlCC/pCCHIGwAECyAEASA'
...
final $typed_data.Uint8List rateLimitDescriptor = $convert.base64Decode(
    ...
    'cnMSLgoLaGVhZGVyX25hbWUYASABKAlCDfpCCnIIEAHAAQHIAQBSCmhlYWRlck5hbWUSLgoOZG'
...
final $typed_data.Uint8List headerMatcherDescriptor = $convert.base64Decode(
    'Cg1IZWFkZXJNYXRjaGVyEiEKBG5hbWUYASABKAlCDfpCCnIIEAHAAQHIAQBSBG5hbWUSLgoLZX'
...
const InternalRedirectPolicy$json = {
  ...
  '2': [
    ...
    {'1': 'response_headers_to_copy', '3': 5, '4': 3, '5': 9, '8': {}, '10': 'responseHeadersToCopy'},
  ],
};
...
final $typed_data.Uint8List internalRedirectPolicyDescriptor = $convert.base64Decode(
    ...
    'JlY3QYBCABKAhSGGFsbG93Q3Jvc3NTY2hlbWVSZWRpcmVjdBJLChhyZXNwb25zZV9oZWFkZXJz'
    'X3RvX2NvcHkYBSADKAlCEvpCD5IBDBgBIghyBsABAcgBAFIVcmVzcG9uc2VIZWFkZXJzVG9Db3'
    'B5');
