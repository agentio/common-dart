...
import '../../../api/v2/auth/secret.pb.dart' as $77;
import '../../../api/v2/cluster.pb.dart' as $100;
...
import '../../../api/v2/core/event_service_config.pb.dart' as $78;
import '../../../api/v2/core/socket_option.pb.dart' as $27;
import '../../../api/v2/listener.pb.dart' as $99;
import '../../metrics/v2/stats.pb.dart' as $96;
import '../../overload/v2alpha/overload.pb.dart' as $98;
...
class Bootstrap_StaticResources extends $pb.GeneratedMessage {
  factory Bootstrap_StaticResources({
    $core.Iterable<$99.Listener>? listeners,
    $core.Iterable<$100.Cluster>? clusters,
    $core.Iterable<$77.Secret>? secrets,
  }) {
    final $result = create();
    if (listeners != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Bootstrap.StaticResources', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.bootstrap.v2'), createEmptyInstance: create)
    ..pc<$99.Listener>(1, _omitFieldNames ? '' : 'listeners', $pb.PbFieldType.PM, subBuilder: $99.Listener.create)
    ..pc<$100.Cluster>(2, _omitFieldNames ? '' : 'clusters', $pb.PbFieldType.PM, subBuilder: $100.Cluster.create)
    ..pc<$77.Secret>(3, _omitFieldNames ? '' : 'secrets', $pb.PbFieldType.PM, subBuilder: $77.Secret.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$99.Listener> get listeners => $_getList(0);
  ...
  /// IP or DNS-based).
  @$pb.TagNumber(2)
  $core.List<$100.Cluster> get clusters => $_getList(1);

  /// These static secrets can be used by :ref:`SdsSecretConfig
  /// <envoy_api_msg_auth.SdsSecretConfig>`
  @$pb.TagNumber(3)
  $core.List<$77.Secret> get secrets => $_getList(2);
}

class Bootstrap_DynamicResources extends $pb.GeneratedMessage {
  factory Bootstrap_DynamicResources({
    $75.ConfigSource? ldsConfig,
    $75.ConfigSource? cdsConfig,
    $75.ApiConfigSource? adsConfig,
  }) {
    final $result = create();
    if (ldsConfig != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Bootstrap.DynamicResources', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.bootstrap.v2'), createEmptyInstance: create)
    ..aOM<$75.ConfigSource>(1, _omitFieldNames ? '' : 'ldsConfig', subBuilder: $75.ConfigSource.create)
    ..aOM<$75.ConfigSource>(2, _omitFieldNames ? '' : 'cdsConfig', subBuilder: $75.ConfigSource.create)
    ..aOM<$75.ApiConfigSource>(3, _omitFieldNames ? '' : 'adsConfig', subBuilder: $75.ApiConfigSource.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $75.ConfigSource get ldsConfig => $_getN(0);
  @$pb.TagNumber(1)
  set ldsConfig($75.ConfigSource v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasLdsConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearLdsConfig() => clearField(1);
  @$pb.TagNumber(1)
  $75.ConfigSource ensureLdsConfig() => $_ensure(0);

  /// All post-bootstrap :ref:`Cluster <envoy_api_msg_Cluster>` definitions are
  /// provided by a single :ref:`CDS <arch_overview_dynamic_config_cds>`
  /// configuration source.
  @$pb.TagNumber(2)
  $75.ConfigSource get cdsConfig => $_getN(1);
  @$pb.TagNumber(2)
  set cdsConfig($75.ConfigSource v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCdsConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearCdsConfig() => clearField(2);
  @$pb.TagNumber(2)
  $75.ConfigSource ensureCdsConfig() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $75.ApiConfigSource get adsConfig => $_getN(2);
  @$pb.TagNumber(3)
  set adsConfig($75.ApiConfigSource v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAdsConfig() => $_has(2);
  @$pb.TagNumber(3)
  void clearAdsConfig() => clearField(3);
  @$pb.TagNumber(3)
  $75.ApiConfigSource ensureAdsConfig() => $_ensure(2);
}
...
class Bootstrap extends $pb.GeneratedMessage {
  factory Bootstrap({
    ...
    $core.Iterable<$96.StatsSink>? statsSinks,
  ...
  @$core.Deprecated('This field is deprecated.')
    Runtime? runtime,
    Admin? admin,
    $96.StatsConfig? statsConfig,
    $75.ApiConfigSource? hdsConfig,
    $98.OverloadManager? overloadManager,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Bootstrap', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.bootstrap.v2'), createEmptyInstance: create)
    ...
    ..pc<$96.StatsSink>(6, _omitFieldNames ? '' : 'statsSinks', $pb.PbFieldType.PM, subBuilder: $96.StatsSink.create)
    ...
    ..aOM<$97.Tracing>(9, _omitFieldNames ? '' : 'tracing', subBuilder: $97.Tracing.create)
    ...
    ..aOM<$96.StatsConfig>(13, _omitFieldNames ? '' : 'statsConfig', subBuilder: $96.StatsConfig.create)
    ..aOM<$75.ApiConfigSource>(14, _omitFieldNames ? '' : 'hdsConfig', subBuilder: $75.ApiConfigSource.create)
    ..aOM<$98.OverloadManager>(15, _omitFieldNames ? '' : 'overloadManager', subBuilder: $98.OverloadManager.create)
  ...
  @$pb.TagNumber(6)
  $core.List<$96.StatsSink> get statsSinks => $_getList(5);
  ...
  @$pb.TagNumber(9)
  $97.Tracing get tracing => $_getN(8);
  @$pb.TagNumber(9)
  set tracing($97.Tracing v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasTracing() => $_has(8);
  @$pb.TagNumber(9)
  void clearTracing() => clearField(9);
  @$pb.TagNumber(9)
  $97.Tracing ensureTracing() => $_ensure(8);
  ...
  @$pb.TagNumber(13)
  $96.StatsConfig get statsConfig => $_getN(11);
  @$pb.TagNumber(13)
  set statsConfig($96.StatsConfig v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasStatsConfig() => $_has(11);
  @$pb.TagNumber(13)
  void clearStatsConfig() => clearField(13);
  @$pb.TagNumber(13)
  $96.StatsConfig ensureStatsConfig() => $_ensure(11);

  /// Health discovery service config option.
  /// (:ref:`core.ApiConfigSource <envoy_api_msg_core.ApiConfigSource>`)
  @$pb.TagNumber(14)
  $75.ApiConfigSource get hdsConfig => $_getN(12);
  @$pb.TagNumber(14)
  set hdsConfig($75.ApiConfigSource v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasHdsConfig() => $_has(12);
  @$pb.TagNumber(14)
  void clearHdsConfig() => clearField(14);
  @$pb.TagNumber(14)
  $75.ApiConfigSource ensureHdsConfig() => $_ensure(12);

  /// Optional overload manager configuration.
  @$pb.TagNumber(15)
  $98.OverloadManager get overloadManager => $_getN(13);
  @$pb.TagNumber(15)
  set overloadManager($98.OverloadManager v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasOverloadManager() => $_has(13);
  @$pb.TagNumber(15)
  void clearOverloadManager() => clearField(15);
  @$pb.TagNumber(15)
  $98.OverloadManager ensureOverloadManager() => $_ensure(13);
  ...
  @$pb.TagNumber(19)
  $26.UInt64Value get statsServerVersionOverride => $_getN(17);
  @$pb.TagNumber(19)
  ...
  @$pb.TagNumber(19)
  $26.UInt64Value ensureStatsServerVersionOverride() => $_ensure(17);
...
class Admin extends $pb.GeneratedMessage {
  factory Admin({
    ...
    $31.Address? address,
    $core.Iterable<$27.SocketOption>? socketOptions,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Admin', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.bootstrap.v2'), createEmptyInstance: create)
    ...
    ..aOM<$31.Address>(3, _omitFieldNames ? '' : 'address', subBuilder: $31.Address.create)
    ..pc<$27.SocketOption>(4, _omitFieldNames ? '' : 'socketOptions', $pb.PbFieldType.PM, subBuilder: $27.SocketOption.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $31.Address get address => $_getN(2);
  @$pb.TagNumber(3)
  set address($31.Address v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAddress() => $_has(2);
  @$pb.TagNumber(3)
  void clearAddress() => clearField(3);
  @$pb.TagNumber(3)
  $31.Address ensureAddress() => $_ensure(2);

  /// Additional socket options that may not be present in Envoy source code or
  /// precompiled binaries.
  @$pb.TagNumber(4)
  $core.List<$27.SocketOption> get socketOptions => $_getList(3);
}
...
class ClusterManager_OutlierDetection extends $pb.GeneratedMessage {
  factory ClusterManager_OutlierDetection({
    ...
    $78.EventServiceConfig? eventService,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClusterManager.OutlierDetection', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.bootstrap.v2'), createEmptyInstance: create)
    ...
    ..aOM<$78.EventServiceConfig>(2, _omitFieldNames ? '' : 'eventService', subBuilder: $78.EventServiceConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $78.EventServiceConfig get eventService => $_getN(1);
  @$pb.TagNumber(2)
  set eventService($78.EventServiceConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasEventService() => $_has(1);
  @$pb.TagNumber(2)
  void clearEventService() => clearField(2);
  @$pb.TagNumber(2)
  $78.EventServiceConfig ensureEventService() => $_ensure(1);
}
...
class ClusterManager extends $pb.GeneratedMessage {
  factory ClusterManager({
    ...
    $75.ApiConfigSource? loadStatsConfig,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClusterManager', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.bootstrap.v2'), createEmptyInstance: create)
    ...
    ..aOM<$31.BindConfig>(3, _omitFieldNames ? '' : 'upstreamBindConfig', subBuilder: $31.BindConfig.create)
    ..aOM<$75.ApiConfigSource>(4, _omitFieldNames ? '' : 'loadStatsConfig', subBuilder: $75.ApiConfigSource.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $31.BindConfig get upstreamBindConfig => $_getN(2);
  @$pb.TagNumber(3)
  set upstreamBindConfig($31.BindConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasUpstreamBindConfig() => $_has(2);
  @$pb.TagNumber(3)
  void clearUpstreamBindConfig() => clearField(3);
  @$pb.TagNumber(3)
  $31.BindConfig ensureUpstreamBindConfig() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $75.ApiConfigSource get loadStatsConfig => $_getN(3);
  @$pb.TagNumber(4)
  set loadStatsConfig($75.ApiConfigSource v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLoadStatsConfig() => $_has(3);
  @$pb.TagNumber(4)
  void clearLoadStatsConfig() => clearField(4);
  @$pb.TagNumber(4)
  $75.ApiConfigSource ensureLoadStatsConfig() => $_ensure(3);
}
...
class RuntimeLayer_RtdsLayer extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RuntimeLayer.RtdsLayer', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.bootstrap.v2'), createEmptyInstance: create)
    ...
    ..aOM<$75.ConfigSource>(2, _omitFieldNames ? '' : 'rtdsConfig', subBuilder: $75.ConfigSource.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $75.ConfigSource get rtdsConfig => $_getN(1);
  @$pb.TagNumber(2)
  set rtdsConfig($75.ConfigSource v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasRtdsConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearRtdsConfig() => clearField(2);
  @$pb.TagNumber(2)
  $75.ConfigSource ensureRtdsConfig() => $_ensure(1);
}
