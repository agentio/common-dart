...
class FileBasedMetadataConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FileBasedMetadataConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.grpc_credential.v2alpha'), createEmptyInstance: create)
    ..aOM<$36.DataSource>(1, _omitFieldNames ? '' : 'secretData', subBuilder: $36.DataSource.create)
  ...
  @$pb.TagNumber(1)
  $36.DataSource get secretData => $_getN(0);
  @$pb.TagNumber(1)
  set secretData($36.DataSource v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSecretData() => $_has(0);
  @$pb.TagNumber(1)
  void clearSecretData() => clearField(1);
  @$pb.TagNumber(1)
  $36.DataSource ensureSecretData() => $_ensure(0);
