...
class ScaleTimersOverloadActionConfig_ScaleTimer extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScaleTimersOverloadActionConfig.ScaleTimer', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.overload.v3'), createEmptyInstance: create)
    ...
    ..aOM<$28.Duration>(2, _omitFieldNames ? '' : 'minTimeout', subBuilder: $28.Duration.create)
    ..aOM<$44.Percent>(3, _omitFieldNames ? '' : 'minScale', subBuilder: $44.Percent.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $28.Duration get minTimeout => $_getN(1);
  @$pb.TagNumber(2)
  set minTimeout($28.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMinTimeout() => $_has(1);
  @$pb.TagNumber(2)
  void clearMinTimeout() => clearField(2);
  @$pb.TagNumber(2)
  $28.Duration ensureMinTimeout() => $_ensure(1);

  /// Sets the minimum duration as a percentage of the maximum value.
  @$pb.TagNumber(3)
  $44.Percent get minScale => $_getN(2);
  @$pb.TagNumber(3)
  set minScale($44.Percent v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMinScale() => $_has(2);
  @$pb.TagNumber(3)
  void clearMinScale() => clearField(3);
  @$pb.TagNumber(3)
  $44.Percent ensureMinScale() => $_ensure(2);
}
...
class OverloadManager extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OverloadManager', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.overload.v3'), createEmptyInstance: create)
    ..aOM<$28.Duration>(1, _omitFieldNames ? '' : 'refreshInterval', subBuilder: $28.Duration.create)
  ...
  @$pb.TagNumber(1)
  $28.Duration get refreshInterval => $_getN(0);
  @$pb.TagNumber(1)
  set refreshInterval($28.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasRefreshInterval() => $_has(0);
  @$pb.TagNumber(1)
  void clearRefreshInterval() => clearField(1);
  @$pb.TagNumber(1)
  $28.Duration ensureRefreshInterval() => $_ensure(0);
