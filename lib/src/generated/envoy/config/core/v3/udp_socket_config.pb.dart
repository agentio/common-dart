...
class UdpSocketConfig extends $pb.GeneratedMessage {
  factory UdpSocketConfig({
    $26.UInt64Value? maxRxDatagramSize,
    $26.BoolValue? preferGro,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UdpSocketConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<$26.UInt64Value>(1, _omitFieldNames ? '' : 'maxRxDatagramSize', subBuilder: $26.UInt64Value.create)
    ..aOM<$26.BoolValue>(2, _omitFieldNames ? '' : 'preferGro', subBuilder: $26.BoolValue.create)
  ...
  @$pb.TagNumber(1)
  $26.UInt64Value get maxRxDatagramSize => $_getN(0);
  @$pb.TagNumber(1)
  set maxRxDatagramSize($26.UInt64Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasMaxRxDatagramSize() => $_has(0);
  @$pb.TagNumber(1)
  void clearMaxRxDatagramSize() => clearField(1);
  @$pb.TagNumber(1)
  $26.UInt64Value ensureMaxRxDatagramSize() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $26.BoolValue get preferGro => $_getN(1);
  @$pb.TagNumber(2)
  set preferGro($26.BoolValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPreferGro() => $_has(1);
  @$pb.TagNumber(2)
  void clearPreferGro() => clearField(2);
  @$pb.TagNumber(2)
  $26.BoolValue ensurePreferGro() => $_ensure(1);
}
