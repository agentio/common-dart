...
class ApiConfigSource extends $pb.GeneratedMessage {
  factory ApiConfigSource({
    ...
    $28.Duration? refreshDelay,
    $core.Iterable<$48.GrpcService>? grpcServices,
    $28.Duration? requestTimeout,
    RateLimitSettings? rateLimitSettings,
    $core.bool? setNodeOnFirstMessageOnly,
    ApiVersion? transportApiVersion,
    $core.Iterable<$40.TypedExtensionConfig>? configValidators,
  }) {
    final $result = create();
    if (apiType != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ApiConfigSource', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..aOM<$28.Duration>(3, _omitFieldNames ? '' : 'refreshDelay', subBuilder: $28.Duration.create)
    ..pc<$48.GrpcService>(4, _omitFieldNames ? '' : 'grpcServices', $pb.PbFieldType.PM, subBuilder: $48.GrpcService.create)
    ..aOM<$28.Duration>(5, _omitFieldNames ? '' : 'requestTimeout', subBuilder: $28.Duration.create)
    ...
    ..pc<$40.TypedExtensionConfig>(9, _omitFieldNames ? '' : 'configValidators', $pb.PbFieldType.PM, subBuilder: $40.TypedExtensionConfig.create)
  ...
  @$pb.TagNumber(3)
  $28.Duration get refreshDelay => $_getN(2);
  @$pb.TagNumber(3)
  set refreshDelay($28.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasRefreshDelay() => $_has(2);
  @$pb.TagNumber(3)
  void clearRefreshDelay() => clearField(3);
  @$pb.TagNumber(3)
  $28.Duration ensureRefreshDelay() => $_ensure(2);

  /// Multiple gRPC services be provided for GRPC. If > 1 cluster is defined,
  /// services will be cycled through if any kind of failure occurs.
  @$pb.TagNumber(4)
  $core.List<$48.GrpcService> get grpcServices => $_getList(3);

  /// For REST APIs, the request timeout. If not set, a default value of 1s will be used.
  @$pb.TagNumber(5)
  $28.Duration get requestTimeout => $_getN(4);
  @$pb.TagNumber(5)
  set requestTimeout($28.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasRequestTimeout() => $_has(4);
  @$pb.TagNumber(5)
  void clearRequestTimeout() => clearField(5);
  @$pb.TagNumber(5)
  $28.Duration ensureRequestTimeout() => $_ensure(4);
  ...
  @$pb.TagNumber(9)
  $core.List<$40.TypedExtensionConfig> get configValidators => $_getList(8);
}
...
class RateLimitSettings extends $pb.GeneratedMessage {
  factory RateLimitSettings({
    $26.UInt32Value? maxTokens,
    $26.DoubleValue? fillRate,
  }) {
    final $result = create();
    if (maxTokens != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimitSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<$26.UInt32Value>(1, _omitFieldNames ? '' : 'maxTokens', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.DoubleValue>(2, _omitFieldNames ? '' : 'fillRate', subBuilder: $26.DoubleValue.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $26.UInt32Value get maxTokens => $_getN(0);
  @$pb.TagNumber(1)
  set maxTokens($26.UInt32Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasMaxTokens() => $_has(0);
  @$pb.TagNumber(1)
  void clearMaxTokens() => clearField(1);
  @$pb.TagNumber(1)
  $26.UInt32Value ensureMaxTokens() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $26.DoubleValue get fillRate => $_getN(1);
  @$pb.TagNumber(2)
  set fillRate($26.DoubleValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFillRate() => $_has(1);
  @$pb.TagNumber(2)
  void clearFillRate() => clearField(2);
  @$pb.TagNumber(2)
  $26.DoubleValue ensureFillRate() => $_ensure(1);
}
...
class PathConfigSource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PathConfigSource', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..aOM<$47.WatchedDirectory>(2, _omitFieldNames ? '' : 'watchedDirectory', subBuilder: $47.WatchedDirectory.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $47.WatchedDirectory get watchedDirectory => $_getN(1);
  @$pb.TagNumber(2)
  set watchedDirectory($47.WatchedDirectory v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasWatchedDirectory() => $_has(1);
  @$pb.TagNumber(2)
  void clearWatchedDirectory() => clearField(2);
  @$pb.TagNumber(2)
  $47.WatchedDirectory ensureWatchedDirectory() => $_ensure(1);
}
...
class ConfigSource extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    $28.Duration? initialFetchTimeout,
    SelfConfigSource? self,
    ApiVersion? resourceApiVersion,
    $core.Iterable<$49.Authority>? authorities,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConfigSource', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..aOM<$28.Duration>(4, _omitFieldNames ? '' : 'initialFetchTimeout', subBuilder: $28.Duration.create)
    ...
    ..pc<$49.Authority>(7, _omitFieldNames ? '' : 'authorities', $pb.PbFieldType.PM, subBuilder: $49.Authority.create)
  ...
  @$pb.TagNumber(4)
  $28.Duration get initialFetchTimeout => $_getN(3);
  @$pb.TagNumber(4)
  set initialFetchTimeout($28.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasInitialFetchTimeout() => $_has(3);
  @$pb.TagNumber(4)
  void clearInitialFetchTimeout() => clearField(4);
  @$pb.TagNumber(4)
  $28.Duration ensureInitialFetchTimeout() => $_ensure(3);
  ...
  /// [#not-implemented-hide:]
  @$pb.TagNumber(7)
  $core.List<$49.Authority> get authorities => $_getList(6);
...
class ExtensionConfigSource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExtensionConfigSource', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..aOM<$34.Any>(2, _omitFieldNames ? '' : 'defaultConfig', subBuilder: $34.Any.create)
  ...
  @$pb.TagNumber(2)
  $34.Any get defaultConfig => $_getN(1);
  @$pb.TagNumber(2)
  set defaultConfig($34.Any v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDefaultConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearDefaultConfig() => clearField(2);
  @$pb.TagNumber(2)
  $34.Any ensureDefaultConfig() => $_ensure(1);
