...
import '../../../type/v3/http.pbenum.dart' as $102;
import '../../../type/v3/range.pb.dart' as $54;
import 'base.pb.dart' as $47;
import 'base.pbenum.dart' as $47;
import 'event_service_config.pb.dart' as $101;
import 'extension.pb.dart' as $40;
import 'health_check.pbenum.dart';
import 'proxy_protocol.pb.dart' as $63;
...
class HealthCheck_HttpHealthCheck extends $pb.GeneratedMessage {
  factory HealthCheck_HttpHealthCheck({
    ...
    $core.Iterable<$54.Int64Range>? expectedStatuses,
    $102.CodecClientType? codecClientType,
    $58.StringMatcher? serviceNameMatcher,
    $core.Iterable<$54.Int64Range>? retriableStatuses,
    $47.RequestMethod? method,
    $26.UInt64Value? responseBufferSize,
  }) {
    final $result = create();
    if (host != null) {
      $result.host = host;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HealthCheck.HttpHealthCheck', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..pc<$47.HeaderValueOption>(6, _omitFieldNames ? '' : 'requestHeadersToAdd', $pb.PbFieldType.PM, subBuilder: $47.HeaderValueOption.create)
    ..pPS(8, _omitFieldNames ? '' : 'requestHeadersToRemove')
    ..pc<$54.Int64Range>(9, _omitFieldNames ? '' : 'expectedStatuses', $pb.PbFieldType.PM, subBuilder: $54.Int64Range.create)
    ..e<$102.CodecClientType>(10, _omitFieldNames ? '' : 'codecClientType', $pb.PbFieldType.OE, defaultOrMaker: $102.CodecClientType.HTTP1, valueOf: $102.CodecClientType.valueOf, enumValues: $102.CodecClientType.values)
    ..aOM<$58.StringMatcher>(11, _omitFieldNames ? '' : 'serviceNameMatcher', subBuilder: $58.StringMatcher.create)
    ..pc<$54.Int64Range>(12, _omitFieldNames ? '' : 'retriableStatuses', $pb.PbFieldType.PM, subBuilder: $54.Int64Range.create)
    ..e<$47.RequestMethod>(13, _omitFieldNames ? '' : 'method', $pb.PbFieldType.OE, defaultOrMaker: $47.RequestMethod.METHOD_UNSPECIFIED, valueOf: $47.RequestMethod.valueOf, enumValues: $47.RequestMethod.values)
    ..aOM<$26.UInt64Value>(14, _omitFieldNames ? '' : 'responseBufferSize', subBuilder: $26.UInt64Value.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $core.List<$47.HeaderValueOption> get requestHeadersToAdd => $_getList(4);
  ...
  @$pb.TagNumber(9)
  $core.List<$54.Int64Range> get expectedStatuses => $_getList(6);

  /// Use specified application protocol for health checks.
  @$pb.TagNumber(10)
  $102.CodecClientType get codecClientType => $_getN(7);
  @$pb.TagNumber(10)
  set codecClientType($102.CodecClientType v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  $58.StringMatcher get serviceNameMatcher => $_getN(8);
  @$pb.TagNumber(11)
  set serviceNameMatcher($58.StringMatcher v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasServiceNameMatcher() => $_has(8);
  @$pb.TagNumber(11)
  void clearServiceNameMatcher() => clearField(11);
  @$pb.TagNumber(11)
  $58.StringMatcher ensureServiceNameMatcher() => $_ensure(8);
  ...
  @$pb.TagNumber(12)
  $core.List<$54.Int64Range> get retriableStatuses => $_getList(9);
  ...
  @$pb.TagNumber(13)
  $47.RequestMethod get method => $_getN(10);
  @$pb.TagNumber(13)
  set method($47.RequestMethod v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  $26.UInt64Value get responseBufferSize => $_getN(11);
  @$pb.TagNumber(14)
  set responseBufferSize($26.UInt64Value v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasResponseBufferSize() => $_has(11);
  @$pb.TagNumber(14)
  void clearResponseBufferSize() => clearField(14);
  @$pb.TagNumber(14)
  $26.UInt64Value ensureResponseBufferSize() => $_ensure(11);
}
...
class HealthCheck_TcpHealthCheck extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HealthCheck.TcpHealthCheck', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..aOM<$63.ProxyProtocolConfig>(3, _omitFieldNames ? '' : 'proxyProtocolConfig', subBuilder: $63.ProxyProtocolConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $63.ProxyProtocolConfig get proxyProtocolConfig => $_getN(2);
  @$pb.TagNumber(3)
  set proxyProtocolConfig($63.ProxyProtocolConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasProxyProtocolConfig() => $_has(2);
  @$pb.TagNumber(3)
  void clearProxyProtocolConfig() => clearField(3);
  @$pb.TagNumber(3)
  $63.ProxyProtocolConfig ensureProxyProtocolConfig() => $_ensure(2);
}
...
class HealthCheck_GrpcHealthCheck extends $pb.GeneratedMessage {
  factory HealthCheck_GrpcHealthCheck({
    ...
    $core.Iterable<$47.HeaderValueOption>? initialMetadata,
  }) {
    final $result = create();
    if (serviceName != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HealthCheck.GrpcHealthCheck', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..pc<$47.HeaderValueOption>(3, _omitFieldNames ? '' : 'initialMetadata', $pb.PbFieldType.PM, subBuilder: $47.HeaderValueOption.create)
    ..hasRequiredFields = false
  ;
  ...
  /// <config_http_conn_man_headers_custom_request_headers>`.
  @$pb.TagNumber(3)
  $core.List<$47.HeaderValueOption> get initialMetadata => $_getList(2);
}
...
class HealthCheck extends $pb.GeneratedMessage {
  factory HealthCheck({
    ...
    $28.Duration? intervalJitter,
    $26.UInt32Value? unhealthyThreshold,
    $26.UInt32Value? healthyThreshold,
    $26.UInt32Value? altPort,
    $26.BoolValue? reuseConnection,
    ...
    $28.Duration? noTrafficInterval,
    HealthCheck_CustomHealthCheck? customHealthCheck,
    $28.Duration? unhealthyInterval,
    $28.Duration? unhealthyEdgeInterval,
    $28.Duration? healthyEdgeInterval,
  @$core.Deprecated('This field is deprecated.')
    $core.String? eventLogPath,
    $core.int? intervalJitterPercent,
    $core.bool? alwaysLogHealthCheckFailures,
    $28.Duration? initialJitter,
    HealthCheck_TlsOptions? tlsOptions,
    $101.EventServiceConfig? eventService,
    $30.Struct? transportSocketMatchCriteria,
    $28.Duration? noTrafficHealthyInterval,
    $core.Iterable<$40.TypedExtensionConfig>? eventLogger,
    $core.bool? alwaysLogHealthCheckSuccess,
  }) {
    final $result = create();
    if (timeout != null) {
    ...
    if (alwaysLogHealthCheckSuccess != null) {
      $result.alwaysLogHealthCheckSuccess = alwaysLogHealthCheckSuccess;
    }
    return $result;
  }
  HealthCheck._() : super();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HealthCheck', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..oo(0, [8, 9, 11, 13])
    ..aOM<$28.Duration>(1, _omitFieldNames ? '' : 'timeout', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(2, _omitFieldNames ? '' : 'interval', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(3, _omitFieldNames ? '' : 'intervalJitter', subBuilder: $28.Duration.create)
    ..aOM<$26.UInt32Value>(4, _omitFieldNames ? '' : 'unhealthyThreshold', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(5, _omitFieldNames ? '' : 'healthyThreshold', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(6, _omitFieldNames ? '' : 'altPort', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.BoolValue>(7, _omitFieldNames ? '' : 'reuseConnection', subBuilder: $26.BoolValue.create)
    ...
    ..aOM<$28.Duration>(12, _omitFieldNames ? '' : 'noTrafficInterval', subBuilder: $28.Duration.create)
    ..aOM<HealthCheck_CustomHealthCheck>(13, _omitFieldNames ? '' : 'customHealthCheck', subBuilder: HealthCheck_CustomHealthCheck.create)
    ..aOM<$28.Duration>(14, _omitFieldNames ? '' : 'unhealthyInterval', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(15, _omitFieldNames ? '' : 'unhealthyEdgeInterval', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(16, _omitFieldNames ? '' : 'healthyEdgeInterval', subBuilder: $28.Duration.create)
    ...
    ..aOM<$28.Duration>(20, _omitFieldNames ? '' : 'initialJitter', subBuilder: $28.Duration.create)
    ..aOM<HealthCheck_TlsOptions>(21, _omitFieldNames ? '' : 'tlsOptions', subBuilder: HealthCheck_TlsOptions.create)
    ..aOM<$101.EventServiceConfig>(22, _omitFieldNames ? '' : 'eventService', subBuilder: $101.EventServiceConfig.create)
    ..aOM<$30.Struct>(23, _omitFieldNames ? '' : 'transportSocketMatchCriteria', subBuilder: $30.Struct.create)
    ..aOM<$28.Duration>(24, _omitFieldNames ? '' : 'noTrafficHealthyInterval', subBuilder: $28.Duration.create)
    ..pc<$40.TypedExtensionConfig>(25, _omitFieldNames ? '' : 'eventLogger', $pb.PbFieldType.PM, subBuilder: $40.TypedExtensionConfig.create)
    ..aOB(26, _omitFieldNames ? '' : 'alwaysLogHealthCheckSuccess')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $28.Duration get timeout => $_getN(0);
  @$pb.TagNumber(1)
  set timeout($28.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTimeout() => $_has(0);
  @$pb.TagNumber(1)
  void clearTimeout() => clearField(1);
  @$pb.TagNumber(1)
  $28.Duration ensureTimeout() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $28.Duration get intervalJitter => $_getN(2);
  @$pb.TagNumber(3)
  set intervalJitter($28.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasIntervalJitter() => $_has(2);
  @$pb.TagNumber(3)
  void clearIntervalJitter() => clearField(3);
  @$pb.TagNumber(3)
  $28.Duration ensureIntervalJitter() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $26.UInt32Value get unhealthyThreshold => $_getN(3);
  @$pb.TagNumber(4)
  set unhealthyThreshold($26.UInt32Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasUnhealthyThreshold() => $_has(3);
  @$pb.TagNumber(4)
  void clearUnhealthyThreshold() => clearField(4);
  @$pb.TagNumber(4)
  $26.UInt32Value ensureUnhealthyThreshold() => $_ensure(3);

  /// The number of healthy health checks required before a host is marked
  /// healthy. Note that during startup, only a single successful health check is
  /// required to mark a host healthy.
  @$pb.TagNumber(5)
  $26.UInt32Value get healthyThreshold => $_getN(4);
  @$pb.TagNumber(5)
  set healthyThreshold($26.UInt32Value v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasHealthyThreshold() => $_has(4);
  @$pb.TagNumber(5)
  void clearHealthyThreshold() => clearField(5);
  @$pb.TagNumber(5)
  $26.UInt32Value ensureHealthyThreshold() => $_ensure(4);

  /// [#not-implemented-hide:] Non-serving port for health checking.
  @$pb.TagNumber(6)
  $26.UInt32Value get altPort => $_getN(5);
  @$pb.TagNumber(6)
  set altPort($26.UInt32Value v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasAltPort() => $_has(5);
  @$pb.TagNumber(6)
  void clearAltPort() => clearField(6);
  @$pb.TagNumber(6)
  $26.UInt32Value ensureAltPort() => $_ensure(5);

  /// Reuse health check connection between health checks. Default is true.
  @$pb.TagNumber(7)
  $26.BoolValue get reuseConnection => $_getN(6);
  @$pb.TagNumber(7)
  set reuseConnection($26.BoolValue v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasReuseConnection() => $_has(6);
  @$pb.TagNumber(7)
  void clearReuseConnection() => clearField(7);
  @$pb.TagNumber(7)
  $26.BoolValue ensureReuseConnection() => $_ensure(6);
  ...
  @$pb.TagNumber(12)
  $28.Duration get noTrafficInterval => $_getN(10);
  @$pb.TagNumber(12)
  set noTrafficInterval($28.Duration v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasNoTrafficInterval() => $_has(10);
  @$pb.TagNumber(12)
  void clearNoTrafficInterval() => clearField(12);
  @$pb.TagNumber(12)
  $28.Duration ensureNoTrafficInterval() => $_ensure(10);
  ...
  @$pb.TagNumber(14)
  $28.Duration get unhealthyInterval => $_getN(12);
  @$pb.TagNumber(14)
  set unhealthyInterval($28.Duration v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasUnhealthyInterval() => $_has(12);
  @$pb.TagNumber(14)
  void clearUnhealthyInterval() => clearField(14);
  @$pb.TagNumber(14)
  $28.Duration ensureUnhealthyInterval() => $_ensure(12);
  ...
  @$pb.TagNumber(15)
  $28.Duration get unhealthyEdgeInterval => $_getN(13);
  @$pb.TagNumber(15)
  set unhealthyEdgeInterval($28.Duration v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasUnhealthyEdgeInterval() => $_has(13);
  @$pb.TagNumber(15)
  void clearUnhealthyEdgeInterval() => clearField(15);
  @$pb.TagNumber(15)
  $28.Duration ensureUnhealthyEdgeInterval() => $_ensure(13);
  ...
  @$pb.TagNumber(16)
  $28.Duration get healthyEdgeInterval => $_getN(14);
  @$pb.TagNumber(16)
  set healthyEdgeInterval($28.Duration v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasHealthyEdgeInterval() => $_has(14);
  @$pb.TagNumber(16)
  void clearHealthyEdgeInterval() => clearField(16);
  @$pb.TagNumber(16)
  $28.Duration ensureHealthyEdgeInterval() => $_ensure(14);
  ...
  @$pb.TagNumber(20)
  $28.Duration get initialJitter => $_getN(18);
  @$pb.TagNumber(20)
  set initialJitter($28.Duration v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasInitialJitter() => $_has(18);
  @$pb.TagNumber(20)
  void clearInitialJitter() => clearField(20);
  @$pb.TagNumber(20)
  $28.Duration ensureInitialJitter() => $_ensure(18);
  ...
  @$pb.TagNumber(22)
  $101.EventServiceConfig get eventService => $_getN(20);
  @$pb.TagNumber(22)
  set eventService($101.EventServiceConfig v) { setField(22, v); }
  @$pb.TagNumber(22)
  $core.bool hasEventService() => $_has(20);
  @$pb.TagNumber(22)
  void clearEventService() => clearField(22);
  @$pb.TagNumber(22)
  $101.EventServiceConfig ensureEventService() => $_ensure(20);
  ...
  @$pb.TagNumber(23)
  $30.Struct get transportSocketMatchCriteria => $_getN(21);
  @$pb.TagNumber(23)
  set transportSocketMatchCriteria($30.Struct v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasTransportSocketMatchCriteria() => $_has(21);
  @$pb.TagNumber(23)
  void clearTransportSocketMatchCriteria() => clearField(23);
  @$pb.TagNumber(23)
  $30.Struct ensureTransportSocketMatchCriteria() => $_ensure(21);
  ...
  @$pb.TagNumber(24)
  $28.Duration get noTrafficHealthyInterval => $_getN(22);
  @$pb.TagNumber(24)
  set noTrafficHealthyInterval($28.Duration v) { setField(24, v); }
  @$pb.TagNumber(24)
  $core.bool hasNoTrafficHealthyInterval() => $_has(22);
  @$pb.TagNumber(24)
  void clearNoTrafficHealthyInterval() => clearField(24);
  @$pb.TagNumber(24)
  $28.Duration ensureNoTrafficHealthyInterval() => $_ensure(22);

  /// A list of event log sinks to process the health check event.
  /// [#extension-category: envoy.health_check.event_sinks]
  @$pb.TagNumber(25)
  $core.List<$40.TypedExtensionConfig> get eventLogger => $_getList(23);
  ...
  /// The default value is false.
  @$pb.TagNumber(26)
  $core.bool get alwaysLogHealthCheckSuccess => $_getBF(24);
  @$pb.TagNumber(26)
  set alwaysLogHealthCheckSuccess($core.bool v) { $_setBool(24, v); }
  @$pb.TagNumber(26)
  $core.bool hasAlwaysLogHealthCheckSuccess() => $_has(24);
  @$pb.TagNumber(26)
  void clearAlwaysLogHealthCheckSuccess() => clearField(26);
}
