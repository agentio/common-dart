...
const QuicProtocolOptions$json = {
  ...
  '2': [
    ...
    {'1': 'idle_network_timeout', '3': 8, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '8': {}, '10': 'idleNetworkTimeout'},
  ],
};
...
final $typed_data.Uint8List quicProtocolOptionsDescriptor = $convert.base64Decode(
    ...
    'Nvbm5lY3Rpb25fb3B0aW9ucxgHIAEoCVIXY2xpZW50Q29ubmVjdGlvbk9wdGlvbnMSXAoUaWRs'
    'ZV9uZXR3b3JrX3RpbWVvdXQYCCABKAsyGS5nb29nbGUucHJvdG9idWYuRHVyYXRpb25CD/pCDK'
    'oBCSIDCNgEMgIIAVISaWRsZU5ldHdvcmtUaW1lb3V0');
...
final $typed_data.Uint8List upstreamHttpProtocolOptionsDescriptor = $convert.base64Decode(
    ...
    'cnJpZGVfYXV0b19zbmlfaGVhZGVyGAMgASgJQgv6QghyBsABAdABAVIVb3ZlcnJpZGVBdXRvU2'
...
final $typed_data.Uint8List alternateProtocolsCacheOptionsDescriptor = $convert.base64Decode(
    ...
    'EicKCGhvc3RuYW1lGAEgASgJQgv6QghyBsABAdABAVIIaG9zdG5hbWUSHwoEcG9ydBgCIAEoDU'
...
final $typed_data.Uint8List http2ProtocolOptionsDescriptor = $convert.base64Decode(
    ...
    'dG9idWYuQm9vbFZhbHVlQgjSxqThBgIIAVIPdXNlT2dodHRwMkNvZGVjGuUBChFTZXR0aW5nc1'
    'BhcmFtZXRlchJRCgppZGVudGlmaWVyGAEgASgLMhwuZ29vZ2xlLnByb3RvYnVmLlVJbnQzMlZh'
    'bHVlQhP6QggqBhj//wMoAPpCBYoBAhABUgppZGVudGlmaWVyEjwKBXZhbHVlGAIgASgLMhwuZ2'
    '9vZ2xlLnByb3RvYnVmLlVJbnQzMlZhbHVlQgj6QgWKAQIQAVIFdmFsdWU6P5rFiB46CjhlbnZv'
    'eS5hcGkudjIuY29yZS5IdHRwMlByb3RvY29sT3B0aW9ucy5TZXR0aW5nc1BhcmFtZXRlcjotms'
    'WIHigKJmVudm95LmFwaS52Mi5jb3JlLkh0dHAyUHJvdG9jb2xPcHRpb25z');
...
final $typed_data.Uint8List http3ProtocolOptionsDescriptor = $convert.base64Decode(
    ...
    'ThBgIIAVIUYWxsb3dFeHRlbmRlZENvbm5lY3QSJQoOYWxsb3dfbWV0YWRhdGEYBiABKAhSDWFs'
    'bG93TWV0YWRhdGE=');
...
const SchemeHeaderTransformation$json = {
  ...
  '2': [
    ...
    {'1': 'match_upstream', '3': 2, '4': 1, '5': 8, '10': 'matchUpstream'},
  ],
  '8': [
    {'1': 'transformation'},
  ],
...
final $typed_data.Uint8List schemeHeaderTransformationDescriptor = $convert.base64Decode(
    ...
    'gJQhL6Qg9yDVIEaHR0cFIFaHR0cHNIAFIRc2NoZW1lVG9PdmVyd3JpdGUSJQoObWF0Y2hfdXBz'
    'dHJlYW0YAiABKAhSDW1hdGNoVXBzdHJlYW1CEAoOdHJhbnNmb3JtYXRpb24=');
