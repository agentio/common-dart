...
class QuicKeepAliveSettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QuicKeepAliveSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<$28.Duration>(1, _omitFieldNames ? '' : 'maxInterval', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(2, _omitFieldNames ? '' : 'initialInterval', subBuilder: $28.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $28.Duration get maxInterval => $_getN(0);
  @$pb.TagNumber(1)
  set maxInterval($28.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasMaxInterval() => $_has(0);
  @$pb.TagNumber(1)
  void clearMaxInterval() => clearField(1);
  @$pb.TagNumber(1)
  $28.Duration ensureMaxInterval() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $28.Duration get initialInterval => $_getN(1);
  @$pb.TagNumber(2)
  set initialInterval($28.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasInitialInterval() => $_has(1);
  @$pb.TagNumber(2)
  void clearInitialInterval() => clearField(2);
  @$pb.TagNumber(2)
  $28.Duration ensureInitialInterval() => $_ensure(1);
}
...
class QuicProtocolOptions extends $pb.GeneratedMessage {
  factory QuicProtocolOptions({
    $26.UInt32Value? maxConcurrentStreams,
    $26.UInt32Value? initialStreamWindowSize,
    $26.UInt32Value? initialConnectionWindowSize,
    $26.UInt32Value? numTimeoutsToTriggerPortMigration,
    QuicKeepAliveSettings? connectionKeepalive,
    $core.String? connectionOptions,
    $core.String? clientConnectionOptions,
    $28.Duration? idleNetworkTimeout,
  }) {
    final $result = create();
    ...
    if (idleNetworkTimeout != null) {
      $result.idleNetworkTimeout = idleNetworkTimeout;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QuicProtocolOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<$26.UInt32Value>(1, _omitFieldNames ? '' : 'maxConcurrentStreams', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(2, _omitFieldNames ? '' : 'initialStreamWindowSize', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(3, _omitFieldNames ? '' : 'initialConnectionWindowSize', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(4, _omitFieldNames ? '' : 'numTimeoutsToTriggerPortMigration', subBuilder: $26.UInt32Value.create)
    ...
    ..aOM<$28.Duration>(8, _omitFieldNames ? '' : 'idleNetworkTimeout', subBuilder: $28.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  /// if not specified.
  @$pb.TagNumber(1)
  $26.UInt32Value get maxConcurrentStreams => $_getN(0);
  @$pb.TagNumber(1)
  set maxConcurrentStreams($26.UInt32Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasMaxConcurrentStreams() => $_has(0);
  @$pb.TagNumber(1)
  void clearMaxConcurrentStreams() => clearField(1);
  @$pb.TagNumber(1)
  $26.UInt32Value ensureMaxConcurrentStreams() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $26.UInt32Value get initialStreamWindowSize => $_getN(1);
  @$pb.TagNumber(2)
  set initialStreamWindowSize($26.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasInitialStreamWindowSize() => $_has(1);
  @$pb.TagNumber(2)
  void clearInitialStreamWindowSize() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt32Value ensureInitialStreamWindowSize() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $26.UInt32Value get initialConnectionWindowSize => $_getN(2);
  @$pb.TagNumber(3)
  set initialConnectionWindowSize($26.UInt32Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasInitialConnectionWindowSize() => $_has(2);
  @$pb.TagNumber(3)
  void clearInitialConnectionWindowSize() => clearField(3);
  @$pb.TagNumber(3)
  $26.UInt32Value ensureInitialConnectionWindowSize() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $26.UInt32Value get numTimeoutsToTriggerPortMigration => $_getN(3);
  @$pb.TagNumber(4)
  set numTimeoutsToTriggerPortMigration($26.UInt32Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasNumTimeoutsToTriggerPortMigration() => $_has(3);
  @$pb.TagNumber(4)
  void clearNumTimeoutsToTriggerPortMigration() => clearField(4);
  @$pb.TagNumber(4)
  $26.UInt32Value ensureNumTimeoutsToTriggerPortMigration() => $_ensure(3);
  ...
  @$pb.TagNumber(8)
  $28.Duration get idleNetworkTimeout => $_getN(7);
  @$pb.TagNumber(8)
  set idleNetworkTimeout($28.Duration v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasIdleNetworkTimeout() => $_has(7);
  @$pb.TagNumber(8)
  void clearIdleNetworkTimeout() => clearField(8);
  @$pb.TagNumber(8)
  $28.Duration ensureIdleNetworkTimeout() => $_ensure(7);
}
...
class AlternateProtocolsCacheOptions extends $pb.GeneratedMessage {
  factory AlternateProtocolsCacheOptions({
    $core.String? name,
    $26.UInt32Value? maxEntries,
    $40.TypedExtensionConfig? keyValueStoreConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AlternateProtocolsCacheOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.UInt32Value>(2, _omitFieldNames ? '' : 'maxEntries', subBuilder: $26.UInt32Value.create)
    ..aOM<$40.TypedExtensionConfig>(3, _omitFieldNames ? '' : 'keyValueStoreConfig', subBuilder: $40.TypedExtensionConfig.create)
  ...
  @$pb.TagNumber(2)
  $26.UInt32Value get maxEntries => $_getN(1);
  @$pb.TagNumber(2)
  set maxEntries($26.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMaxEntries() => $_has(1);
  @$pb.TagNumber(2)
  void clearMaxEntries() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt32Value ensureMaxEntries() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $40.TypedExtensionConfig get keyValueStoreConfig => $_getN(2);
  @$pb.TagNumber(3)
  set keyValueStoreConfig($40.TypedExtensionConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasKeyValueStoreConfig() => $_has(2);
  @$pb.TagNumber(3)
  void clearKeyValueStoreConfig() => clearField(3);
  @$pb.TagNumber(3)
  $40.TypedExtensionConfig ensureKeyValueStoreConfig() => $_ensure(2);
...
class HttpProtocolOptions extends $pb.GeneratedMessage {
  factory HttpProtocolOptions({
    ...
    $26.UInt32Value? maxHeadersCount,
    $28.Duration? maxConnectionDuration,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpProtocolOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<$28.Duration>(1, _omitFieldNames ? '' : 'idleTimeout', subBuilder: $28.Duration.create)
    ..aOM<$26.UInt32Value>(2, _omitFieldNames ? '' : 'maxHeadersCount', subBuilder: $26.UInt32Value.create)
    ..aOM<$28.Duration>(3, _omitFieldNames ? '' : 'maxConnectionDuration', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(4, _omitFieldNames ? '' : 'maxStreamDuration', subBuilder: $28.Duration.create)
    ...
    ..aOM<$26.UInt32Value>(6, _omitFieldNames ? '' : 'maxRequestsPerConnection', subBuilder: $26.UInt32Value.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $28.Duration get idleTimeout => $_getN(0);
  @$pb.TagNumber(1)
  set idleTimeout($28.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasIdleTimeout() => $_has(0);
  @$pb.TagNumber(1)
  void clearIdleTimeout() => clearField(1);
  @$pb.TagNumber(1)
  $28.Duration ensureIdleTimeout() => $_ensure(0);

  /// The maximum number of headers. If unconfigured, the default
  /// maximum number of request headers allowed is 100. Requests that exceed this limit will receive
  /// a 431 response for HTTP/1.x and cause a stream reset for HTTP/2.
  @$pb.TagNumber(2)
  $26.UInt32Value get maxHeadersCount => $_getN(1);
  @$pb.TagNumber(2)
  set maxHeadersCount($26.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMaxHeadersCount() => $_has(1);
  @$pb.TagNumber(2)
  void clearMaxHeadersCount() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt32Value ensureMaxHeadersCount() => $_ensure(1);
  ...
  /// <envoy_v3_api_field_extensions.filters.network.http_connection_manager.v3.HttpConnectionManager.drain_timeout>`.
  @$pb.TagNumber(3)
  $28.Duration get maxConnectionDuration => $_getN(2);
  @$pb.TagNumber(3)
  set maxConnectionDuration($28.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMaxConnectionDuration() => $_has(2);
  @$pb.TagNumber(3)
  void clearMaxConnectionDuration() => clearField(3);
  @$pb.TagNumber(3)
  $28.Duration ensureMaxConnectionDuration() => $_ensure(2);

  /// Total duration to keep alive an HTTP request/response stream. If the time limit is reached the stream will be
  /// reset independent of any other timeouts. If not specified, this value is not set.
  @$pb.TagNumber(4)
  $28.Duration get maxStreamDuration => $_getN(3);
  @$pb.TagNumber(4)
  set maxStreamDuration($28.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasMaxStreamDuration() => $_has(3);
  @$pb.TagNumber(4)
  void clearMaxStreamDuration() => clearField(4);
  @$pb.TagNumber(4)
  $28.Duration ensureMaxStreamDuration() => $_ensure(3);
  ...
  @$pb.TagNumber(6)
  $26.UInt32Value get maxRequestsPerConnection => $_getN(5);
  @$pb.TagNumber(6)
  set maxRequestsPerConnection($26.UInt32Value v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasMaxRequestsPerConnection() => $_has(5);
  @$pb.TagNumber(6)
  void clearMaxRequestsPerConnection() => clearField(6);
  @$pb.TagNumber(6)
  $26.UInt32Value ensureMaxRequestsPerConnection() => $_ensure(5);
}
...
class Http1ProtocolOptions_HeaderKeyFormat extends $pb.GeneratedMessage {
  factory Http1ProtocolOptions_HeaderKeyFormat({
    ...
    $40.TypedExtensionConfig? statefulFormatter,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Http1ProtocolOptions.HeaderKeyFormat', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..aOM<$40.TypedExtensionConfig>(8, _omitFieldNames ? '' : 'statefulFormatter', subBuilder: $40.TypedExtensionConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  $40.TypedExtensionConfig get statefulFormatter => $_getN(1);
  @$pb.TagNumber(8)
  set statefulFormatter($40.TypedExtensionConfig v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasStatefulFormatter() => $_has(1);
  @$pb.TagNumber(8)
  void clearStatefulFormatter() => clearField(8);
  @$pb.TagNumber(8)
  $40.TypedExtensionConfig ensureStatefulFormatter() => $_ensure(1);
}

/// [#next-free-field: 11]
class Http1ProtocolOptions extends $pb.GeneratedMessage {
  factory Http1ProtocolOptions({
    $26.BoolValue? allowAbsoluteUrl,
    ...
    $26.BoolValue? overrideStreamErrorOnInvalidHttpMessage,
    $core.bool? sendFullyQualifiedUrl,
    $26.BoolValue? useBalsaParser,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Http1ProtocolOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<$26.BoolValue>(1, _omitFieldNames ? '' : 'allowAbsoluteUrl', subBuilder: $26.BoolValue.create)
    ...
    ..aOM<$26.BoolValue>(7, _omitFieldNames ? '' : 'overrideStreamErrorOnInvalidHttpMessage', subBuilder: $26.BoolValue.create)
    ..aOB(8, _omitFieldNames ? '' : 'sendFullyQualifiedUrl')
    ..aOM<$26.BoolValue>(9, _omitFieldNames ? '' : 'useBalsaParser', subBuilder: $26.BoolValue.create)
  ...
  @$pb.TagNumber(1)
  $26.BoolValue get allowAbsoluteUrl => $_getN(0);
  @$pb.TagNumber(1)
  set allowAbsoluteUrl($26.BoolValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAllowAbsoluteUrl() => $_has(0);
  @$pb.TagNumber(1)
  void clearAllowAbsoluteUrl() => clearField(1);
  @$pb.TagNumber(1)
  $26.BoolValue ensureAllowAbsoluteUrl() => $_ensure(0);
  ...
  @$pb.TagNumber(7)
  $26.BoolValue get overrideStreamErrorOnInvalidHttpMessage => $_getN(6);
  @$pb.TagNumber(7)
  set overrideStreamErrorOnInvalidHttpMessage($26.BoolValue v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(7)
  $26.BoolValue ensureOverrideStreamErrorOnInvalidHttpMessage() => $_ensure(6);
  ...
  /// See issue #21245.
  @$pb.TagNumber(9)
  $26.BoolValue get useBalsaParser => $_getN(8);
  @$pb.TagNumber(9)
  set useBalsaParser($26.BoolValue v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasUseBalsaParser() => $_has(8);
  @$pb.TagNumber(9)
  void clearUseBalsaParser() => clearField(9);
  @$pb.TagNumber(9)
  $26.BoolValue ensureUseBalsaParser() => $_ensure(8);
...
class KeepaliveSettings extends $pb.GeneratedMessage {
  factory KeepaliveSettings({
    ...
    $28.Duration? timeout,
    $44.Percent? intervalJitter,
    $28.Duration? connectionIdleInterval,
  }) {
    final $result = create();
    if (interval != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeepaliveSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<$28.Duration>(1, _omitFieldNames ? '' : 'interval', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(2, _omitFieldNames ? '' : 'timeout', subBuilder: $28.Duration.create)
    ..aOM<$44.Percent>(3, _omitFieldNames ? '' : 'intervalJitter', subBuilder: $44.Percent.create)
    ..aOM<$28.Duration>(4, _omitFieldNames ? '' : 'connectionIdleInterval', subBuilder: $28.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $28.Duration get interval => $_getN(0);
  @$pb.TagNumber(1)
  set interval($28.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasInterval() => $_has(0);
  @$pb.TagNumber(1)
  void clearInterval() => clearField(1);
  @$pb.TagNumber(1)
  $28.Duration ensureInterval() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $28.Duration get timeout => $_getN(1);
  @$pb.TagNumber(2)
  set timeout($28.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTimeout() => $_has(1);
  @$pb.TagNumber(2)
  void clearTimeout() => clearField(2);
  @$pb.TagNumber(2)
  $28.Duration ensureTimeout() => $_ensure(1);

  /// A random jitter amount as a percentage of interval that will be added to each interval.
  /// A value of zero means there will be no jitter.
  /// The default value is 15%.
  @$pb.TagNumber(3)
  $44.Percent get intervalJitter => $_getN(2);
  @$pb.TagNumber(3)
  set intervalJitter($44.Percent v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasIntervalJitter() => $_has(2);
  @$pb.TagNumber(3)
  void clearIntervalJitter() => clearField(3);
  @$pb.TagNumber(3)
  $44.Percent ensureIntervalJitter() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $28.Duration get connectionIdleInterval => $_getN(3);
  @$pb.TagNumber(4)
  set connectionIdleInterval($28.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasConnectionIdleInterval() => $_has(3);
  @$pb.TagNumber(4)
  void clearConnectionIdleInterval() => clearField(4);
  @$pb.TagNumber(4)
  $28.Duration ensureConnectionIdleInterval() => $_ensure(3);
}
...
class Http2ProtocolOptions_SettingsParameter extends $pb.GeneratedMessage {
  factory Http2ProtocolOptions_SettingsParameter({
    $26.UInt32Value? identifier,
    $26.UInt32Value? value,
  }) {
    final $result = create();
    if (identifier != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Http2ProtocolOptions.SettingsParameter', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<$26.UInt32Value>(1, _omitFieldNames ? '' : 'identifier', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(2, _omitFieldNames ? '' : 'value', subBuilder: $26.UInt32Value.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $26.UInt32Value get identifier => $_getN(0);
  @$pb.TagNumber(1)
  set identifier($26.UInt32Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasIdentifier() => $_has(0);
  @$pb.TagNumber(1)
  void clearIdentifier() => clearField(1);
  @$pb.TagNumber(1)
  $26.UInt32Value ensureIdentifier() => $_ensure(0);

  /// The 32 bit parameter value.
  @$pb.TagNumber(2)
  $26.UInt32Value get value => $_getN(1);
  @$pb.TagNumber(2)
  set value($26.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValue() => $_has(1);
  @$pb.TagNumber(2)
  void clearValue() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt32Value ensureValue() => $_ensure(1);
}

/// [#next-free-field: 17]
class Http2ProtocolOptions extends $pb.GeneratedMessage {
  factory Http2ProtocolOptions({
    $26.UInt32Value? hpackTableSize,
    $26.UInt32Value? maxConcurrentStreams,
    $26.UInt32Value? initialStreamWindowSize,
    $26.UInt32Value? initialConnectionWindowSize,
    $core.bool? allowConnect,
    $core.bool? allowMetadata,
    $26.UInt32Value? maxOutboundFrames,
    $26.UInt32Value? maxOutboundControlFrames,
    $26.UInt32Value? maxConsecutiveInboundFramesWithEmptyPayload,
    $26.UInt32Value? maxInboundPriorityFramesPerStream,
    $26.UInt32Value? maxInboundWindowUpdateFramesPerDataFrameSent,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Http2ProtocolOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<$26.UInt32Value>(1, _omitFieldNames ? '' : 'hpackTableSize', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(2, _omitFieldNames ? '' : 'maxConcurrentStreams', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(3, _omitFieldNames ? '' : 'initialStreamWindowSize', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(4, _omitFieldNames ? '' : 'initialConnectionWindowSize', subBuilder: $26.UInt32Value.create)
    ..aOB(5, _omitFieldNames ? '' : 'allowConnect')
    ..aOB(6, _omitFieldNames ? '' : 'allowMetadata')
    ..aOM<$26.UInt32Value>(7, _omitFieldNames ? '' : 'maxOutboundFrames', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(8, _omitFieldNames ? '' : 'maxOutboundControlFrames', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(9, _omitFieldNames ? '' : 'maxConsecutiveInboundFramesWithEmptyPayload', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(10, _omitFieldNames ? '' : 'maxInboundPriorityFramesPerStream', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(11, _omitFieldNames ? '' : 'maxInboundWindowUpdateFramesPerDataFrameSent', subBuilder: $26.UInt32Value.create)
    ...
    ..aOM<$26.BoolValue>(14, _omitFieldNames ? '' : 'overrideStreamErrorOnInvalidHttpMessage', subBuilder: $26.BoolValue.create)
    ..aOM<KeepaliveSettings>(15, _omitFieldNames ? '' : 'connectionKeepalive', subBuilder: KeepaliveSettings.create)
    ..aOM<$26.BoolValue>(16, _omitFieldNames ? '' : 'useOghttp2Codec', subBuilder: $26.BoolValue.create)
    ..hasRequiredFields = false
  ;
  ...
  /// compression.
  @$pb.TagNumber(1)
  $26.UInt32Value get hpackTableSize => $_getN(0);
  @$pb.TagNumber(1)
  set hpackTableSize($26.UInt32Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasHpackTableSize() => $_has(0);
  @$pb.TagNumber(1)
  void clearHpackTableSize() => clearField(1);
  @$pb.TagNumber(1)
  $26.UInt32Value ensureHpackTableSize() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $26.UInt32Value get maxConcurrentStreams => $_getN(1);
  @$pb.TagNumber(2)
  set maxConcurrentStreams($26.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMaxConcurrentStreams() => $_has(1);
  @$pb.TagNumber(2)
  void clearMaxConcurrentStreams() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt32Value ensureMaxConcurrentStreams() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $26.UInt32Value get initialStreamWindowSize => $_getN(2);
  @$pb.TagNumber(3)
  set initialStreamWindowSize($26.UInt32Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasInitialStreamWindowSize() => $_has(2);
  @$pb.TagNumber(3)
  void clearInitialStreamWindowSize() => clearField(3);
  @$pb.TagNumber(3)
  $26.UInt32Value ensureInitialStreamWindowSize() => $_ensure(2);

  /// Similar to ``initial_stream_window_size``, but for connection-level flow-control
  /// window. Currently, this has the same minimum/maximum/default as ``initial_stream_window_size``.
  @$pb.TagNumber(4)
  $26.UInt32Value get initialConnectionWindowSize => $_getN(3);
  @$pb.TagNumber(4)
  set initialConnectionWindowSize($26.UInt32Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasInitialConnectionWindowSize() => $_has(3);
  @$pb.TagNumber(4)
  void clearInitialConnectionWindowSize() => clearField(4);
  @$pb.TagNumber(4)
  $26.UInt32Value ensureInitialConnectionWindowSize() => $_ensure(3);
  ...
  @$pb.TagNumber(7)
  $26.UInt32Value get maxOutboundFrames => $_getN(6);
  @$pb.TagNumber(7)
  set maxOutboundFrames($26.UInt32Value v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasMaxOutboundFrames() => $_has(6);
  @$pb.TagNumber(7)
  void clearMaxOutboundFrames() => clearField(7);
  @$pb.TagNumber(7)
  $26.UInt32Value ensureMaxOutboundFrames() => $_ensure(6);
  ...
  @$pb.TagNumber(8)
  $26.UInt32Value get maxOutboundControlFrames => $_getN(7);
  @$pb.TagNumber(8)
  set maxOutboundControlFrames($26.UInt32Value v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasMaxOutboundControlFrames() => $_has(7);
  @$pb.TagNumber(8)
  void clearMaxOutboundControlFrames() => clearField(8);
  @$pb.TagNumber(8)
  $26.UInt32Value ensureMaxOutboundControlFrames() => $_ensure(7);
  ...
  @$pb.TagNumber(9)
  $26.UInt32Value get maxConsecutiveInboundFramesWithEmptyPayload => $_getN(8);
  @$pb.TagNumber(9)
  set maxConsecutiveInboundFramesWithEmptyPayload($26.UInt32Value v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(9)
  $26.UInt32Value ensureMaxConsecutiveInboundFramesWithEmptyPayload() => $_ensure(8);
  ...
  @$pb.TagNumber(10)
  $26.UInt32Value get maxInboundPriorityFramesPerStream => $_getN(9);
  @$pb.TagNumber(10)
  set maxInboundPriorityFramesPerStream($26.UInt32Value v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasMaxInboundPriorityFramesPerStream() => $_has(9);
  @$pb.TagNumber(10)
  void clearMaxInboundPriorityFramesPerStream() => clearField(10);
  @$pb.TagNumber(10)
  $26.UInt32Value ensureMaxInboundPriorityFramesPerStream() => $_ensure(9);
  ...
  @$pb.TagNumber(11)
  $26.UInt32Value get maxInboundWindowUpdateFramesPerDataFrameSent => $_getN(10);
  @$pb.TagNumber(11)
  set maxInboundWindowUpdateFramesPerDataFrameSent($26.UInt32Value v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(11)
  $26.UInt32Value ensureMaxInboundWindowUpdateFramesPerDataFrameSent() => $_ensure(10);
  ...
  ///  See `RFC7540, sec. 8.1 <https://tools.ietf.org/html/rfc7540#section-8.1>`_ for details.
  @$pb.TagNumber(14)
  $26.BoolValue get overrideStreamErrorOnInvalidHttpMessage => $_getN(13);
  @$pb.TagNumber(14)
  set overrideStreamErrorOnInvalidHttpMessage($26.BoolValue v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(14)
  $26.BoolValue ensureOverrideStreamErrorOnInvalidHttpMessage() => $_ensure(13);
  ...
  @$pb.TagNumber(16)
  $26.BoolValue get useOghttp2Codec => $_getN(15);
  @$pb.TagNumber(16)
  set useOghttp2Codec($26.BoolValue v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasUseOghttp2Codec() => $_has(15);
  @$pb.TagNumber(16)
  void clearUseOghttp2Codec() => clearField(16);
  @$pb.TagNumber(16)
  $26.BoolValue ensureUseOghttp2Codec() => $_ensure(15);
}
...
class Http3ProtocolOptions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Http3ProtocolOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.BoolValue>(2, _omitFieldNames ? '' : 'overrideStreamErrorOnInvalidHttpMessage', subBuilder: $26.BoolValue.create)
  ...
  ///  <envoy_v3_api_field_extensions.filters.network.http_connection_manager.v3.HttpConnectionManager.stream_error_on_invalid_http_message>`.
  @$pb.TagNumber(2)
  $26.BoolValue get overrideStreamErrorOnInvalidHttpMessage => $_getN(1);
  @$pb.TagNumber(2)
  set overrideStreamErrorOnInvalidHttpMessage($26.BoolValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  $26.BoolValue ensureOverrideStreamErrorOnInvalidHttpMessage() => $_ensure(1);
  ...
  ///  information.
  @$pb.TagNumber(6)
  $core.bool get allowMetadata => $_getBF(3);
  @$pb.TagNumber(6)
  set allowMetadata($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(6)
  $core.bool hasAllowMetadata() => $_has(3);
  @$pb.TagNumber(6)
  void clearAllowMetadata() => clearField(6);
}
...
class SchemeHeaderTransformation extends $pb.GeneratedMessage {
  factory SchemeHeaderTransformation({
    ...
    $core.bool? matchUpstream,
  }) {
    final $result = create();
    if (schemeToOverwrite != null) {
      $result.schemeToOverwrite = schemeToOverwrite;
    }
    if (matchUpstream != null) {
      $result.matchUpstream = matchUpstream;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SchemeHeaderTransformation', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..aOB(2, _omitFieldNames ? '' : 'matchUpstream')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.bool get matchUpstream => $_getBF(1);
  @$pb.TagNumber(2)
  set matchUpstream($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasMatchUpstream() => $_has(1);
  @$pb.TagNumber(2)
  void clearMatchUpstream() => clearField(2);
}
