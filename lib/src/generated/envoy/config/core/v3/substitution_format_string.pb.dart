...
class SubstitutionFormatString extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    $47.DataSource? textFormatSource,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SubstitutionFormatString', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..aOM<$30.Struct>(2, _omitFieldNames ? '' : 'jsonFormat', subBuilder: $30.Struct.create)
    ..aOB(3, _omitFieldNames ? '' : 'omitEmptyValues')
    ..aOS(4, _omitFieldNames ? '' : 'contentType')
    ..aOM<$47.DataSource>(5, _omitFieldNames ? '' : 'textFormatSource', subBuilder: $47.DataSource.create)
    ..pc<$40.TypedExtensionConfig>(6, _omitFieldNames ? '' : 'formatters', $pb.PbFieldType.PM, subBuilder: $40.TypedExtensionConfig.create)
  ...
  ///   }
  @$pb.TagNumber(2)
  $30.Struct get jsonFormat => $_getN(1);
  @$pb.TagNumber(2)
  set jsonFormat($30.Struct v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasJsonFormat() => $_has(1);
  @$pb.TagNumber(2)
  void clearJsonFormat() => clearField(2);
  @$pb.TagNumber(2)
  $30.Struct ensureJsonFormat() => $_ensure(1);
  ...
  ///    upstream connect error:503:path=/foo
  @$pb.TagNumber(5)
  $47.DataSource get textFormatSource => $_getN(4);
  @$pb.TagNumber(5)
  set textFormatSource($47.DataSource v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasTextFormatSource() => $_has(4);
  @$pb.TagNumber(5)
  void clearTextFormatSource() => clearField(5);
  @$pb.TagNumber(5)
  $47.DataSource ensureTextFormatSource() => $_ensure(4);

  /// Specifies a collection of Formatter plugins that can be called from the access log configuration.
  /// See the formatters extensions documentation for details.
  /// [#extension-category: envoy.formatter]
  @$pb.TagNumber(6)
  $core.List<$40.TypedExtensionConfig> get formatters => $_getList(5);
