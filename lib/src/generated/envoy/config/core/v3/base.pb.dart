...
import '../../../../xds/core/v3/context_params.pb.dart' as $43;
import '../../../type/v3/percent.pb.dart' as $44;
import '../../../type/v3/semantic_version.pb.dart' as $41;
import 'address.pb.dart' as $42;
import 'backoff.pb.dart' as $45;
import 'base.pbenum.dart';
import 'http_uri.pb.dart' as $46;
...
class BuildVersion extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BuildVersion', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<$41.SemanticVersion>(1, _omitFieldNames ? '' : 'version', subBuilder: $41.SemanticVersion.create)
    ..aOM<$30.Struct>(2, _omitFieldNames ? '' : 'metadata', subBuilder: $30.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $41.SemanticVersion get version => $_getN(0);
  @$pb.TagNumber(1)
  set version($41.SemanticVersion v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasVersion() => $_has(0);
  @$pb.TagNumber(1)
  void clearVersion() => clearField(1);
  @$pb.TagNumber(1)
  $41.SemanticVersion ensureVersion() => $_ensure(0);

  /// Free-form build information.
  /// Envoy defines several well known keys in the source/common/version/version.h file
  @$pb.TagNumber(2)
  $30.Struct get metadata => $_getN(1);
  @$pb.TagNumber(2)
  set metadata($30.Struct v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMetadata() => $_has(1);
  @$pb.TagNumber(2)
  void clearMetadata() => clearField(2);
  @$pb.TagNumber(2)
  $30.Struct ensureMetadata() => $_ensure(1);
}
...
class Node extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    $core.Iterable<$42.Address>? listeningAddresses,
    $core.Map<$core.String, $43.ContextParams>? dynamicParameters,
  }) {
    final $result = create();
    if (id != null) {
      $result.id = id;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Node', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..aOM<$30.Struct>(3, _omitFieldNames ? '' : 'metadata', subBuilder: $30.Struct.create)
    ...
    ..pc<$42.Address>(11, _omitFieldNames ? '' : 'listeningAddresses', $pb.PbFieldType.PM, subBuilder: $42.Address.create)
    ..m<$core.String, $43.ContextParams>(12, _omitFieldNames ? '' : 'dynamicParameters', entryClassName: 'Node.DynamicParametersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $43.ContextParams.create, valueDefaultOrMaker: $43.ContextParams.getDefault, packageName: const $pb.PackageName('envoy.config.core.v3'))
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $30.Struct get metadata => $_getN(2);
  @$pb.TagNumber(3)
  set metadata($30.Struct v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMetadata() => $_has(2);
  @$pb.TagNumber(3)
  void clearMetadata() => clearField(3);
  @$pb.TagNumber(3)
  $30.Struct ensureMetadata() => $_ensure(2);
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(11)
  $core.List<$42.Address> get listeningAddresses => $_getList(9);
  ...
  @$pb.TagNumber(12)
  $core.Map<$core.String, $43.ContextParams> get dynamicParameters => $_getMap(10);
}
...
class Metadata extends $pb.GeneratedMessage {
  factory Metadata({
    $core.Map<$core.String, $30.Struct>? filterMetadata,
    $core.Map<$core.String, $34.Any>? typedFilterMetadata,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Metadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..m<$core.String, $30.Struct>(1, _omitFieldNames ? '' : 'filterMetadata', entryClassName: 'Metadata.FilterMetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $30.Struct.create, valueDefaultOrMaker: $30.Struct.getDefault, packageName: const $pb.PackageName('envoy.config.core.v3'))
    ..m<$core.String, $34.Any>(2, _omitFieldNames ? '' : 'typedFilterMetadata', entryClassName: 'Metadata.TypedFilterMetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $34.Any.create, valueDefaultOrMaker: $34.Any.getDefault, packageName: const $pb.PackageName('envoy.config.core.v3'))
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.Map<$core.String, $30.Struct> get filterMetadata => $_getMap(0);
  ...
  /// only ``typed_filter_metadata`` field will be parsed.
  @$pb.TagNumber(2)
  $core.Map<$core.String, $34.Any> get typedFilterMetadata => $_getMap(1);
}
...
class RuntimePercent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RuntimePercent', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<$44.Percent>(1, _omitFieldNames ? '' : 'defaultValue', subBuilder: $44.Percent.create)
  ...
  /// Default value if runtime value is not available.
  @$pb.TagNumber(1)
  $44.Percent get defaultValue => $_getN(0);
  @$pb.TagNumber(1)
  set defaultValue($44.Percent v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDefaultValue() => $_has(0);
  @$pb.TagNumber(1)
  void clearDefaultValue() => clearField(1);
  @$pb.TagNumber(1)
  $44.Percent ensureDefaultValue() => $_ensure(0);
...
class RuntimeFeatureFlag extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RuntimeFeatureFlag', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<$26.BoolValue>(1, _omitFieldNames ? '' : 'defaultValue', subBuilder: $26.BoolValue.create)
    ..aOS(2, _omitFieldNames ? '' : 'runtimeKey')
    ..hasRequiredFields = false
  ;
  ...
  /// Default value if runtime value is not available.
  @$pb.TagNumber(1)
  $26.BoolValue get defaultValue => $_getN(0);
  @$pb.TagNumber(1)
  set defaultValue($26.BoolValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDefaultValue() => $_has(0);
  @$pb.TagNumber(1)
  void clearDefaultValue() => clearField(1);
  @$pb.TagNumber(1)
  $26.BoolValue ensureDefaultValue() => $_ensure(0);
...
class KeyValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeyValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
...
class KeyValueAppend extends $pb.GeneratedMessage {
  factory KeyValueAppend({
    KeyValue? entry,
    KeyValueAppend_KeyValueAppendAction? action,
  }) {
    final $result = create();
    if (entry != null) {
      $result.entry = entry;
  ...
  KeyValueAppend._() : super();
  factory KeyValueAppend.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory KeyValueAppend.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeyValueAppend', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<KeyValue>(1, _omitFieldNames ? '' : 'entry', subBuilder: KeyValue.create)
    ..e<KeyValueAppend_KeyValueAppendAction>(2, _omitFieldNames ? '' : 'action', $pb.PbFieldType.OE, defaultOrMaker: KeyValueAppend_KeyValueAppendAction.APPEND_IF_EXISTS_OR_ADD, valueOf: KeyValueAppend_KeyValueAppendAction.valueOf, enumValues: KeyValueAppend_KeyValueAppendAction.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  KeyValueAppend clone() => KeyValueAppend()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeyValueAppend copyWith(void Function(KeyValueAppend) updates) => super.copyWith((message) => updates(message as KeyValueAppend)) as KeyValueAppend;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static KeyValueAppend create() => KeyValueAppend._();
  KeyValueAppend createEmptyInstance() => create();
  static $pb.PbList<KeyValueAppend> createRepeated() => $pb.PbList<KeyValueAppend>();
  @$core.pragma('dart2js:noInline')
  static KeyValueAppend getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<KeyValueAppend>(create);
  static KeyValueAppend? _defaultInstance;

  /// Key/value pair entry that this option to append or overwrite.
  @$pb.TagNumber(1)
  KeyValue get entry => $_getN(0);
  @$pb.TagNumber(1)
  set entry(KeyValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasEntry() => $_has(0);
  @$pb.TagNumber(1)
  void clearEntry() => clearField(1);
  @$pb.TagNumber(1)
  KeyValue ensureEntry() => $_ensure(0);

  /// Describes the action taken to append/overwrite the given value for an existing
  /// key or to only add this key if it's absent.
  @$pb.TagNumber(2)
  KeyValueAppend_KeyValueAppendAction get action => $_getN(1);
  @$pb.TagNumber(2)
  set action(KeyValueAppend_KeyValueAppendAction v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class KeyValueMutation extends $pb.GeneratedMessage {
  factory KeyValueMutation({
    KeyValueAppend? append,
    $core.String? remove,
  }) {
    final $result = create();
    if (append != null) {
  ...
  KeyValueMutation._() : super();
  factory KeyValueMutation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory KeyValueMutation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeyValueMutation', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<KeyValueAppend>(1, _omitFieldNames ? '' : 'append', subBuilder: KeyValueAppend.create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  KeyValueMutation clone() => KeyValueMutation()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeyValueMutation copyWith(void Function(KeyValueMutation) updates) => super.copyWith((message) => updates(message as KeyValueMutation)) as KeyValueMutation;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static KeyValueMutation create() => KeyValueMutation._();
  KeyValueMutation createEmptyInstance() => create();
  static $pb.PbList<KeyValueMutation> createRepeated() => $pb.PbList<KeyValueMutation>();
  @$core.pragma('dart2js:noInline')
  static KeyValueMutation getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<KeyValueMutation>(create);
  static KeyValueMutation? _defaultInstance;

  /// Key/value pair to append or overwrite. Only one of ``append`` or ``remove`` can be set.
  @$pb.TagNumber(1)
  KeyValueAppend get append => $_getN(0);
  @$pb.TagNumber(1)
  set append(KeyValueAppend v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAppend() => $_has(0);
  @$pb.TagNumber(1)
  void clearAppend() => clearField(1);
  @$pb.TagNumber(1)
  KeyValueAppend ensureAppend() => $_ensure(0);
...
class HeaderValueOption extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HeaderValueOption', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.BoolValue>(2, _omitFieldNames ? '' : 'append', subBuilder: $26.BoolValue.create)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  $26.BoolValue get append => $_getN(1);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  set append($26.BoolValue v) { setField(2, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  $26.BoolValue ensureAppend() => $_ensure(1);
...
class DataSource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DataSource', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..aOM<WatchedDirectory>(5, _omitFieldNames ? '' : 'watchedDirectory', subBuilder: WatchedDirectory.create)
    ..hasRequiredFields = false
  ;
  ...
  ///    details.
  @$pb.TagNumber(5)
  WatchedDirectory get watchedDirectory => $_getN(4);
  @$pb.TagNumber(5)
  set watchedDirectory(WatchedDirectory v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasWatchedDirectory() => $_has(4);
  @$pb.TagNumber(5)
  void clearWatchedDirectory() => clearField(5);
  @$pb.TagNumber(5)
  WatchedDirectory ensureWatchedDirectory() => $_ensure(4);
}
...
class RetryPolicy_RetryPriority extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, RetryPolicy_RetryPriority_ConfigType> _RetryPolicy_RetryPriority_ConfigTypeByTag = {
    2 : RetryPolicy_RetryPriority_ConfigType.typedConfig,
    0 : RetryPolicy_RetryPriority_ConfigType.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RetryPolicy.RetryPriority', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOS(1, _omitFieldNames ? '' : 'name')
...
class RetryPolicy_RetryHostPredicate extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, RetryPolicy_RetryHostPredicate_ConfigType> _RetryPolicy_RetryHostPredicate_ConfigTypeByTag = {
    2 : RetryPolicy_RetryHostPredicate_ConfigType.typedConfig,
    0 : RetryPolicy_RetryHostPredicate_ConfigType.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RetryPolicy.RetryHostPredicate', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$34.Any>(2, _omitFieldNames ? '' : 'typedConfig', subBuilder: $34.Any.create)
    ..hasRequiredFields = false
...
class RetryPolicy extends $pb.GeneratedMessage {
  factory RetryPolicy({
    $45.BackoffStrategy? retryBackOff,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RetryPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<$45.BackoffStrategy>(1, _omitFieldNames ? '' : 'retryBackOff', subBuilder: $45.BackoffStrategy.create)
    ..aOM<$26.UInt32Value>(2, _omitFieldNames ? '' : 'numRetries', subBuilder: $26.UInt32Value.create)
    ..aOS(3, _omitFieldNames ? '' : 'retryOn')
  ...
  @$pb.TagNumber(1)
  $45.BackoffStrategy get retryBackOff => $_getN(0);
  @$pb.TagNumber(1)
  set retryBackOff($45.BackoffStrategy v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasRetryBackOff() => $_has(0);
  @$pb.TagNumber(1)
  void clearRetryBackOff() => clearField(1);
  @$pb.TagNumber(1)
  $45.BackoffStrategy ensureRetryBackOff() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $core.String get retryOn => $_getSZ(2);
  @$pb.TagNumber(3)
  set retryOn($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasRetryOn() => $_has(2);
  @$pb.TagNumber(3)
  void clearRetryOn() => clearField(3);
...
class RuntimeFractionalPercent extends $pb.GeneratedMessage {
  factory RuntimeFractionalPercent({
    $44.FractionalPercent? defaultValue,
    $core.String? runtimeKey,
  }) {
    final $result = create();
    if (defaultValue != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RuntimeFractionalPercent', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<$44.FractionalPercent>(1, _omitFieldNames ? '' : 'defaultValue', subBuilder: $44.FractionalPercent.create)
    ..aOS(2, _omitFieldNames ? '' : 'runtimeKey')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $44.FractionalPercent get defaultValue => $_getN(0);
  @$pb.TagNumber(1)
  set defaultValue($44.FractionalPercent v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDefaultValue() => $_has(0);
  @$pb.TagNumber(1)
  void clearDefaultValue() => clearField(1);
  @$pb.TagNumber(1)
  $44.FractionalPercent ensureDefaultValue() => $_ensure(0);
