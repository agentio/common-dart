...
class GrpcService_EnvoyGrpc extends $pb.GeneratedMessage {
  factory GrpcService_EnvoyGrpc({
    ...
    $26.UInt32Value? maxReceiveMessageLength,
    $core.bool? skipEnvoyHeaders,
  }) {
    final $result = create();
    if (clusterName != null) {
    ...
    if (maxReceiveMessageLength != null) {
      $result.maxReceiveMessageLength = maxReceiveMessageLength;
    }
    if (skipEnvoyHeaders != null) {
      $result.skipEnvoyHeaders = skipEnvoyHeaders;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrpcService.EnvoyGrpc', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..aOM<$47.RetryPolicy>(3, _omitFieldNames ? '' : 'retryPolicy', subBuilder: $47.RetryPolicy.create)
    ..aOM<$26.UInt32Value>(4, _omitFieldNames ? '' : 'maxReceiveMessageLength', subBuilder: $26.UInt32Value.create)
    ..aOB(5, _omitFieldNames ? '' : 'skipEnvoyHeaders')
  ...
  @$pb.TagNumber(3)
  $47.RetryPolicy get retryPolicy => $_getN(2);
  @$pb.TagNumber(3)
  set retryPolicy($47.RetryPolicy v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasRetryPolicy() => $_has(2);
  @$pb.TagNumber(3)
  void clearRetryPolicy() => clearField(3);
  @$pb.TagNumber(3)
  $47.RetryPolicy ensureRetryPolicy() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $26.UInt32Value get maxReceiveMessageLength => $_getN(3);
  @$pb.TagNumber(4)
  set maxReceiveMessageLength($26.UInt32Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasMaxReceiveMessageLength() => $_has(3);
  @$pb.TagNumber(4)
  void clearMaxReceiveMessageLength() => clearField(4);
  @$pb.TagNumber(4)
  $26.UInt32Value ensureMaxReceiveMessageLength() => $_ensure(3);
  ...
  /// Default to false.
  @$pb.TagNumber(5)
  $core.bool get skipEnvoyHeaders => $_getBF(4);
  @$pb.TagNumber(5)
  set skipEnvoyHeaders($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasSkipEnvoyHeaders() => $_has(4);
  @$pb.TagNumber(5)
  void clearSkipEnvoyHeaders() => clearField(5);
}
...
class GrpcService_GoogleGrpc_SslCredentials extends $pb.GeneratedMessage {
  factory GrpcService_GoogleGrpc_SslCredentials({
    $47.DataSource? rootCerts,
    $47.DataSource? privateKey,
    $47.DataSource? certChain,
  }) {
    final $result = create();
    if (rootCerts != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrpcService.GoogleGrpc.SslCredentials', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<$47.DataSource>(1, _omitFieldNames ? '' : 'rootCerts', subBuilder: $47.DataSource.create)
    ..aOM<$47.DataSource>(2, _omitFieldNames ? '' : 'privateKey', subBuilder: $47.DataSource.create)
    ..aOM<$47.DataSource>(3, _omitFieldNames ? '' : 'certChain', subBuilder: $47.DataSource.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $47.DataSource get rootCerts => $_getN(0);
  @$pb.TagNumber(1)
  set rootCerts($47.DataSource v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasRootCerts() => $_has(0);
  @$pb.TagNumber(1)
  void clearRootCerts() => clearField(1);
  @$pb.TagNumber(1)
  $47.DataSource ensureRootCerts() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $47.DataSource get certChain => $_getN(2);
  @$pb.TagNumber(3)
  set certChain($47.DataSource v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCertChain() => $_has(2);
  @$pb.TagNumber(3)
  void clearCertChain() => clearField(3);
  @$pb.TagNumber(3)
  $47.DataSource ensureCertChain() => $_ensure(2);
}
...
class GrpcService_GoogleGrpc extends $pb.GeneratedMessage {
  factory GrpcService_GoogleGrpc({
    ...
    $30.Struct? config,
    $26.UInt32Value? perStreamBufferLimitBytes,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrpcService.GoogleGrpc', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.UInt32Value>(7, _omitFieldNames ? '' : 'perStreamBufferLimitBytes', subBuilder: $26.UInt32Value.create)
  ...
  @$pb.TagNumber(7)
  $26.UInt32Value get perStreamBufferLimitBytes => $_getN(6);
  @$pb.TagNumber(7)
  set perStreamBufferLimitBytes($26.UInt32Value v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasPerStreamBufferLimitBytes() => $_has(6);
  @$pb.TagNumber(7)
  void clearPerStreamBufferLimitBytes() => clearField(7);
  @$pb.TagNumber(7)
  $26.UInt32Value ensurePerStreamBufferLimitBytes() => $_ensure(6);
...
class GrpcService extends $pb.GeneratedMessage {
  factory GrpcService({
    ...
    $28.Duration? timeout,
    $core.Iterable<$47.HeaderValue>? initialMetadata,
    $47.RetryPolicy? retryPolicy,
  }) {
    final $result = create();
    if (envoyGrpc != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrpcService', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..pc<$47.HeaderValue>(5, _omitFieldNames ? '' : 'initialMetadata', $pb.PbFieldType.PM, subBuilder: $47.HeaderValue.create)
    ..aOM<$47.RetryPolicy>(6, _omitFieldNames ? '' : 'retryPolicy', subBuilder: $47.RetryPolicy.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $core.List<$47.HeaderValue> get initialMetadata => $_getList(3);
  ...
  @$pb.TagNumber(6)
  $47.RetryPolicy get retryPolicy => $_getN(4);
  @$pb.TagNumber(6)
  set retryPolicy($47.RetryPolicy v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasRetryPolicy() => $_has(4);
  @$pb.TagNumber(6)
  void clearRetryPolicy() => clearField(6);
  @$pb.TagNumber(6)
  $47.RetryPolicy ensureRetryPolicy() => $_ensure(4);
}
