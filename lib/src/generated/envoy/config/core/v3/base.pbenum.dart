...
class KeyValueAppend_KeyValueAppendAction extends $pb.ProtobufEnum {
  static const KeyValueAppend_KeyValueAppendAction APPEND_IF_EXISTS_OR_ADD = KeyValueAppend_KeyValueAppendAction._(0, _omitEnumNames ? '' : 'APPEND_IF_EXISTS_OR_ADD');
  static const KeyValueAppend_KeyValueAppendAction ADD_IF_ABSENT = KeyValueAppend_KeyValueAppendAction._(1, _omitEnumNames ? '' : 'ADD_IF_ABSENT');
  static const KeyValueAppend_KeyValueAppendAction OVERWRITE_IF_EXISTS_OR_ADD = KeyValueAppend_KeyValueAppendAction._(2, _omitEnumNames ? '' : 'OVERWRITE_IF_EXISTS_OR_ADD');
  static const KeyValueAppend_KeyValueAppendAction OVERWRITE_IF_EXISTS = KeyValueAppend_KeyValueAppendAction._(3, _omitEnumNames ? '' : 'OVERWRITE_IF_EXISTS');

  static const $core.List<KeyValueAppend_KeyValueAppendAction> values = <KeyValueAppend_KeyValueAppendAction> [
  ...
  static final $core.Map<$core.int, KeyValueAppend_KeyValueAppendAction> _byValue = $pb.ProtobufEnum.initByValue(values);
  static KeyValueAppend_KeyValueAppendAction? valueOf($core.int value) => _byValue[value];

  const KeyValueAppend_KeyValueAppendAction._($core.int v, $core.String n) : super(v, n);
}

/// Describes the supported actions types for header append action.
class HeaderValueOption_HeaderAppendAction extends $pb.ProtobufEnum {
  static const HeaderValueOption_HeaderAppendAction APPEND_IF_EXISTS_OR_ADD = HeaderValueOption_HeaderAppendAction._(0, _omitEnumNames ? '' : 'APPEND_IF_EXISTS_OR_ADD');
  static const HeaderValueOption_HeaderAppendAction ADD_IF_ABSENT = HeaderValueOption_HeaderAppendAction._(1, _omitEnumNames ? '' : 'ADD_IF_ABSENT');
  static const HeaderValueOption_HeaderAppendAction OVERWRITE_IF_EXISTS_OR_ADD = HeaderValueOption_HeaderAppendAction._(2, _omitEnumNames ? '' : 'OVERWRITE_IF_EXISTS_OR_ADD');
  static const HeaderValueOption_HeaderAppendAction OVERWRITE_IF_EXISTS = HeaderValueOption_HeaderAppendAction._(3, _omitEnumNames ? '' : 'OVERWRITE_IF_EXISTS');

  static const $core.List<HeaderValueOption_HeaderAppendAction> values = <HeaderValueOption_HeaderAppendAction> [
    APPEND_IF_EXISTS_OR_ADD,
    ADD_IF_ABSENT,
    OVERWRITE_IF_EXISTS_OR_ADD,
    OVERWRITE_IF_EXISTS,
  ...
  static final $core.Map<$core.int, HeaderValueOption_HeaderAppendAction> _byValue = $pb.ProtobufEnum.initByValue(values);
  static HeaderValueOption_HeaderAppendAction? valueOf($core.int value) => _byValue[value];

  const HeaderValueOption_HeaderAppendAction._($core.int v, $core.String n) : super(v, n);
}
