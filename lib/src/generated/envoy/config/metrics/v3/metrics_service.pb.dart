...
import '../../core/v3/config_source.pbenum.dart' as $50;
...
class MetricsServiceConfig extends $pb.GeneratedMessage {
  factory MetricsServiceConfig({
    ...
    $26.BoolValue? reportCountersAsDeltas,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MetricsServiceConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.metrics.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.BoolValue>(2, _omitFieldNames ? '' : 'reportCountersAsDeltas', subBuilder: $26.BoolValue.create)
    ..e<$50.ApiVersion>(3, _omitFieldNames ? '' : 'transportApiVersion', $pb.PbFieldType.OE, defaultOrMaker: $50.ApiVersion.AUTO, valueOf: $50.ApiVersion.valueOf, enumValues: $50.ApiVersion.values)
  ...
  @$pb.TagNumber(2)
  $26.BoolValue get reportCountersAsDeltas => $_getN(1);
  @$pb.TagNumber(2)
  set reportCountersAsDeltas($26.BoolValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasReportCountersAsDeltas() => $_has(1);
  @$pb.TagNumber(2)
  void clearReportCountersAsDeltas() => clearField(2);
  @$pb.TagNumber(2)
  $26.BoolValue ensureReportCountersAsDeltas() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $50.ApiVersion get transportApiVersion => $_getN(2);
  @$pb.TagNumber(3)
  set transportApiVersion($50.ApiVersion v) { setField(3, v); }
  @$pb.TagNumber(3)
