...
class StatsMatcher extends $pb.GeneratedMessage {
  factory StatsMatcher({
    $core.bool? rejectAll,
    $74.ListStringMatcher? exclusionList,
    $74.ListStringMatcher? inclusionList,
  }) {
    final $result = create();
    if (rejectAll != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StatsMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.metrics.v2'), createEmptyInstance: create)
    ...
    ..aOM<$74.ListStringMatcher>(2, _omitFieldNames ? '' : 'exclusionList', subBuilder: $74.ListStringMatcher.create)
    ..aOM<$74.ListStringMatcher>(3, _omitFieldNames ? '' : 'inclusionList', subBuilder: $74.ListStringMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $74.ListStringMatcher get exclusionList => $_getN(1);
  @$pb.TagNumber(2)
  set exclusionList($74.ListStringMatcher v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasExclusionList() => $_has(1);
  @$pb.TagNumber(2)
  void clearExclusionList() => clearField(2);
  @$pb.TagNumber(2)
  $74.ListStringMatcher ensureExclusionList() => $_ensure(1);

  /// Inclusive match. No stats are enabled except for those matching one of the supplied
  /// StringMatcher protos.
  @$pb.TagNumber(3)
  $74.ListStringMatcher get inclusionList => $_getN(2);
  @$pb.TagNumber(3)
  set inclusionList($74.ListStringMatcher v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasInclusionList() => $_has(2);
  @$pb.TagNumber(3)
  void clearInclusionList() => clearField(3);
  @$pb.TagNumber(3)
  $74.ListStringMatcher ensureInclusionList() => $_ensure(2);
}
