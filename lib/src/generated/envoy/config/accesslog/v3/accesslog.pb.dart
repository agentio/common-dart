...
import '../../../data/accesslog/v3/accesslog.pbenum.dart' as $67;
...
class ComparisonFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ComparisonFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.accesslog.v3'), createEmptyInstance: create)
    ...
    ..aOM<$47.RuntimeUInt32>(2, _omitFieldNames ? '' : 'value', subBuilder: $47.RuntimeUInt32.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $47.RuntimeUInt32 get value => $_getN(1);
  @$pb.TagNumber(2)
  set value($47.RuntimeUInt32 v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValue() => $_has(1);
  @$pb.TagNumber(2)
  void clearValue() => clearField(2);
  @$pb.TagNumber(2)
  $47.RuntimeUInt32 ensureValue() => $_ensure(1);
}
...
class RuntimeFilter extends $pb.GeneratedMessage {
  factory RuntimeFilter({
    ...
    $44.FractionalPercent? percentSampled,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RuntimeFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.accesslog.v3'), createEmptyInstance: create)
    ...
    ..aOM<$44.FractionalPercent>(2, _omitFieldNames ? '' : 'percentSampled', subBuilder: $44.FractionalPercent.create)
  ...
  /// denominator of 100.
  @$pb.TagNumber(2)
  $44.FractionalPercent get percentSampled => $_getN(1);
  @$pb.TagNumber(2)
  set percentSampled($44.FractionalPercent v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPercentSampled() => $_has(1);
  @$pb.TagNumber(2)
  void clearPercentSampled() => clearField(2);
  @$pb.TagNumber(2)
  $44.FractionalPercent ensurePercentSampled() => $_ensure(1);
...
class HeaderFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HeaderFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.accesslog.v3'), createEmptyInstance: create)
    ..aOM<$66.HeaderMatcher>(1, _omitFieldNames ? '' : 'header', subBuilder: $66.HeaderMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $66.HeaderMatcher get header => $_getN(0);
  @$pb.TagNumber(1)
  set header($66.HeaderMatcher v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasHeader() => $_has(0);
  @$pb.TagNumber(1)
  void clearHeader() => clearField(1);
  @$pb.TagNumber(1)
  $66.HeaderMatcher ensureHeader() => $_ensure(0);
}
...
class MetadataFilter extends $pb.GeneratedMessage {
  factory MetadataFilter({
    $62.MetadataMatcher? matcher,
    $26.BoolValue? matchIfKeyNotFound,
  }) {
    final $result = create();
    if (matcher != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MetadataFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.accesslog.v3'), createEmptyInstance: create)
    ..aOM<$62.MetadataMatcher>(1, _omitFieldNames ? '' : 'matcher', subBuilder: $62.MetadataMatcher.create)
    ..aOM<$26.BoolValue>(2, _omitFieldNames ? '' : 'matchIfKeyNotFound', subBuilder: $26.BoolValue.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $62.MetadataMatcher get matcher => $_getN(0);
  @$pb.TagNumber(1)
  set matcher($62.MetadataMatcher v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasMatcher() => $_has(0);
  @$pb.TagNumber(1)
  void clearMatcher() => clearField(1);
  @$pb.TagNumber(1)
  $62.MetadataMatcher ensureMatcher() => $_ensure(0);

  /// Default result if the key does not exist in dynamic metadata: if unset or
  /// true, then log; if false, then don't log.
  @$pb.TagNumber(2)
  $26.BoolValue get matchIfKeyNotFound => $_getN(1);
  @$pb.TagNumber(2)
  set matchIfKeyNotFound($26.BoolValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMatchIfKeyNotFound() => $_has(1);
  @$pb.TagNumber(2)
  void clearMatchIfKeyNotFound() => clearField(2);
  @$pb.TagNumber(2)
  $26.BoolValue ensureMatchIfKeyNotFound() => $_ensure(1);
}

/// Filters based on access log type.
class LogTypeFilter extends $pb.GeneratedMessage {
  factory LogTypeFilter({
    $core.Iterable<$67.AccessLogType>? types,
    $core.bool? exclude,
  }) {
    final $result = create();
    if (types != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LogTypeFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.accesslog.v3'), createEmptyInstance: create)
    ..pc<$67.AccessLogType>(1, _omitFieldNames ? '' : 'types', $pb.PbFieldType.KE, valueOf: $67.AccessLogType.valueOf, enumValues: $67.AccessLogType.values, defaultEnumValue: $67.AccessLogType.NotSet)
    ..aOB(2, _omitFieldNames ? '' : 'exclude')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$67.AccessLogType> get types => $_getList(0);
