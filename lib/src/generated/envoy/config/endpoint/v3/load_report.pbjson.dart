...
const UpstreamLocalityStats$json = {
  ...
  '2': [
    ...
    {'1': 'total_active_connections', '3': 9, '4': 1, '5': 4, '8': {}, '10': 'totalActiveConnections'},
    {'1': 'total_new_connections', '3': 10, '4': 1, '5': 4, '8': {}, '10': 'totalNewConnections'},
    {'1': 'total_fail_connections', '3': 11, '4': 1, '5': 4, '8': {}, '10': 'totalFailConnections'},
    {'1': 'cpu_utilization', '3': 12, '4': 1, '5': 11, '6': '.envoy.config.endpoint.v3.UnnamedEndpointLoadMetricStats', '10': 'cpuUtilization'},
    {'1': 'mem_utilization', '3': 13, '4': 1, '5': 11, '6': '.envoy.config.endpoint.v3.UnnamedEndpointLoadMetricStats', '10': 'memUtilization'},
    {'1': 'application_utilization', '3': 14, '4': 1, '5': 11, '6': '.envoy.config.endpoint.v3.UnnamedEndpointLoadMetricStats', '10': 'applicationUtilization'},
...
final $typed_data.Uint8List upstreamLocalityStatsDescriptor = $convert.base64Decode(
    ...
    'RzGAggASgEUhN0b3RhbElzc3VlZFJlcXVlc3RzEkIKGHRvdGFsX2FjdGl2ZV9jb25uZWN0aW9u'
    'cxgJIAEoBEII0sak4QYCCAFSFnRvdGFsQWN0aXZlQ29ubmVjdGlvbnMSPAoVdG90YWxfbmV3X2'
    'Nvbm5lY3Rpb25zGAogASgEQgjSxqThBgIIAVITdG90YWxOZXdDb25uZWN0aW9ucxI+ChZ0b3Rh'
    'bF9mYWlsX2Nvbm5lY3Rpb25zGAsgASgEQgjSxqThBgIIAVIUdG90YWxGYWlsQ29ubmVjdGlvbn'
    'MSYQoPY3B1X3V0aWxpemF0aW9uGAwgASgLMjguZW52b3kuY29uZmlnLmVuZHBvaW50LnYzLlVu'
    'bmFtZWRFbmRwb2ludExvYWRNZXRyaWNTdGF0c1IOY3B1VXRpbGl6YXRpb24SYQoPbWVtX3V0aW'
    'xpemF0aW9uGA0gASgLMjguZW52b3kuY29uZmlnLmVuZHBvaW50LnYzLlVubmFtZWRFbmRwb2lu'
    'dExvYWRNZXRyaWNTdGF0c1IObWVtVXRpbGl6YXRpb24ScQoXYXBwbGljYXRpb25fdXRpbGl6YX'
    'Rpb24YDiABKAsyOC5lbnZveS5jb25maWcuZW5kcG9pbnQudjMuVW5uYW1lZEVuZHBvaW50TG9h'
    'ZE1ldHJpY1N0YXRzUhZhcHBsaWNhdGlvblV0aWxpemF0aW9uEl0KEWxvYWRfbWV0cmljX3N0YX'
    'RzGAUgAygLMjEuZW52b3kuY29uZmlnLmVuZHBvaW50LnYzLkVuZHBvaW50TG9hZE1ldHJpY1N0'
    'YXRzUg9sb2FkTWV0cmljU3RhdHMSZwoXdXBzdHJlYW1fZW5kcG9pbnRfc3RhdHMYByADKAsyLy'
    '5lbnZveS5jb25maWcuZW5kcG9pbnQudjMuVXBzdHJlYW1FbmRwb2ludFN0YXRzUhV1cHN0cmVh'
    'bUVuZHBvaW50U3RhdHMSGgoIcHJpb3JpdHkYBiABKA1SCHByaW9yaXR5OjKaxYgeLQorZW52b3'
    'kuYXBpLnYyLmVuZHBvaW50LlVwc3RyZWFtTG9jYWxpdHlTdGF0cw==');
...
@$core.Deprecated('Use unnamedEndpointLoadMetricStatsDescriptor instead')
const UnnamedEndpointLoadMetricStats$json = {
  '1': 'UnnamedEndpointLoadMetricStats',
  '2': [
    {'1': 'num_requests_finished_with_metric', '3': 1, '4': 1, '5': 4, '10': 'numRequestsFinishedWithMetric'},
    {'1': 'total_metric_value', '3': 2, '4': 1, '5': 1, '10': 'totalMetricValue'},
  ],
};

/// Descriptor for `UnnamedEndpointLoadMetricStats`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List unnamedEndpointLoadMetricStatsDescriptor = $convert.base64Decode(
    'Ch5Vbm5hbWVkRW5kcG9pbnRMb2FkTWV0cmljU3RhdHMSSAohbnVtX3JlcXVlc3RzX2ZpbmlzaG'
    'VkX3dpdGhfbWV0cmljGAEgASgEUh1udW1SZXF1ZXN0c0ZpbmlzaGVkV2l0aE1ldHJpYxIsChJ0'
    'b3RhbF9tZXRyaWNfdmFsdWUYAiABKAFSEHRvdGFsTWV0cmljVmFsdWU=');
