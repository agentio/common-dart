...
import '../../core/v3/health_check.pbenum.dart' as $103;
...
class LbEndpoint extends $pb.GeneratedMessage {
  factory LbEndpoint({
    Endpoint? endpoint,
    $103.HealthStatus? healthStatus,
    $47.Metadata? metadata,
    $26.UInt32Value? loadBalancingWeight,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LbEndpoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.endpoint.v3'), createEmptyInstance: create)
    ...
    ..e<$103.HealthStatus>(2, _omitFieldNames ? '' : 'healthStatus', $pb.PbFieldType.OE, defaultOrMaker: $103.HealthStatus.UNKNOWN, valueOf: $103.HealthStatus.valueOf, enumValues: $103.HealthStatus.values)
    ..aOM<$47.Metadata>(3, _omitFieldNames ? '' : 'metadata', subBuilder: $47.Metadata.create)
    ..aOM<$26.UInt32Value>(4, _omitFieldNames ? '' : 'loadBalancingWeight', subBuilder: $26.UInt32Value.create)
  ...
  @$pb.TagNumber(2)
  $103.HealthStatus get healthStatus => $_getN(1);
  @$pb.TagNumber(2)
  set healthStatus($103.HealthStatus v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  $26.UInt32Value get loadBalancingWeight => $_getN(3);
  @$pb.TagNumber(4)
  set loadBalancingWeight($26.UInt32Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLoadBalancingWeight() => $_has(3);
  @$pb.TagNumber(4)
  void clearLoadBalancingWeight() => clearField(4);
  @$pb.TagNumber(4)
  $26.UInt32Value ensureLoadBalancingWeight() => $_ensure(3);
...
class LedsClusterLocalityConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LedsClusterLocalityConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.endpoint.v3'), createEmptyInstance: create)
    ..aOM<$50.ConfigSource>(1, _omitFieldNames ? '' : 'ledsConfig', subBuilder: $50.ConfigSource.create)
  ...
  @$pb.TagNumber(1)
  $50.ConfigSource get ledsConfig => $_getN(0);
  @$pb.TagNumber(1)
  set ledsConfig($50.ConfigSource v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasLedsConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearLedsConfig() => clearField(1);
  @$pb.TagNumber(1)
  $50.ConfigSource ensureLedsConfig() => $_ensure(0);
...
class LocalityLbEndpoints extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LocalityLbEndpoints', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.endpoint.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.UInt32Value>(3, _omitFieldNames ? '' : 'loadBalancingWeight', subBuilder: $26.UInt32Value.create)
    ..a<$core.int>(5, _omitFieldNames ? '' : 'priority', $pb.PbFieldType.OU3)
    ..aOM<$26.UInt32Value>(6, _omitFieldNames ? '' : 'proximity', subBuilder: $26.UInt32Value.create)
    ...
    ..aOM<$47.Metadata>(9, _omitFieldNames ? '' : 'metadata', subBuilder: $47.Metadata.create)
    ..hasRequiredFields = false
  ;
  ...
  ///  assigned no load.
  @$pb.TagNumber(3)
  $26.UInt32Value get loadBalancingWeight => $_getN(2);
  @$pb.TagNumber(3)
  set loadBalancingWeight($26.UInt32Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasLoadBalancingWeight() => $_has(2);
  @$pb.TagNumber(3)
  void clearLoadBalancingWeight() => clearField(3);
  @$pb.TagNumber(3)
  $26.UInt32Value ensureLoadBalancingWeight() => $_ensure(2);
  ...
  /// [#not-implemented-hide:]
  @$pb.TagNumber(6)
  $26.UInt32Value get proximity => $_getN(4);
  @$pb.TagNumber(6)
  set proximity($26.UInt32Value v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasProximity() => $_has(4);
  @$pb.TagNumber(6)
  void clearProximity() => clearField(6);
  @$pb.TagNumber(6)
  $26.UInt32Value ensureProximity() => $_ensure(4);
  ...
  @$pb.TagNumber(9)
  $47.Metadata get metadata => $_getN(7);
  @$pb.TagNumber(9)
  set metadata($47.Metadata v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasMetadata() => $_has(7);
  @$pb.TagNumber(9)
  void clearMetadata() => clearField(9);
  @$pb.TagNumber(9)
  $47.Metadata ensureMetadata() => $_ensure(7);
}
