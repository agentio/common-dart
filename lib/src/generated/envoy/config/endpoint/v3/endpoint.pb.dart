...
import 'endpoint_components.pb.dart' as $104;
...
class ClusterLoadAssignment_Policy_DropOverload extends $pb.GeneratedMessage {
  factory ClusterLoadAssignment_Policy_DropOverload({
    ...
    $44.FractionalPercent? dropPercentage,
  }) {
    final $result = create();
    if (category != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClusterLoadAssignment.Policy.DropOverload', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.endpoint.v3'), createEmptyInstance: create)
    ...
    ..aOM<$44.FractionalPercent>(2, _omitFieldNames ? '' : 'dropPercentage', subBuilder: $44.FractionalPercent.create)
  ...
  @$pb.TagNumber(2)
  $44.FractionalPercent get dropPercentage => $_getN(1);
  @$pb.TagNumber(2)
  set dropPercentage($44.FractionalPercent v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDropPercentage() => $_has(1);
  @$pb.TagNumber(2)
  void clearDropPercentage() => clearField(2);
  @$pb.TagNumber(2)
  $44.FractionalPercent ensureDropPercentage() => $_ensure(1);
}
...
class ClusterLoadAssignment extends $pb.GeneratedMessage {
  factory ClusterLoadAssignment({
    ...
    $core.Iterable<$104.LocalityLbEndpoints>? endpoints,
    ClusterLoadAssignment_Policy? policy,
    $core.Map<$core.String, $104.Endpoint>? namedEndpoints,
  }) {
    final $result = create();
    if (clusterName != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClusterLoadAssignment', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.endpoint.v3'), createEmptyInstance: create)
    ...
    ..pc<$104.LocalityLbEndpoints>(2, _omitFieldNames ? '' : 'endpoints', $pb.PbFieldType.PM, subBuilder: $104.LocalityLbEndpoints.create)
    ..aOM<ClusterLoadAssignment_Policy>(4, _omitFieldNames ? '' : 'policy', subBuilder: ClusterLoadAssignment_Policy.create)
    ..m<$core.String, $104.Endpoint>(5, _omitFieldNames ? '' : 'namedEndpoints', entryClassName: 'ClusterLoadAssignment.NamedEndpointsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $104.Endpoint.create, valueDefaultOrMaker: $104.Endpoint.getDefault, packageName: const $pb.PackageName('envoy.config.endpoint.v3'))
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$104.LocalityLbEndpoints> get endpoints => $_getList(1);
  ...
  @$pb.TagNumber(5)
  $core.Map<$core.String, $104.Endpoint> get namedEndpoints => $_getMap(3);
}
