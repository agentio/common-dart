...
class CircuitBreakers_Thresholds_RetryBudget extends $pb.GeneratedMessage {
  factory CircuitBreakers_Thresholds_RetryBudget({
    $44.Percent? budgetPercent,
    $26.UInt32Value? minRetryConcurrency,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CircuitBreakers.Thresholds.RetryBudget', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.cluster.v3'), createEmptyInstance: create)
    ..aOM<$44.Percent>(1, _omitFieldNames ? '' : 'budgetPercent', subBuilder: $44.Percent.create)
    ..aOM<$26.UInt32Value>(2, _omitFieldNames ? '' : 'minRetryConcurrency', subBuilder: $26.UInt32Value.create)
  ...
  @$pb.TagNumber(1)
  $44.Percent get budgetPercent => $_getN(0);
  @$pb.TagNumber(1)
  set budgetPercent($44.Percent v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBudgetPercent() => $_has(0);
  @$pb.TagNumber(1)
  void clearBudgetPercent() => clearField(1);
  @$pb.TagNumber(1)
  $44.Percent ensureBudgetPercent() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $26.UInt32Value get minRetryConcurrency => $_getN(1);
  @$pb.TagNumber(2)
  set minRetryConcurrency($26.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMinRetryConcurrency() => $_has(1);
  @$pb.TagNumber(2)
  void clearMinRetryConcurrency() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt32Value ensureMinRetryConcurrency() => $_ensure(1);
}
...
class CircuitBreakers_Thresholds extends $pb.GeneratedMessage {
  factory CircuitBreakers_Thresholds({
    ...
    $26.UInt32Value? maxConnections,
    $26.UInt32Value? maxPendingRequests,
    $26.UInt32Value? maxRequests,
    $26.UInt32Value? maxRetries,
    $core.bool? trackRemaining,
    $26.UInt32Value? maxConnectionPools,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CircuitBreakers.Thresholds', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.cluster.v3'), createEmptyInstance: create)
    ..e<$47.RoutingPriority>(1, _omitFieldNames ? '' : 'priority', $pb.PbFieldType.OE, defaultOrMaker: $47.RoutingPriority.DEFAULT, valueOf: $47.RoutingPriority.valueOf, enumValues: $47.RoutingPriority.values)
    ..aOM<$26.UInt32Value>(2, _omitFieldNames ? '' : 'maxConnections', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(3, _omitFieldNames ? '' : 'maxPendingRequests', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(4, _omitFieldNames ? '' : 'maxRequests', subBuilder: $26.UInt32Value.create)
    ..aOM<$26.UInt32Value>(5, _omitFieldNames ? '' : 'maxRetries', subBuilder: $26.UInt32Value.create)
    ..aOB(6, _omitFieldNames ? '' : 'trackRemaining')
    ..aOM<$26.UInt32Value>(7, _omitFieldNames ? '' : 'maxConnectionPools', subBuilder: $26.UInt32Value.create)
  ...
  @$pb.TagNumber(1)
  $47.RoutingPriority get priority => $_getN(0);
  @$pb.TagNumber(1)
  set priority($47.RoutingPriority v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $26.UInt32Value get maxConnections => $_getN(1);
  @$pb.TagNumber(2)
  set maxConnections($26.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMaxConnections() => $_has(1);
  @$pb.TagNumber(2)
  void clearMaxConnections() => clearField(2);
  @$pb.TagNumber(2)
  $26.UInt32Value ensureMaxConnections() => $_ensure(1);

  /// The maximum number of pending requests that Envoy will allow to the
  /// upstream cluster. If not specified, the default is 1024.
  /// This limit is applied as a connection limit for non-HTTP traffic.
  @$pb.TagNumber(3)
  $26.UInt32Value get maxPendingRequests => $_getN(2);
  @$pb.TagNumber(3)
  set maxPendingRequests($26.UInt32Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMaxPendingRequests() => $_has(2);
  @$pb.TagNumber(3)
  void clearMaxPendingRequests() => clearField(3);
  @$pb.TagNumber(3)
  $26.UInt32Value ensureMaxPendingRequests() => $_ensure(2);

  /// The maximum number of parallel requests that Envoy will make to the
  /// upstream cluster. If not specified, the default is 1024.
  /// This limit does not apply to non-HTTP traffic.
  @$pb.TagNumber(4)
  $26.UInt32Value get maxRequests => $_getN(3);
  @$pb.TagNumber(4)
  set maxRequests($26.UInt32Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasMaxRequests() => $_has(3);
  @$pb.TagNumber(4)
  void clearMaxRequests() => clearField(4);
  @$pb.TagNumber(4)
  $26.UInt32Value ensureMaxRequests() => $_ensure(3);

  /// The maximum number of parallel retries that Envoy will allow to the
  /// upstream cluster. If not specified, the default is 3.
  @$pb.TagNumber(5)
  $26.UInt32Value get maxRetries => $_getN(4);
  @$pb.TagNumber(5)
  set maxRetries($26.UInt32Value v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasMaxRetries() => $_has(4);
  @$pb.TagNumber(5)
  void clearMaxRetries() => clearField(5);
  @$pb.TagNumber(5)
  $26.UInt32Value ensureMaxRetries() => $_ensure(4);
  ...
  /// more details.
  @$pb.TagNumber(7)
  $26.UInt32Value get maxConnectionPools => $_getN(6);
  @$pb.TagNumber(7)
  set maxConnectionPools($26.UInt32Value v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasMaxConnectionPools() => $_has(6);
  @$pb.TagNumber(7)
  void clearMaxConnectionPools() => clearField(7);
  @$pb.TagNumber(7)
  $26.UInt32Value ensureMaxConnectionPools() => $_ensure(6);
...
class CircuitBreakers extends $pb.GeneratedMessage {
  factory CircuitBreakers({
    ...
    $core.Iterable<CircuitBreakers_Thresholds>? perHostThresholds,
  }) {
    final $result = create();
    if (thresholds != null) {
      $result.thresholds.addAll(thresholds);
    }
    if (perHostThresholds != null) {
      $result.perHostThresholds.addAll(perHostThresholds);
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CircuitBreakers', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.cluster.v3'), createEmptyInstance: create)
    ...
    ..pc<CircuitBreakers_Thresholds>(2, _omitFieldNames ? '' : 'perHostThresholds', $pb.PbFieldType.PM, subBuilder: CircuitBreakers_Thresholds.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<CircuitBreakers_Thresholds> get perHostThresholds => $_getList(1);
}
