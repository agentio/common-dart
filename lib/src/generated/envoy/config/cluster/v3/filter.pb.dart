...
class Filter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Filter', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.cluster.v3'), createEmptyInstance: create)
    ...
    ..aOM<$50.ExtensionConfigSource>(3, _omitFieldNames ? '' : 'configDiscovery', subBuilder: $50.ExtensionConfigSource.create)
  ...
  @$pb.TagNumber(3)
  set configDiscovery($50.ExtensionConfigSource v) { setField(3, v); }
  @$pb.TagNumber(3)
