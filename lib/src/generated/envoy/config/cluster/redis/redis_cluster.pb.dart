...
class RedisClusterConfig extends $pb.GeneratedMessage {
  factory RedisClusterConfig({
    $28.Duration? clusterRefreshRate,
    $28.Duration? clusterRefreshTimeout,
    $28.Duration? redirectRefreshInterval,
    $26.UInt32Value? redirectRefreshThreshold,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RedisClusterConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.cluster.redis'), createEmptyInstance: create)
    ..aOM<$28.Duration>(1, _omitFieldNames ? '' : 'clusterRefreshRate', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(2, _omitFieldNames ? '' : 'clusterRefreshTimeout', subBuilder: $28.Duration.create)
    ..aOM<$28.Duration>(3, _omitFieldNames ? '' : 'redirectRefreshInterval', subBuilder: $28.Duration.create)
    ..aOM<$26.UInt32Value>(4, _omitFieldNames ? '' : 'redirectRefreshThreshold', subBuilder: $26.UInt32Value.create)
  ...
  @$pb.TagNumber(1)
  $28.Duration get clusterRefreshRate => $_getN(0);
  @$pb.TagNumber(1)
  set clusterRefreshRate($28.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasClusterRefreshRate() => $_has(0);
  @$pb.TagNumber(1)
  void clearClusterRefreshRate() => clearField(1);
  @$pb.TagNumber(1)
  $28.Duration ensureClusterRefreshRate() => $_ensure(0);

  /// Timeout for topology refresh request. If not set, this defaults to 3s.
  @$pb.TagNumber(2)
  $28.Duration get clusterRefreshTimeout => $_getN(1);
  @$pb.TagNumber(2)
  set clusterRefreshTimeout($28.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasClusterRefreshTimeout() => $_has(1);
  @$pb.TagNumber(2)
  void clearClusterRefreshTimeout() => clearField(2);
  @$pb.TagNumber(2)
  $28.Duration ensureClusterRefreshTimeout() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $28.Duration get redirectRefreshInterval => $_getN(2);
  @$pb.TagNumber(3)
  set redirectRefreshInterval($28.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasRedirectRefreshInterval() => $_has(2);
  @$pb.TagNumber(3)
  void clearRedirectRefreshInterval() => clearField(3);
  @$pb.TagNumber(3)
  $28.Duration ensureRedirectRefreshInterval() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $26.UInt32Value get redirectRefreshThreshold => $_getN(3);
  @$pb.TagNumber(4)
  set redirectRefreshThreshold($26.UInt32Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasRedirectRefreshThreshold() => $_has(3);
  @$pb.TagNumber(4)
  void clearRedirectRefreshThreshold() => clearField(4);
  @$pb.TagNumber(4)
  $26.UInt32Value ensureRedirectRefreshThreshold() => $_ensure(3);
