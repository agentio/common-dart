...
import '../../../../google/api/expr/v1alpha1/checked.pb.dart' as $141;
import '../../../../google/api/expr/v1alpha1/syntax.pb.dart' as $125;
import '../../../type/matcher/v3/filter_state.pb.dart' as $143;
...
import '../../route/v3/route_components.pb.dart' as $66;
...
class RBAC_AuditLoggingOptions_AuditLoggerConfig extends $pb.GeneratedMessage {
  factory RBAC_AuditLoggingOptions_AuditLoggerConfig({
    $40.TypedExtensionConfig? auditLogger,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RBAC.AuditLoggingOptions.AuditLoggerConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.rbac.v3'), createEmptyInstance: create)
    ..aOM<$40.TypedExtensionConfig>(1, _omitFieldNames ? '' : 'auditLogger', subBuilder: $40.TypedExtensionConfig.create)
  ...
  @$pb.TagNumber(1)
  $40.TypedExtensionConfig get auditLogger => $_getN(0);
  @$pb.TagNumber(1)
  set auditLogger($40.TypedExtensionConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAuditLogger() => $_has(0);
  @$pb.TagNumber(1)
  void clearAuditLogger() => clearField(1);
  @$pb.TagNumber(1)
  $40.TypedExtensionConfig ensureAuditLogger() => $_ensure(0);
...
class Policy extends $pb.GeneratedMessage {
  factory Policy({
    ...
    $125.Expr? condition,
    $141.CheckedExpr? checkedCondition,
  }) {
    final $result = create();
    if (permissions != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Policy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.rbac.v3'), createEmptyInstance: create)
    ...
    ..aOM<$125.Expr>(3, _omitFieldNames ? '' : 'condition', subBuilder: $125.Expr.create)
    ..aOM<$141.CheckedExpr>(4, _omitFieldNames ? '' : 'checkedCondition', subBuilder: $141.CheckedExpr.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $125.Expr get condition => $_getN(2);
  @$pb.TagNumber(3)
  set condition($125.Expr v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCondition() => $_has(2);
  @$pb.TagNumber(3)
  void clearCondition() => clearField(3);
  @$pb.TagNumber(3)
  $125.Expr ensureCondition() => $_ensure(2);

  /// [#not-implemented-hide:]
  /// An optional symbolic expression that has been successfully type checked.
  /// Only be used when condition is not used.
  @$pb.TagNumber(4)
  $141.CheckedExpr get checkedCondition => $_getN(3);
  @$pb.TagNumber(4)
  set checkedCondition($141.CheckedExpr v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCheckedCondition() => $_has(3);
  @$pb.TagNumber(4)
  void clearCheckedCondition() => clearField(4);
  @$pb.TagNumber(4)
  $141.CheckedExpr ensureCheckedCondition() => $_ensure(3);
}
...
class Permission extends $pb.GeneratedMessage {
  factory Permission({
    ...
    $core.bool? any,
    $66.HeaderMatcher? header,
    $42.CidrRange? destinationIp,
    $core.int? destinationPort,
    $62.MetadataMatcher? metadata,
    Permission? notRule,
    $58.StringMatcher? requestedServerName,
    $142.PathMatcher? urlPath,
    $54.Int32Range? destinationPortRange,
    $40.TypedExtensionConfig? matcher,
    $40.TypedExtensionConfig? uriTemplate,
  }) {
    final $result = create();
    if (andRules != null) {
  ...
  static const $core.Map<$core.int, Permission_Rule> _Permission_RuleByTag = {
    ...
    13 : Permission_Rule.uriTemplate,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Permission', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.rbac.v3'), createEmptyInstance: create)
    ...
    ..aOM<$66.HeaderMatcher>(4, _omitFieldNames ? '' : 'header', subBuilder: $66.HeaderMatcher.create)
    ..aOM<$42.CidrRange>(5, _omitFieldNames ? '' : 'destinationIp', subBuilder: $42.CidrRange.create)
    ..a<$core.int>(6, _omitFieldNames ? '' : 'destinationPort', $pb.PbFieldType.OU3)
    ..aOM<$62.MetadataMatcher>(7, _omitFieldNames ? '' : 'metadata', subBuilder: $62.MetadataMatcher.create)
    ..aOM<Permission>(8, _omitFieldNames ? '' : 'notRule', subBuilder: Permission.create)
    ..aOM<$58.StringMatcher>(9, _omitFieldNames ? '' : 'requestedServerName', subBuilder: $58.StringMatcher.create)
    ..aOM<$142.PathMatcher>(10, _omitFieldNames ? '' : 'urlPath', subBuilder: $142.PathMatcher.create)
    ..aOM<$54.Int32Range>(11, _omitFieldNames ? '' : 'destinationPortRange', subBuilder: $54.Int32Range.create)
    ..aOM<$40.TypedExtensionConfig>(12, _omitFieldNames ? '' : 'matcher', subBuilder: $40.TypedExtensionConfig.create)
    ..aOM<$40.TypedExtensionConfig>(13, _omitFieldNames ? '' : 'uriTemplate', subBuilder: $40.TypedExtensionConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $66.HeaderMatcher get header => $_getN(3);
  @$pb.TagNumber(4)
  set header($66.HeaderMatcher v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasHeader() => $_has(3);
  @$pb.TagNumber(4)
  void clearHeader() => clearField(4);
  @$pb.TagNumber(4)
  $66.HeaderMatcher ensureHeader() => $_ensure(3);

  /// A CIDR block that describes the destination IP.
  @$pb.TagNumber(5)
  $42.CidrRange get destinationIp => $_getN(4);
  @$pb.TagNumber(5)
  set destinationIp($42.CidrRange v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDestinationIp() => $_has(4);
  @$pb.TagNumber(5)
  void clearDestinationIp() => clearField(5);
  @$pb.TagNumber(5)
  $42.CidrRange ensureDestinationIp() => $_ensure(4);
  ...
  @$pb.TagNumber(7)
  $62.MetadataMatcher get metadata => $_getN(6);
  @$pb.TagNumber(7)
  set metadata($62.MetadataMatcher v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasMetadata() => $_has(6);
  @$pb.TagNumber(7)
  void clearMetadata() => clearField(7);
  @$pb.TagNumber(7)
  $62.MetadataMatcher ensureMetadata() => $_ensure(6);
  ...
  ///  setup SNI.
  @$pb.TagNumber(9)
  $58.StringMatcher get requestedServerName => $_getN(8);
  @$pb.TagNumber(9)
  set requestedServerName($58.StringMatcher v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasRequestedServerName() => $_has(8);
  @$pb.TagNumber(9)
  void clearRequestedServerName() => clearField(9);
  @$pb.TagNumber(9)
  $58.StringMatcher ensureRequestedServerName() => $_ensure(8);

  /// A URL path on the incoming HTTP request. Only available for HTTP.
  @$pb.TagNumber(10)
  $142.PathMatcher get urlPath => $_getN(9);
  @$pb.TagNumber(10)
  set urlPath($142.PathMatcher v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasUrlPath() => $_has(9);
  @$pb.TagNumber(10)
  void clearUrlPath() => clearField(10);
  @$pb.TagNumber(10)
  $142.PathMatcher ensureUrlPath() => $_ensure(9);

  /// A port number range that describes a range of destination ports connecting to.
  @$pb.TagNumber(11)
  $54.Int32Range get destinationPortRange => $_getN(10);
  @$pb.TagNumber(11)
  set destinationPortRange($54.Int32Range v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasDestinationPortRange() => $_has(10);
  @$pb.TagNumber(11)
  void clearDestinationPortRange() => clearField(11);
  @$pb.TagNumber(11)
  $54.Int32Range ensureDestinationPortRange() => $_ensure(10);

  /// Extension for configuring custom matchers for RBAC.
  /// [#extension-category: envoy.rbac.matchers]
  @$pb.TagNumber(12)
  $40.TypedExtensionConfig get matcher => $_getN(11);
  @$pb.TagNumber(12)
  set matcher($40.TypedExtensionConfig v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasMatcher() => $_has(11);
  @$pb.TagNumber(12)
  void clearMatcher() => clearField(12);
  @$pb.TagNumber(12)
  $40.TypedExtensionConfig ensureMatcher() => $_ensure(11);

  /// URI template path matching.
  /// [#extension-category: envoy.path.match]
  @$pb.TagNumber(13)
  $40.TypedExtensionConfig get uriTemplate => $_getN(12);
  @$pb.TagNumber(13)
  set uriTemplate($40.TypedExtensionConfig v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasUriTemplate() => $_has(12);
  @$pb.TagNumber(13)
  void clearUriTemplate() => clearField(13);
  @$pb.TagNumber(13)
  $40.TypedExtensionConfig ensureUriTemplate() => $_ensure(12);
}
...
class Principal_Authenticated extends $pb.GeneratedMessage {
  factory Principal_Authenticated({
    $58.StringMatcher? principalName,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Principal.Authenticated', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.rbac.v3'), createEmptyInstance: create)
    ..aOM<$58.StringMatcher>(2, _omitFieldNames ? '' : 'principalName', subBuilder: $58.StringMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $58.StringMatcher get principalName => $_getN(0);
  @$pb.TagNumber(2)
  set principalName($58.StringMatcher v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPrincipalName() => $_has(0);
  @$pb.TagNumber(2)
  void clearPrincipalName() => clearField(2);
  @$pb.TagNumber(2)
  $58.StringMatcher ensurePrincipalName() => $_ensure(0);
}
...
class Principal extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    $42.CidrRange? sourceIp,
    $66.HeaderMatcher? header,
    $62.MetadataMatcher? metadata,
    Principal? notId,
    $142.PathMatcher? urlPath,
    $42.CidrRange? directRemoteIp,
    $42.CidrRange? remoteIp,
    $143.FilterStateMatcher? filterState,
  }) {
    final $result = create();
    if (andIds != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Principal', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.rbac.v3'), createEmptyInstance: create)
    ...
    ..aOM<$42.CidrRange>(5, _omitFieldNames ? '' : 'sourceIp', subBuilder: $42.CidrRange.create)
    ..aOM<$66.HeaderMatcher>(6, _omitFieldNames ? '' : 'header', subBuilder: $66.HeaderMatcher.create)
    ..aOM<$62.MetadataMatcher>(7, _omitFieldNames ? '' : 'metadata', subBuilder: $62.MetadataMatcher.create)
    ..aOM<Principal>(8, _omitFieldNames ? '' : 'notId', subBuilder: Principal.create)
    ..aOM<$142.PathMatcher>(9, _omitFieldNames ? '' : 'urlPath', subBuilder: $142.PathMatcher.create)
    ..aOM<$42.CidrRange>(10, _omitFieldNames ? '' : 'directRemoteIp', subBuilder: $42.CidrRange.create)
    ..aOM<$42.CidrRange>(11, _omitFieldNames ? '' : 'remoteIp', subBuilder: $42.CidrRange.create)
    ..aOM<$143.FilterStateMatcher>(12, _omitFieldNames ? '' : 'filterState', subBuilder: $143.FilterStateMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  $42.CidrRange get sourceIp => $_getN(4);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  set sourceIp($42.CidrRange v) { setField(5, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  $42.CidrRange ensureSourceIp() => $_ensure(4);
  ...
  @$pb.TagNumber(6)
  $66.HeaderMatcher get header => $_getN(5);
  @$pb.TagNumber(6)
  set header($66.HeaderMatcher v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasHeader() => $_has(5);
  @$pb.TagNumber(6)
  void clearHeader() => clearField(6);
  @$pb.TagNumber(6)
  $66.HeaderMatcher ensureHeader() => $_ensure(5);
  ...
  /// A URL path on the incoming HTTP request. Only available for HTTP.
  @$pb.TagNumber(9)
  $142.PathMatcher get urlPath => $_getN(8);
  @$pb.TagNumber(9)
  set urlPath($142.PathMatcher v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasUrlPath() => $_has(8);
  @$pb.TagNumber(9)
  void clearUrlPath() => clearField(9);
  @$pb.TagNumber(9)
  $142.PathMatcher ensureUrlPath() => $_ensure(8);
  ...
  /// etc.
  @$pb.TagNumber(10)
  $42.CidrRange get directRemoteIp => $_getN(9);
  @$pb.TagNumber(10)
  set directRemoteIp($42.CidrRange v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasDirectRemoteIp() => $_has(9);
  @$pb.TagNumber(10)
  void clearDirectRemoteIp() => clearField(10);
  @$pb.TagNumber(10)
  $42.CidrRange ensureDirectRemoteIp() => $_ensure(9);
  ...
  /// protocol, etc.
  @$pb.TagNumber(11)
  $42.CidrRange get remoteIp => $_getN(10);
  @$pb.TagNumber(11)
  set remoteIp($42.CidrRange v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasRemoteIp() => $_has(10);
  @$pb.TagNumber(11)
  void clearRemoteIp() => clearField(11);
  @$pb.TagNumber(11)
  $42.CidrRange ensureRemoteIp() => $_ensure(10);

  /// Identifies the principal using a filter state object.
  @$pb.TagNumber(12)
  $143.FilterStateMatcher get filterState => $_getN(11);
  @$pb.TagNumber(12)
  set filterState($143.FilterStateMatcher v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasFilterState() => $_has(11);
  @$pb.TagNumber(12)
  void clearFilterState() => clearField(12);
  @$pb.TagNumber(12)
  $143.FilterStateMatcher ensureFilterState() => $_ensure(11);
}
