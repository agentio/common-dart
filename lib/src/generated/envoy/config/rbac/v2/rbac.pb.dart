...
import '../../../type/matcher/metadata.pb.dart' as $126;
import '../../../type/matcher/path.pb.dart' as $127;
...
class Permission extends $pb.GeneratedMessage {
  factory Permission({
    ...
    $31.CidrRange? destinationIp,
    $core.int? destinationPort,
    $126.MetadataMatcher? metadata,
    Permission? notRule,
    $74.StringMatcher? requestedServerName,
    $127.PathMatcher? urlPath,
  }) {
    final $result = create();
    if (andRules != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Permission', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.rbac.v2'), createEmptyInstance: create)
    ...
    ..aOM<$91.HeaderMatcher>(4, _omitFieldNames ? '' : 'header', subBuilder: $91.HeaderMatcher.create)
    ..aOM<$31.CidrRange>(5, _omitFieldNames ? '' : 'destinationIp', subBuilder: $31.CidrRange.create)
    ..a<$core.int>(6, _omitFieldNames ? '' : 'destinationPort', $pb.PbFieldType.OU3)
    ..aOM<$126.MetadataMatcher>(7, _omitFieldNames ? '' : 'metadata', subBuilder: $126.MetadataMatcher.create)
    ..aOM<Permission>(8, _omitFieldNames ? '' : 'notRule', subBuilder: Permission.create)
    ..aOM<$74.StringMatcher>(9, _omitFieldNames ? '' : 'requestedServerName', subBuilder: $74.StringMatcher.create)
    ..aOM<$127.PathMatcher>(10, _omitFieldNames ? '' : 'urlPath', subBuilder: $127.PathMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $91.HeaderMatcher get header => $_getN(3);
  @$pb.TagNumber(4)
  set header($91.HeaderMatcher v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasHeader() => $_has(3);
  @$pb.TagNumber(4)
  void clearHeader() => clearField(4);
  @$pb.TagNumber(4)
  $91.HeaderMatcher ensureHeader() => $_ensure(3);

  /// A CIDR block that describes the destination IP.
  @$pb.TagNumber(5)
  $31.CidrRange get destinationIp => $_getN(4);
  @$pb.TagNumber(5)
  set destinationIp($31.CidrRange v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDestinationIp() => $_has(4);
  @$pb.TagNumber(5)
  void clearDestinationIp() => clearField(5);
  @$pb.TagNumber(5)
  $31.CidrRange ensureDestinationIp() => $_ensure(4);
  ...
  @$pb.TagNumber(7)
  $126.MetadataMatcher get metadata => $_getN(6);
  @$pb.TagNumber(7)
  set metadata($126.MetadataMatcher v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasMetadata() => $_has(6);
  @$pb.TagNumber(7)
  void clearMetadata() => clearField(7);
  @$pb.TagNumber(7)
  $126.MetadataMatcher ensureMetadata() => $_ensure(6);
  ...
  ///  setup SNI.
  @$pb.TagNumber(9)
  $74.StringMatcher get requestedServerName => $_getN(8);
  @$pb.TagNumber(9)
  set requestedServerName($74.StringMatcher v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasRequestedServerName() => $_has(8);
  @$pb.TagNumber(9)
  void clearRequestedServerName() => clearField(9);
  @$pb.TagNumber(9)
  $74.StringMatcher ensureRequestedServerName() => $_ensure(8);

  /// A URL path on the incoming HTTP request. Only available for HTTP.
  @$pb.TagNumber(10)
  $127.PathMatcher get urlPath => $_getN(9);
  @$pb.TagNumber(10)
  set urlPath($127.PathMatcher v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasUrlPath() => $_has(9);
  @$pb.TagNumber(10)
  void clearUrlPath() => clearField(10);
  @$pb.TagNumber(10)
  $127.PathMatcher ensureUrlPath() => $_ensure(9);
}
...
class Principal_Authenticated extends $pb.GeneratedMessage {
  factory Principal_Authenticated({
    $74.StringMatcher? principalName,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Principal.Authenticated', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.rbac.v2'), createEmptyInstance: create)
    ..aOM<$74.StringMatcher>(2, _omitFieldNames ? '' : 'principalName', subBuilder: $74.StringMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  /// authenticated.
  @$pb.TagNumber(2)
  $74.StringMatcher get principalName => $_getN(0);
  @$pb.TagNumber(2)
  set principalName($74.StringMatcher v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPrincipalName() => $_has(0);
  @$pb.TagNumber(2)
  void clearPrincipalName() => clearField(2);
  @$pb.TagNumber(2)
  $74.StringMatcher ensurePrincipalName() => $_ensure(0);
}
...
class Principal extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    $31.CidrRange? sourceIp,
    $91.HeaderMatcher? header,
    $126.MetadataMatcher? metadata,
    Principal? notId,
    $127.PathMatcher? urlPath,
    $31.CidrRange? directRemoteIp,
    $31.CidrRange? remoteIp,
  }) {
    final $result = create();
    if (andIds != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Principal', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.rbac.v2'), createEmptyInstance: create)
    ...
    ..aOM<$31.CidrRange>(5, _omitFieldNames ? '' : 'sourceIp', subBuilder: $31.CidrRange.create)
    ..aOM<$91.HeaderMatcher>(6, _omitFieldNames ? '' : 'header', subBuilder: $91.HeaderMatcher.create)
    ..aOM<$126.MetadataMatcher>(7, _omitFieldNames ? '' : 'metadata', subBuilder: $126.MetadataMatcher.create)
    ..aOM<Principal>(8, _omitFieldNames ? '' : 'notId', subBuilder: Principal.create)
    ..aOM<$127.PathMatcher>(9, _omitFieldNames ? '' : 'urlPath', subBuilder: $127.PathMatcher.create)
    ..aOM<$31.CidrRange>(10, _omitFieldNames ? '' : 'directRemoteIp', subBuilder: $31.CidrRange.create)
    ..aOM<$31.CidrRange>(11, _omitFieldNames ? '' : 'remoteIp', subBuilder: $31.CidrRange.create)
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  $31.CidrRange get sourceIp => $_getN(4);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  set sourceIp($31.CidrRange v) { setField(5, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  $31.CidrRange ensureSourceIp() => $_ensure(4);
  ...
  /// field if you want to match the URL path without the query and fragment string.
  @$pb.TagNumber(6)
  $91.HeaderMatcher get header => $_getN(5);
  @$pb.TagNumber(6)
  set header($91.HeaderMatcher v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasHeader() => $_has(5);
  @$pb.TagNumber(6)
  void clearHeader() => clearField(6);
  @$pb.TagNumber(6)
  $91.HeaderMatcher ensureHeader() => $_ensure(5);
  ...
  /// A URL path on the incoming HTTP request. Only available for HTTP.
  @$pb.TagNumber(9)
  $127.PathMatcher get urlPath => $_getN(8);
  @$pb.TagNumber(9)
  set urlPath($127.PathMatcher v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasUrlPath() => $_has(8);
  @$pb.TagNumber(9)
  void clearUrlPath() => clearField(9);
  @$pb.TagNumber(9)
  $127.PathMatcher ensureUrlPath() => $_ensure(8);
  ...
  @$pb.TagNumber(10)
  $31.CidrRange get directRemoteIp => $_getN(9);
  @$pb.TagNumber(10)
  set directRemoteIp($31.CidrRange v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasDirectRemoteIp() => $_has(9);
  @$pb.TagNumber(10)
  void clearDirectRemoteIp() => clearField(10);
  @$pb.TagNumber(10)
  $31.CidrRange ensureDirectRemoteIp() => $_ensure(9);
  ...
  /// proxy protocol, etc.
  @$pb.TagNumber(11)
  $31.CidrRange get remoteIp => $_getN(10);
  @$pb.TagNumber(11)
  set remoteIp($31.CidrRange v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasRemoteIp() => $_has(10);
  @$pb.TagNumber(11)
  void clearRemoteIp() => clearField(11);
  @$pb.TagNumber(11)
  $31.CidrRange ensureRemoteIp() => $_ensure(10);
}
