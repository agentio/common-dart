...
class OmitHostMetadataConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OmitHostMetadataConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.retry.omit_host_metadata.v2'), createEmptyInstance: create)
    ..aOM<$36.Metadata>(1, _omitFieldNames ? '' : 'metadataMatch', subBuilder: $36.Metadata.create)
  ...
  @$pb.TagNumber(1)
  $36.Metadata get metadataMatch => $_getN(0);
  @$pb.TagNumber(1)
  set metadataMatch($36.Metadata v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasMetadataMatch() => $_has(0);
  @$pb.TagNumber(1)
  void clearMetadataMatch() => clearField(1);
  @$pb.TagNumber(1)
  $36.Metadata ensureMetadataMatch() => $_ensure(0);
}
