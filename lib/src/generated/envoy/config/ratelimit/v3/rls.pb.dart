...
class RateLimitServiceConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RateLimitServiceConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.ratelimit.v3'), createEmptyInstance: create)
    ...
    ..e<$50.ApiVersion>(4, _omitFieldNames ? '' : 'transportApiVersion', $pb.PbFieldType.OE, defaultOrMaker: $50.ApiVersion.AUTO, valueOf: $50.ApiVersion.valueOf, enumValues: $50.ApiVersion.values)
  ...
  @$pb.TagNumber(4)
  $50.ApiVersion get transportApiVersion => $_getN(1);
  @$pb.TagNumber(4)
  set transportApiVersion($50.ApiVersion v) { setField(4, v); }
  @$pb.TagNumber(4)
