...
class ApiListener extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ApiListener', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.listener.v2'), createEmptyInstance: create)
    ..aOM<$34.Any>(1, _omitFieldNames ? '' : 'apiListener', subBuilder: $34.Any.create)
  ...
  @$pb.TagNumber(1)
  $34.Any get apiListener => $_getN(0);
  @$pb.TagNumber(1)
  set apiListener($34.Any v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasApiListener() => $_has(0);
  @$pb.TagNumber(1)
  void clearApiListener() => clearField(1);
  @$pb.TagNumber(1)
  $34.Any ensureApiListener() => $_ensure(0);
}
