...
import 'api_listener.pb.dart' as $71;
import 'listener.pbenum.dart';
import 'listener_components.pb.dart' as $69;
import 'udp_listener_config.pb.dart' as $70;
...
class ListenerCollection extends $pb.GeneratedMessage {
  factory ListenerCollection({
    $core.Iterable<$68.CollectionEntry>? entries,
  }) {
    final $result = create();
    if (entries != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListenerCollection', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.listener.v3'), createEmptyInstance: create)
    ..pc<$68.CollectionEntry>(1, _omitFieldNames ? '' : 'entries', $pb.PbFieldType.PM, subBuilder: $68.CollectionEntry.create)
    ..hasRequiredFields = false
  ;
...
class Listener_DeprecatedV1 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Listener.DeprecatedV1', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.listener.v3'), createEmptyInstance: create)
    ..aOM<$26.BoolValue>(1, _omitFieldNames ? '' : 'bindToPort', subBuilder: $26.BoolValue.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $26.BoolValue get bindToPort => $_getN(0);
  @$pb.TagNumber(1)
  set bindToPort($26.BoolValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBindToPort() => $_has(0);
  @$pb.TagNumber(1)
  void clearBindToPort() => clearField(1);
  @$pb.TagNumber(1)
  $26.BoolValue ensureBindToPort() => $_ensure(0);
}
...
class Listener_ConnectionBalanceConfig extends $pb.GeneratedMessage {
  factory Listener_ConnectionBalanceConfig({
    ...
    $40.TypedExtensionConfig? extendBalance,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Listener.ConnectionBalanceConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.listener.v3'), createEmptyInstance: create)
    ...
    ..aOM<$40.TypedExtensionConfig>(2, _omitFieldNames ? '' : 'extendBalance', subBuilder: $40.TypedExtensionConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $40.TypedExtensionConfig get extendBalance => $_getN(1);
  @$pb.TagNumber(2)
  set extendBalance($40.TypedExtensionConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasExtendBalance() => $_has(1);
  @$pb.TagNumber(2)
  void clearExtendBalance() => clearField(2);
  @$pb.TagNumber(2)
  $40.TypedExtensionConfig ensureExtendBalance() => $_ensure(1);
}
...
class Listener extends $pb.GeneratedMessage {
  factory Listener({
    $core.String? name,
    $42.Address? address,
    $core.Iterable<$69.FilterChain>? filterChains,
    $26.BoolValue? useOriginalDst,
    $26.UInt32Value? perConnectionBufferLimitBytes,
    $47.Metadata? metadata,
  @$core.Deprecated('This field is deprecated.')
    Listener_DeprecatedV1? deprecatedV1,
    Listener_DrainType? drainType,
    $core.Iterable<$69.ListenerFilter>? listenerFilters,
    $26.BoolValue? transparent,
    $26.BoolValue? freebind,
    $26.UInt32Value? tcpFastOpenQueueLength,
    $core.Iterable<$39.SocketOption>? socketOptions,
    $28.Duration? listenerFiltersTimeout,
    $47.TrafficDirection? trafficDirection,
    $core.bool? continueOnListenerFiltersTimeout,
    $70.UdpListenerConfig? udpListenerConfig,
    $71.ApiListener? apiListener,
    Listener_ConnectionBalanceConfig? connectionBalanceConfig,
  @$core.Deprecated('This field is deprecated.')
    $core.bool? reusePort,
    $core.Iterable<$72.AccessLog>? accessLog,
    $26.UInt32Value? tcpBacklogSize,
    $69.FilterChain? defaultFilterChain,
    $26.BoolValue? bindToPort,
    Listener_InternalListenerConfig? internalListener,
    $core.String? statPrefix,
    $26.BoolValue? enableReusePort,
    $core.bool? enableMptcp,
    $core.bool? ignoreGlobalConnLimit,
    $61.Matcher? filterChainMatcher,
    $core.Iterable<AdditionalAddress>? additionalAddresses,
    $26.UInt32Value? maxConnectionsToAcceptPerSocketEvent,
    $core.bool? bypassOverloadManager,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
    ...
    if (bypassOverloadManager != null) {
      $result.bypassOverloadManager = bypassOverloadManager;
    }
    return $result;
  }
  Listener._() : super();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Listener', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.listener.v3'), createEmptyInstance: create)
    ...
    ..aOM<$42.Address>(2, _omitFieldNames ? '' : 'address', subBuilder: $42.Address.create)
    ..pc<$69.FilterChain>(3, _omitFieldNames ? '' : 'filterChains', $pb.PbFieldType.PM, subBuilder: $69.FilterChain.create)
    ..aOM<$26.BoolValue>(4, _omitFieldNames ? '' : 'useOriginalDst', subBuilder: $26.BoolValue.create)
    ..aOM<$26.UInt32Value>(5, _omitFieldNames ? '' : 'perConnectionBufferLimitBytes', subBuilder: $26.UInt32Value.create)
    ..aOM<$47.Metadata>(6, _omitFieldNames ? '' : 'metadata', subBuilder: $47.Metadata.create)
    ...
    ..pc<$69.ListenerFilter>(9, _omitFieldNames ? '' : 'listenerFilters', $pb.PbFieldType.PM, subBuilder: $69.ListenerFilter.create)
    ..aOM<$26.BoolValue>(10, _omitFieldNames ? '' : 'transparent', subBuilder: $26.BoolValue.create)
    ..aOM<$26.BoolValue>(11, _omitFieldNames ? '' : 'freebind', subBuilder: $26.BoolValue.create)
    ..aOM<$26.UInt32Value>(12, _omitFieldNames ? '' : 'tcpFastOpenQueueLength', subBuilder: $26.UInt32Value.create)
    ..pc<$39.SocketOption>(13, _omitFieldNames ? '' : 'socketOptions', $pb.PbFieldType.PM, subBuilder: $39.SocketOption.create)
    ..aOM<$28.Duration>(15, _omitFieldNames ? '' : 'listenerFiltersTimeout', subBuilder: $28.Duration.create)
    ..e<$47.TrafficDirection>(16, _omitFieldNames ? '' : 'trafficDirection', $pb.PbFieldType.OE, defaultOrMaker: $47.TrafficDirection.UNSPECIFIED, valueOf: $47.TrafficDirection.valueOf, enumValues: $47.TrafficDirection.values)
    ..aOB(17, _omitFieldNames ? '' : 'continueOnListenerFiltersTimeout')
    ..aOM<$70.UdpListenerConfig>(18, _omitFieldNames ? '' : 'udpListenerConfig', subBuilder: $70.UdpListenerConfig.create)
    ..aOM<$71.ApiListener>(19, _omitFieldNames ? '' : 'apiListener', subBuilder: $71.ApiListener.create)
    ...
    ..pc<$72.AccessLog>(22, _omitFieldNames ? '' : 'accessLog', $pb.PbFieldType.PM, subBuilder: $72.AccessLog.create)
    ..aOM<$26.UInt32Value>(24, _omitFieldNames ? '' : 'tcpBacklogSize', subBuilder: $26.UInt32Value.create)
    ..aOM<$69.FilterChain>(25, _omitFieldNames ? '' : 'defaultFilterChain', subBuilder: $69.FilterChain.create)
    ..aOM<$26.BoolValue>(26, _omitFieldNames ? '' : 'bindToPort', subBuilder: $26.BoolValue.create)
    ...
    ..aOM<$26.BoolValue>(29, _omitFieldNames ? '' : 'enableReusePort', subBuilder: $26.BoolValue.create)
    ..aOB(30, _omitFieldNames ? '' : 'enableMptcp')
    ..aOB(31, _omitFieldNames ? '' : 'ignoreGlobalConnLimit')
    ..aOM<$61.Matcher>(32, _omitFieldNames ? '' : 'filterChainMatcher', subBuilder: $61.Matcher.create)
    ..pc<AdditionalAddress>(33, _omitFieldNames ? '' : 'additionalAddresses', $pb.PbFieldType.PM, subBuilder: AdditionalAddress.create)
    ..aOM<$26.UInt32Value>(34, _omitFieldNames ? '' : 'maxConnectionsToAcceptPerSocketEvent', subBuilder: $26.UInt32Value.create)
    ..aOB(35, _omitFieldNames ? '' : 'bypassOverloadManager')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $42.Address get address => $_getN(1);
  @$pb.TagNumber(2)
  set address($42.Address v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAddress() => $_has(1);
  @$pb.TagNumber(2)
  void clearAddress() => clearField(2);
  @$pb.TagNumber(2)
  $42.Address ensureAddress() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $core.List<$69.FilterChain> get filterChains => $_getList(2);
  ...
  @$pb.TagNumber(4)
  $26.BoolValue get useOriginalDst => $_getN(3);
  @$pb.TagNumber(4)
  set useOriginalDst($26.BoolValue v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasUseOriginalDst() => $_has(3);
  @$pb.TagNumber(4)
  void clearUseOriginalDst() => clearField(4);
  @$pb.TagNumber(4)
  $26.BoolValue ensureUseOriginalDst() => $_ensure(3);
  ...
  /// Listener metadata.
  @$pb.TagNumber(6)
  $47.Metadata get metadata => $_getN(5);
  @$pb.TagNumber(6)
  set metadata($47.Metadata v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasMetadata() => $_has(5);
  @$pb.TagNumber(6)
  void clearMetadata() => clearField(6);
  @$pb.TagNumber(6)
  $47.Metadata ensureMetadata() => $_ensure(5);
  ...
  @$pb.TagNumber(9)
  $core.List<$69.ListenerFilter> get listenerFilters => $_getList(8);
  ...
  @$pb.TagNumber(10)
  $26.BoolValue get transparent => $_getN(9);
  @$pb.TagNumber(10)
  set transparent($26.BoolValue v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasTransparent() => $_has(9);
  @$pb.TagNumber(10)
  void clearTransparent() => clearField(10);
  @$pb.TagNumber(10)
  $26.BoolValue ensureTransparent() => $_ensure(9);
  ...
  /// nor disabled.
  @$pb.TagNumber(11)
  $26.BoolValue get freebind => $_getN(10);
  @$pb.TagNumber(11)
  set freebind($26.BoolValue v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasFreebind() => $_has(10);
  @$pb.TagNumber(11)
  void clearFreebind() => clearField(11);
  @$pb.TagNumber(11)
  $26.BoolValue ensureFreebind() => $_ensure(10);
  ...
  @$pb.TagNumber(12)
  $26.UInt32Value get tcpFastOpenQueueLength => $_getN(11);
  @$pb.TagNumber(12)
  set tcpFastOpenQueueLength($26.UInt32Value v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasTcpFastOpenQueueLength() => $_has(11);
  @$pb.TagNumber(12)
  void clearTcpFastOpenQueueLength() => clearField(12);
  @$pb.TagNumber(12)
  $26.UInt32Value ensureTcpFastOpenQueueLength() => $_ensure(11);
  ...
  @$pb.TagNumber(13)
  $core.List<$39.SocketOption> get socketOptions => $_getList(12);
  ...
  @$pb.TagNumber(15)
  $28.Duration get listenerFiltersTimeout => $_getN(13);
  @$pb.TagNumber(15)
  set listenerFiltersTimeout($28.Duration v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasListenerFiltersTimeout() => $_has(13);
  @$pb.TagNumber(15)
  void clearListenerFiltersTimeout() => clearField(15);
  @$pb.TagNumber(15)
  $28.Duration ensureListenerFiltersTimeout() => $_ensure(13);

  /// Specifies the intended direction of the traffic relative to the local Envoy.
  /// This property is required on Windows for listeners using the original destination filter,
  /// see :ref:`Original Destination <config_listener_filters_original_dst>`.
  @$pb.TagNumber(16)
  $47.TrafficDirection get trafficDirection => $_getN(14);
  @$pb.TagNumber(16)
  set trafficDirection($47.TrafficDirection v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(18)
  $70.UdpListenerConfig get udpListenerConfig => $_getN(16);
  @$pb.TagNumber(18)
  set udpListenerConfig($70.UdpListenerConfig v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasUdpListenerConfig() => $_has(16);
  @$pb.TagNumber(18)
  void clearUdpListenerConfig() => clearField(18);
  @$pb.TagNumber(18)
  $70.UdpListenerConfig ensureUdpListenerConfig() => $_ensure(16);
  ...
  @$pb.TagNumber(19)
  $71.ApiListener get apiListener => $_getN(17);
  @$pb.TagNumber(19)
  set apiListener($71.ApiListener v) { setField(19, v); }
  @$pb.TagNumber(19)
  $core.bool hasApiListener() => $_has(17);
  @$pb.TagNumber(19)
  void clearApiListener() => clearField(19);
  @$pb.TagNumber(19)
  $71.ApiListener ensureApiListener() => $_ensure(17);
  ...
  @$pb.TagNumber(22)
  $core.List<$72.AccessLog> get accessLog => $_getList(20);
  ...
  @$pb.TagNumber(24)
  $26.UInt32Value get tcpBacklogSize => $_getN(21);
  @$pb.TagNumber(24)
  set tcpBacklogSize($26.UInt32Value v) { setField(24, v); }
  @$pb.TagNumber(24)
  $core.bool hasTcpBacklogSize() => $_has(21);
  @$pb.TagNumber(24)
  void clearTcpBacklogSize() => clearField(24);
  @$pb.TagNumber(24)
  $26.UInt32Value ensureTcpBacklogSize() => $_ensure(21);

  /// The default filter chain if none of the filter chain matches. If no default filter chain is supplied,
  /// the connection will be closed. The filter chain match is ignored in this field.
  @$pb.TagNumber(25)
  $69.FilterChain get defaultFilterChain => $_getN(22);
  @$pb.TagNumber(25)
  set defaultFilterChain($69.FilterChain v) { setField(25, v); }
  @$pb.TagNumber(25)
  $core.bool hasDefaultFilterChain() => $_has(22);
  @$pb.TagNumber(25)
  void clearDefaultFilterChain() => clearField(25);
  @$pb.TagNumber(25)
  $69.FilterChain ensureDefaultFilterChain() => $_ensure(22);
  ...
  @$pb.TagNumber(26)
  $26.BoolValue get bindToPort => $_getN(23);
  @$pb.TagNumber(26)
  set bindToPort($26.BoolValue v) { setField(26, v); }
  @$pb.TagNumber(26)
  $core.bool hasBindToPort() => $_has(23);
  @$pb.TagNumber(26)
  void clearBindToPort() => clearField(26);
  @$pb.TagNumber(26)
  $26.BoolValue ensureBindToPort() => $_ensure(23);
  ...
  @$pb.TagNumber(29)
  $26.BoolValue get enableReusePort => $_getN(26);
  @$pb.TagNumber(29)
  set enableReusePort($26.BoolValue v) { setField(29, v); }
  @$pb.TagNumber(29)
  $core.bool hasEnableReusePort() => $_has(26);
  @$pb.TagNumber(29)
  void clearEnableReusePort() => clearField(29);
  @$pb.TagNumber(29)
  $26.BoolValue ensureEnableReusePort() => $_ensure(26);
  ...
  @$pb.TagNumber(32)
  $61.Matcher get filterChainMatcher => $_getN(29);
  @$pb.TagNumber(32)
  set filterChainMatcher($61.Matcher v) { setField(32, v); }
  @$pb.TagNumber(32)
  $core.bool hasFilterChainMatcher() => $_has(29);
  @$pb.TagNumber(32)
  void clearFilterChainMatcher() => clearField(32);
  @$pb.TagNumber(32)
  $61.Matcher ensureFilterChainMatcher() => $_ensure(29);
  ...
  /// from the kernel.
  @$pb.TagNumber(34)
  $26.UInt32Value get maxConnectionsToAcceptPerSocketEvent => $_getN(31);
  @$pb.TagNumber(34)
  set maxConnectionsToAcceptPerSocketEvent($26.UInt32Value v) { setField(34, v); }
  @$pb.TagNumber(34)
  $core.bool hasMaxConnectionsToAcceptPerSocketEvent() => $_has(31);
  @$pb.TagNumber(34)
  void clearMaxConnectionsToAcceptPerSocketEvent() => clearField(34);
  @$pb.TagNumber(34)
  $26.UInt32Value ensureMaxConnectionsToAcceptPerSocketEvent() => $_ensure(31);

  /// Whether the listener bypasses configured overload manager actions.
  @$pb.TagNumber(35)
  $core.bool get bypassOverloadManager => $_getBF(32);
  @$pb.TagNumber(35)
  set bypassOverloadManager($core.bool v) { $_setBool(32, v); }
  @$pb.TagNumber(35)
  $core.bool hasBypassOverloadManager() => $_has(32);
  @$pb.TagNumber(35)
  void clearBypassOverloadManager() => clearField(35);
}
