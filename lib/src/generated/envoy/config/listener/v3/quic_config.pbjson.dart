...
const QuicProtocolOptions$json = {
  ...
  '2': [
    ...
    {'1': 'send_disable_active_migration', '3': 10, '4': 1, '5': 11, '6': '.google.protobuf.BoolValue', '10': 'sendDisableActiveMigration'},
    {'1': 'connection_debug_visitor_config', '3': 11, '4': 1, '5': 11, '6': '.envoy.config.core.v3.TypedExtensionConfig', '10': 'connectionDebugVisitorConfig'},
  ],
  '7': {},
};
...
final $typed_data.Uint8List quicProtocolOptionsDescriptor = $convert.base64Decode(
    ...
    'Npb25Db25maWdCCNLGpOEGAggBUhxzZXJ2ZXJQcmVmZXJyZWRBZGRyZXNzQ29uZmlnEl0KHXNl'
    'bmRfZGlzYWJsZV9hY3RpdmVfbWlncmF0aW9uGAogASgLMhouZ29vZ2xlLnByb3RvYnVmLkJvb2'
    'xWYWx1ZVIac2VuZERpc2FibGVBY3RpdmVNaWdyYXRpb24ScQofY29ubmVjdGlvbl9kZWJ1Z192'
    'aXNpdG9yX2NvbmZpZxgLIAEoCzIqLmVudm95LmNvbmZpZy5jb3JlLnYzLlR5cGVkRXh0ZW5zaW'
    '9uQ29uZmlnUhxjb25uZWN0aW9uRGVidWdWaXNpdG9yQ29uZmlnOjCaxYgeKwopZW52b3kuYXBp'
    'LnYyLmxpc3RlbmVyLlF1aWNQcm90b2NvbE9wdGlvbnM=');
