...
class FilterChainMatch extends $pb.GeneratedMessage {
  factory FilterChainMatch({
    $core.Iterable<$42.CidrRange>? prefixRanges,
    $core.String? addressSuffix,
    $26.UInt32Value? suffixLen,
    $core.Iterable<$42.CidrRange>? sourcePrefixRanges,
    $core.Iterable<$core.int>? sourcePorts,
    $26.UInt32Value? destinationPort,
    ...
    $core.Iterable<$42.CidrRange>? directSourcePrefixRanges,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FilterChainMatch', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.listener.v3'), createEmptyInstance: create)
    ..pc<$42.CidrRange>(3, _omitFieldNames ? '' : 'prefixRanges', $pb.PbFieldType.PM, subBuilder: $42.CidrRange.create)
    ..aOS(4, _omitFieldNames ? '' : 'addressSuffix')
    ..aOM<$26.UInt32Value>(5, _omitFieldNames ? '' : 'suffixLen', subBuilder: $26.UInt32Value.create)
    ..pc<$42.CidrRange>(6, _omitFieldNames ? '' : 'sourcePrefixRanges', $pb.PbFieldType.PM, subBuilder: $42.CidrRange.create)
    ..p<$core.int>(7, _omitFieldNames ? '' : 'sourcePorts', $pb.PbFieldType.KU3)
    ..aOM<$26.UInt32Value>(8, _omitFieldNames ? '' : 'destinationPort', subBuilder: $26.UInt32Value.create)
    ...
    ..pc<$42.CidrRange>(13, _omitFieldNames ? '' : 'directSourcePrefixRanges', $pb.PbFieldType.PM, subBuilder: $42.CidrRange.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.List<$42.CidrRange> get prefixRanges => $_getList(0);
  ...
  /// [#not-implemented-hide:]
  @$pb.TagNumber(5)
  $26.UInt32Value get suffixLen => $_getN(2);
  @$pb.TagNumber(5)
  set suffixLen($26.UInt32Value v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasSuffixLen() => $_has(2);
  @$pb.TagNumber(5)
  void clearSuffixLen() => clearField(5);
  @$pb.TagNumber(5)
  $26.UInt32Value ensureSuffixLen() => $_ensure(2);
  ...
  /// ignored.
  @$pb.TagNumber(6)
  $core.List<$42.CidrRange> get sourcePrefixRanges => $_getList(3);
  ...
  @$pb.TagNumber(8)
  $26.UInt32Value get destinationPort => $_getN(5);
  @$pb.TagNumber(8)
  set destinationPort($26.UInt32Value v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasDestinationPort() => $_has(5);
  @$pb.TagNumber(8)
  void clearDestinationPort() => clearField(8);
  @$pb.TagNumber(8)
  $26.UInt32Value ensureDestinationPort() => $_ensure(5);
  ...
  @$pb.TagNumber(13)
  $core.List<$42.CidrRange> get directSourcePrefixRanges => $_getList(10);
}
...
class FilterChain_OnDemandConfiguration extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FilterChain.OnDemandConfiguration', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.listener.v3'), createEmptyInstance: create)
    ..aOM<$28.Duration>(1, _omitFieldNames ? '' : 'rebuildTimeout', subBuilder: $28.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $28.Duration get rebuildTimeout => $_getN(0);
  @$pb.TagNumber(1)
  set rebuildTimeout($28.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasRebuildTimeout() => $_has(0);
  @$pb.TagNumber(1)
  void clearRebuildTimeout() => clearField(1);
  @$pb.TagNumber(1)
  $28.Duration ensureRebuildTimeout() => $_ensure(0);
}
...
class FilterChain extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FilterChain', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.listener.v3'), createEmptyInstance: create)
    ...
    ..aOM<$26.BoolValue>(4, _omitFieldNames ? '' : 'useProxyProto', subBuilder: $26.BoolValue.create)
    ..aOM<$47.Metadata>(5, _omitFieldNames ? '' : 'metadata', subBuilder: $47.Metadata.create)
    ..aOM<$47.TransportSocket>(6, _omitFieldNames ? '' : 'transportSocket', subBuilder: $47.TransportSocket.create)
    ...
    ..aOM<$28.Duration>(9, _omitFieldNames ? '' : 'transportSocketConnectTimeout', subBuilder: $28.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(4)
  $26.BoolValue get useProxyProto => $_getN(2);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(4)
  set useProxyProto($26.BoolValue v) { setField(4, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(4)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(4)
  $26.BoolValue ensureUseProxyProto() => $_ensure(2);

  /// [#not-implemented-hide:] filter chain metadata.
  @$pb.TagNumber(5)
  $47.Metadata get metadata => $_getN(3);
  @$pb.TagNumber(5)
  set metadata($47.Metadata v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  $47.TransportSocket get transportSocket => $_getN(4);
  @$pb.TagNumber(6)
  set transportSocket($47.TransportSocket v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasTransportSocket() => $_has(4);
  @$pb.TagNumber(6)
  void clearTransportSocket() => clearField(6);
  @$pb.TagNumber(6)
  $47.TransportSocket ensureTransportSocket() => $_ensure(4);
  ...
  @$pb.TagNumber(9)
  $28.Duration get transportSocketConnectTimeout => $_getN(7);
  @$pb.TagNumber(9)
  set transportSocketConnectTimeout($28.Duration v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasTransportSocketConnectTimeout() => $_has(7);
  @$pb.TagNumber(9)
  void clearTransportSocketConnectTimeout() => clearField(9);
  @$pb.TagNumber(9)
  $28.Duration ensureTransportSocketConnectTimeout() => $_ensure(7);
}
...
class ListenerFilterChainMatchPredicate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListenerFilterChainMatchPredicate', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.listener.v3'), createEmptyInstance: create)
    ...
    ..aOM<$54.Int32Range>(5, _omitFieldNames ? '' : 'destinationPortRange', subBuilder: $54.Int32Range.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $54.Int32Range get destinationPortRange => $_getN(4);
  @$pb.TagNumber(5)
  set destinationPortRange($54.Int32Range v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDestinationPortRange() => $_has(4);
  @$pb.TagNumber(5)
  void clearDestinationPortRange() => clearField(5);
  @$pb.TagNumber(5)
  $54.Int32Range ensureDestinationPortRange() => $_ensure(4);
}
...
class ListenerFilter extends $pb.GeneratedMessage {
  ...
  /// listener closes the connections.
  @$pb.TagNumber(5)
  $50.ExtensionConfigSource get configDiscovery => $_getN(3);
  @$pb.TagNumber(5)
  set configDiscovery($50.ExtensionConfigSource v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  void clearConfigDiscovery() => clearField(5);
  @$pb.TagNumber(5)
  $50.ExtensionConfigSource ensureConfigDiscovery() => $_ensure(3);
}
